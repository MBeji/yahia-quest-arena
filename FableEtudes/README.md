...
| 18  | [Cours vivants (blocs pédagogiques & illustration)](18-cours-vivants/ETUDE.md)               | 📐 le cours cesse d'être un mur de texte ; la géométrie cesse d'être enseignée sans figure | moyenne+   | en exécution | é14 (livrée) ; médium **SVG seul** + cadrage arbitrés 2026-07-14 ; **lots 1-4 livrés** (517 cours structurés · 3 827 cartes · figures légendées · **gate contenu ouvert aux 541 leçons** → 46 violations de notation corrigées, axe 5 « Illustration » actif) ; reste lot 5 (géométrie 9ᵉ) |
...
**`18` (cours vivants) s'insère en parallèle** : ses lots 1 à 3 sont du code pur (aucun fichier de
contenu touché) et transforment 512 cours / 541 résumés d'un coup ; ses lots 4-5 (doctrine
d'illustration + géométrie 9ᵉ) conditionnent la qualité de toute campagne de contenu ultérieure —
donc à passer **avant** les grosses vagues de génération (16, lycée).
