...
| 20  | [Réponses acceptées (rappel tolérant & questions libres natives)](20-rappel-reponses-acceptees/ETUDE.md) | 🧠 rend les ~12 400 missions Rappel réellement jouables — une réponse juste formulée autrement cesse d'être refusée, **zéro question exclue** — et ouvre le type natif `short_answer` : la question **sans réponses proposées** devient authorable | moyenne+   | brouillon    | é17 + é03 (livrées) ; scoring ensembliste + champ contenu `acceptedAnswers` généré hors-ligne & server-only, consommé par le mode Rappel ET le type natif ; Q-1/Q-3 arbitrées 2026-07-15, Q-2/Q-4/Q-5 ouvertes ; **arbitrages humains : zéro question exclue (2026-07-15) · volet questions libres (2026-07-16)**             |
