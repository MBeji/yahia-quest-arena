...
| 20  | [Rappel actif tolérant (jeu de réponses acceptées)](20-rappel-reponses-acceptees/ETUDE.md)   | 🧠 rend les ~12 400 missions Rappel réellement jouables — une réponse juste formulée autrement cesse d'être refusée, **zéro question exclue** | moyenne+   | brouillon    | é17 (livrée) ; scoring ensembliste + champ contenu `recallAnswers` généré hors-ligne & server-only ; Q-1…Q-4 ouvertes ; **arbitrage humain 2026-07-15 : on n'exclut aucune question**                                                                                                                                         |
