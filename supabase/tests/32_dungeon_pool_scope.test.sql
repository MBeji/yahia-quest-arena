...
INSERT INTO public.parcours (id, name_fr, kind, theme_id, grade_id, icon, color)
VALUES
  ('dj-parcours-riche',  'DJ Riche',  'libre', 'dj-theme', 'd0000000-0000-0000-0000-0000000a0001'::uuid, 'Brain', 'subject-math'),
  ('dj-parcours-voisin', 'DJ Voisin', 'libre', 'dj-theme', 'd0000000-0000-0000-0000-0000000a0002'::uuid, 'Brain', 'subject-math'),
  ('dj-parcours-pauvre', 'DJ Pauvre', 'libre', 'dj-theme', 'd0000000-0000-0000-0000-0000000a0003'::uuid, 'Brain', 'subject-math');
...
INSERT INTO public.parcours (id, name_fr, kind, theme_id, grade_id, icon, color)
VALUES ('dj-parcours-limite', 'DJ Limite', 'libre', 'dj-theme', 'd0000000-0000-0000-0000-0000000a0004'::uuid, 'Brain', 'subject-math');
