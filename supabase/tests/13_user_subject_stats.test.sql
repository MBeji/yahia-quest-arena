...
INSERT INTO public.chapters (id, subject_id, title) VALUES
  ('f9000000-0000-0000-0000-000000000001', 'stats-s1', 'Ch1'),
  ('f9000000-0000-0000-0000-000000000002', 'stats-s2', 'Ch2');

INSERT INTO public.exercises (id, chapter_id, subject_id, title, xp_reward) VALUES
  ('fd000000-0000-0000-0000-000000000001', 'f9000000-0000-0000-0000-000000000001', 'stats-s1', 'E1', 50),
  ('fd000000-0000-0000-0000-000000000002', 'f9000000-0000-0000-0000-000000000002', 'stats-s2', 'E2', 50);

INSERT INTO public.attempts
  (user_id, exercise_id, subject_id, correct_count, total_count, score_pct, duration_seconds, xp_earned)
VALUES
  ('e5555555-5555-5555-5555-555555555555', 'fd000000-0000-0000-0000-000000000001', 'stats-s1', 4, 5, 80, 120, 50),
  ('e5555555-5555-5555-5555-555555555555', 'fd000000-0000-0000-0000-000000000001', 'stats-s1', 3, 5, 60, 120, 30),
  ('e5555555-5555-5555-5555-555555555555', 'fd000000-0000-0000-0000-000000000002', 'stats-s2', 5, 5, 100, 120, 40),
  -- A different user's attempt must NOT leak into A's stats.
  ('e6666666-6666-6666-6666-666666666666', 'fd000000-0000-0000-0000-000000000001', 'stats-s1', 5, 5, 100, 120, 99);
