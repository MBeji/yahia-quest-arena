...
- **Piège n°1 :** ne jamais oublier l''accord du participe avec le sujet. **Piège n°2 :** _est tombé_ n''est pas un passif mais un passé composé actif (test : « par qui ? »).', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
- **Relative de but/souhait** → subjonctif (objet recherché : _une maison qui **soit** calme_) ; relative de fait → indicatif (objet réel : _une maison qui **est** calme_).', 2, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ _grâce à_ = positif ; _à cause de_ = neutre ou négatif.', 3, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ **Pièges clés** — _quoique_ (= bien que) ≠ _quoi que_ (= peu importe ce que) ; _alors que_ jamais au subjonctif ; _malgré_ jamais devant un verbe conjugué.', 4, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Piège majeur** : « dont » est interdit après une autre préposition ou dans un groupe prépositionnel → on passe alors à _duquel / de laquelle_.', 5, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ **Pièges B2** — gérondif sans « en », sujet différent du verbe principal, accord erroné du participe présent (qui reste invariable).', 6, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Collocations soutenues** : _prendre position_, _faire valoir un argument_, _peser le pour et le contre_, _tirer une conclusion_, _nuancer son propos_. ⚠️ _davantage_ (plus) ≠ _d''avantages_ (de bénéfices).', 7, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Élimination** : barre la sur-interprétation, le contresens (voix adverse prise pour la thèse) et la lecture partielle.', 8, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('025bb3ed-d1d4-58e1-b433-06560ac2376c', '8a87a758-27ab-521e-aaf6-f97fa1ccaedb', 'Quelle phrase exprime correctement la MANIÈRE par un gérondif ?', '[{"id":"a","text":"Elle est entrée souriant à tout le monde."},{"id":"b","text":"Elle est entrée souriante en tout le monde."},{"id":"c","text":"Elle est entrée à sourire à tout le monde."},{"id":"d","text":"Elle est entrée en souriant à tout le monde."}]'::jsonb, 'd', '« Elle est entrée en souriant à tout le monde » : le gérondif « en souriant » exprime la manière (= avec le sourire) — c''est la bonne réponse. « souriant à tout le monde » est un participe présent sans « en » ; « souriante en tout le monde » accorde l''adjectif verbal et emploie « en » de façon fautive ; « à sourire » n''exprime pas la manière.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
