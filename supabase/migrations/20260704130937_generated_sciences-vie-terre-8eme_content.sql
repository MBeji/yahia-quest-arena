...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('11c47cac-5992-5223-b711-6503c9c42afa', '48065d0a-33cd-5ee5-b533-2802a227a3cb', 'بأيّ عضو خضريّ تتكاثر البطاطا في الطّبيعة؟', '[{"id":"a","text":"بالدّرنة"},{"id":"b","text":"بالبصلة"},{"id":"c","text":"بالبذرة"},{"id":"d","text":"بالجذمور"}]'::jsonb, 'a', 'البطاطا تتكاثر بالدّرنة، وهي انتفاخ في ساق تحت أرضيّة يخزّن موادّ احتياطيّة وعليه براعم (عيون) تنبت منها نباتات جديدة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8848618c-8585-52b7-858f-d54f3c290b9b', '48065d0a-33cd-5ee5-b533-2802a227a3cb', 'كيف تُكثِر نخلةً في واحة توزر مع الحفاظ على نوع تمرها نفسه؟', '[{"id":"a","text":"بزرع نواة تمرة منها"},{"id":"b","text":"بقطع أوراقها وغرسها في الماء"},{"id":"c","text":"بتطعيم غصن منها على شجرة زيتون"},{"id":"d","text":"بفصل فسيلة تنمو عند قاعدتها وغرسها"}]'::jsonb, 'd', 'الفسيلة برعم ينمو عند قاعدة النّخلة الأمّ؛ بفصلها وغرسها نحصل على نخلة نسخة مطابقة للأمّ بنفس نوع تمرها. زرع النّواة تكاثر جنسيّ قد يعطي تمرًا مختلفًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('20743489-0031-5ccb-9ac8-b1c76fcc34a5', '32565d66-3cf6-5143-8708-ccd52cb9c5ef', 'تنتشر نبتة الفراولة في حديقة بنابل بواسطة سيقان تزحف فوق سطح التّربة وتكوّن جذورًا عند تماسّها بالأرض. ماذا نسمّي هذا العضو؟', '[{"id":"a","text":"الجذمور"},{"id":"b","text":"البصلة"},{"id":"c","text":"الفسيلة"},{"id":"d","text":"السّاق الزّاحفة (المدّادة)"}]'::jsonb, 'd', 'السّاق الزّاحفة تنمو أفقيًّا فوق سطح التّربة وتكوّن جذورًا وبراعم عند نقاط تماسّها بالأرض فتعطي نباتات جديدة، كما في الفراولة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2a03a1c7-f8c8-57bd-92f1-2156bd0bf8de', '32565d66-3cf6-5143-8708-ccd52cb9c5ef', 'أخذ بستانيّ في الوطن القبليّ غصنًا من شجرة الياسمين (الفلّ)، فصله وغرسه في التّربة فكوّن جذورًا ونما نبتة جديدة. ما اسم هذه التّقنية؟', '[{"id":"a","text":"الترقيد"},{"id":"b","text":"التطعيم"},{"id":"c","text":"العُقلة"},{"id":"d","text":"زرع البذور"}]'::jsonb, 'c', 'العُقلة تقنية تكاثر خضريّ اصطناعيّ: يُفصل جزء من النّبات (غصن) ثمّ يُغرس فيكوّن جذورًا وينمو نبتة جديدة، كما في الياسمين والعنب والتّين.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('077df22e-6ad6-5cf9-8ddd-fda5ac0f3024', '18788a03-a302-5110-9255-8db6881b174a', 'أيّ ممّا يلي يُعدّ عضوًا من أعضاء التّكاثر الخضريّ الطّبيعيّ عند النّبات؟', '[{"id":"a","text":"الدّرنة"},{"id":"b","text":"الزّهرة"},{"id":"c","text":"البذرة"},{"id":"d","text":"حبّة اللّقاح"}]'::jsonb, 'a', 'الدّرنة عضو تكاثر خضريّ طبيعيّ (كما في البطاطا). أمّا الزّهرة وحبّة اللّقاح والبذرة فتخصّ التّكاثر الجنسيّ لا الخضريّ.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e60f1b9c-891a-5b6c-b821-a8af4bb74ce1', '58aa5e5c-8633-5c0d-ad49-e7edb4c733d1', 'ما الفرق بين الجذمور والدّرنة؟', '[{"id":"a","text":"الجذمور بذرة، والدّرنة زهرة"},{"id":"b","text":"كلاهما ساق تنمو فوق سطح التّربة وتزحف"},{"id":"c","text":"الجذمور ساق أفقيّة تحت التّربة تحمل براعم، والدّرنة انتفاخ في ساق تحت أرضيّة يخزّن موادّ احتياطيّة وعليه عيون"},{"id":"d","text":"الجذمور عضو تكاثر جنسيّ، والدّرنة عضو تكاثر خضريّ"}]'::jsonb, 'c', 'الجذمور ساق أفقيّة تمتدّ تحت التّربة وتحمل براعم (القصب)، بينما الدّرنة انتفاخ مدّخِر في ساق تحت أرضيّة عليه براعم تُسمّى العيون (البطاطا). وكلاهما عضو تكاثر خضريّ لا جنسيّ.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bcaeec67-1e37-5d61-9e87-607f3719db2a', 'c31f20c8-26e6-5065-9299-1944741f24c5', 'أيّ العبارات التالية عن التّكاثر الخضريّ **خاطئة**؟', '[{"id":"a","text":"النّبتة النّاتجة عن التّكاثر الخضريّ نسخة مطابقة للنّبات الأمّ"},{"id":"b","text":"البطاطا تتكاثر خضريًّا بالدّرنة، والقصب بالجذمور"},{"id":"c","text":"التطعيم والعُقلة والترقيد تقنيّات تكاثر خضريّ اصطناعيّ"},{"id":"d","text":"التّكاثر الخضريّ يحتاج دائمًا إلى زهرة وإخصاب لتتكوّن بذرة"}]'::jsonb, 'd', 'العبارة الخاطئة هي أنّ التّكاثر الخضريّ يحتاج إلى زهرة وإخصاب وبذرة: هذا يخصّ التّكاثر الجنسيّ. التّكاثر الخضريّ لا جنسيّ ينطلق من عضو خضريّ دون شيء من ذلك. العبارات الثّلاث الأخرى صحيحة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('49ef8acd-9569-56d9-8c85-90b86a4fd924', 'c31f20c8-26e6-5065-9299-1944741f24c5', 'يريد مشتلٌ إنتاج آلاف نباتات فراولة **متطابقة** الصّفات وبسرعة كبيرة لتسويقها. ما الطّريقة الأنسب علميًّا؟', '[{"id":"a","text":"زرع بذور الفراولة، لأنّها تعطي نباتات مطابقة تمامًا للأمّ"},{"id":"b","text":"تطعيم كلّ نبتة فراولة على شجرة زيتون"},{"id":"c","text":"انتظار التّأبير والإخصاب بين الأزهار لإنتاج نباتات متطابقة"},{"id":"d","text":"التّكاثر الخضريّ (بالسّيقان الزّاحفة أو العُقل)، لأنّه سريع ويعطي نسخًا مطابقة للأمّ"}]'::jsonb, 'd', 'للحصول على نباتات متطابقة بسرعة يُختار التّكاثر الخضريّ (السّاق الزّاحفة أو العُقل)، لأنّه لا جنسيّ فيعطي نسخًا مطابقة للأمّ وينتشر بسرعة. زرع البذور والتّأبير والإخصاب تكاثر جنسيّ يعطي نباتات مختلفة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5df8db17-11ba-533c-9ad1-216c345a45b1', 'ab075f92-8aaa-51b7-bf2a-5b2a3924c767', 'أيّ عبارة تصف السّاق الزّاحفة (المدّادة) وصفًا صحيحًا؟', '[{"id":"a","text":"انتفاخ تحت أرضيّ يخزّن موادّ احتياطيّة"},{"id":"b","text":"ساق تزحف فوق سطح التّربة وتكوّن جذورًا وبراعم عند نقاط تماسّها بالأرض"},{"id":"c","text":"ساق قصيرة محاطة بأوراق سميكة مدّخِرة"},{"id":"d","text":"برعم ينمو من قاعدة النّبات الأمّ"}]'::jsonb, 'b', 'السّاق الزّاحفة تنمو أفقيًّا فوق سطح التّربة وتكوّن جذورًا وبراعم عند تماسّها بالأرض فتعطي نباتات جديدة (الفراولة). الانتفاخ المدّخر هو الدّرنة، والسّاق ذات الأوراق المدّخِرة هي البصلة، والبرعم من قاعدة الأمّ هو الفسيلة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1816efba-4963-591c-9462-a117dc6cac82', '1f17cdcd-ce30-54e8-b937-041e308b84d8', 'ما الفرق الدّقيق بين البصلة والدّرنة كعضوين للتّكاثر الخضريّ؟', '[{"id":"a","text":"البصلة تحت التّربة والدّرنة فوقها تزحف على السّطح"},{"id":"b","text":"البصلة ساق قصيرة محاطة بأوراق سميكة مدّخِرة (البصل)، والدّرنة انتفاخ في ساق تحت أرضيّة يخزّن غذاءً وعليه عيون (البطاطا)"},{"id":"c","text":"البصلة عضو تكاثر جنسيّ والدّرنة عضو تكاثر خضريّ"},{"id":"d","text":"لا فرق بينهما، فكلاهما اسم لنفس العضو"}]'::jsonb, 'b', 'البصلة ساق قصيرة جدًّا محاطة بأوراق سميكة مدّخِرة للغذاء (البصل، الثّوم)، بينما الدّرنة انتفاخ في ساق تحت أرضيّة يخزّن موادّ احتياطيّة وعليه براعم تُسمّى العيون (البطاطا). وكلاهما عضو تكاثر خضريّ طبيعيّ.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fe155b96-c66a-5f6c-9116-f3c636a38c7c', 'b661058f-3f46-5d94-9ff7-bdef7386045c', 'ما العضو المسؤول عن التكاثر الجنسي عند النبات الزهري؟', '[{"id":"a","text":"الجذر"},{"id":"b","text":"الزهرة"},{"id":"c","text":"الورقة الخضراء"},{"id":"d","text":"الساق"}]'::jsonb, 'b', 'التكاثر الجنسيّ عند النبات الزهري يتمّ في الزهرة، لأنّها تحمل الأعضاء التكاثرية: الأسدية (ذكرية) والمدقّة (أنثوية). الجذر والساق والورقة أعضاء خضرية تُستعمل في التكاثر الخضريّ لا الجنسيّ.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('870b81c3-630e-50cf-b1b9-49bb3ead76c8', '9959a780-c054-587c-a688-6f55875b4190', 'أين تُنتَج حبوب الطلع في الزهرة؟', '[{"id":"a","text":"في الميسم"},{"id":"b","text":"في المبيض"},{"id":"c","text":"في المئبر (أعلى السداة)"},{"id":"d","text":"في السبلات"}]'::jsonb, 'c', 'حبوب الطلع تُنتَج وتُحفَظ في المئبر، وهو الكيس الموجود أعلى خيط السداة. الميسم والمبيض جزءان من المدقّة الأنثوية، والسبلات أوراق واقية.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('18471247-1365-5c1d-b46e-6812ab797757', '8b0f237b-7d43-5a7f-876b-9a685096322c', 'رتّب أجزاء المدقّة من الأعلى نحو الأسفل ترتيبًا صحيحًا.', '[{"id":"a","text":"المبيض ← القلم ← الميسم"},{"id":"b","text":"الميسم ← المبيض ← القلم"},{"id":"c","text":"القلم ← الميسم ← المبيض"},{"id":"d","text":"الميسم ← القلم ← المبيض"}]'::jsonb, 'd', 'المدقّة من الأعلى نحو الأسفل: الميسم (لالتقاط الطلع) ثمّ القلم (عنق) ثمّ المبيض (المنتفخ، فيه البويضات). لذلك يجب أن ينزل الأنبوب الطلعيّ من الميسم عبر القلم إلى المبيض.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0f1b9755-5aeb-50ae-a07a-51b17457f042', 'e24ffbee-4222-58e7-981a-15561c53e42f', 'قالت رانية: «حبوب الطلع تحمل المشيج الأنثويّ». صحّح العبارة.', '[{"id":"a","text":"العبارة صحيحة كما هي"},{"id":"b","text":"حبوب الطلع تحمل المشيج الذكريّ، والبويضة تحمل المشيج الأنثويّ"},{"id":"c","text":"حبوب الطلع تحمل المشيجين معًا"},{"id":"d","text":"حبوب الطلع لا تحمل أيّ مشيج"}]'::jsonb, 'b', 'حبوب الطلع (من الأسدية الذكرية) تحمل المشيج الذكريّ، بينما البويضة (داخل مبيض المدقّة الأنثوية) تحمل المشيج الأنثويّ. عكسُ ذلك خطأ شائع.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a05fb75d-9e4a-5999-bd34-1c797de2f8e4', 'af76941e-c47c-534e-af10-4909c0cdb600', 'زهرةٌ خنثى تحمل أسديةً ومدقّةً معًا، لكنّ مئابرها تنضج وتُفرغ طلعها قبل أن ينضج ميسمها بأيّام. ما الأثر الأرجح على تأبيرها؟', '[{"id":"a","text":"يستحيل أيّ تأبيرٍ لهذه الزهرة إطلاقًا"},{"id":"b","text":"يصبح التأبير الذاتيّ إجباريًّا لأنّ العضوين في زهرةٍ واحدة"},{"id":"c","text":"يُرجَّح التأبير الخلطيّ لأنّ طلعها يجهز قبل جهوز ميسمها فيصعب التأبير الذاتيّ"},{"id":"d","text":"يتحوّل ميسمها إلى مئبرٍ لتعويض الفارق"}]'::jsonb, 'c', 'اختلافُ توقيت نضج المئبر والميسم يعيق وصول طلع الزهرة إلى ميسمها هي (تأبير ذاتيّ)، فيُرجَّح أن يأتي الطلع من زهرةٍ أخرى نضج ميسمها في الوقت المناسب (تأبير خلطيّ). فوجود العضوين معًا لا يجعل التأبير الذاتيّ إجباريًّا، والميسم لا يتحوّل إلى مئبر.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e92d1c2c-ef08-59cb-8754-e8424175a7f2', 'a338554a-cd0a-5ec5-a2f5-5eed2ced2141', 'أيّ عبارةٍ تصف دور الكأس والتويج بدقّة؟', '[{"id":"a","text":"هما العضوان التكاثريّان المنتجان للطلع والبويضات"},{"id":"b","text":"السبلات تحمي البرعم والبتلات تجذب الحشرات، وليسا عضوَي تكاثر"},{"id":"c","text":"الكأس يحمل حبوب الطلع والتويج يحمل البويضات"},{"id":"d","text":"كلاهما يتحوّل إلى ثمرةٍ بعد الإخصاب"}]'::jsonb, 'b', 'الكأس (سبلات) يحمي البرعم، والتويج (بتلات ملوّنة) يجذب الحشرات؛ وكلاهما ورقتان واقية وجاذبة لا عضوا تكاثر. الأعضاء التكاثرية هي الأسدية والمدقّة، والمبيض وحده (لا الكأس والتويج) يعطي الثمرة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('78f3ff70-e62c-5f5a-b5f4-3099cd15e33b', 'a338554a-cd0a-5ec5-a2f5-5eed2ced2141', 'بعد نضج ثمرة طماطم، وجدنا بداخلها بذورًا. ما الأصل الصحيح لكلٍّ من الثمرة والبذور؟', '[{"id":"a","text":"الثمرة من البتلات والبذور من الميسم"},{"id":"b","text":"الثمرة من المبيض والبذور من البويضات المخصبة داخله"},{"id":"c","text":"الثمرة من البويضات والبذور من المبيض"},{"id":"d","text":"الثمرة والبذور كلاهما من حبوب الطلع"}]'::jsonb, 'b', 'الثمرة (لبّ الطماطم) هي المبيض المتضخّم، والبذور بداخلها نشأت من البويضات بعد إخصابها. الخيار (c) يعكس القاعدة، والبتلات والميسم يذبلان ولا يعطيان ثمرةً أو بذورًا، وحبوب الطلع لا تصير ثمرةً ولا بذرة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e612c77f-cdf8-5f9a-ae85-f89ae1f83439', '769d57ea-fc3e-56b7-890e-5a034366d2b3', 'أراد فلّاح في سهول باجة الحصول على صنف قمح يجمع بين غزارة الإنتاج ومقاومة الجفاف عبر تزويج صنفين مختلفين. ما اسم هذه التّقنية؟', '[{"id":"a","text":"التطعيم"},{"id":"b","text":"التهجين"},{"id":"c","text":"الترقيد"},{"id":"d","text":"زراعة الأنسجة"}]'::jsonb, 'b', 'تزويج صنفين مختلفين للحصول على هجين يجمع صفاتهما المرغوبة هو التهجين. أمّا التطعيم والترقيد وزراعة الأنسجة فهي تقنيات إكثار خضريّ لا تزويج بين صنفين.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('17ea2ebf-0c6d-55ed-b16d-c06d18d669d2', '769d57ea-fc3e-56b7-890e-5a034366d2b3', 'في التطعيم، يُثبَّت الطُّعم المأخوذ من صنف حمضيّات مرغوب على أصل ذي جذور قويّة. ما الّذي يمنحه الطُّعم للشّجرة النّاتجة؟', '[{"id":"a","text":"الثّمار المرغوبة"},{"id":"b","text":"الجذور القويّة المقاومة"},{"id":"c","text":"الماء والأملاح المعدنية من التّربة"},{"id":"d","text":"المقاومة لأمراض التّربة فقط"}]'::jsonb, 'a', 'الطُّعم مأخوذ من الصّنف المرغوب، فهو يمنح الشّجرة جزأها الهوائيّ وثمارها الجيّدة؛ أمّا الجذور القويّة المقاومة فيمنحها الأصل (حامل الطُّعم).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c695ce74-0819-5c52-8607-f78297a9ffd0', '769d57ea-fc3e-56b7-890e-5a034366d2b3', 'أيّ من هذه الأهداف يمثّل تحسين الإنتاج «كيفًا» (جودةً) لا «كمًّا»؟', '[{"id":"a","text":"الحصول على عدد أكبر من الحبوب في نفس المساحة"},{"id":"b","text":"الحصول على أشجار زيتون مقاومة لأمراض التّربة وذات ثمار أجود"},{"id":"c","text":"زراعة مساحة أوسع بنفس الصّنف"},{"id":"d","text":"مضاعفة عدد النّباتات المنتَجة بزراعة الأنسجة"}]'::jsonb, 'b', 'تحسين الكيف يخصّ جودة الثّمار ومقاومتها للأمراض، كما في أشجار الزّيتون المقاومة ذات الثّمار الأجود. أمّا زيادة عدد الحبوب أو النّباتات أو المساحة فتخصّ الكمّ.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('60619f59-c5c6-5848-bd2d-89e866ec641a', 'bc1d884b-979a-5f87-8903-a48674c6c13f', 'يريد مركز بحث فلاحيّ إنتاج آلاف النّسخ المطابقة من نبتة موز ممتازة خالية من الأمراض في أقصر وقت. أيّ تقنية هي الأنسب؟', '[{"id":"a","text":"الانتخاب الطبيعيّ على مدى أجيال"},{"id":"b","text":"التهجين مع صنف موز آخر"},{"id":"c","text":"زراعة الأنسجة (الإكثار المخبريّ)"},{"id":"d","text":"زراعة البذور النّاتجة عن الإخصاب"}]'::jsonb, 'c', 'زراعة الأنسجة إكثار خضريّ مخبريّ يعطي عددًا كبيرًا من النّسخ المطابقة من نبتة واحدة في وقت قصير، فهي الأنسب هنا. أمّا التهجين والبذور فيُدخلان تنوّعًا، والانتخاب الطبيعيّ بطيء ولا يضمن المطابقة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e5414e10-be3a-50c6-a30e-0fd619e71265', '8117b5dd-8e46-5f51-bf30-21683a2558d8', 'أراد مركز بحث الحصول على صنف فلفل جديد يجمع بين لون جذّاب من صنف ومقاومة لمرض من صنف آخر. ما التّقنية المناسبة؟', '[{"id":"a","text":"التهجين بين الصّنفين"},{"id":"b","text":"الإكثار بالعُقَل لأحد الصّنفين"},{"id":"c","text":"زراعة الأنسجة لأحد الصّنفين"},{"id":"d","text":"الترقيد لأحد الصّنفين"}]'::jsonb, 'a', 'الجمع بين صفتين مرغوبتين موجودتين في صنفين مختلفين يتطلّب تزويجهما، أي التهجين، لأنّه وحده يُنشئ تركيبة جديدة. أمّا العُقَل وزراعة الأنسجة والترقيد فتعطي نُسخًا مطابقة لصنف واحد ولا تجمع صفات صنفين.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('58a5a4e8-55d7-5508-963b-21a9194151e5', '45e01563-eb45-5b27-a493-99b644705361', 'أراد مركز بحث صنعَ صنف قمح جديد أكثر مقاومة للصّدأ (مرض فطريّ) وأغزر إنتاجًا، ثمّ تعميمه على فلّاحي الجهة بصفات ثابتة. ما التّرتيب الصّحيح للتّقنيات؟', '[{"id":"a","text":"تطعيم القمح على أصل مقاوم ثمّ توزيعه"},{"id":"b","text":"تهجين صنفين (مقاوم + غزير) للحصول على هجين، ثمّ انتخاب أفضل النّباتات وإكثار بذورها المنتخبة لتعميم الصّنف الثّابت"},{"id":"c","text":"إكثار خضريّ للقمح بالعُقَل ثمّ تهجينه لاحقًا"},{"id":"d","text":"الاكتفاء بالانتخاب الطبيعيّ حتّى تظهر المقاومة وحدها"}]'::jsonb, 'b', 'لخلق تركيبة جديدة (مقاومة + غزارة) يلزم التهجين أوّلًا؛ ثمّ الانتخاب لاصطفاء أفضل النّباتات الهجينة؛ ثمّ إكثار بذورها المنتخبة لتثبيت الصّنف وتعميمه. القمح يُكثَر عادةً بالبذور لا بالعُقَل أو التطعيم، والانتخاب الطبيعيّ وحده لا يضمن الجمع بين الصّفتين.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d2fe60de-f50e-5002-865e-0233b1221974', '9ba61fcc-3cdb-5744-ad92-27d56bb27fa9', 'يريد فلّاح تكثير صنف موز خالٍ من الأمراض بأقصى سرعة وبأكبر عدد من النّسخ المطابقة. ما التّقنية المثلى؟', '[{"id":"a","text":"التهجين مع صنف موز آخر"},{"id":"b","text":"زراعة الأنسجة (الإكثار المخبريّ)"},{"id":"c","text":"زراعة البذور الهجينة"},{"id":"d","text":"الانتخاب الطبيعيّ عبر الأجيال"}]'::jsonb, 'b', 'زراعة الأنسجة تعطي عددًا كبيرًا من النّسخ المطابقة في وقت قصير مع المحافظة على خلوّ الصّنف من الأمراض. التهجين والبذور يُدخلان تنوّعًا، والانتخاب الطبيعيّ بطيء ولا يضمن المطابقة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7c6eb913-6a7e-5194-83fa-b36eafce94a8', 'dda4e91e-da70-56ad-8819-c91169b35611', 'الأرنب من الثدييات ويلد صغاره أحياءً. إلى أيّ صنف ينتمي؟', '[{"id":"a","text":"حيوان ولود"},{"id":"b","text":"حيوان بيوض"},{"id":"c","text":"حيوان يفقس من بيضة"},{"id":"d","text":"حيوان لا ينمو"}]'::jsonb, 'a', 'الأرنب من الثدييات، ينمو صغيره داخل جسم الأمّ ثمّ يولد حيًّا، فهو حيوان ولود مثل بقية الثدييات.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('349cd98a-e65e-5846-9f86-69d5e438167a', 'dda4e91e-da70-56ad-8819-c91169b35611', 'أين يلتقي الحيوان المنوي بالبويضة في الإخصاب الداخلي؟', '[{"id":"a","text":"في الماء خارج الجسم"},{"id":"b","text":"داخل جسم الأنثى"},{"id":"c","text":"داخل البيضة بعد وضعها"},{"id":"d","text":"في الهواء أثناء الطيران"}]'::jsonb, 'b', 'في الإخصاب الداخلي يلتقي الحيوان المنوي بالبويضة داخل جسم الأنثى بعد تزاوج الذكر والأنثى.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6b7ec60a-cfba-5961-8587-c989f7f2e5b3', '95303c2e-c807-5bf5-9eb7-56e70eea638e', 'أيّ خليّة تنتجها الأنثى في التكاثر الجنسي؟', '[{"id":"a","text":"الحيوان المنوي"},{"id":"b","text":"البويضة"},{"id":"c","text":"الخادرة"},{"id":"d","text":"الفرخ"}]'::jsonb, 'b', 'تنتج الأنثى خليّة تكاثرية كبيرة غير متحرّكة تُسمّى البويضة، بينما ينتج الذكر الحيوانات المنوية.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f08c510b-2db3-55c4-a23a-df5a301941fb', '95303c2e-c807-5bf5-9eb7-56e70eea638e', 'أيّ الحيوانات التالية إخصابه خارجي؟', '[{"id":"a","text":"الجمل"},{"id":"b","text":"النورس"},{"id":"c","text":"السردين"},{"id":"d","text":"الأرنب"}]'::jsonb, 'c', 'السردين سمكة تطرح خلاياها التكاثرية في الماء فيحدث اللقاء خارج جسم الأنثى: إخصاب خارجي. أمّا الجمل والأرنب (ثدييات) والنورس (طائر) فإخصابها داخلي.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2e7e5c00-1ee1-56a7-8334-ebc960ed7979', 'a17f73b5-d6e9-50f9-9d59-5c5d42fc49f1', 'وُضعت بيوض مخصّبة سليمة في مفرخة لكنّ الجهاز تعطّل فبقيت الحرارة منخفضة طوال المدّة. ما النتيجة الأرجح ولماذا؟', '[{"id":"a","text":"تفقس كلّها لأنّ الإخصاب وحده يكفي دون حرارة"},{"id":"b","text":"تفقس أسرع لأنّ البرودة تسرّع نموّ الجنين"},{"id":"c","text":"تتحوّل البيوض إلى بيوض غير مخصّبة بسبب البرد"},{"id":"d","text":"لا تفقس أو يتعطّل نموّها لأنّ نموّ الجنين يحتاج حرارة مناسبة يوفّرها التفريخ"}]'::jsonb, 'd', 'الإخصاب شرط ضروري لكنّه غير كافٍ: يحتاج الجنين داخل البيضة المخصّبة إلى حرارة مناسبة طوال التفريخ حتّى يكتمل نموّه. غياب الحرارة (تعطّل المفرخة) يوقف هذا النموّ فلا تفقس البيوض رغم أنّها مخصّبة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('11a6116d-0726-5eaf-9cdd-a6239d9f1ad2', '5daef3fb-d24a-57b1-a996-8759e50d2373', 'احتُضنت بيوض دجاجة نحو 21 يومًا ففقس أغلبها بينما لم تفقس بيضتان لأنّهما لم تُخصَّبا. ماذا نستنتج عن شرطَي الفقس؟', '[{"id":"a","text":"الحرارة وحدها تكفي للفقس دون إخصاب"},{"id":"b","text":"الفقس يحتاج شرطين معًا: بيضة مخصّبة + تفريخ يوفّر الحرارة المناسبة"},{"id":"c","text":"الإخصاب وحده يكفي دون حرارة"},{"id":"d","text":"البيضتان غير المخصّبتين تفقسان لاحقًا بعد 21 يومًا إضافيًّا"}]'::jsonb, 'b', 'فقس البيض المخصّب دون غير المخصّب رغم تفريخ الجميع يبيّن أنّ الفقس يحتاج شرطين معًا: بيضة مخصّبة تحمل جنينًا، وتفريخ يوفّر الحرارة اللازمة لنموّه. غياب أيّ شرط يمنع الفقس.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4234efe4-a907-5de6-b2a3-fa0a14e2bae0', 'b7845e62-06f5-5884-b797-aff68bae0906', 'من أيّ حيوان من حيوانات التّربية نحصل أساسًا على الصّوف؟', '[{"id":"a","text":"الأغنام"},{"id":"b","text":"الدّجاج"},{"id":"c","text":"النّحل"},{"id":"d","text":"السّمك"}]'::jsonb, 'a', 'الصّوف منتوج نحصل عليه من الأغنام. أمّا الدّجاج فمصدر للبيض واللّحم، والنّحل مصدر للعسل.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0b15bd21-2b5d-5e10-86c7-13ee305177f1', '6585500e-bbed-54e4-acb9-35af02eaa808', 'الفرق الأساسيّ بين الانتخاب والتّهجين هو أنّ:', '[{"id":"a","text":"الانتخاب يتمّ داخل السّلالة الواحدة، والتّهجين بين سلالتين مختلفتين"},{"id":"b","text":"الانتخاب يخصّ النّبات والتّهجين يخصّ الحيوان فقط"},{"id":"c","text":"الانتخاب يرفع المردود دون توريث، والتّهجين لا يوريّث شيئًا"},{"id":"d","text":"لا فرق بينهما فهما تسميتان لتقنية واحدة"}]'::jsonb, 'a', 'الانتخاب اصطفاء للأفضل داخل السّلالة الواحدة، أمّا التّهجين فتزويج فردين من سلالتين مختلفتين لجمع صفاتهما. وكلاهما تقنية وراثيّة تؤثّر في صفات النّسل.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('85e2f90e-f732-5f47-a411-9139b4da0920', '1b7bd92a-132a-51cd-b333-61a6c6363921', 'نجح مربٍّ بالانتخاب في رفع معدّل إنتاج قطيعه من الحليب من 8 لترات إلى 15 لترًا في اليوم عبر عدّة أجيال. ما الّذي حدث حقيقةً؟', '[{"id":"a","text":"تحوّل القطيع فجأة إلى سلالة مستوردة"},{"id":"b","text":"تغيّر العلف وحده هو الّذي رفع المعدّل دون أيّ توريث"},{"id":"c","text":"تراكمت في القطيع صفات الغزارة الموروثة باصطفاء الأغزر للتّكاثر جيلًا بعد جيل"},{"id":"d","text":"ارتفع الإنتاج في يوم واحد دون علاقة بالأجيال"}]'::jsonb, 'c', 'الانتخاب رفع المعدّل بتوريث صفة الغزارة: باصطفاء الأغزر للتّكاثر جيلًا بعد جيل تتراكم الصّفات الجيّدة الموروثة في القطيع، فيرتفع المعدّل تدريجيًّا عبر الأجيال (من 8 إلى 15 لترًا)، لا في يوم واحد ولا بالعلف وحده.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9ff03a8a-8813-5327-a8b8-76759e27a367', 'f00b7066-a233-5fb2-b1f6-64165b830c3e', 'في النظام البيئي، أيّ حلقة تصنع مادّتها العضوية بنفسها؟', '[{"id":"a","text":"المستهلك الأوّل"},{"id":"b","text":"المنتِج"},{"id":"c","text":"المستهلك الثاني"},{"id":"d","text":"المحلِّل"}]'::jsonb, 'b', 'المنتِج نبتة خضراء تصنع مادّتها العضوية بنفسها من الماء والأملاح المعدنية والضوء، ولهذا تبدأ به كلّ سلسلة غذائية.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4bff6b03-ee5c-5c23-9c59-f6aac9ef3f7b', '63baf174-368c-5650-85e3-f333aacfcea0', 'في نظام بستان الزيتون، إلى أيّ حلقة تنتمي شجرة الزيتون؟', '[{"id":"a","text":"مستهلك أوّل"},{"id":"b","text":"محلِّل"},{"id":"c","text":"منتِج"},{"id":"d","text":"مستهلك ثانٍ"}]'::jsonb, 'c', 'شجرة الزيتون نبتة خضراء تصنع مادّتها العضوية بنفسها، فهي منتِج في هذا النظام البيئي.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e1458d9f-5952-575b-8138-5e5aa4ec0ae4', '63baf174-368c-5650-85e3-f333aacfcea0', 'في الواد، تأكل يرقة طحالبَ خضراء. إلى أيّ حلقة تنتمي اليرقة؟', '[{"id":"a","text":"منتِج"},{"id":"b","text":"محلِّل"},{"id":"c","text":"مستهلك ثانٍ"},{"id":"d","text":"مستهلك أوّل"}]'::jsonb, 'd', 'اليرقة تتغذّى مباشرة على الطحالب (المنتِج)، فهي مستهلك أوّل في هذه السلسلة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b50efb35-d4f0-57f1-a7ad-db9fa68b0582', 'c650da8f-9831-56a7-95d5-0987d02dca32', 'أيّ العبارات التالية بخصوص المحلِّلات **خاطئة**؟', '[{"id":"a","text":"المحلِّلات تحوّل المادّة العضوية الميّتة إلى أملاح معدنية"},{"id":"b","text":"من المحلِّلات جراثيم التربة وفطرياتها"},{"id":"c","text":"المحلِّلات تفترس المستهلك الثالث وهو حيّ لتنهي به الشبكة"},{"id":"d","text":"بفضل المحلِّلات تعود المادّة أملاحًا يمتصّها المنتِج"}]'::jsonb, 'c', 'العبارة الخاطئة أنّ المحلِّل يفترس كائنًا حيًّا؛ فهو لا يفترس شيئًا حيًّا بل يتغذّى فقط على البقايا والفضلات الميّتة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('23525484-d92e-5e95-ad04-6691bbd49853', 'e618ef9a-ce64-5db9-8ba4-080994161307', 'أيّ تعريف يصف النظام البيئي وصفًا صحيحًا؟', '[{"id":"a","text":"حيوان واحد يعيش منعزلًا"},{"id":"b","text":"مجموعة نباتات خضراء فقط"},{"id":"c","text":"تربة وماء وهواء دون أيّ كائن حيّ"},{"id":"d","text":"وسط غير حيّ ومجموعة كائنات حيّة تتفاعل فيما بينها ومع وسطها"}]'::jsonb, 'd', 'النظام البيئي يجمع الوسط غير الحيّ ومجموعة الكائنات الحيّة التي تتفاعل معه ومع بعضها؛ لا يُختزل في الكائنات ولا في الوسط وحده.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cf0b1837-3380-5bc5-bef7-647ef17f1fe3', 'c68138e2-b488-5d1f-b004-75ce7e53f1d1', 'في الواد: طحالب → سمك صغير → ضفدع → مالك الحزين، ومحلِّلات في القاع. لو تسبّب تلوّث كيميائي في موت الطحالب كلّها، فما التسلسل الأرجح لانهيار النظام؟', '[{"id":"a","text":"لا يتأثّر أحد لأنّ المحلِّلات تعوّض الطحالب"},{"id":"b","text":"يزدهر السمك الصغير أوّلًا ثمّ الضفادع ثمّ مالك الحزين"},{"id":"c","text":"تتحوّل الطحالب الميّتة مباشرة إلى مالك حزين جديد"},{"id":"d","text":"يجوع السمك الصغير لفقد غذائه، فتقلّ الضفادع، فيندر مالك الحزين، وتنشط المحلِّلات على الجثث"}]'::jsonb, 'd', 'بزوال المنتِج القاعديّ (الطحالب) ينهار ما فوقه بالترتيب: يجوع السمك الصغير فيقلّ، فتقلّ الضفادع، فيندر مالك الحزين؛ وتنشط المحلِّلات على الجثث لكنّها لا تصنع غذاءً بديلًا عن المنتِج.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('91cde1fa-56ec-5344-9194-b2a68e2f4629', 'f0b8dfb1-d3bc-591f-a378-e8fb3d818b52', 'بنى الإنسان مصنعًا يصبّ فضلاته في واد فماتت طحالبه. أيّ تفسير يربط هذا التلوّث باختلال التوازن الطبيعي ربطًا صحيحًا؟', '[{"id":"a","text":"لا علاقة، فموت الطحالب لا يؤثّر في بقيّة الكائنات"},{"id":"b","text":"بموت المنتِج القاعديّ ينهار غذاء كلّ الحلقات فوقه، فتتناقص الأسماك والضفادع والطيور تباعًا"},{"id":"c","text":"موت الطحالب يزيد الأكسجين فيزدهر النظام"},{"id":"d","text":"التلوّث يحوّل الأسماك إلى منتِجات بديلة"}]'::jsonb, 'b', 'الطحالب منتِج قاعديّ تقوم عليه كلّ السلاسل؛ فبموتها بالتلوّث ينهار الغذاء صعودًا (سمك، ضفادع، طيور)، وهو اختلال مباشر للتوازن الطبيعي بيد الإنسان.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('66bcd214-16d9-5f44-b4e8-5e0ec1c0bbff', '7c8c8ef4-b5f5-5b83-8f5a-013f79ca457d', 'ماذا نسمّي الفتات الصّخريّ الّذي يستقرّ ويتراكم في قاع بحيرة أو سبخة بعد أن يفقد الماء قدرته على حمله؟', '[{"id":"a","text":"رواسب"},{"id":"b","text":"غطاء نباتيّ"},{"id":"c","text":"أملاح معدنيّة ذائبة"},{"id":"d","text":"شقوق صخريّة"}]'::jsonb, 'a', 'الفتات المتراكم المستقرّ بعد التّرسّب يُسمّى رواسب؛ وهي ما سيتحوّل عبر ملايين السّنين إلى صخور رسوبيّة لاحقًا.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6b7a8e25-0b5a-59bb-b7b0-414c74058d05', 'a21ae9db-0ea7-523b-96b6-e4a6d391d1ce', 'رتّب المراحل الأولى في تشكّل صخرةٍ رسوبيّة بدءًا من صخرةٍ قديمة.', '[{"id":"a","text":"تعرية ← نقل ← ترسّب"},{"id":"b","text":"ترسّب ← تعرية ← نقل"},{"id":"c","text":"نقل ← تعرية ← ترسّب"},{"id":"d","text":"ترسّب ← نقل ← تعرية"}]'::jsonb, 'a', 'تبدأ السلسلة بالتعرية التي تُفتّت الصخرة، ثم النقل الذي يحمل الفُتات، ثم الترسّب حيث تستقرّ الحبيبات وتتراكم. أيّ ترتيبٍ آخر يعكس منطق العمليّة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b6bfda33-c846-5021-a67a-5726ba5a00b1', '17d15e9f-d5cb-53e0-a41a-642dc835edd1', 'أيّ خاصّيةٍ من الخصائص التالية تُميّز الصخور الرسوبيّة عن الصخور الصهاريّة؟', '[{"id":"a","text":"الصلابة الشديدة دائمًا"},{"id":"b","text":"لونها الأسود دائمًا"},{"id":"c","text":"تكوّنها من تبرّد الصهارة"},{"id":"d","text":"ترتّبها في طبقاتٍ واحتمال احتوائها على مستحاثات"}]'::jsonb, 'd', 'من علامات الصخور الرسوبيّة أنّها تترتّب في طبقات وقد تحتوي مستحاثات. أمّا التكوّن من تبرّد الصهارة فهو خاصّية الصخور الصهاريّة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f8c552d5-9487-576c-afde-7ea2e53d21ab', '17d15e9f-d5cb-53e0-a41a-642dc835edd1', 'في جُرف تينْزارت الكلسيّ، تظهر طبقاتٌ رسوبيّةٌ بعضها فوق بعض. أيّ الطبقات هي الأقدم؟', '[{"id":"a","text":"الطبقة العليا"},{"id":"b","text":"الطبقة الوسطى دائمًا"},{"id":"c","text":"الطبقة السفلى"},{"id":"d","text":"لا يمكن ترتيبها إطلاقًا"}]'::jsonb, 'c', 'تترسّب الطبقة السفلى أوّلًا ثم تعلوها الأحدث، فالطبقة السفلى هي الأقدم والعليا هي الأحدث (ما لم تنقلب الطبقات). هذه قاعدة التعاقب.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b1ffc666-c64a-5cb6-b65b-3343c8d22912', '17d15e9f-d5cb-53e0-a41a-642dc835edd1', 'صخرةٌ مجهولةٌ حبيباتها دقيقةٌ جدًّا لا تُرى بالعين، تصبح لدنةً لزجةً عند بلّها، ويصعب مرور الماء عبرها. ما هي؟', '[{"id":"a","text":"الحجر الرمليّ"},{"id":"b","text":"البازلت"},{"id":"c","text":"الكلس"},{"id":"d","text":"الطين"}]'::jsonb, 'd', 'الحبيبات الدقيقة جدًّا واللدونة عند البلّ والكتامة (صعوبة مرور الماء) كلّها خصائص الطين، خلافًا للرمل النفوذ ذي الحبيبات المرئيّة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('661f54df-8f14-52d5-8339-4e0b75712894', 'cd918789-bf7f-5538-886a-668d0b256493', 'لدينا مستحاثتان: (م1) في صخرةٍ كلسيّةٍ تحوي أصدافًا بحريّة، و(م2) في صخرةٍ رمليّةٍ تحوي آثار أقدامٍ لزواحف يابسة. لو وُجدت (م1) في طبقةٍ أسفل (م2) في المقطع نفسه، ما الاستنتاج المزدوج الصحيح؟', '[{"id":"a","text":"(م2) أقدم من (م1)، وكان المكان يابسًا ثم صار بحرًا"},{"id":"b","text":"المستحاثتان في العمر نفسه، والبيئة لم تتغيّر"},{"id":"c","text":"(م1) أقدم من (م2)، وكان المكان بحرًا ثم انحسر وصار يابسًا"},{"id":"d","text":"لا يمكن استنتاج العمر ولا البيئة"}]'::jsonb, 'c', '(م1) في الطبقة السفلى فهي الأقدم، وبيئتها بحريّة (أصداف)؛ (م2) أعلى فهي أحدث، وبيئتها يابسة (آثار أقدام زواحف). فالمكان كان بحرًا ثم انحسر وصار يابسًا. يُجمع بين قاعدة التعاقب ودلالة المستحاثات على البيئة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1bf93965-be03-521e-94b5-e241baf0d800', 'fa5ea997-8419-5f7a-818c-d267940bc71b', 'لماذا تُعدّ الصخور الرسوبيّة تحديدًا «أرشيفًا» لتاريخ الحياة والبيئة على الأرض، دون غيرها من الصخور؟', '[{"id":"a","text":"لأنّها أصلب أنواع الصخور وأطولها بقاءً"},{"id":"b","text":"لأنّها الوحيدة التي تحتوي معادن ثمينة"},{"id":"c","text":"لأنّها تتشكّل بتراكمٍ هادئٍ في طبقاتٍ متعاقبةٍ تدفن البقايا وتحفظها، فتسجّل ترتيب الأحداث والبيئات القديمة"},{"id":"d","text":"لأنّها تتكوّن بسرعةٍ كبيرةٍ في يومٍ واحد"}]'::jsonb, 'c', 'التراكم الطبقيّ المتعاقب يدفن البقايا فيحفظها كمستحاثات، وترتيب الطبقات يسجّل تسلسل الزمن، ونوع المستحاثات يكشف البيئات القديمة. بهذا تكون الصخور الرسوبيّة سجلًّا لتاريخ الحياة، بخلاف الصهاريّة التي لا تحفظ أثرًا.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
