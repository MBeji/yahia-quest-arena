...
- ⚠️ Pièges fréquents : mauvais auxiliaire (_j''ai allé_), accord oublié (_elle est allé_), participe faux (_j''ai prendu, il a faisé_).', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
- **Marqueurs** : autrefois, avant, quand j''étais petit, tous les jours, d''habitude, souvent, pendant que.', 2, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ **Pièges** — dis _j''**irai**_ (pas ~~j''allerai~~), _je **ferai**_ (pas ~~je fairai~~) ; après _aller_ garde l''**infinitif** (_je vais **partir**_, pas ~~je vais pars~~).', 3, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Ne jamais oublier le pronom (_~~je lave~~_ → je me lave), ni l''élision (_~~je me appelle~~_ → je m''appelle).', 4, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Ne confonds pas _plus … que_ (qualité, adjectif) et _plus **de** … que_ (quantité, nom).', 5, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Ne confonds pas **pendant** (durée) et **dans** (futur), ni **depuis** (en cours) et **il y a** (passé fini).', 6, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **La routine et les loisirs** : **faire les courses**, **faire du sport**, **aller au cinéma**, **sortir**, **prendre rendez-vous**.', 7, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Piège** : ne confonds pas l''heure du rendez-vous et l''heure de l''événement, ni un projet futur avec un fait déjà arrivé.', 8, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
