...
- **الحصر والإقحام:** نحصر عددًا بين أصغرَ منه وأكبرَ منه (375 < 376 < 377)، ونُقحم عددًا يقع تمامًا بين عددين (بين 248 و 250 نُقحم 249).', 2)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **الفخّ:** نسيان الاحتفاظ، مثل 47 × 6 = 282 لا 242.', 4)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
*مثال:* شكلٌ مغلقٌ عدّينا له 4 قطعًا مستقيمة، إذن هو **رباعيّ** وله **4 رؤوس** أيضًا (لأنّ عدد الأضلاع = عدد الرؤوس).
...
- في كلّ مضلّع: **عدد الأضلاع = عدد الرؤوس**.', 5)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **الرسم**: نقطةٌ (رأس) ثمّ ضلعان؛ نقرّبهما لزاويةٍ حادّة، أو نباعد لمنفرجة، أو نستعمل الكوس لقائمة.', 6)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **الفخّ**: في المستطيل اضرب في 2 (ضلعان للطول وضلعان للعرض)، ولا تجمع الطول والعرض مرّةً واحدة فقط.', 7)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **أيّام الأسبوع:** السبت، الأحد، الاثنين، الثلاثاء، الأربعاء، الخميس، الجمعة؛ بعد الجمعة يعود السبت.', 8)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f78377eb-ffa5-5a0b-ba02-62c1c3dafe24', 'a4822e19-f149-5cf7-8216-2e753bc551f8', 'كيف نكتب بالأرقام الألفَ الكامل «ستّة آلاف»؟', '[{"id":"a","text":"6 000"},{"id":"b","text":"600"},{"id":"c","text":"6 600"},{"id":"d","text":"6 060"}]'::jsonb, 'a', 'الألف الكامل نكتبه برقمٍ في الآلاف ثمّ ثلاثة أصفار: ستّة آلاف = 6 × 1000 = 6 000.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fa27437b-3a9a-5819-bf24-90e96d3b05f5', 'ace83de0-204e-5499-a5cf-dad8b5fd3c62', 'أيّ الرمزين يجعل العبارة صحيحة: 999 … 1 000؟', '[{"id":"a","text":"<"},{"id":"b","text":">"},{"id":"c","text":"="},{"id":"d","text":"لا شيء ممّا سبق"}]'::jsonb, 'a', 'العدد 999 من ثلاثة أرقام و 1 000 من أربعة أرقام، فالأكثر أرقامًا أكبر: 999 < 1 000. الرمز الصحيح هو <.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('91f8131c-c796-5739-bf3f-978d67c71767', 'ace83de0-204e-5499-a5cf-dad8b5fd3c62', 'ما العدد التالي مباشرةً للعدد 999؟', '[{"id":"a","text":"998"},{"id":"b","text":"1 000"},{"id":"c","text":"9 910"},{"id":"d","text":"990"}]'::jsonb, 'b', 'العدد التالي يساوي العدد زائد 1: 999 + 1 = 1 000.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0a33dc00-183b-5da5-b5cf-e67d592b4f0f', 'ace83de0-204e-5499-a5cf-dad8b5fd3c62', 'أيّ عددٍ نُقحمه تمامًا بين 248 و 250؟', '[{"id":"a","text":"247"},{"id":"b","text":"251"},{"id":"c","text":"248"},{"id":"d","text":"249"}]'::jsonb, 'd', 'العدد الذي يقع تمامًا بين 248 و 250 هو 249، لأنّ 248 < 249 < 250.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4c1e9c57-af0b-5aa4-82ab-caa262a64adf', '4f418170-5dfd-55b0-82f7-2b5803731829', 'أيّ الرمزين يجعل العبارة صحيحة: 1 350 … 1 530؟', '[{"id":"a","text":"<"},{"id":"b","text":">"},{"id":"c","text":"="},{"id":"d","text":"لا شيء ممّا سبق"}]'::jsonb, 'a', 'الآلاف متساوية (1 = 1)، ثمّ المئات: 3 < 5، إذن 1 350 < 1 530. الرمز الصحيح هو <.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('07e891d8-9868-5a12-b51b-141bddd310b5', '4f418170-5dfd-55b0-82f7-2b5803731829', 'أيّ العددين أكبر: 8 000 أم 800؟', '[{"id":"a","text":"800"},{"id":"b","text":"8 000"},{"id":"c","text":"متساويان"},{"id":"d","text":"لا يمكن المعرفة"}]'::jsonb, 'b', 'العدد 8 000 من أربعة أرقام و 800 من ثلاثة أرقام، فالأكثر أرقامًا أكبر: 8 000 > 800.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e937f7d0-fc4b-510d-ba58-6dae283c5314', '4f418170-5dfd-55b0-82f7-2b5803731829', 'ما العدد السابق مباشرةً للعدد 1 000؟', '[{"id":"a","text":"1 001"},{"id":"b","text":"900"},{"id":"c","text":"999"},{"id":"d","text":"100"}]'::jsonb, 'c', 'العدد السابق يساوي العدد ناقص 1: 1 000 − 1 = 999.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d3cf3423-4c8b-585e-b822-4358635d9b51', '4f418170-5dfd-55b0-82f7-2b5803731829', 'ما العلاقة الصحيحة بين العددين 2 075 و 2 075؟', '[{"id":"a","text":"2 075 < 2 075"},{"id":"b","text":"2 075 > 2 075"},{"id":"c","text":"لا يمكن المقارنة"},{"id":"d","text":"2 075 = 2 075"}]'::jsonb, 'd', 'العددان لهما نفس الأرقام في نفس الرتب، فهما متساويان: 2 075 = 2 075.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dbebcaaa-cea1-55a3-90fe-3f54a7d39be9', '4f418170-5dfd-55b0-82f7-2b5803731829', 'أيّ الأعداد التالية هو الأكبر؟', '[{"id":"a","text":"4 050"},{"id":"b","text":"4 500"},{"id":"c","text":"540"},{"id":"d","text":"450"}]'::jsonb, 'b', 'العددان 540 و 450 من ثلاثة أرقام فهما أصغر؛ ونقارن 4 050 و 4 500: الآلاف متساوية، ثمّ المئات 0 < 5، إذن الأكبر هو 4 500.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9708e374-4f55-5a79-98dd-6b069e6333f7', '4f418170-5dfd-55b0-82f7-2b5803731829', 'ما العدد التالي مباشرةً للعدد 3 209؟', '[{"id":"a","text":"3 210"},{"id":"b","text":"3 208"},{"id":"c","text":"3 300"},{"id":"d","text":"3 219"}]'::jsonb, 'a', 'العدد التالي يساوي العدد زائد 1: 3 209 + 1 = 3 210.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('85f74a48-1eca-5c75-9db8-e6e34b03e3d7', '188ce5c1-85ec-5a2a-bcfe-5825a1dba534', 'ما العدد السابق مباشرةً للعدد 5 000؟', '[{"id":"a","text":"5 001"},{"id":"b","text":"4 900"},{"id":"c","text":"4 000"},{"id":"d","text":"4 999"}]'::jsonb, 'd', 'العدد السابق يساوي العدد ناقص 1: 5 000 − 1 = 4 999. الخطأ الشائع هو نقص رقم الآلاف فقط وكتابة 4 000.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('64a1481c-e7b3-5743-85c7-72ac0aa95607', '188ce5c1-85ec-5a2a-bcfe-5825a1dba534', 'أيّ الأعداد التالية هو الأصغر؟', '[{"id":"a","text":"3 030"},{"id":"b","text":"3 300"},{"id":"c","text":"3 003"},{"id":"d","text":"3 013"}]'::jsonb, 'c', 'الآلاف متساوية (3)؛ نقارن المئات: 3 300 مئاته 3 فهو الأكبر، والباقي مئاته 0. ثمّ بين 3 030 و 3 003 و 3 013 نقارن العشرات: 0 < 1 < 3، إذن الأصغر هو 3 003.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fa721a4d-16ab-5d98-bc68-59bb2d02fee3', '188ce5c1-85ec-5a2a-bcfe-5825a1dba534', 'ما الترتيب التنازليّ الصحيح للأعداد 2 080 و 2 800 و 2 008؟', '[{"id":"a","text":"2 008 > 2 080 > 2 800"},{"id":"b","text":"2 800 > 2 080 > 2 008"},{"id":"c","text":"2 080 > 2 800 > 2 008"},{"id":"d","text":"2 800 > 2 008 > 2 080"}]'::jsonb, 'b', 'الآلاف متساوية (2)؛ نقارن المئات: 8 > 0، فـ 2 800 الأكبر. ثمّ بين 2 080 و 2 008 نقارن العشرات: 8 > 0، فـ 2 080 أكبر. تنازليًّا: 2 800 > 2 080 > 2 008.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('03a32a5a-be33-506e-a3a5-2ff7ebaee9cd', '5294d31e-f59b-5298-9ae0-dd9e39b3934f', 'أيّ الرمزين يجعل العبارة صحيحة: 2 640 … 2 460؟', '[{"id":"a","text":"<"},{"id":"b","text":">"},{"id":"c","text":"="},{"id":"d","text":"لا شيء ممّا سبق"}]'::jsonb, 'b', 'الآلاف متساوية (2 = 2)، ثمّ المئات: 6 > 4، إذن 2 640 > 2 460. الرمز الصحيح هو >.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9ad20e3c-192e-5c72-bd73-b4b546628371', '5294d31e-f59b-5298-9ae0-dd9e39b3934f', 'ما العدد التالي مباشرةً للعدد 1 999؟', '[{"id":"a","text":"1 998"},{"id":"b","text":"2 000"},{"id":"c","text":"1 990"},{"id":"d","text":"2 999"}]'::jsonb, 'b', 'العدد التالي يساوي العدد زائد 1: 1 999 + 1 = 2 000.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('59ca1275-583d-5f38-851e-8d41f26486b9', '5294d31e-f59b-5298-9ae0-dd9e39b3934f', 'أيّ حصرٍ صحيحٍ للعدد 4 387 بين أقرب مئتين؟', '[{"id":"a","text":"4 387 < 4 300 < 4 400"},{"id":"b","text":"4 400 < 4 387 < 4 500"},{"id":"c","text":"4 300 < 4 387 < 4 400"},{"id":"d","text":"4 200 < 4 387 < 4 300"}]'::jsonb, 'c', 'العدد 4 387 أكبر من 4 300 وأصغر من 4 400، فالحصر الصحيح هو 4 300 < 4 387 < 4 400.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ba7960cc-764f-5885-9a63-011d070af677', '5294d31e-f59b-5298-9ae0-dd9e39b3934f', 'ما العدد السابق مباشرةً للعدد 6 410؟', '[{"id":"a","text":"6 411"},{"id":"b","text":"6 400"},{"id":"c","text":"6 420"},{"id":"d","text":"6 409"}]'::jsonb, 'd', 'العدد السابق يساوي العدد ناقص 1: 6 410 − 1 = 6 409.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a61cc046-5a5d-5a42-934b-d69e7b9fc935', '5294d31e-f59b-5298-9ae0-dd9e39b3934f', 'ما العلاقة الصحيحة بين العددين 989 و 1 001؟', '[{"id":"a","text":"989 < 1 001"},{"id":"b","text":"989 > 1 001"},{"id":"c","text":"989 = 1 001"},{"id":"d","text":"لا يمكن المقارنة"}]'::jsonb, 'a', 'العدد 989 من ثلاثة أرقام و 1 001 من أربعة أرقام، فالأكثر أرقامًا أكبر: 989 < 1 001.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d1afcdad-f3d7-5662-bb75-239502758533', 'b8e2bd70-6fd8-5603-a8ed-08ff81d911b4', 'ما الترتيب التصاعديّ الصحيح للأعداد 4 044 و 4 404 و 444؟', '[{"id":"a","text":"444 < 4 404 < 4 044"},{"id":"b","text":"444 < 4 044 < 4 404"},{"id":"c","text":"4 044 < 444 < 4 404"},{"id":"d","text":"4 404 < 4 044 < 444"}]'::jsonb, 'b', 'العدد 444 من ثلاثة أرقام فهو الأصغر؛ ثمّ نقارن 4 044 و 4 404: الآلاف متساوية، ثمّ المئات 0 < 4. الترتيب التصاعديّ: 444 < 4 044 < 4 404.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b83f8517-7b08-5fae-9a32-ea539840b0f6', 'b8e2bd70-6fd8-5603-a8ed-08ff81d911b4', 'كم عددًا يقع تمامًا بين 2 988 و 3 002 (دون أن نَعُدّهما)؟', '[{"id":"a","text":"14"},{"id":"b","text":"12"},{"id":"c","text":"11"},{"id":"d","text":"13"}]'::jsonb, 'd', 'الأعداد الواقعة بينهما هي من 2 989 إلى 3 001، أي 3 001 − 2 989 + 1 = 13 عددًا. لا نَعُدّ الطرفين.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c83cacbb-95ff-55c4-9ae0-770951eba7a3', 'b8e2bd70-6fd8-5603-a8ed-08ff81d911b4', 'ما أصغر عددٍ من أربعة أرقام نُكوّنه بالأرقام 5 و 0 و 7 و 2، باستعمال كلّ رقمٍ مرّةً واحدة؟', '[{"id":"a","text":"0 257"},{"id":"b","text":"2 075"},{"id":"c","text":"2 057"},{"id":"d","text":"5 027"}]'::jsonb, 'c', 'لا يبدأ عددٌ من أربعة أرقام بالصفر، فنضع أصغر رقمٍ غير الصفر في الآلاف (2)، ثمّ نرتّب الباقي تصاعديًّا: 0 ثمّ 5 ثمّ 7. فالعدد هو 2 057.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('29bc0c3d-86b3-5091-a0b4-b1d8c16da9bc', '030d3b56-40d6-589b-8be9-99b77357ef43', 'أيّ الرمزين يجعل العبارة صحيحة: 9 000 … 990؟', '[{"id":"a","text":"<"},{"id":"b","text":"="},{"id":"c","text":">"},{"id":"d","text":"لا شيء ممّا سبق"}]'::jsonb, 'c', 'العدد 9 000 من أربعة أرقام و 990 من ثلاثة أرقام، فالأكثر أرقامًا أكبر: 9 000 > 990. الرمز الصحيح هو >.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9353c1af-1104-50fa-9ebf-d4c0cb787eea', '030d3b56-40d6-589b-8be9-99b77357ef43', 'ما العدد التالي مباشرةً للعدد 7 660؟', '[{"id":"a","text":"7 661"},{"id":"b","text":"7 659"},{"id":"c","text":"7 670"},{"id":"d","text":"7 600"}]'::jsonb, 'a', 'العدد التالي يساوي العدد زائد 1: 7 660 + 1 = 7 661.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('32096824-ce13-5765-91a7-80b2140617c1', '030d3b56-40d6-589b-8be9-99b77357ef43', 'ما العدد السابق مباشرةً للعدد 3 100؟', '[{"id":"a","text":"3 101"},{"id":"b","text":"3 110"},{"id":"c","text":"3 000"},{"id":"d","text":"3 099"}]'::jsonb, 'd', 'العدد السابق يساوي العدد ناقص 1: 3 100 − 1 = 3 099.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('547b6e87-2d2c-5891-a3b3-50883ead4216', '030d3b56-40d6-589b-8be9-99b77357ef43', 'ما الترتيب التصاعديّ الصحيح للأعداد 5 215 و 5 251 و 5 152؟', '[{"id":"a","text":"5 152 < 5 215 < 5 251"},{"id":"b","text":"5 152 < 5 251 < 5 215"},{"id":"c","text":"5 215 < 5 152 < 5 251"},{"id":"d","text":"5 251 < 5 215 < 5 152"}]'::jsonb, 'a', 'الآلاف متساوية (5)؛ نقارن المئات: 5 152 مئاته 1 فهو الأصغر؛ ثمّ 5 215 و 5 251 مئاتهما 2، فنقارن العشرات: 1 < 5، إذن 5 215 < 5 251. الترتيب: 5 152 < 5 215 < 5 251.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('712f91f9-687c-56c1-8074-175d8491a7b6', 'd072d43d-4ca5-589a-8306-69c004005258', 'بالطرح بالزيادة (الإكمال)، كم نضيف إلى 58 لنبلغ 62؟ أي 62 − 58 = ؟', '[{"id":"a","text":"4"},{"id":"b","text":"6"},{"id":"c","text":"14"},{"id":"d","text":"120"}]'::jsonb, 'a', 'في الطرح بالزيادة نَعدّ تصاعديًّا من المطروح إلى المطروح منه: 58 + 4 = 62، فالفرق هو 4، أي 62 − 58 = 4.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c5d93406-1c09-5ce8-98b9-81d6b697c3cd', '27d2f233-fc4a-5350-b0ae-9eed34f4273a', 'أيّ جمعٍ متكرّر يساوي 4 × 3؟', '[{"id":"a","text":"3 + 3 + 3 + 3"},{"id":"b","text":"4 + 3"},{"id":"c","text":"4 + 4 + 4"},{"id":"d","text":"3 + 3 + 3"}]'::jsonb, 'a', '4 × 3 تعني العدد 3 مأخوذًا 4 مرّات: 3 + 3 + 3 + 3 = 12. الفخّ: جمع العاملين 4 + 3 بدل تكرار الحدّ.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5261e219-d50e-5c0f-ab92-854aee32863e', '27d2f233-fc4a-5350-b0ae-9eed34f4273a', 'بفضل التبديلية، إذا كان 8 × 5 = 40 فإنّ 5 × 8 يساوي:', '[{"id":"a","text":"13"},{"id":"b","text":"40"},{"id":"c","text":"45"},{"id":"d","text":"58"}]'::jsonb, 'b', 'الضرب تبديليّ: a × b = b × a، فترتيب العاملين لا يُغيّر الجداء. إذن 5 × 8 = 8 × 5 = 40.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0ae2eb2f-d6e9-53fa-81de-366e5ef62bad', '27d2f233-fc4a-5350-b0ae-9eed34f4273a', 'ما حاصل 34 × 10؟', '[{"id":"a","text":"44"},{"id":"b","text":"304"},{"id":"c","text":"340"},{"id":"d","text":"3 400"}]'::jsonb, 'c', 'للضرب في 10 نُضيف صفرًا واحدًا على يمين العدد: 34 × 10 = 340. الفخّ: إضافة صفرين تعطي 3 400 وهي نتيجة الضرب في 100.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('73b04a81-2f64-5c8c-8364-91a1555d0506', '27d2f233-fc4a-5350-b0ae-9eed34f4273a', 'ما حاصل 6 × (4 + 3) باستعمال التوزيعية؟', '[{"id":"a","text":"13"},{"id":"b","text":"42"},{"id":"c","text":"27"},{"id":"d","text":"67"}]'::jsonb, 'b', 'التوزيعية: 6 × (4 + 3) = 6 × 4 + 6 × 3 = 24 + 18 = 42، وهو نفسه 6 × 7 = 42.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0c17bef0-546b-5798-b08b-214195a13281', '2c5f8d1b-6351-5046-8474-04dfd3b2d0e5', 'أيّ عمليّة ضربٍ توافق الجمع 5 + 5 + 5 + 5؟', '[{"id":"a","text":"4 × 5"},{"id":"b","text":"5 + 4"},{"id":"c","text":"5 × 5"},{"id":"d","text":"4 × 4"}]'::jsonb, 'a', 'العدد 5 مأخوذٌ 4 مرّات، فالجمع 5 + 5 + 5 + 5 = 4 × 5 = 20.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8ac97830-e2fe-5f06-a8c0-611127b2636c', '2c5f8d1b-6351-5046-8474-04dfd3b2d0e5', 'ما جداء 3 × 6؟', '[{"id":"a","text":"9"},{"id":"b","text":"18"},{"id":"c","text":"36"},{"id":"d","text":"12"}]'::jsonb, 'b', 'في جدول 3: 3 × 6 = 6 + 6 + 6 = 18. إذن الجداء هو 18.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cf90789d-037f-5667-820c-2fd7eda40447', '2c5f8d1b-6351-5046-8474-04dfd3b2d0e5', 'كم يساوي 7 × 1؟', '[{"id":"a","text":"0"},{"id":"b","text":"1"},{"id":"c","text":"7"},{"id":"d","text":"8"}]'::jsonb, 'c', 'كلّ عددٍ مضروبٍ في 1 يبقى كما هو، فـ 7 × 1 = 7.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b8f8127a-6f4f-5fdc-8ad2-ea0207b1c37c', '2c5f8d1b-6351-5046-8474-04dfd3b2d0e5', 'ما هو ضِعف العدد 8؟', '[{"id":"a","text":"10"},{"id":"b","text":"4"},{"id":"c","text":"18"},{"id":"d","text":"16"}]'::jsonb, 'd', 'ضِعف عددٍ هو جداؤه في 2، فضِعف 8 هو 2 × 8 = 16.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('594d6a62-1bc0-5491-bfc8-d924826ba846', '2c5f8d1b-6351-5046-8474-04dfd3b2d0e5', 'ما جداء 4 × 7؟', '[{"id":"a","text":"11"},{"id":"b","text":"24"},{"id":"c","text":"28"},{"id":"d","text":"32"}]'::jsonb, 'c', 'في جدول 4: 4 × 7 = 28. (24 هو 4 × 6 و32 هو 4 × 8.)', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('58029863-152b-5790-a3b3-79325851c816', '2c5f8d1b-6351-5046-8474-04dfd3b2d0e5', 'كم يساوي 9 × 0؟', '[{"id":"a","text":"0"},{"id":"b","text":"9"},{"id":"c","text":"90"},{"id":"d","text":"1"}]'::jsonb, 'a', 'كلّ عددٍ مضروبٍ في 0 يساوي 0، فـ 9 × 0 = 0.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5f5c4a91-cdf5-55b4-be49-49bb94090fe9', '62d1e486-ec13-5bed-a60e-abc24b5bf6a1', 'ما جداء 8 × 9؟', '[{"id":"a","text":"17"},{"id":"b","text":"64"},{"id":"c","text":"72"},{"id":"d","text":"81"}]'::jsonb, 'c', 'من جدول الضرب: 8 × 9 = 72. الخطأ الشائع: قلب الرقمين أو الخلط مع 8 × 8 = 64 و9 × 9 = 81؛ و17 هو مجموع العاملين لا جداؤهما.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('866a47e2-74b7-5904-b599-0e9ff468fe22', '62d1e486-ec13-5bed-a60e-abc24b5bf6a1', 'بالتوزيعية، كم يساوي 6 × (5 + 4)؟', '[{"id":"a","text":"54"},{"id":"b","text":"15"},{"id":"c","text":"34"},{"id":"d","text":"44"}]'::jsonb, 'a', 'التوزيعية: 6 × (5 + 4) = 6 × 5 + 6 × 4 = 30 + 24 = 54، وهو نفسه 6 × 9 = 54. الخطأ الشائع: ضرب 6 في الحدّ الأوّل فقط (6 × 5 = 30) ونسيان 6 × 4.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('81cb3427-414c-5784-b709-50f8de4fd778', '62d1e486-ec13-5bed-a60e-abc24b5bf6a1', 'ما حاصل 7 × 100؟', '[{"id":"a","text":"70"},{"id":"b","text":"700"},{"id":"c","text":"7 000"},{"id":"d","text":"107"}]'::jsonb, 'b', 'للضرب في 100 نُضيف صفرين على يمين العدد: 7 × 100 = 700. الخطأ الشائع: إضافة صفرٍ واحدٍ يعطي 70 (وهو الضرب في 10).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7f8dc560-1465-5d3c-9af6-09a4764646d9', '62d1e486-ec13-5bed-a60e-abc24b5bf6a1', 'ما حاصل 213 × 3؟', '[{"id":"a","text":"216"},{"id":"b","text":"636"},{"id":"c","text":"693"},{"id":"d","text":"639"}]'::jsonb, 'd', 'نضرب كلّ رقمٍ في 3: الآحاد 3 × 3 = 9، العشرات 3 × 1 = 3، المئات 3 × 2 = 6، فالجداء 639 ✓. الخطأ الشائع: جمع 213 + 3 = 216 بدل الضرب.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a2998481-71a7-562e-b470-6efef047ecad', '62d1e486-ec13-5bed-a60e-abc24b5bf6a1', 'ما حاصل 47 × 6؟', '[{"id":"a","text":"242"},{"id":"b","text":"282"},{"id":"c","text":"246"},{"id":"d","text":"53"}]'::jsonb, 'b', 'الآحاد: 6 × 7 = 42، نكتب 2 ونحتفظ بـ 4. العشرات: 6 × 4 = 24 زائد الاحتفاظ 4 = 28. الجداء 282 ✓. الخطأ الشائع: نسيان الاحتفاظ 4 يعطي 242.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('afd74cb8-bfbd-5c21-a2b2-f28d342fc54c', '62d1e486-ec13-5bed-a60e-abc24b5bf6a1', 'ما حاصل 8 × 30؟', '[{"id":"a","text":"38"},{"id":"b","text":"110"},{"id":"c","text":"240"},{"id":"d","text":"2 400"}]'::jsonb, 'c', 'بما أنّ 30 = 3 × 10 نضرب في 3 ثمّ نُضيف صفرًا: 8 × 3 = 24، ثمّ 240. الخطأ الشائع: جمع 8 + 30 = 38، أو إضافة صفرين فيُكتب 2 400.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2b46c7b7-3342-5781-b3a0-8b872f2260d0', 'de8e0a2a-0174-542f-ab5a-a568d93d9d9c', 'ما جداء 5 × 7؟', '[{"id":"a","text":"12"},{"id":"b","text":"30"},{"id":"c","text":"35"},{"id":"d","text":"57"}]'::jsonb, 'c', 'في جدول 5: 5 × 7 = 35. (30 هو 5 × 6 و12 هو مجموع العاملين.)', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0e5ef739-119e-5c9e-8432-f40dc22b05a7', 'de8e0a2a-0174-542f-ab5a-a568d93d9d9c', 'بالتبديلية، إذا كان 9 × 4 = 36 فكم يساوي 4 × 9؟', '[{"id":"a","text":"36"},{"id":"b","text":"13"},{"id":"c","text":"45"},{"id":"d","text":"27"}]'::jsonb, 'a', 'الضرب تبديليّ: ترتيب العاملين لا يُغيّر الجداء، فـ 4 × 9 = 9 × 4 = 36.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3d9cab6c-f6ec-5b03-adeb-fe272e70fb81', 'de8e0a2a-0174-542f-ab5a-a568d93d9d9c', 'ما حاصل 60 × 100؟', '[{"id":"a","text":"160"},{"id":"b","text":"600"},{"id":"c","text":"60 000"},{"id":"d","text":"6 000"}]'::jsonb, 'd', 'للضرب في 100 نُضيف صفرين على اليمين: 60 × 100 = 6 000. (إضافة صفرٍ واحدٍ تعطي 600 وهو الضرب في 10.)', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('78be4ec0-379e-5e18-ab0b-417325dcb0f8', 'de8e0a2a-0174-542f-ab5a-a568d93d9d9c', 'ما حاصل 124 × 2؟', '[{"id":"a","text":"126"},{"id":"b","text":"248"},{"id":"c","text":"228"},{"id":"d","text":"244"}]'::jsonb, 'b', 'نضرب كلّ رقمٍ في 2: الآحاد 2 × 4 = 8، العشرات 2 × 2 = 4، المئات 2 × 1 = 2، فالجداء 248. (جمع 124 + 2 = 126 خطأ.)', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0fc931b8-3b5a-5b59-b02f-ad617575fe40', 'de8e0a2a-0174-542f-ab5a-a568d93d9d9c', 'ما حاصل 24 × 3؟', '[{"id":"a","text":"62"},{"id":"b","text":"27"},{"id":"c","text":"72"},{"id":"d","text":"612"}]'::jsonb, 'c', 'الآحاد: 3 × 4 = 12، نكتب 2 ونحتفظ بـ 1. العشرات: 3 × 2 = 6 زائد 1 = 7. فالجداء 72. (نسيان الاحتفاظ يعطي 62.)', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2ce60d50-7d9b-505d-8f3c-c13ef5e142a2', 'de8e0a2a-0174-542f-ab5a-a568d93d9d9c', 'اشترى بطلٌ 8 علبٍ، في كلّ علبةٍ 7 سهام. كم سهمًا اشترى في المجموع؟', '[{"id":"a","text":"15 سهمًا"},{"id":"b","text":"56 سهمًا"},{"id":"c","text":"78 سهمًا"},{"id":"d","text":"49 سهمًا"}]'::jsonb, 'b', 'نضرب عدد العلب في عدد السهام في كلّ علبة: 8 × 7 = 56 سهمًا. (جمع 8 + 7 = 15 بدل الضرب خطأ.)', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c882d9ee-79d8-501c-9adf-37d229646cba', 'd0e632bc-7b9c-5602-b313-cad273d88dc1', 'بالتجميعية، ما حاصل 2 × 3 × 5؟', '[{"id":"a","text":"10"},{"id":"b","text":"30"},{"id":"c","text":"25"},{"id":"d","text":"16"}]'::jsonb, 'b', 'نجمّع كما نشاء: (2 × 3) × 5 = 6 × 5 = 30، وكذلك 2 × (3 × 5) = 2 × 15 = 30 ✓. الخطأ الشائع: جمع الأعداد 2 + 3 + 5 = 10 بدل ضربها.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('48811efe-dac4-582a-b239-86c0ab587f31', 'd0e632bc-7b9c-5602-b313-cad273d88dc1', 'عددٌ مضروبٌ في 4 يساوي 32. ما هو هذا العدد؟', '[{"id":"a","text":"8"},{"id":"b","text":"6"},{"id":"c","text":"28"},{"id":"d","text":"7"}]'::jsonb, 'a', 'نبحث في جدول 4 عن النتيجة 32: 4 × 8 = 32، فالعدد هو 8 ✓. الخطأ الشائع: طرح 32 − 4 = 28 بدل البحث في الجدول.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('959f521b-35a2-5856-b7d1-2b857f5f9391', 'd0e632bc-7b9c-5602-b313-cad273d88dc1', 'ما حاصل 9 × 1000؟', '[{"id":"a","text":"900"},{"id":"b","text":"90 000"},{"id":"c","text":"1 009"},{"id":"d","text":"9 000"}]'::jsonb, 'd', 'للضرب في 1000 نُضيف ثلاثة أصفار على اليمين: 9 × 1000 = 9 000 ✓. الخطأ الشائع: إضافة صفرين فقط يعطي 900 (وهو الضرب في 100).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7e852c4f-c78f-560d-a8d9-3fc03460c4a7', '6514fe71-6d72-59e7-9260-ae643880620f', 'ما جداء 7 × 9؟', '[{"id":"a","text":"16"},{"id":"b","text":"72"},{"id":"c","text":"56"},{"id":"d","text":"63"}]'::jsonb, 'd', 'من جدول الضرب: 7 × 9 = 63. الخطأ الشائع: 72 هو 8 × 9 و56 هو 7 × 8 و16 هو مجموع العاملين.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('23927ed2-26b7-5b78-92ea-143960596122', '6514fe71-6d72-59e7-9260-ae643880620f', 'بالتوزيعية، كم يساوي 5 × (8 + 2)؟', '[{"id":"a","text":"42"},{"id":"b","text":"50"},{"id":"c","text":"15"},{"id":"d","text":"40"}]'::jsonb, 'b', 'التوزيعية: 5 × (8 + 2) = 5 × 8 + 5 × 2 = 40 + 10 = 50، وهو نفسه 5 × 10 = 50. الخطأ الشائع: ضرب 5 في الحدّ الأوّل فقط (5 × 8 = 40) ونسيان 5 × 2.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('76ed5ae0-6a7f-55a0-a1cd-6bb485cb68e6', '6514fe71-6d72-59e7-9260-ae643880620f', 'ما حاصل 90 × 10؟', '[{"id":"a","text":"100"},{"id":"b","text":"9 000"},{"id":"c","text":"900"},{"id":"d","text":"910"}]'::jsonb, 'c', 'للضرب في 10 نُضيف صفرًا واحدًا على اليمين: 90 × 10 = 900. الخطأ الشائع: إضافة صفرين يعطي 9 000 (وهو الضرب في 100).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ff440060-dce6-5dd5-9719-2cb2eb07bb9a', '6514fe71-6d72-59e7-9260-ae643880620f', 'ما حاصل 153 × 3؟', '[{"id":"a","text":"359"},{"id":"b","text":"459"},{"id":"c","text":"453"},{"id":"d","text":"156"}]'::jsonb, 'b', 'الآحاد: 3 × 3 = 9. العشرات: 3 × 5 = 15 نكتب 5 ونحتفظ 1. المئات: 3 × 1 = 3 زائد 1 = 4. فالجداء 459 ✓. الخطأ الشائع: نسيان الاحتفاظ في المئات يعطي 359.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d9aef2f9-ed4b-540e-b2b6-3a6eee141605', '6514fe71-6d72-59e7-9260-ae643880620f', 'ما حاصل 36 × 5؟', '[{"id":"a","text":"180"},{"id":"b","text":"150"},{"id":"c","text":"41"},{"id":"d","text":"155"}]'::jsonb, 'a', 'الآحاد: 5 × 6 = 30 نكتب 0 ونحتفظ 3. العشرات: 5 × 3 = 15 زائد 3 = 18. فالجداء 180 ✓. الخطأ الشائع: نسيان الاحتفاظ 3 يعطي 150.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('25776c89-b5fd-5882-8c95-6a0e6e4b382b', '6514fe71-6d72-59e7-9260-ae643880620f', 'ما حاصل 8 × 400؟', '[{"id":"a","text":"320"},{"id":"b","text":"408"},{"id":"c","text":"32 000"},{"id":"d","text":"3 200"}]'::jsonb, 'd', 'بما أنّ 400 = 4 × 100 نضرب في 4 ثمّ نُضيف صفرين: 8 × 4 = 32، ثمّ 3 200 ✓. الخطأ الشائع: إضافة صفرٍ واحدٍ يعطي 320 بدل صفرين.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b6886e80-b384-5f66-8c7a-949b39153443', '68fcfcd2-e474-535f-afcb-4be86b27d228', 'في الشبكة، ما اسم النقطة التي يلتقي فيها خطّان (سطرٌ مع عمود)؟', '[{"id":"a","text":"العقدة"},{"id":"b","text":"الخانة"},{"id":"c","text":"الضلع"},{"id":"d","text":"العمود"}]'::jsonb, 'a', 'العقدة هي نقطة تقاطُع سطرٍ مع عمود. أمّا الخانة فهي المساحة المحصورة بين الخطوط.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f9436f60-ced4-5082-a963-35cc12e0b8d6', '68fcfcd2-e474-535f-afcb-4be86b27d228', 'ما عدد أضلاع المثلّث؟', '[{"id":"a","text":"ضلعان"},{"id":"b","text":"5 أضلاع"},{"id":"c","text":"4 أضلاع"},{"id":"d","text":"3 أضلاع"}]'::jsonb, 'd', 'المثلّث مضلّعٌ له 3 أضلاع و3 رؤوس، وهو أقلّ المضلّعات أضلاعًا.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b278954b-c27e-5088-a321-113da23c229d', '6f8bca92-5bde-5296-a8e9-e6c5f5cd9f99', 'ما عدد أضلاع الرباعيّ؟', '[{"id":"a","text":"3 أضلاع"},{"id":"b","text":"4 أضلاع"},{"id":"c","text":"5 أضلاع"},{"id":"d","text":"6 أضلاع"}]'::jsonb, 'b', 'الرباعيّ مضلّعٌ له 4 أضلاع و4 رؤوس.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e8908e1c-7cad-541d-a2ff-fff7a9cc7670', '6f8bca92-5bde-5296-a8e9-e6c5f5cd9f99', 'العقدة المعلّمة تقع في السطر 1 والعمود 3. ما موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(3، 1)"},{"id":"b","text":"(1، 3)"},{"id":"c","text":"(1، 1)"},{"id":"d","text":"(3، 3)"}]'::jsonb, 'b', 'نكتب السطر أوّلًا ثمّ العمود: السطر 1 والعمود 3 يُكتب (1، 3).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3f4882ae-6233-5155-8dec-159e7ced1c3f', '6f8bca92-5bde-5296-a8e9-e6c5f5cd9f99', 'كم رأسًا للمضلّع السداسيّ؟', '[{"id":"a","text":"4 رؤوس"},{"id":"b","text":"5 رؤوس"},{"id":"c","text":"6 رؤوس"},{"id":"d","text":"3 رؤوس"}]'::jsonb, 'c', 'في كلّ مضلّع عدد الرؤوس يساوي عدد الأضلاع. السداسيّ له 6 أضلاع، إذن 6 رؤوس.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6b1f9272-473b-575b-b255-4193de487852', '44a3f827-8941-5fd9-8895-2f5fb266d3d4', 'شكلٌ مغلقٌ عدّينا له 5 رؤوس. كم ضلعًا له؟', '[{"id":"a","text":"4 أضلاع"},{"id":"b","text":"6 أضلاع"},{"id":"c","text":"5 أضلاع"},{"id":"d","text":"10 أضلاع"}]'::jsonb, 'c', 'في كلّ مضلّع عدد الأضلاع يساوي عدد الرؤوس، إذن 5 رؤوس ← 5 أضلاع (خماسيّ). الخطأ الشائع: مضاعفة العدد (5 × 2 = 10) ظنًّا أنّ لكلّ رأسٍ ضلعين.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2a4016cb-8483-5ce4-9936-8f67fc1f62cd', '44a3f827-8941-5fd9-8895-2f5fb266d3d4', 'مضلّعان: الأوّل له 4 أضلاع والثاني له 6 أضلاع. كم ضلعًا في الثاني أكثر من الأوّل؟', '[{"id":"a","text":"2"},{"id":"b","text":"10"},{"id":"c","text":"3"},{"id":"d","text":"1"}]'::jsonb, 'a', 'الفرق 6 − 4 = 2، أي ضلعان أكثر (سداسيّ مقابل رباعيّ). الخطأ الشائع: جمع العددين 6 + 4 = 10 بدل طرحهما.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0d1c0441-9d90-5bc0-a8b7-6023a7f562a7', 'ec820faa-04fd-53ac-9841-5477b8ba7984', 'العقدة في السطر 3 والعمود 2. ما موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(2، 3)"},{"id":"b","text":"(3، 2)"},{"id":"c","text":"(3، 3)"},{"id":"d","text":"(2، 2)"}]'::jsonb, 'b', 'السطر أوّلًا ثمّ العمود: السطر 3 والعمود 2 يُكتب (3، 2). الزوج (2، 3) يعكس الترتيب فهو خطأ.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('86824189-3bb6-5239-bc1b-e8d2f633a505', 'ec820faa-04fd-53ac-9841-5477b8ba7984', 'مسلكٌ يمرّ بـ 6 عُقد على التوالي. كم خطوةً فيه؟', '[{"id":"a","text":"6 خطوات"},{"id":"b","text":"7 خطوات"},{"id":"c","text":"4 خطوات"},{"id":"d","text":"5 خطوات"}]'::jsonb, 'd', 'عدد الخطوات = عدد القطع = عدد العُقد ناقص 1، أي 6 − 1 = 5 خطوات.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('de5c898b-5059-5777-b25f-0f08e1aad169', 'ec820faa-04fd-53ac-9841-5477b8ba7984', 'أيّ مضلّعٍ له عدد أضلاعٍ أكثر من الرباعيّ بضلعين؟', '[{"id":"a","text":"السداسيّ"},{"id":"b","text":"الخماسيّ"},{"id":"c","text":"المثلّث"},{"id":"d","text":"الرباعيّ"}]'::jsonb, 'a', 'الرباعيّ له 4 أضلاع، و4 + 2 = 6، فالمضلّع المطلوب هو السداسيّ (6 أضلاع).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d8d061f3-d5f6-5f14-8966-f49f4acf5ea0', '04650261-2f0b-5fc9-8f35-c08ecc71698b', 'رسمنا مضلّعًا بـ 3 رؤوس ثمّ مضلّعًا بـ 5 رؤوس. كم ضلعًا مجموع المضلّعين معًا؟', '[{"id":"a","text":"7"},{"id":"b","text":"8"},{"id":"c","text":"9"},{"id":"d","text":"15"}]'::jsonb, 'b', 'أضلاع كلّ مضلّعٍ = رؤوسه: 3 و5. المجموع 3 + 5 = 8 أضلاع. الخطأ الشائع: ضرب العددين 3 × 5 = 15 بدل جمعهما.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('611936ee-593a-5c1b-8de9-d915b0bf6d1e', '04650261-2f0b-5fc9-8f35-c08ecc71698b', 'أيّ زوجٍ من المسالك بين نفس النقطتين يكون حتمًا متكافئًا؟', '[{"id":"a","text":"مسلكان طولهما 3 خطوات و4 خطوات"},{"id":"b","text":"مسلكان طولهما 5 خطوات و6 خطوات"},{"id":"c","text":"مسلكان طولهما 4 خطوات و4 خطوات"},{"id":"d","text":"مسلكان طولهما 2 خطوة و4 خطوات"}]'::jsonb, 'c', 'المسلكان متكافئان فقط إذا تساوى عدد خطواتهما؛ 4 = 4 وحدها تحقّق ذلك. الخطأ الشائع: اعتبار أيّ مسلكين بين نفس النقطتين متكافئين، لكنّ الطول قد يختلف.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a892f36b-999a-572d-b15c-4b8c0d272958', '836f097b-ff8d-5790-a559-f91a64bc4129', 'في الشبكة، الخطوط الأفقيّة تُسمّى:', '[{"id":"a","text":"الأسطر"},{"id":"b","text":"الأعمدة"},{"id":"c","text":"الرؤوس"},{"id":"d","text":"الأضلاع"}]'::jsonb, 'a', 'الخطوط الأفقيّة هي الأسطر (نعدّها من الأعلى إلى الأسفل)، والعموديّة هي الأعمدة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('597bdb0b-ee05-5669-ac88-d71acc96be73', '836f097b-ff8d-5790-a559-f91a64bc4129', 'العقدة في السطر 2 والعمود 1. ما موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(1، 2)"},{"id":"b","text":"(2، 2)"},{"id":"c","text":"(2، 1)"},{"id":"d","text":"(1، 1)"}]'::jsonb, 'c', 'السطر أوّلًا ثمّ العمود: السطر 2 والعمود 1 يُكتب (2، 1). الزوج (1، 2) يعكس الترتيب.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cbe88324-1ef1-53ff-8eb4-a7dba0c7e302', '836f097b-ff8d-5790-a559-f91a64bc4129', 'مضلّعٌ له 6 أضلاع. كم رأسًا له؟', '[{"id":"a","text":"12 رأسًا"},{"id":"b","text":"5 رؤوس"},{"id":"c","text":"6 رؤوس"},{"id":"d","text":"3 رؤوس"}]'::jsonb, 'c', 'عدد الرؤوس = عدد الأضلاع في كلّ مضلّع، إذن 6 رؤوس. الخطأ الشائع: مضاعفة العدد (6 × 2 = 12).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('31ed67af-8a43-5ad4-b31a-5a4b14241a84', '4ab0f5c0-7980-55ec-a656-e4bf2914b93e', 'النقطة التي ينطلق منها ضلعا الزاوية تُسمّى:', '[{"id":"a","text":"رأس الزاوية"},{"id":"b","text":"الضلع"},{"id":"c","text":"الفتحة"},{"id":"d","text":"المستقيم"}]'::jsonb, 'a', 'ضلعا الزاوية (نصفا المستقيم) ينطلقان من نقطةٍ واحدة تُسمّى رأس الزاوية (le sommet).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e9c853dd-15dc-5b21-b161-9590c8b82bb9', '4ab0f5c0-7980-55ec-a656-e4bf2914b93e', 'ما هي الزاوية القائمة؟', '[{"id":"a","text":"زاوية فتحتها واسعة جدًّا"},{"id":"b","text":"الزاوية التي نراها في ركن الورقة أو الطاولة"},{"id":"c","text":"زاوية ضلعاها قصيران"},{"id":"d","text":"زاوية فتحتها ضيّقة جدًّا"}]'::jsonb, 'b', 'الزاوية القائمة هي زاوية ركن الورقة وركن الطاولة، نتحقّق منها بالكوس ونعلّمها بمربّعٍ صغير.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ae96db0c-000a-51f5-85cf-1715d50413f2', '4ab0f5c0-7980-55ec-a656-e4bf2914b93e', 'لو مدَدْنا ضلعَي زاويةٍ حتّى صارا أطول، فإنّ الزاوية:', '[{"id":"a","text":"تكبر فتحتها"},{"id":"b","text":"تصغر فتحتها"},{"id":"c","text":"تبقى كما هي"},{"id":"d","text":"تصير قائمة"}]'::jsonb, 'c', 'طول الضلعين لا يغيّر الزاوية؛ المهمّ اتّساع الفتحة فقط، فتبقى الزاوية كما هي.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bbffce1e-f5d5-5f09-bfa0-d4a4733160d4', '80671e5e-3745-5397-8ef0-19ccadbe23ba', 'الزاوية هي:', '[{"id":"a","text":"الفتحة بين ضلعين ينطلقان من رأسٍ واحد"},{"id":"b","text":"خطٌّ مستقيمٌ طويل"},{"id":"c","text":"نقطةٌ واحدة"},{"id":"d","text":"شكلٌ مدوّر"}]'::jsonb, 'a', 'الزاوية هي الفتحة بين ضلعين (نصفَي مستقيم) ينطلقان من نقطةٍ واحدة هي الرأس.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8733f912-9b50-5f21-8baa-a094fb20bef2', '80671e5e-3745-5397-8ef0-19ccadbe23ba', 'كم ضلعًا للزاوية؟', '[{"id":"a","text":"ضلعٌ واحد"},{"id":"b","text":"ضلعان"},{"id":"c","text":"3 أضلاع"},{"id":"d","text":"4 أضلاع"}]'::jsonb, 'b', 'للزاوية ضلعان (نصفا مستقيم) يلتقيان عند الرأس، وبينهما الفتحة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('73145393-e9e6-5d1d-9142-b14383a10baf', '80671e5e-3745-5397-8ef0-19ccadbe23ba', 'بأيّ أداةٍ نتحقّق من أنّ الزاوية قائمة؟', '[{"id":"a","text":"بالمسطرة"},{"id":"b","text":"بالكوس"},{"id":"c","text":"بالبركار"},{"id":"d","text":"بالممحاة"}]'::jsonb, 'b', 'نطابق ركن الكوس على رأس الزاوية وضلعيها؛ إن انطبق تمامًا فالزاوية قائمة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cd0799e5-a961-5125-acfe-1c6e44333edc', '80671e5e-3745-5397-8ef0-19ccadbe23ba', 'زاويةٌ فتحتها أصغر من ركن الورقة (أصغر من القائمة). ما نوعها؟', '[{"id":"a","text":"منفرجة"},{"id":"b","text":"قائمة"},{"id":"c","text":"حادّة"},{"id":"d","text":"مدوّرة"}]'::jsonb, 'c', 'الزاوية الحادّة فتحتها أصغر من القائمة، أي أصغر من ركن الورقة، والضلعان قريبان من بعضهما.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('baaf2cce-3b12-54f2-9a89-90ce30b800c7', '84b9d057-4b4f-576b-b93e-ca9b8152fbc5', 'زاويتان لهما نفس الفتحة، لكنّ ضلعَي الأولى أطول. أيّهما أكبر؟', '[{"id":"a","text":"الأولى (ذات الضلعين الأطول)"},{"id":"b","text":"الثانية (ذات الضلعين الأقصر)"},{"id":"c","text":"لا نستطيع المقارنة"},{"id":"d","text":"هما متساويتان"}]'::jsonb, 'd', 'طول الضلعين لا يغيّر الزاوية؛ ما دامت الفتحة واحدة فالزاويتان متساويتان. الخطأ الشائع: ظنّ أنّ الضلع الأطول يصنع زاويةً أكبر.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('de49ba9c-8149-51cc-9bd9-6ef59c809dd5', '84b9d057-4b4f-576b-b93e-ca9b8152fbc5', 'زاويةٌ نطابق عليها ركن الكوس فيبقى ضلعٌ من الزاوية خارج الكوس (الفتحة أوسع من الكوس). ما نوعها؟', '[{"id":"a","text":"قائمة"},{"id":"b","text":"حادّة"},{"id":"c","text":"منفرجة"},{"id":"d","text":"لا يمكن تحديدها"}]'::jsonb, 'c', 'إذا تجاوزت فتحة الزاوية ركن الكوس فهي أكبر من القائمة، أي منفرجة. الخطأ الشائع: ظنّ كلّ زاويةٍ نقيسها بالكوس قائمة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ddcda47f-97e7-5dbd-bc29-68b53c10524e', '1521713b-5e31-544b-96d6-7bfb9228f4fd', 'أيّ هذه الأشياء فيه زاوية قائمة؟', '[{"id":"a","text":"ركن الكتاب"},{"id":"b","text":"رأس قطعة بيتزا"},{"id":"c","text":"خطٌّ مستقيم"},{"id":"d","text":"دائرة الساعة"}]'::jsonb, 'a', 'ركن الكتاب زاوية قائمة كركن الورقة. رأس البيتزا حادّة، والدائرة لا زوايا لها.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9a87e92a-aa70-588b-a33e-d5975fdadd0b', '1521713b-5e31-544b-96d6-7bfb9228f4fd', 'للمثلّث ثلاث زوايا عند رؤوسه الثلاثة. عددُ زوايا المثلّث هو:', '[{"id":"a","text":"زاويتان"},{"id":"b","text":"3 زوايا"},{"id":"c","text":"4 زوايا"},{"id":"d","text":"لا زوايا له"}]'::jsonb, 'b', 'للمثلّث 3 رؤوس، وعند كلّ رأسٍ زاوية، فله 3 زوايا.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7728ca21-21a8-58f4-97d2-55cc89d28a22', '1521713b-5e31-544b-96d6-7bfb9228f4fd', 'أردنا رسم زاوية حادّة. كيف نضع الضلعين؟', '[{"id":"a","text":"نباعد بينهما كثيرًا"},{"id":"b","text":"نجعلهما متعامدين بالكوس"},{"id":"c","text":"نقرّبهما من بعضهما (فتحة ضيّقة)"},{"id":"d","text":"نجعلهما على استقامةٍ واحدة"}]'::jsonb, 'c', 'الزاوية الحادّة فتحتها أصغر من القائمة، فنقرّب الضلعين ليكوّنا فتحةً ضيّقة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f951e624-a703-5d0d-8d91-b70c9892d733', 'b0352055-ab04-5b5c-a731-4bffde13ed0d', 'أيّ زوجٍ من الأشياء فيه زاويتان من نوعٍ واحد؟', '[{"id":"a","text":"ركن الباب وركن البلاطة"},{"id":"b","text":"ركن النافذة ورأس قطعة بيتزا"},{"id":"c","text":"رأس قلمٍ مبري وركن الكتاب"},{"id":"d","text":"مسند كرسيٍّ مائل وركن الطاولة"}]'::jsonb, 'a', 'ركن الباب وركن البلاطة كلاهما زاوية قائمة، فهما من نوعٍ واحد. أمّا البقية فتخلط بين قائمة وحادّة أو منفرجة. الخطأ الشائع: عدّ كلّ ركنٍ زاويةً قائمة دون النظر إلى نوع الزاوية الأخرى.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('03678a81-1a8a-5d9a-a6c0-eae67d882077', 'ba770364-9225-5efb-87f8-6831189a5814', 'ما اسم الضلعين اللذين يكوّنان الزاوية، والنقطة التي ينطلقان منها؟', '[{"id":"a","text":"الضلعان والرأس"},{"id":"b","text":"الفتحة والمحيط"},{"id":"c","text":"السطر والعمود"},{"id":"d","text":"الطول والعرض"}]'::jsonb, 'a', 'الزاوية لها ضلعان (نصفا مستقيم) ينطلقان من نقطةٍ واحدة تُسمّى الرأس.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6822dc87-edf3-57bf-9df1-f04f38e4897a', 'ba770364-9225-5efb-87f8-6831189a5814', 'ما نوع هذه الزاوية؟ <svg viewBox="0 0 110 90" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="75" x2="95" y2="75" stroke="currentColor" stroke-width="2.5"/><line x1="20" y1="75" x2="76" y2="48" stroke="currentColor" stroke-width="2.5"/><circle cx="20" cy="75" r="3" fill="currentColor"/></svg>', '[{"id":"a","text":"قائمة"},{"id":"b","text":"منفرجة"},{"id":"c","text":"حادّة"},{"id":"d","text":"ليست زاوية"}]'::jsonb, 'c', 'فتحة الزاوية أصغر من ركن الورقة (الضلعان قريبان)، إذًا هي زاوية حادّة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('30b63efc-4809-5199-850a-106a28096777', 'ba770364-9225-5efb-87f8-6831189a5814', 'صديقك رسم زاويةً بضلعين قصيرين. لو رسم زاويةً بنفس الفتحة لكن بضلعين طويلين، تكون الزاوية الجديدة:', '[{"id":"a","text":"أكبر"},{"id":"b","text":"أصغر"},{"id":"c","text":"قائمة"},{"id":"d","text":"بنفس الاتّساع"}]'::jsonb, 'd', 'طول الضلعين لا يغيّر الزاوية؛ ما دامت الفتحة واحدة فالزاوية بنفس الاتّساع. الخطأ الشائع: ربط حجم الزاوية بطول الضلعين.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2c6ea3dc-ec1a-5a23-804b-8e32bfb3fb01', 'ba770364-9225-5efb-87f8-6831189a5814', 'ما نوع هذه الزاوية؟ <svg viewBox="0 0 110 90" xmlns="http://www.w3.org/2000/svg"><line x1="20" y1="75" x2="95" y2="75" stroke="currentColor" stroke-width="2.5"/><line x1="20" y1="75" x2="20" y2="10" stroke="currentColor" stroke-width="2.5"/><polyline points="20,58 37,58 37,75" fill="none" stroke="currentColor" stroke-width="2"/><circle cx="20" cy="75" r="3" fill="currentColor"/></svg>', '[{"id":"a","text":"حادّة"},{"id":"b","text":"قائمة"},{"id":"c","text":"منفرجة"},{"id":"d","text":"ليست زاوية"}]'::jsonb, 'b', 'المربّع الصغير عند الرأس علامة الزاوية القائمة، وضلعاها متعامدان مثل ركن الورقة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e011e29a-aa1b-54a5-954c-609f0b2fab8c', 'ba770364-9225-5efb-87f8-6831189a5814', 'طابقنا ركن الكوس على زاوية فدخل ضلعا الزاوية داخل الكوس ولم يبلغا حافّتيه (الفتحة أضيق من الكوس). ما نوعها؟', '[{"id":"a","text":"قائمة"},{"id":"b","text":"منفرجة"},{"id":"c","text":"حادّة"},{"id":"d","text":"لا يمكن تحديدها"}]'::jsonb, 'c', 'إذا بقيت فتحة الزاوية داخل ركن الكوس (أضيق منه) فهي أصغر من القائمة، أي حادّة. الخطأ الشائع: ظنّ كلّ زاويةٍ نضع عليها الكوس قائمة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5725c1c4-83bc-5c25-95a6-52eb3c903886', 'fd6c52fc-9d01-5de4-b32c-8897708e53e3', 'كم زاوية قائمة للمستطيل؟', '[{"id":"a","text":"زاويتان قائمتان"},{"id":"b","text":"3 زوايا قائمة"},{"id":"c","text":"لا زوايا قائمة له"},{"id":"d","text":"4 زوايا قائمة"}]'::jsonb, 'd', 'المستطيل له 4 أضلاع و4 زوايا قائمة، والأضلاع المتقابلة فيه متساوية (طول وعرض).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('de75f3ee-c8d4-5afd-9e90-6a8d9f247f1e', 'fd6c52fc-9d01-5de4-b32c-8897708e53e3', 'ماذا نعني بمحيط شكلٍ ما؟', '[{"id":"a","text":"عدد زواياه القائمة"},{"id":"b","text":"مجموع أطوال أضلاعه"},{"id":"c","text":"عدد أضلاعه"},{"id":"d","text":"طول أطول ضلعٍ فيه"}]'::jsonb, 'b', 'محيط الشكل هو مجموع أطوال أضلاعه، أي طول الخطّ الذي يحيط به، ويُقاس بـ cm أو m.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ed5208fa-35cd-503b-8ac0-b157453d6d36', 'fd6c52fc-9d01-5de4-b32c-8897708e53e3', 'مربّعٌ ضلعه 6 cm. ما محيطه؟', '[{"id":"a","text":"12 cm"},{"id":"b","text":"18 cm"},{"id":"c","text":"24 cm"},{"id":"d","text":"36 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 6 × 4 = 24 cm. (أو 6 + 6 + 6 + 6 = 24 cm.)', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4cc37990-780f-5128-9aaa-41c545ec436c', '0a2a8702-3e93-58fb-b458-2566b9c0fe4a', 'كم ضلعًا للمربّع؟', '[{"id":"a","text":"3 أضلاع"},{"id":"b","text":"4 أضلاع"},{"id":"c","text":"5 أضلاع"},{"id":"d","text":"ضلعان"}]'::jsonb, 'b', 'المربّع شكلٌ له 4 أضلاع متساوية و4 زوايا قائمة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b4a5d4d0-f362-5966-85d8-106a2b902430', '0a2a8702-3e93-58fb-b458-2566b9c0fe4a', 'مربّعٌ ضلعه 3 cm. ما محيطه؟', '[{"id":"a","text":"9 cm"},{"id":"b","text":"6 cm"},{"id":"c","text":"12 cm"},{"id":"d","text":"7 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 3 × 4 = 12 cm. (أو 3 + 3 + 3 + 3 = 12 cm.)', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2d6acb95-8a5b-5c4b-af1d-fa9edfc4f3f9', '0a2a8702-3e93-58fb-b458-2566b9c0fe4a', 'ما العدد الذي نضرب فيه ضلع المربّع لنحصل على محيطه؟', '[{"id":"a","text":"2"},{"id":"b","text":"3"},{"id":"c","text":"4"},{"id":"d","text":"5"}]'::jsonb, 'c', 'للمربّع 4 أضلاع متساوية، فمحيطه = الضلع × 4.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f516cb77-19e2-56e9-8fb6-8475f6b2d822', '0a2a8702-3e93-58fb-b458-2566b9c0fe4a', 'مستطيلٌ طوله 5 cm وعرضه 3 cm. ما محيطه؟', '[{"id":"a","text":"8 cm"},{"id":"b","text":"13 cm"},{"id":"c","text":"15 cm"},{"id":"d","text":"16 cm"}]'::jsonb, 'd', 'المحيط = (الطول + العرض) × 2 = (5 + 3) × 2 = 8 × 2 = 16 cm.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4c93393c-7a0e-5ac4-8918-7a20ca32623b', '06b6c8c0-3f73-58b2-a9da-b180bc217e9d', 'مستطيلٌ طوله 7 cm وعرضه 3 cm. ما محيطه؟', '[{"id":"a","text":"10 cm"},{"id":"b","text":"21 cm"},{"id":"c","text":"20 cm"},{"id":"d","text":"14 cm"}]'::jsonb, 'c', 'المحيط = (7 + 3) × 2 = 10 × 2 = 20 cm. الخطأ الشائع: التوقّف عند 7 + 3 = 10 ونسيان الضرب في 2، لأنّ للمستطيل ضلعين بكلّ قياس.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5f46accb-6bfb-515b-a7a8-788ce0403247', '06b6c8c0-3f73-58b2-a9da-b180bc217e9d', 'مربّعٌ محيطه 20 cm. ما طول ضلعه؟', '[{"id":"a","text":"4 cm"},{"id":"b","text":"10 cm"},{"id":"c","text":"16 cm"},{"id":"d","text":"5 cm"}]'::jsonb, 'd', 'محيط المربّع = الضلع × 4، فالضلع = 20 ÷ 4 = 5 cm. تحقّق: 5 × 4 = 20 cm. ✓ الخطأ الشائع: طرح 4 بدل القسمة عليها.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c55604cb-be60-5678-9231-11c46370c256', '06b6c8c0-3f73-58b2-a9da-b180bc217e9d', 'مستطيلٌ طوله 8 cm، ومحيطه 24 cm. ما عرضه؟', '[{"id":"a","text":"4 cm"},{"id":"b","text":"16 cm"},{"id":"c","text":"12 cm"},{"id":"d","text":"3 cm"}]'::jsonb, 'a', 'المحيط = (الطول + العرض) × 2. فمجموع الطول والعرض = 24 ÷ 2 = 12، والعرض = 12 − 8 = 4 cm. تحقّق: (8 + 4) × 2 = 24 cm. ✓', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8f0dcb17-26a7-5b5c-af2c-c0176bc657d6', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'كم زاوية قائمة للمربّع؟', '[{"id":"a","text":"زاويتان"},{"id":"b","text":"3 زوايا"},{"id":"c","text":"4 زوايا"},{"id":"d","text":"لا زوايا قائمة له"}]'::jsonb, 'c', 'المربّع له 4 أضلاع متساوية و4 زوايا قائمة، مثل المستطيل تمامًا.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fe65563d-dad8-51c7-9e57-9dafde6f137d', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'مربّعٌ ضلعه 8 cm. ما محيطه؟', '[{"id":"a","text":"16 cm"},{"id":"b","text":"24 cm"},{"id":"c","text":"32 cm"},{"id":"d","text":"64 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 8 × 4 = 32 cm.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('af4fd70b-8a4b-57be-be0a-4191d0d6c101', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'مستطيلٌ طوله 10 cm وعرضه 4 cm. ما محيطه؟', '[{"id":"a","text":"14 cm"},{"id":"b","text":"28 cm"},{"id":"c","text":"40 cm"},{"id":"d","text":"24 cm"}]'::jsonb, 'b', 'المحيط = (الطول + العرض) × 2 = (10 + 4) × 2 = 14 × 2 = 28 cm.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b86a261f-6175-5855-be3b-7df4894c91b4', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'مثلّثٌ أطوال أضلاعه 5 cm و6 cm و7 cm. ما محيطه؟', '[{"id":"a","text":"18 cm"},{"id":"b","text":"17 cm"},{"id":"c","text":"210 cm"},{"id":"d","text":"11 cm"}]'::jsonb, 'a', 'محيط المضلّع = مجموع أطوال أضلاعه = 5 + 6 + 7 = 18 cm.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('541879ca-de8d-51d8-844a-4955a026b58f', '4c411e2a-c4ea-5aeb-8fba-8dfa26506f58', 'مستطيلٌ طوله ضعف عرضه. إذا كان العرض 5 cm، فما محيطه؟', '[{"id":"a","text":"15 cm"},{"id":"b","text":"20 cm"},{"id":"c","text":"50 cm"},{"id":"d","text":"30 cm"}]'::jsonb, 'd', 'الطول = ضعف العرض = 5 × 2 = 10 cm. المحيط = (10 + 5) × 2 = 15 × 2 = 30 cm. الخطأ الشائع: نسيان حساب الطول واستعمال 5 مرّتين.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c0d573d0-3a3e-5a60-836c-79c1e5ff7354', '4c411e2a-c4ea-5aeb-8fba-8dfa26506f58', 'سلكٌ طوله 36 cm نطويه ليكوّن مربّعًا كاملًا. ما طول ضلع المربّع؟', '[{"id":"a","text":"6 cm"},{"id":"b","text":"4 cm"},{"id":"c","text":"9 cm"},{"id":"d","text":"12 cm"}]'::jsonb, 'c', 'طول السلك هو محيط المربّع = 36 cm. الضلع = 36 ÷ 4 = 9 cm. تحقّق: 9 × 4 = 36 cm. ✓ الخطأ الشائع: قسمة 36 على 2 بدل 4.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bcf65aa0-7ca6-5b70-bf73-532ee5e95930', '4c411e2a-c4ea-5aeb-8fba-8dfa26506f58', 'مربّعٌ ضلعه 7 cm ومستطيلٌ طوله 9 cm وعرضه 5 cm. أيّهما محيطه أكبر؟', '[{"id":"a","text":"المربّع، لأنّ محيطه 28 cm"},{"id":"b","text":"المستطيل، لأنّ محيطه 30 cm"},{"id":"c","text":"لهما نفس المحيط: 28 cm"},{"id":"d","text":"المربّع، لأنّ محيطه 49 cm"}]'::jsonb, 'c', 'محيط المربّع = 7 × 4 = 28 cm، ومحيط المستطيل = (9 + 5) × 2 = 28 cm. فهما متساويان. الخطأ الشائع: حساب 7 × 7 = 49 للمربّع بدل الضرب في 4.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1c954ae7-239c-51b7-96e0-b787e7d1002b', 'cfb47759-fb46-529a-8bff-460fbc2e2c7f', 'مربّعٌ ضلعه 4 cm. ما محيطه؟', '[{"id":"a","text":"8 cm"},{"id":"b","text":"12 cm"},{"id":"c","text":"16 cm"},{"id":"d","text":"20 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 4 × 4 = 16 cm.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1661dfd2-b764-5846-ba5d-62b2e2b45879', 'cfb47759-fb46-529a-8bff-460fbc2e2c7f', 'مربّعٌ محيطه 32 cm. ما طول ضلعه؟', '[{"id":"a","text":"6 cm"},{"id":"b","text":"8 cm"},{"id":"c","text":"16 cm"},{"id":"d","text":"28 cm"}]'::jsonb, 'b', 'الضلع = المحيط ÷ 4 = 32 ÷ 4 = 8 cm. تحقّق: 8 × 4 = 32 cm. ✓ الخطأ الشائع: طرح 4 من 32 بدل القسمة عليها.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1bf022b6-69f0-57c1-b723-39bb0e63cd9d', 'cfb47759-fb46-529a-8bff-460fbc2e2c7f', 'مستطيلٌ طوله 11 cm، ومحيطه 30 cm. ما عرضه؟', '[{"id":"a","text":"4 cm"},{"id":"b","text":"19 cm"},{"id":"c","text":"8 cm"},{"id":"d","text":"15 cm"}]'::jsonb, 'a', 'مجموع الطول والعرض = 30 ÷ 2 = 15، والعرض = 15 − 11 = 4 cm. تحقّق: (11 + 4) × 2 = 30 cm. ✓', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4919d76f-8775-5846-bfb2-e18eb19e1350', '58b3f1f7-ec46-5f6a-9eb5-65e031cef733', 'كم مليمًا في الدينار الواحد؟', '[{"id":"a","text":"100 مليم"},{"id":"b","text":"1000 مليم"},{"id":"c","text":"500 مليم"},{"id":"d","text":"10 مليم"}]'::jsonb, 'b', 'العلاقة الأساسيّة بين الوحدتين: 1 د = 1000 مليم. إذن الدينار الواحد فيه 1000 مليم.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('784f25f6-77ac-5c5c-ad48-b1af2b3e29f9', '58b3f1f7-ec46-5f6a-9eb5-65e031cef733', 'كم صنتيمترًا في المتر الواحد؟', '[{"id":"a","text":"10 cm"},{"id":"b","text":"50 cm"},{"id":"c","text":"100 cm"},{"id":"d","text":"1000 cm"}]'::jsonb, 'c', 'العلاقة العشريّة للأطوال: 1 m = 100 cm. إذن المتر الواحد يساوي 100 صنتيمتر.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('114952e7-b343-5a80-b1fb-aca92f22a620', '58b3f1f7-ec46-5f6a-9eb5-65e031cef733', 'بأيّ وحدةٍ نقيس كميّة الماء في قارورة؟', '[{"id":"a","text":"اللتر (L)"},{"id":"b","text":"المتر (m)"},{"id":"c","text":"الصنتيمتر (cm)"},{"id":"d","text":"الدقيقة"}]'::jsonb, 'a', 'نقيس كميّة السوائل (ماء، حليب، عصير) باللتر (L). أمّا المتر والصنتيمتر فللأطوال.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('73fa6c8d-6653-574e-b751-54223357b451', '58b3f1f7-ec46-5f6a-9eb5-65e031cef733', 'كم يومًا في الأسبوع الواحد؟', '[{"id":"a","text":"5 أيّام"},{"id":"b","text":"12 يومًا"},{"id":"c","text":"30 يومًا"},{"id":"d","text":"7 أيّام"}]'::jsonb, 'd', 'الأسبوع فيه 7 أيّام: السبت والأحد والاثنين والثلاثاء والأربعاء والخميس والجمعة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('54870836-fb3e-5716-92d7-f55845da13f4', '58b3f1f7-ec46-5f6a-9eb5-65e031cef733', 'كم دقيقةً في الساعة الواحدة؟', '[{"id":"a","text":"30 دقيقة"},{"id":"b","text":"60 دقيقة"},{"id":"c","text":"100 دقيقة"},{"id":"d","text":"24 دقيقة"}]'::jsonb, 'b', 'العلاقة في الزمن: 1 ساعة = 60 دقيقة. إذن الساعة الواحدة فيها 60 دقيقة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('828ff023-ae29-5fed-a65b-461f61bac72d', '830c7471-068a-5dc3-9874-069e6271db4c', '1 د = … مليم؟', '[{"id":"a","text":"1000"},{"id":"b","text":"100"},{"id":"c","text":"10"},{"id":"d","text":"500"}]'::jsonb, 'a', 'العلاقة بين الوحدتين: 1 د = 1000 مليم. إذن الجواب 1000 مليم.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0197e4c5-a81f-5a1d-ad7a-61223e7b3bcf', '830c7471-068a-5dc3-9874-069e6271db4c', 'كم دسيمترًا في المتر الواحد؟', '[{"id":"a","text":"100 dm"},{"id":"b","text":"10 dm"},{"id":"c","text":"1000 dm"},{"id":"d","text":"1 dm"}]'::jsonb, 'b', 'العلاقة العشريّة: 1 m = 10 dm. إذن المتر الواحد فيه 10 دسيمترات.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0dbbae78-c528-52c4-88e0-e81b6e051b5c', '830c7471-068a-5dc3-9874-069e6271db4c', 'نصفُ اللتر + نصفُ اللتر = ؟', '[{"id":"a","text":"2 L"},{"id":"b","text":"نصف L"},{"id":"c","text":"1 L"},{"id":"d","text":"4 L"}]'::jsonb, 'c', 'نصفان يكوّنان وحدةً كاملة: نصف L + نصف L = 1 L كامل.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5a62a01d-4f99-5b6e-aba1-c55c1f333e0e', '830c7471-068a-5dc3-9874-069e6271db4c', 'كم ساعةً في اليوم الواحد؟', '[{"id":"a","text":"12 ساعة"},{"id":"b","text":"48 ساعة"},{"id":"c","text":"60 ساعة"},{"id":"d","text":"24 ساعة"}]'::jsonb, 'd', 'اليوم الواحد فيه 24 ساعة: نهارٌ وليل. إذن الجواب 24 ساعة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9d5da433-0987-51c5-af5b-2e7fd67a2af9', '830c7471-068a-5dc3-9874-069e6271db4c', 'كم صنتيمترًا يساوي 3 m؟', '[{"id":"a","text":"300 cm"},{"id":"b","text":"30 cm"},{"id":"c","text":"103 cm"},{"id":"d","text":"3000 cm"}]'::jsonb, 'a', 'من m إلى cm نضرب في 100: 3 × 100 = 300. إذن 3 m = 300 cm.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7921d110-1d3b-588e-8812-aa74bed039c8', '830c7471-068a-5dc3-9874-069e6271db4c', 'ثمنُ قلمٍ 2 د ودفتر 3 د. كم ندفع في المجموع؟', '[{"id":"a","text":"6 د"},{"id":"b","text":"23 د"},{"id":"c","text":"5 د"},{"id":"d","text":"1 د"}]'::jsonb, 'c', 'نجمع الثمنين: 2 د + 3 د = 5 د. إذن ندفع 5 د في المجموع.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('20632e95-094c-583a-8778-7a710895a119', '98d6c352-f53c-535a-8ef2-2705aadd17be', 'كم مترًا يساوي 400 cm؟', '[{"id":"a","text":"40 m"},{"id":"b","text":"400 m"},{"id":"c","text":"4 m"},{"id":"d","text":"4000 m"}]'::jsonb, 'c', 'من cm إلى m نقسم على 100: 400 ÷ 100 = 4. إذن 400 cm = 4 m.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f6a49196-377c-5cc4-9ae4-b9861354f4d1', '98d6c352-f53c-535a-8ef2-2705aadd17be', 'كم مليمترًا يساوي 7 cm؟', '[{"id":"a","text":"70 mm"},{"id":"b","text":"7 mm"},{"id":"c","text":"700 mm"},{"id":"d","text":"17 mm"}]'::jsonb, 'a', 'من cm إلى mm نضرب في 10: 7 × 10 = 70. إذن 7 cm = 70 mm.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7ae63ab8-0097-5245-8fe4-9fa5a445188f', '98d6c352-f53c-535a-8ef2-2705aadd17be', 'أيُّ طولٍ أكبر: 1 m أم 80 cm؟', '[{"id":"a","text":"1 m"},{"id":"b","text":"80 cm"},{"id":"c","text":"متساويان"},{"id":"d","text":"لا يمكن المقارنة"}]'::jsonb, 'a', 'نوحّد الوحدة: 1 m = 100 cm. وبما أنّ 100 أكبرُ من 80، فإنّ 1 m أكبر. ✓ الخطأ الشائع: مقارنة 1 و 80 مباشرةً دون توحيد الوحدة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d5233fa8-e35b-5d6d-80e9-d3335224d5b9', '98d6c352-f53c-535a-8ef2-2705aadd17be', 'بدأ الدرسُ الساعة 8 وانتهى الساعة 9. كم دقيقةً دام؟', '[{"id":"a","text":"100 دقيقة"},{"id":"b","text":"60 دقيقة"},{"id":"c","text":"30 دقيقة"},{"id":"d","text":"90 دقيقة"}]'::jsonb, 'b', 'من الساعة 8 إلى الساعة 9 ساعةٌ كاملة، والساعة = 60 دقيقة. ✓ الخطأ الشائع: اعتبار الساعة 100 دقيقة بدل 60.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7015fa6c-7120-5e3b-a531-4afd4cf2b5fb', '3ccc9a99-300c-586e-a12f-1f425c5987c4', 'كم مترًا يساوي 2 km؟', '[{"id":"a","text":"200 m"},{"id":"b","text":"2000 m"},{"id":"c","text":"20 m"},{"id":"d","text":"2 m"}]'::jsonb, 'b', 'من km إلى m نضرب في 1000: 2 × 1000 = 2000. إذن 2 km = 2000 m.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3aeebf9c-d91a-553f-a0ac-1c68c96b8687', '3ccc9a99-300c-586e-a12f-1f425c5987c4', 'ثمنُ لعبةٍ 8 د. كيف نؤدّيه بقطعةٍ وورقة؟', '[{"id":"a","text":"5 د + 5 د"},{"id":"b","text":"2 د + 2 د"},{"id":"c","text":"5 د + 2 د"},{"id":"d","text":"5 د + 2 د + 1 د"}]'::jsonb, 'd', 'نختار قطعًا مجموعُها 8 د: 5 د + 2 د + 1 د = 8 د. أمّا 5 + 2 = 7 د فأقلّ من الثمن.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('592f8c5b-68fc-573f-9b03-3810978e702a', '3ccc9a99-300c-586e-a12f-1f425c5987c4', 'قارورةٌ سعتُها 2 L وأخرى 3 L. ما مجموع سعتيهما؟', '[{"id":"a","text":"5 L"},{"id":"b","text":"23 L"},{"id":"c","text":"1 L"},{"id":"d","text":"6 L"}]'::jsonb, 'a', 'نجمع السعتين بنفس الوحدة: 2 L + 3 L = 5 L. إذن المجموع 5 L.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0ca6435c-fae3-5dcf-8e59-91378087c627', '3ccc9a99-300c-586e-a12f-1f425c5987c4', 'كم شهرًا في السنة الواحدة؟', '[{"id":"a","text":"7 أشهر"},{"id":"b","text":"24 شهرًا"},{"id":"c","text":"12 شهرًا"},{"id":"d","text":"30 شهرًا"}]'::jsonb, 'c', 'السنة الواحدة فيها 12 شهرًا، وتساوي تقريبًا 365 يومًا.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('25b81e93-3d9e-573a-9206-6c652acbd14e', '3ccc9a99-300c-586e-a12f-1f425c5987c4', 'كم صنتيمترًا يساوي 5 dm؟', '[{"id":"a","text":"5 cm"},{"id":"b","text":"50 cm"},{"id":"c","text":"500 cm"},{"id":"d","text":"15 cm"}]'::jsonb, 'b', 'من dm إلى cm نضرب في 10: 5 × 10 = 50. إذن 5 dm = 50 cm.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('62f05e5c-1cb1-51de-ae53-9afe816cb184', '3ccc9a99-300c-586e-a12f-1f425c5987c4', 'كم دقيقةً في نصف ساعة؟', '[{"id":"a","text":"60 دقيقة"},{"id":"b","text":"15 دقيقة"},{"id":"c","text":"50 دقيقة"},{"id":"d","text":"30 دقيقة"}]'::jsonb, 'd', 'الساعة = 60 دقيقة، ونصفُها 60 ÷ 2 = 30. إذن نصف الساعة = 30 دقيقة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('145a2f96-6795-521f-a804-285aba4a0c74', 'c71ce92c-76e1-513f-bc93-24b5e1a80b90', 'شريطٌ طوله 1 m، قُطِع منه 35 cm. كم بقي منه بالصنتيمترات؟', '[{"id":"a","text":"65 cm"},{"id":"b","text":"35 cm"},{"id":"c","text":"135 cm"},{"id":"d","text":"95 cm"}]'::jsonb, 'a', 'نحوّل أوّلًا: 1 m = 100 cm، ثمّ 100 − 35 = 65. إذن البقيّة 65 cm. ✓ الخطأ الشائع: الطرح 100 − 35 دون تحويل المتر إلى 100 cm.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6611d761-c47d-5fc7-9bec-7d3086590fd0', 'c71ce92c-76e1-513f-bc93-24b5e1a80b90', 'دفع البطل ورقةً ماليّةً من 5 د ثمنًا لشيءٍ بـ 3 د. كم يَرُدّ له البائع؟', '[{"id":"a","text":"8 د"},{"id":"b","text":"3 د"},{"id":"c","text":"2 د"},{"id":"d","text":"1 د"}]'::jsonb, 'c', 'الباقي = المدفوع − الثمن = 5 د − 3 د = 2 د. ✓ الخطأ الشائع: جمعُ 5 و 3 فيعطي 8 بدل الطرح.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('78885cac-683f-572e-8984-947676cac276', 'c71ce92c-76e1-513f-bc93-24b5e1a80b90', 'ساعةٌ وربعٌ كم دقيقة؟ (الساعة = 60 دقيقة، الربع = 15 دقيقة)', '[{"id":"a","text":"60 دقيقة"},{"id":"b","text":"75 دقيقة"},{"id":"c","text":"90 دقيقة"},{"id":"d","text":"65 دقيقة"}]'::jsonb, 'b', 'ساعة = 60 دقيقة وربع = 15 دقيقة، نجمع: 60 + 15 = 75. إذن ساعة وربع = 75 دقيقة. ✓ الخطأ الشائع: إضافة 5 بدل 15 فيعطي 65.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d2241f84-c7bd-5dcf-9dc6-33d6acd6e042', 'c71ce92c-76e1-513f-bc93-24b5e1a80b90', 'إذا كان اليوم الخميس، فما اليوم بعد ثلاثة أيّام؟', '[{"id":"a","text":"الأحد"},{"id":"b","text":"السبت"},{"id":"c","text":"الاثنين"},{"id":"d","text":"الجمعة"}]'::jsonb, 'a', 'بعد الخميس: الجمعة (1)، السبت (2)، الأحد (3). إذن بعد ثلاثة أيّام من الخميس هو الأحد. ✓ الخطأ الشائع: البدء بعدّ الخميس نفسه يومًا أوّل.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8a8dd284-ea33-5d23-abe4-def5eace567e', 'fc14c4c7-2440-5982-b72d-b5d6445f68f2', 'كم مليمترًا يساوي 1 m؟', '[{"id":"a","text":"10 mm"},{"id":"b","text":"100 mm"},{"id":"c","text":"1 mm"},{"id":"d","text":"1000 mm"}]'::jsonb, 'd', 'العلاقة العشريّة للأطوال: 1 m = 1000 mm. إذن المتر الواحد فيه 1000 مليمتر.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f2e14a4f-0bcd-5ca4-a8a6-cca4451604dc', 'fc14c4c7-2440-5982-b72d-b5d6445f68f2', 'نصفُ الدينار يساوي بالمليم…', '[{"id":"a","text":"100 مليم"},{"id":"b","text":"250 مليم"},{"id":"c","text":"500 مليم"},{"id":"d","text":"1000 مليم"}]'::jsonb, 'c', 'الدينار 1000 مليم، ونصفُه 1000 ÷ 2 = 500 مليم. إذن نصف الدينار = 500 مليم.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('aa69924e-9039-5252-a3f7-5c93db6e18b3', 'fc14c4c7-2440-5982-b72d-b5d6445f68f2', 'كم صنتيمترًا يساوي 6 m؟', '[{"id":"a","text":"60 cm"},{"id":"b","text":"600 cm"},{"id":"c","text":"106 cm"},{"id":"d","text":"6000 cm"}]'::jsonb, 'b', 'من m إلى cm نضرب في 100: 6 × 100 = 600. إذن 6 m = 600 cm. ✓ الخطأ الشائع: الضرب في 10 بدل 100 فيعطي 60 cm.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9ade0c9c-16e4-54ea-9888-0d192a16981b', 'fc14c4c7-2440-5982-b72d-b5d6445f68f2', 'أيُّهما أكبر: 1 km أم 800 m؟', '[{"id":"a","text":"800 m"},{"id":"b","text":"متساويان"},{"id":"c","text":"1 km"},{"id":"d","text":"لا يمكن المقارنة"}]'::jsonb, 'c', 'نوحّد الوحدة: 1 km = 1000 m. وبما أنّ 1000 أكبرُ من 800، فإنّ 1 km أكبر. ✓ الخطأ الشائع: مقارنة 1 و 800 دون توحيد الوحدة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
