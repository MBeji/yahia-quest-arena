...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('svt', 'Sciences physiques', 'الضوء والكهرباء والكيمياء وفق برنامج العلوم الفيزيائية للسنة التاسعة أساسي', 'Observation', 'subject-svt', 'Atom', 4, 'ar', false, 'ecole-tn', (SELECT id FROM public.grades WHERE theme_id = 'ecole-tn' AND slug = '9eme-base'))
