...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('60f03e17-5782-5aa7-97b3-bd4e1823608f', 'bb5012b6-9312-5af9-89d2-24660bc58d99', 'أيّ الأجسام التالية في حالة صلبة؟', '[{"id":"a","text":"الحليب"},{"id":"b","text":"الزيت"},{"id":"c","text":"الحجر"},{"id":"d","text":"بخار الماء"}]'::jsonb, 'c', 'الحجر جسم صلب يحافظ على شكله وحجمه الخاصّين، أمّا الحليب والزيت فسائلان وبخار الماء غاز.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0bc8a57d-0d32-5d39-8fa5-a0a2c4f59ae1', 'bb5012b6-9312-5af9-89d2-24660bc58d99', 'ما الذي يميّز الحالة السائلة عن الحالة الصلبة؟', '[{"id":"a","text":"السائل يأخذ شكل إنائه والصلب يحافظ على شكله الخاصّ"},{"id":"b","text":"السائل ليس له حجم مطلقًا"},{"id":"c","text":"الصلب يتغيّر شكله من تلقاء نفسه"},{"id":"d","text":"لا فرق بينهما"}]'::jsonb, 'a', 'السائل لا شكل خاصّ ثابت له فيتبع شكل إنائه، بينما الجسم الصلب يحافظ على شكله الخاصّ مهما نُقل.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('98c34492-bd01-53ad-91e6-504ae6570965', '4a675a51-ac33-55b2-b2e1-cddad1a3eaa2', 'أيّ الأمثلة التالية جسم في الحالة الغازية؟', '[{"id":"a","text":"الجليد"},{"id":"b","text":"العسل"},{"id":"c","text":"الهواء داخل بالون منتفخ"},{"id":"d","text":"الحجر"}]'::jsonb, 'c', 'هواء البالون غاز لأنّه لا شكل خاصّ ولا حجم ثابت له، ويأخذ شكل وحجم البالون الذي يُحبَس فيه.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('33cdf4b2-bb86-595c-9647-ba27d8741350', '4a675a51-ac33-55b2-b2e1-cddad1a3eaa2', 'عند نقل قطعة حجر من مكان إلى آخر، ماذا يحدث لشكلها؟', '[{"id":"a","text":"يتغيّر باستمرار"},{"id":"b","text":"يبقى كما هو دون تغيّر"},{"id":"c","text":"يصبح مستديرًا دائمًا"},{"id":"d","text":"يختفي شكلها"}]'::jsonb, 'b', 'الجسم الصلب كالحجر يحافظ على شكله الخاصّ مهما غُيّر مكانه أو وضعه.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('796f552c-cacb-5b2a-8985-69420ddc9ad5', '4a675a51-ac33-55b2-b2e1-cddad1a3eaa2', 'عندما نسكب كمّية من الزيت من كأس إلى قارورة، ماذا يتغيّر فيها وماذا يبقى ثابتًا؟', '[{"id":"a","text":"يتغيّر حجمها ويبقى شكلها ثابتًا"},{"id":"b","text":"يتغيّر كلّ من شكلها وحجمها"},{"id":"c","text":"لا يتغيّر أيّ منهما"},{"id":"d","text":"يتغيّر شكلها ويبقى حجمها ثابتًا"}]'::jsonb, 'd', 'السائل يأخذ في كلّ مرّة شكل الإناء الذي يُسكب فيه، لكنّ كمّيته (حجمه) تبقى ثابتة دون تغيّر.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('67409778-b9fe-54c5-806e-0b6ffaa35065', '4a675a51-ac33-55b2-b2e1-cddad1a3eaa2', 'الماء السائل، وقطعة الجليد، وبخار الماء المتصاعد من كأس ساخن: الثلاثة مكوّنة من نفس مادّة الماء، لكنّها تختلف في:', '[{"id":"a","text":"نوع المادّة نفسها"},{"id":"b","text":"كونها أجسامًا لا موادّ"},{"id":"c","text":"حالتها الفيزيائية فقط"},{"id":"d","text":"عدم إمكانية تصنيفها ضمن الحالات الثلاث"}]'::jsonb, 'c', 'الماء والجليد وبخار الماء مادّة واحدة (الماء) لكنّها تظهر هنا في ثلاث حالات فيزيائية مختلفة: سائلة وصلبة وغازية.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6b4e1d17-d431-5ba2-83ea-937423614f37', 'd5bedad5-e857-5c51-a5c2-30f5fa2f1b4e', 'أيّ العبارات التالية **خاطئة**؟', '[{"id":"a","text":"الغاز يحافظ على شكله لكن لا يحافظ على حجمه"},{"id":"b","text":"الجسم الصلب يحافظ على شكله وحجمه معًا"},{"id":"c","text":"السائل يحافظ على حجمه لكن لا يحافظ على شكله"},{"id":"d","text":"الغاز لا يحافظ لا على شكله ولا على حجمه"}]'::jsonb, 'a', 'العبارة الصحيحة أنّ الغاز لا شكل خاصّ ثابت له إطلاقًا، لا أنّه ''يحافظ على شكله''؛ فالعبارة الأولى معكوسة وتصف الغاز خطأً وكأنّ له شكلًا ثابتًا، بينما الصحيح أنّه لا شكل ثابت له ولا حجم ثابت (كما في العبارة الرابعة).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ad585e38-d99e-5a20-a59e-d96d7b73445a', '097b407f-dccb-50cb-8fcb-c05f97acb277', 'قطعة معدنية (كالمفتاح) جسم في أيّ حالة فيزيائية؟', '[{"id":"a","text":"صلبة"},{"id":"b","text":"سائلة"},{"id":"c","text":"غازية"},{"id":"d","text":"لا يمكن تصنيفها"}]'::jsonb, 'a', 'المفتاح المعدني جسم صلب يحافظ على شكله وحجمه الخاصّين مهما نُقل أو غُيّر إناؤه.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('22a0d754-42ac-5cc0-aa5e-0d22662b8fda', '2d1b314c-c3a2-52ee-8d8e-e941c80d16f2', 'أيّ ممّا يلي مصدر ماء عذب (غير مالح) في الطبيعة؟', '[{"id":"a","text":"البحر الأبيض المتوسط"},{"id":"b","text":"عين ماء جوفية"},{"id":"c","text":"المحيط الأطلسي"},{"id":"d","text":"بحيرة مالحة"}]'::jsonb, 'b', 'العين مصدر ماء جوفي عذب يخرج طبيعيًّا إلى السطح، بينما البحار والمحيطات والبحيرات المالحة مصادر مياه مالحة غير صالحة للشرب مباشرة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5e10ee26-e748-5abd-8bfb-1c7c04fb0f65', '2d1b314c-c3a2-52ee-8d8e-e941c80d16f2', 'ما لون مسحوق كبريتات النحاس اللامائية قبل أن يلامس الماء؟', '[{"id":"a","text":"أزرق"},{"id":"b","text":"أسود"},{"id":"c","text":"أبيض"},{"id":"d","text":"أحمر"}]'::jsonb, 'c', 'مسحوق كبريتات النحاس اللامائية أبيض اللون قبل ملامسته للماء، ويتحوّل إلى الأزرق عند وجود الماء.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('925db6f1-5a8a-5b9a-8688-383740672c9f', 'a811c46e-203e-54c2-b529-bfdaf3b5817b', 'ما اسم المجرى المائي العذب الذي يجري على سطح الأرض، كوادي مجردة؟', '[{"id":"a","text":"بئر"},{"id":"b","text":"عين"},{"id":"c","text":"نهر (واد)"},{"id":"d","text":"بحر"}]'::jsonb, 'c', 'النهر (الوادي) مجرى مائي عذب يجري على سطح الأرض، كوادي مجردة أطول أنهار تونس؛ أمّا البئر والعين فمصدرهما الماء الجوفي، والبحر ماء مالح.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('844b3ba2-3331-5552-b055-3255bfdc8e44', 'a811c46e-203e-54c2-b529-bfdaf3b5817b', 'العين والبئر يشتركان في كون مصدر مائهما:', '[{"id":"a","text":"مياه سطحية"},{"id":"b","text":"مياه مالحة دائمًا"},{"id":"c","text":"مياه مصنّعة كيميائيًّا"},{"id":"d","text":"مياه جوفية"}]'::jsonb, 'd', 'العين خروج طبيعي للماء الجوفي، والبئر حفرة يصل بها الإنسان إلى الماء الجوفي؛ فكلاهما مصدره المياه الجوفية المحبوسة تحت سطح الأرض.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f842969c-f85f-5472-a913-56852f33420f', '1f88fd80-ae9f-5b42-808f-b20b8953802b', 'ما الفرق الأساسي بين العين والبئر؟', '[{"id":"a","text":"العين خروج طبيعي للماء الجوفي، والبئر حفرة يحفرها الإنسان للوصول إليه"},{"id":"b","text":"العين ماء مالح والبئر ماء عذب"},{"id":"c","text":"لا فرق بينهما إطلاقًا"},{"id":"d","text":"مصدر العين المطر مباشرة فقط، ومصدر البئر البحر مباشرة"}]'::jsonb, 'a', 'العين مكان يخرج فيه الماء الجوفي طبيعيًّا إلى السطح دون حفر، أمّا البئر فحفرة يحفرها الإنسان بنفسه للوصول إلى الماء الجوفي؛ كلاهما مصدره الماء الجوفي لكن طريقة الوصول إليه تختلف.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4186b6ca-f45a-5d6c-bad8-92e3369383ec', '1f88fd80-ae9f-5b42-808f-b20b8953802b', 'لماذا يحتاج بعض ماء الشرب إلى معالجة قبل استهلاكه رغم أنّه يبدو صافيًا؟', '[{"id":"a","text":"لأنّ لونه أزرق غامق دائمًا"},{"id":"b","text":"لأنّه أثقل من الزيت دائمًا"},{"id":"c","text":"لأنّه يحتوي على موادّ مذابة لا نراها بالعين المجرّدة رغم صفائه"},{"id":"d","text":"لأنّه لا يحتوي على أيّ موادّ أخرى مطلقًا"}]'::jsonb, 'c', 'الماء الطبيعي، حتّى إن بدا صافيًا وشفّافًا، يحتوي دائمًا على موادّ مذابة (كأملاح معدنية) اكتسبها من التربة والصخور، وهو ما قد يستدعي معالجته قبل الشرب.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('23259b60-f2cf-56c4-a903-c1480f16bf36', '1f88fd80-ae9f-5b42-808f-b20b8953802b', 'أيّ العبارات التالية **خاطئة**؟', '[{"id":"a","text":"كبريتات النحاس اللامائية بيضاء اللون قبل ملامسة الماء"},{"id":"b","text":"يدلّ تحوّل اللون إلى الأزرق على وجود الماء"},{"id":"c","text":"ماء البحر مالح وغير صالح للشرب مباشرة"},{"id":"d","text":"يتحوّل لون كبريتات النحاس اللامائية من الأزرق إلى الأبيض عند وجود الماء"}]'::jsonb, 'd', 'العبارة الرابعة خاطئة: الاتّجاه الصحيح هو تحوّل اللون من الأبيض إلى الأزرق عند وجود الماء، لا العكس؛ العبارات الثلاث الأخرى صحيحة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9a9396fd-2410-57f3-b569-613ae181478d', '3d5f0675-fab5-51af-8933-d7ed2b846285', 'شكّ تلميذ في وجود ماء داخل قطعة قماش مبلّلة بسائل شفّاف، فوضع عليها القليل من مسحوق كبريتات النحاس اللامائية الأبيض. أيّ ملاحظة تؤكّد له وجود الماء؟', '[{"id":"a","text":"بقاء المسحوق أبيض كما هو"},{"id":"b","text":"اختفاء المسحوق كليًّا"},{"id":"c","text":"تحوّل المسحوق إلى اللون الأزرق"},{"id":"d","text":"تصاعد رائحة من المسحوق"}]'::jsonb, 'c', 'تحوّل كبريتات النحاس اللامائية من الأبيض إلى الأزرق هو الدليل القاطع على وجود الماء في السائل الذي بلّل القماش.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8167e9a3-1930-5cb2-b3cd-939d5d7989e8', '43c8fce0-1550-57a8-9b8c-aa5fc293a18f', 'ما الفرق الأساسي بين ماء السدّ وماء البحر؟', '[{"id":"a","text":"كلاهما مالح تمامًا"},{"id":"b","text":"ماء السدّ عذب يجمعه الإنسان من الأمطار والأودية، وماء البحر مالح طبيعيًّا واسع الامتداد"},{"id":"c","text":"كلاهما مصدره الأمطار مباشرة فقط"},{"id":"d","text":"لا فرق بينهما إطلاقًا"}]'::jsonb, 'b', 'ماء السدّ عذب، يجمعه الإنسان اصطناعيًّا من الأمطار وجريان الأودية، بينما ماء البحر مالح طبيعيًّا ويمتدّ على مساحات واسعة جدًّا.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2cb8a402-6b4a-527e-b678-d919f7d2e0e9', '43c8fce0-1550-57a8-9b8c-aa5fc293a18f', 'أيّ العبارات التالية **خاطئة** بخصوص الماء؟', '[{"id":"a","text":"ماء البحر صالح للشرب مباشرة دون أيّ معالجة"},{"id":"b","text":"الماء ضروري لنموّ النبات"},{"id":"c","text":"الأمطار أصل معظم المياه العذبة"},{"id":"d","text":"كبريتات النحاس اللامائية تتحوّل إلى الأزرق بوجود الماء"}]'::jsonb, 'a', 'العبارة الأولى خاطئة: ماء البحر مالح وغير صالح للشرب مباشرة؛ أمّا العبارات الثلاث الأخرى فصحيحة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2369f0fe-e368-5a19-b41b-ded487837b7a', '5096e461-4102-5977-87e9-4009b3d08c56', 'ما اسم التحوّل الذي ينتقل فيه الماء من الحالة الصلبة إلى الحالة السائلة؟', '[{"id":"a","text":"التصلّب"},{"id":"b","text":"التبخّر"},{"id":"c","text":"الانصهار"},{"id":"d","text":"التكاثف"}]'::jsonb, 'c', 'انتقال الماء من الحالة الصلبة (جليد) إلى الحالة السائلة يسمّى الانصهار، ويحدث عند تسخين الجليد.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('03c1d873-afa8-53c5-aba6-c28ad92e6ef0', '5096e461-4102-5977-87e9-4009b3d08c56', 'بأيّ وحدة نقيس عادة درجة حرارة الماء؟', '[{"id":"a","text":"الغرام (g)"},{"id":"b","text":"اللتر (L)"},{"id":"c","text":"المتر (m)"},{"id":"d","text":"الدرجة السلسيوس (°C)"}]'::jsonb, 'd', 'تقاس درجة حرارة الماء بوحدة الدرجة السلسيوس °C باستعمال مقياس الحرارة، بينما الغرام واللتر والمتر وحدات للكتلة والحجم والطول.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e4cc086f-bb3a-5000-aba7-2a4f0bbad3fd', 'e96054ac-27e8-55e1-8da2-1d9168c52bdb', 'بأيّ جهاز نقيس درجة حرارة الماء؟', '[{"id":"a","text":"مقياس الحرارة"},{"id":"b","text":"الميزان"},{"id":"c","text":"المسطرة"},{"id":"d","text":"الكأس المدرّج"}]'::jsonb, 'a', 'نقيس درجة حرارة الماء بجهاز يسمّى مقياس الحرارة (الترمومتر)، بوحدة الدرجة السلسيوس °C.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ad27127b-8780-5782-9960-6fe2a6f05b8d', 'e96054ac-27e8-55e1-8da2-1d9168c52bdb', 'عند أيّ درجة حرارة يتصلّب (يتجمّد) الماء النقيّ عند مستوى سطح البحر؟', '[{"id":"a","text":"100°C"},{"id":"b","text":"50°C"},{"id":"c","text":"0°C"},{"id":"d","text":"−10°C"}]'::jsonb, 'c', 'يتصلّب (يتجمّد) الماء النقيّ عند θ = 0°C عند مستوى سطح البحر.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f240d1f4-dfc3-5929-8b4d-a9ace963e51d', '197975c5-6a17-5a55-aadc-2c868c02cd08', 'خرج تلميذان لملاحظة الطبيعة: الأوّل شاهد بركة ماء صغيرة تنكمش تدريجيًّا على مدى أيّام تحت الشمس دون أن تغلي، والثاني شاهد ماء يغلي بقوّة في قدر على النار خلال دقائق. أيّ العبارتين صحيحة؟', '[{"id":"a","text":"شاهد الأوّل تبخّرًا بطيئًا، والثاني غليانًا سريعًا"},{"id":"b","text":"شاهد الأوّل غليانًا، والثاني تبخّرًا"},{"id":"c","text":"شاهد كلاهما نفس التحوّل بالضبط"},{"id":"d","text":"لم يشاهد أيّ منهما أيّ تحوّل فيزيائي"}]'::jsonb, 'a', 'انكماش البركة تدريجيًّا دون فقّاعات على مدى أيّام هو تبخّر بطيء يحدث على السطح، بينما تكوّن الفقّاعات بقوّة خلال دقائق في قدر على النار هو غليان سريع في كامل السائل.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2179f3d9-856b-5471-aae4-7b71df3a4e22', '9f8636de-815f-57d2-81fa-dd82eb5241a6', 'عند أيّ درجة حرارة يغلي الماء النقيّ عند مستوى سطح البحر؟', '[{"id":"a","text":"0°C"},{"id":"b","text":"50°C"},{"id":"c","text":"100°C"},{"id":"d","text":"200°C"}]'::jsonb, 'c', 'يغلي الماء النقيّ عند θ = 100°C عند مستوى سطح البحر.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ca119b79-766a-5b6a-8734-46505c011a81', '49fb92aa-01be-5a83-a53f-790259d36bb4', 'ما اسم التحوّل العكسي للانصهار؟', '[{"id":"a","text":"التبخّر"},{"id":"b","text":"التكاثف"},{"id":"c","text":"التصلّب"},{"id":"d","text":"الغليان"}]'::jsonb, 'c', 'التحوّل العكسي للانصهار (صلب إلى سائل) هو التصلّب (سائل إلى صلب).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a6a26794-72e9-5714-8cd7-d07a8ce02bcc', '49fb92aa-01be-5a83-a53f-790259d36bb4', 'لماذا يُعتبر الغليان أسرع من التبخّر عمومًا؟', '[{"id":"a","text":"لأنّه يحدث فقط في الليل"},{"id":"b","text":"لأنّه لا يحتاج إلى أيّ حرارة"},{"id":"c","text":"لأنّه يحدث فقط في الأواني الزجاجية"},{"id":"d","text":"لأنّه يحدث في كامل كتلة السائل وليس على سطحه فقط"}]'::jsonb, 'd', 'الغليان يحدث في كامل كتلة السائل دفعة واحدة (بتكوّن فقّاعات في كلّ الاتّجاهات)، بينما يقتصر التبخّر على سطح السائل فقط، لذا يكون الغليان أسرع بكثير.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5395abad-43a2-523e-aec0-e574f3cd2cf1', 'fa103e1a-5e49-5859-9419-389b9f560220', 'ما اسم التحوّل الذي يفسّر جفاف بركة ماء صغيرة تدريجيًّا في يوم بارد وغائم دون أن تسخن الشمس الماء كثيرًا؟', '[{"id":"a","text":"الغليان، لأنّه الوحيد الذي يفسّر جفاف الماء"},{"id":"b","text":"التبخّر، لأنّه يحدث في أيّ درجة حرارة ولو منخفضة نسبيًّا، بخلاف الغليان الذي يتطلّب درجة حرارة ثابتة ومرتفعة"},{"id":"c","text":"التكاثف، لأنّه يحدث دائمًا في الطقس البارد"},{"id":"d","text":"التصلّب، لأنّ الطقس بارد وغائم"}]'::jsonb, 'b', 'التبخّر يحدث في أيّ درجة حرارة، حتّى المنخفضة نسبيًّا، لأنّه لا يتطلّب بلوغ درجة حرارة ثابتة معيّنة كالغليان؛ لهذا يمكن لبركة ماء أن تجفّ تدريجيًّا حتّى في طقس بارد نسبيًّا.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('965783e0-4c50-5c51-9b8a-aa7aed77d53e', '8fc8478a-71cd-5fcf-90af-52df65e4c5c8', 'ماذا نسمّي الجسم الصلب الذي يستقرّ في قاع الإناء بعد عملية الترسيب؟', '[{"id":"a","text":"الراشح"},{"id":"b","text":"البخار"},{"id":"c","text":"المحلول"},{"id":"d","text":"الراسب"}]'::jsonb, 'd', 'الجسم الصلب الذي يستقرّ في قاع الإناء بعد الترسيب يُسمّى الراسب.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('875fcb04-6c65-5c5e-84a6-f08efa922043', '8062b6dc-baa0-501d-9567-adc4df833cd6', 'ماء البحر يحتوي على ملح مذاب تمامًا فيه. كيف نصنّف ماء البحر من حيث التجانس؟', '[{"id":"a","text":"مزيج غير متجانس"},{"id":"b","text":"مزيج متجانس"},{"id":"c","text":"ليس مزيجًا لأنّه ماء طبيعي"},{"id":"d","text":"جسم صلب فقط"}]'::jsonb, 'b', 'رغم أنّ ماء البحر يحتوي على ملح، فإنّ هذا الملح مذاب تمامًا ولا نميّزه بالعين المجرّدة، فيُصنَّف ماء البحر مزيجًا متجانسًا.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('354627b4-4b60-5958-948d-f870f30ae9c5', '8062b6dc-baa0-501d-9567-adc4df833cd6', 'أيّ سلوك يساهم في المحافظة على سلامة الماء؟', '[{"id":"a","text":"عدم رمي النفايات والموادّ الكيميائية في الأودية والسدود"},{"id":"b","text":"رمي المبيدات الفلاحية الزائدة في الوادي القريب"},{"id":"c","text":"ترك صنبور الماء مفتوحًا دون استعمال"},{"id":"d","text":"صرف مياه الصرف الصحّي مباشرة في البحر دون معالجة"}]'::jsonb, 'a', 'عدم رمي النفايات والموادّ الكيميائية في مصادر الماء يحافظ على سلامتها؛ أمّا رمي المبيدات أو النفايات أو تبذير الماء أو صرف المياه القذرة دون معالجة فسلوكيات تضرّ بالماء.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4b4a9bf8-e61f-5e12-a6b5-898d05c589f5', 'aa3a4b3e-9b95-53b7-87d2-14cf033bd53f', 'ما تعريف المزيج غير المتجانس؟', '[{"id":"a","text":"مزيج نستطيع تمييز مكوّنَين على الأقلّ منه بالعين المجرّدة"},{"id":"b","text":"مزيج لا نستطيع تمييز أيّ مكوّن منه إطلاقًا"},{"id":"c","text":"مزيج يحتوي على الماء فقط"},{"id":"d","text":"مزيج ناتج عن التقطير حصرًا"}]'::jsonb, 'a', 'المزيج غير المتجانس هو مزيج نستطيع أن نميّز فيه مكوّنَين على الأقلّ بالعين المجرّدة، كالماء والرمل أو الماء والزيت.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0510a07c-bcc5-59e2-91a7-88664c6cce3c', '651b06b2-f6d4-5e63-be16-626ebca82db2', 'احتوى كأس على مزيج ماء وسكّر ذاب تمامًا، وكأس آخر على مزيج ماء ورمل عالق ظاهر للعين. أراد تلميذ استرجاع كلّ من السكّر والرمل جافّين من كأسيهما. أيّ توليفة من التقنيات تحقّق هدفه لكلّ كأس على التوالي؟', '[{"id":"a","text":"الترسيب للكأس الأوّل، والترشيح للكأس الثاني"},{"id":"b","text":"التقطير للكأسين معًا فقط"},{"id":"c","text":"الترشيح للكأس الأوّل، والتقطير للكأس الثاني"},{"id":"d","text":"التقطير لاسترجاع السكّر من الكأس الأوّل (مزيج متجانس)، والترشيح لاسترجاع الرمل من الكأس الثاني (مزيج غير متجانس)"}]'::jsonb, 'd', 'الكأس الأوّل مزيج متجانس (سكّر مذاب) فيحتاج التقطير لاسترجاع السكّر جافًّا بعد تبخّر الماء، أمّا الكأس الثاني مزيج غير متجانس (رمل عالق ظاهر) فيكفي الترشيح لحجز الرمل على ورقة الترشيح.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b540dacf-4370-57d9-ba22-e7613dcdf899', 'ccfb9bd4-ab3e-5cb2-b160-1d9bdf5a7749', 'أيّ ممّا يلي مصدر من مصادر تلوّث الهواء؟', '[{"id":"a","text":"دخان المصانع دون تصفية"},{"id":"b","text":"التشجير في المدن"},{"id":"c","text":"استعمال الدرّاجة بدل السيّارة"},{"id":"d","text":"قياس الضغط الجوّي بالبارومتر"}]'::jsonb, 'a', 'دخان المصانع المنبعث دون تصفية كافية يُعدّ من أهمّ مصادر تلوّث الهواء؛ أمّا التشجير واستعمال الدرّاجة فيساهمان في الحدّ من التلوّث، وقياس الضغط الجوّي لا علاقة له بالتلوّث.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1f2622fb-106a-5fe4-9d6d-6ae507cb9a82', '446982dc-36b0-57df-be46-1ec522a7e4e1', 'ما اسم الجهاز المستعمل لقياس الضغط الجوّي؟', '[{"id":"a","text":"الترمومتر"},{"id":"b","text":"البارومتر"},{"id":"c","text":"الساعة الشمسية"},{"id":"d","text":"المطياف"}]'::jsonb, 'b', 'البارومتر هو الجهاز المستعمل لقياس الضغط الجوّي؛ يختلف عن الترمومتر الذي يقيس درجة الحرارة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a16ec459-0454-50e9-ab1e-20237c1088e5', 'a302d03f-62ec-5f1a-b08c-4de595ef059c', 'أيّ العبارات التالية **خاطئة** بخصوص الهواء والضغط الجوّي؟', '[{"id":"a","text":"الهواء مادّة له كتلة ويشغل حيّزًا"},{"id":"b","text":"الضغط الجوّي يضغط في جميع الاتّجاهات"},{"id":"c","text":"الضغط الجوّي ثابت لا يتغيّر مهما ارتفعنا عن سطح البحر"},{"id":"d","text":"البارومتر جهاز يقيس الضغط الجوّي"}]'::jsonb, 'c', 'العبارة الثالثة خاطئة: الضغط الجوّي يتغيّر فعلًا، إذ يقلّ كلّما ارتفعنا عن سطح البحر؛ أمّا العبارات الأخرى فصحيحة وتصف خصائص الهواء والضغط الجوّي بدقّة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ce20ac22-6e69-5a2b-b0c8-5900b405f0f6', 'a302d03f-62ec-5f1a-b08c-4de595ef059c', 'لاحظ سكّان حيّ سكني أنّ الهواء المحيط بهم أصبح ملوّثًا بسبب ازدحام السيّارات ودخان مصنع قريب. اقترح أحدهم الاكتفاء بإغلاق نوافذ المنازل فقط لحلّ المشكلة. ما الرأي الأصحّ في هذا الاقتراح؟', '[{"id":"a","text":"الاقتراح كافٍ تمامًا ويحلّ المشكلة نهائيًّا"},{"id":"b","text":"لا داعي لأيّ إجراء لأنّ الهواء يتنقّى من تلقاء نفسه دائمًا"},{"id":"c","text":"يكفي إلزام سائقي السيّارات فقط دون التطرّق للمصنع"},{"id":"d","text":"الاقتراح غير كافٍ؛ فالحلّ الجذري يتطلّب تقليل عوادم السيّارات وتصفية انبعاثات المصنع معًا، لا مجرّد إغلاق النوافذ"}]'::jsonb, 'd', 'إغلاق النوافذ لا يعالج مصدر التلوّث؛ الحلّ الجذري يتطلّب معالجة المشكلة عند منبعها: تقليل عوادم السيّارات بتشجيع النقل النظيف، وإلزام المصنع بتصفية انبعاثاته.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1098811d-5e00-5b05-8c16-648587078de1', '83897fbd-8a2a-53c2-ae47-61a49a68bc32', 'أيّ تجربة من التالية تثبت أنّ الهواء يشغل حيّزًا من الفضاء؟', '[{"id":"a","text":"نفخ بالون حتّى الانفجار"},{"id":"b","text":"قلب كأس فارغ رأسًا على عقب في حوض ماء، فيبقى منديل في قاعه جافًّا"},{"id":"c","text":"تسخين الماء حتّى الغليان"},{"id":"d","text":"خلط الملح بالماء حتّى الذوبان"}]'::jsonb, 'b', 'في هذه التجربة، الهواء المحبوس داخل الكأس المقلوب يشغل حيّزًا يمنع الماء من دخوله بالكامل، ولذلك يبقى المنديل الموضوع في قاعه جافًّا.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2b715d28-5a33-5ac7-979b-5fedd2c77930', '1b3f79ca-085b-58b7-a651-d2364307d25b', 'أيّ من الموادّ التالية مادّة ناقلة للتيّار الكهربائي؟', '[{"id":"a","text":"النحاس"},{"id":"b","text":"الخشب الجافّ"},{"id":"c","text":"المطّاط"},{"id":"d","text":"الزجاج"}]'::jsonb, 'a', 'النحاس معدن، وأغلب المعادن موادّ ناقلة تسمح بمرور التيّار الكهربائي بسهولة؛ الخشب الجافّ والمطّاط والزجاج موادّ عازلة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2397a29e-c519-5964-bbf1-1d6af32c8ef0', '4656dd90-64ce-56e3-9eab-dd4e0ab89d94', 'ما دور أسلاك التوصيل في الدارة الكهربائية؟', '[{"id":"a","text":"تزويد الدارة بالطاقة اللازمة"},{"id":"b","text":"التحكّم في فتح الدارة أو غلقها"},{"id":"c","text":"تحويل الطاقة الكهربائية إلى ضوء"},{"id":"d","text":"ربط جميع عناصر الدارة في حلقة واحدة متّصلة"}]'::jsonb, 'd', 'أسلاك التوصيل تربط جميع عناصر الدارة (المولّد والمستقبل والقاطع) ببعضها لتكوّن حلقة واحدة متّصلة يجري فيها التيّار.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('773e32ac-7c4b-5481-9bb0-7b4b51ad3464', '97ee2cff-e18b-5331-a20a-b9f42e405ee8', 'ما اسم قطبَي المولّد الكهربائي؟', '[{"id":"a","text":"شماليّ وجنوبيّ"},{"id":"b","text":"داخليّ وخارجيّ"},{"id":"c","text":"علويّ وسفليّ"},{"id":"d","text":"موجب وسالب"}]'::jsonb, 'd', 'للمولّد الكهربائي قطبان: قطب موجب (+) وقطب سالب (−).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('904faa07-8c13-5b2c-8a96-694aeee0ba61', '97ee2cff-e18b-5331-a20a-b9f42e405ee8', 'ما اسم العنصر الذي يحوّل الطاقة الكهربائية إلى حركة؟', '[{"id":"a","text":"المولّد"},{"id":"b","text":"المصباح"},{"id":"c","text":"المحرّك"},{"id":"d","text":"القاطع"}]'::jsonb, 'c', 'المحرّك الكهربائي هو المستقبل الذي يحوّل الطاقة الكهربائية إلى حركة، خلافًا للمصباح الذي يحوّلها إلى ضوء.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2acdcfd7-e887-5f26-863c-3ea32dc2caa2', '410b4124-9099-5e10-9e44-d7323b1d5d2f', 'أراد باحث تصميم دارة أمان بسيطة تضيء مصباح تحذير فقط عندما يُغلَق قاطع مخصّص لذلك، وتنطفئ فورًا عند فتحه، دون أيّ احتمال لحدوث دارة قصيرة عرضية. أيّ من التصاميم التالية يحقّق هذا الهدف بأمان؟', '[{"id":"a","text":"توصيل قطبَي المولّد مباشرة بسلك نحاسي واحد فقط دون أيّ مستقبل ولا قاطع"},{"id":"b","text":"توصيل المولّد بقطعة قماش عازلة بدل الأسلاك النحاسية"},{"id":"c","text":"توصيل المولّد بمصباح واحد عبر أسلاك نحاسية سليمة وقاطع، بحيث يمرّ التيّار عبر المصباح دائمًا ولا يلتقي القطبان مباشرة بسلك وحيد"},{"id":"d","text":"ترك الدارة بلا أيّ قاطع إطلاقًا"}]'::jsonb, 'c', 'التصميم الآمن يمرّر التيّار دائمًا عبر مستقبل (المصباح) فلا يلتقي القطبان مباشرة بسلك وحيد (فلا دارة قصيرة)، ويستعمل قاطعًا للتحكّم الطبيعي في الإضاءة؛ التوصيل المباشر بين القطبين ينتج دارة قصيرة خطيرة، والقماش العازل يمنع مرور التيّار كليًّا، وغياب القاطع يفقد التحكّم في الدارة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('86c949e7-f8a9-520f-a423-a78c5a93e048', '041fad4f-cbc1-5132-9de5-f7f15efdd090', 'ما تعريف الدارة الكهربائية المغلقة؟', '[{"id":"a","text":"حلقة تحتوي على مولّد فقط دون أيّ عنصر آخر"},{"id":"b","text":"حلقة بها قاطع مفتوح دائمًا"},{"id":"c","text":"حلقة بلا أسلاك توصيل إطلاقًا"},{"id":"d","text":"حلقة متّصلة بالكامل دون أيّ انقطاع، يجري فيها التيّار الكهربائي"}]'::jsonb, 'd', 'الدارة المغلقة هي حلقة متّصلة بالكامل من المولّد إلى المستقبل وعودةً إليه دون أيّ انقطاع، فيجري فيها التيّار الكهربائي ويعمل المستقبل.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('15cc4921-6a46-5925-98de-9ee6750c61b3', '041fad4f-cbc1-5132-9de5-f7f15efdd090', 'ركّب تلميذ دارة بمولّد ومصباح وقاطع وأسلاك نحاسية، فلاحظ أنّ المصباح ينطفئ كلّما حرّك أحد الأسلاك عند نقطة معيّنة، ويضيء مجدّدًا عندما يمسكه بثبات في وضعية أخرى. ما التفسير الأرجح لهذه الملاحظة؟', '[{"id":"a","text":"أنّ الدارة قصيرة عند تلك النقطة"},{"id":"b","text":"أنّ المصباح تالف بشكل دائم"},{"id":"c","text":"أنّ القاطع هو سبب المشكلة دون أيّ علاقة بالسلك"},{"id":"d","text":"أنّ السلك مقطوع جزئيًّا عند تلك النقطة، فيتّصل أحيانًا وينقطع أحيانًا أخرى"}]'::jsonb, 'd', 'تذبذب إضاءة المصباح حسب وضعية السلك يدلّ على أنّ السلك مقطوع جزئيًّا داخليًّا عند تلك النقطة: يتّصل الجزءان المتبقّيان أحيانًا (فيضيء) وينفصلان أحيانًا أخرى (فينطفئ)، دون أن يكون ذلك دارة قصيرة أو عطلًا في المصباح أو القاطع.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
