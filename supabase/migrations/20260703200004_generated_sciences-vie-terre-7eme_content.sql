...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('sciences-vie-terre-7eme', 'علوم الحياة والأرض', 'الوسط البيئي والتنفّس والتغذية والتربة والماء وفق برنامج السنة السابعة من التعليم الأساسي', 'Vitalite', 'subject-svt', 'Leaf', 7, 'ar', false, 'ecole-tn', (SELECT id FROM public.grades WHERE theme_id = 'ecole-tn' AND slug = '7eme-base'))
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6fd0a15f-9449-527e-9ceb-502221d4ee0c', '7d22a79c-1b15-5f58-8bcb-75385962fdf1', 'أيّ ممّا يلي يُعدّ كائنًا حيًّا؟', '[{"id":"a","text":"شجرة الزيتون"},{"id":"b","text":"صخرة"},{"id":"c","text":"سحابة"},{"id":"d","text":"الماء"}]'::jsonb, 'a', 'شجرة الزيتون كائن حيّ لأنّها تتنفّس وتتغذّى وتنمو وتتكاثر. أمّا الصخرة والسحابة والماء فأجسام غير حيّة لا تقوم بهذه الوظائف مجتمعةً.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('368addf7-9758-5639-907f-9d31c399e59f', '7d22a79c-1b15-5f58-8bcb-75385962fdf1', 'القمح ساقه طريّة وقصيرة الحجم. إلى أيّ صنف من النباتات ينتمي؟', '[{"id":"a","text":"شجرة"},{"id":"b","text":"شجيرة"},{"id":"c","text":"عشب"},{"id":"d","text":"كائن دقيق"}]'::jsonb, 'c', 'القمح عشب لأنّ ساقه طريّة (غضّة) غير خشبية وحجمه قصير. الشجرة والشجيرة لهما ساق خشبية، والكائن الدقيق ليس نباتًا أصلًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f986a840-791d-574a-8186-b23f5f3ee62e', '7d22a79c-1b15-5f58-8bcb-75385962fdf1', 'لماذا يعيش نخيل التمر في الواحة بكثرة؟', '[{"id":"a","text":"لأنّ الواحة باردة جدًّا"},{"id":"b","text":"لأنّه يتحمّل الجفاف والحرارة المرتفعة"},{"id":"c","text":"لأنّ الأمطار غزيرة في الواحة"},{"id":"d","text":"لأنّه كائن دقيق"}]'::jsonb, 'b', 'نخيل التمر نبات يتحمّل الجفاف والحرارة المرتفعة، وهما عاملان مناسبان لمناخ الواحة. عكس ذلك، فالواحة حارّة لا باردة، وأمطارها نادرة جدًّا لا غزيرة، والنخيل نبات لا كائن دقيق.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('182981c6-d125-57c1-9da3-85d1a9445c19', '28867db7-98c1-59c4-a956-cc2fd7ad4756', 'في غابة، نجد تربة ورطوبة وأشجارًا وحيوانات. ماذا يمثّل مجموع الأشجار والحيوانات فيها؟', '[{"id":"a","text":"الوسط الفيزيائي (biotope)"},{"id":"b","text":"العامل المناخي"},{"id":"c","text":"الكائن الدقيق"},{"id":"d","text":"مجموعة الكائنات الحيّة (biocénose)"}]'::jsonb, 'd', 'مجموع الأشجار والحيوانات التي تعيش معًا في الغابة يمثّل مجموعة الكائنات الحيّة (biocénose). أمّا التربة والرطوبة فهما جزء من الوسط الفيزيائي (biotope)، وهو غير الأشجار والحيوانات.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('790dd7f1-b610-5983-b006-fccde71c7709', '28867db7-98c1-59c4-a956-cc2fd7ad4756', 'قورنت غابة عين دراهم بالواحة، فوُجد أنّ نباتات الغابة تحتاج رطوبة عالية بينما نباتات الواحة تتحمّل الجفاف. ما التفسير العلمي لهذا الاختلاف؟', '[{"id":"a","text":"الصدفة وحدها"},{"id":"b","text":"اختلاف عوامل المناخ (الأمطار والرطوبة) بين الوسطين يفرض تكيّف كائنات مختلفة"},{"id":"c","text":"النباتات تختار مكانها بإرادتها"},{"id":"d","text":"لا يوجد اختلاف حقيقي بين الوسطين"}]'::jsonb, 'b', 'غابة عين دراهم غزيرة الأمطار عالية الرطوبة، بينما الواحة نادرة الأمطار جافّة؛ فتتوزّع الكائنات الحيّة تبعًا لهذا الاختلاف في عوامل المناخ لا صدفةً ولا باختيار إرادي من النباتات.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2d0a642a-d010-5b9b-a368-966ee0ca20da', '07c28a0d-f813-5b1f-951b-46d66b0db549', 'ما هي الوظائف التي يقوم بها الكائن الحيّ؟', '[{"id":"a","text":"التنفّس والتغذية والنموّ والتكاثر"},{"id":"b","text":"التنفّس فقط"},{"id":"c","text":"التكاثر فقط"},{"id":"d","text":"الحركة فقط"}]'::jsonb, 'a', 'الكائن الحيّ يقوم بمجموعة وظائف مجتمعة: التنفّس والتغذية والنموّ والقدرة على التكاثر. القيام بوظيفة واحدة فقط (تنفّس، تكاثر، أو حركة) لا يكفي وحده لتصنيف جسم كائنًا حيًّا.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ca35affc-8d5a-569a-a033-975e9bfdfb6f', 'c236d912-19a9-58e4-8078-a8d4cb0e75e3', 'قارن بين وسطين: الأوّل حرارته معتدلة وأمطاره غزيرة، والثاني حرارته مرتفعة وأمطاره نادرة جدًّا. أيّ عبارة صحيحة؟', '[{"id":"a","text":"الوسط الأوّل يلائم كائنات تحبّ الرطوبة كالسرخس، والثاني يلائم كائنات تتحمّل الجفاف كالجمل"},{"id":"b","text":"كلا الوسطين يلائمان نفس الكائنات تمامًا"},{"id":"c","text":"الوسط الثاني وحده يحوي كائنات حيّة"},{"id":"d","text":"عوامل المناخ لا تحدّد نوع الكائنات"}]'::jsonb, 'a', 'اختلاف الحرارة والأمطار بين الوسطين يفرز كائنات مختلفة: الوسط الرطب المعتدل يلائم كائنات محبّة للرطوبة كالسرخس، والوسط الحارّ الجافّ يلائم كائنات متحمّلة للجفاف كالجمل. كلا الوسطين يحويان كائنات حيّة، لكن مختلفة لا متشابهة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6663fd19-3a28-5ad0-8fa0-030624c5819b', 'f10285e8-add4-5166-8f40-19215d69d44b', 'بأيّ عضو يتنفّس الأرنب، وهو حيوان فقاري يعيش في الوسط الهوائي؟', '[{"id":"a","text":"بالخياشيم"},{"id":"b","text":"بالقصبات الهوائية"},{"id":"c","text":"بالرئتين"},{"id":"d","text":"بجلده فقط"}]'::jsonb, 'c', 'الأرنب فقاريّ يعيش على اليابسة، فيتنفّس برئتين: يدخل الهواء عبر الأنف فالقصبة الهوائية وصولًا إلى الرئتين حيث يحدث التبادل الغازي.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('84edca86-55e0-5ddb-9acd-b6606f488c9d', '6f9752f7-ff29-5e27-bc51-078e7d629980', 'الحمامة طائر فقاريّ يعيش في الوسط الهوائي. بأيّ عضو تتنفّس؟', '[{"id":"a","text":"بالقصبات الهوائية"},{"id":"b","text":"بالخياشيم"},{"id":"c","text":"برئتين"},{"id":"d","text":"بجلدها فقط"}]'::jsonb, 'c', 'الحمامة حيوان فقاريّ يعيش على اليابسة، فهي تتنفّس برئتين، مثل بقية الفقاريات البرّية.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('869a5926-cc7c-575a-9e87-8eb6b8c795ad', '6f9752f7-ff29-5e27-bc51-078e7d629980', 'السردين سمكة تعيش في ماء البحر. بأيّ عضو تتنفّس؟', '[{"id":"a","text":"بالخياشيم"},{"id":"b","text":"برئتين"},{"id":"c","text":"بالقصبات الهوائية"},{"id":"d","text":"بفمها فقط دون عضو خاصّ"}]'::jsonb, 'a', 'السردين، مثل بقية الأسماك، يتنفّس بالخياشيم التي تمتصّ الأكسجين المذاب في الماء.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('847d8d78-e4f7-59fe-b34c-6d9786aa8450', '6f9752f7-ff29-5e27-bc51-078e7d629980', 'ما اسم الفتحات الصغيرة الموجودة على جانبَي جسم الحشرة، والتي يدخل منها الهواء إلى القصبات الهوائية؟', '[{"id":"a","text":"الغطاء الخيشومي"},{"id":"b","text":"الحويصلات الهوائية"},{"id":"c","text":"الثغور التنفّسية"},{"id":"d","text":"الأنابيب الشعبية"}]'::jsonb, 'c', 'الهواء يدخل جسم الحشرة عبر فتحات صغيرة على جانبَي جسمها تُسمّى الثغور التنفّسية، ومنها يتوزّع داخل شبكة القصبات الهوائية.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fd79766c-7fb4-5179-b97b-b09ac8abd538', '5927e75d-44cf-5855-b1eb-b733a74351d2', 'الأفعى حيوان فقاريّ يعيش على اليابسة. بأيّ عضو تتنفّس؟', '[{"id":"a","text":"بالخياشيم"},{"id":"b","text":"برئتين"},{"id":"c","text":"بالقصبات الهوائية"},{"id":"d","text":"بجلدها فقط"}]'::jsonb, 'b', 'الأفعى فقاريّ بريّ، فتتنفّس برئتين مثل بقية الفقاريات التي تعيش في الوسط الهوائي.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('485d5190-6be2-5cbd-a32a-124d8946a059', '5927e75d-44cf-5855-b1eb-b733a74351d2', 'ما الفرق الدقيق بين القصبة الهوائية عند الأرنب والقصبات الهوائية عند النحلة؟', '[{"id":"a","text":"لا فرق، فكلاهما يسمّى بنفس الاسم ويؤدّي نفس الدور تمامًا"},{"id":"b","text":"قصبة الأرنب أنبوب واحد يوصل الفم بالرئتين، بينما قصبات النحلة شبكة متفرّعة توزّع الهواء مباشرة داخل الجسم كلّه"},{"id":"c","text":"قصبة الأرنب توجد عند النحلة أيضًا، لكنّ العكس غير صحيح"},{"id":"d","text":"قصبات النحلة أكبر حجمًا من قصبة الأرنب"}]'::jsonb, 'b', 'قصبة الأرنب أنبوب واحد يصل الفم بالرئتين حيث يحدث التبادل الغازي، أمّا قصبات النحلة فشبكة أنابيب متفرّعة توزّع الهواء مباشرة إلى كلّ أعضاء الجسم دون رئتين.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('db551780-ab3d-5290-9b62-9248a47d7fa4', 'fd03878f-9e42-584d-aee1-dfeded694cd2', 'القطّ حيوان فقاريّ أليف يعيش على اليابسة. بأيّ عضو يتنفّس؟', '[{"id":"a","text":"برئتين"},{"id":"b","text":"بالقصبات الهوائية"},{"id":"c","text":"بالخياشيم"},{"id":"d","text":"بجناحيه"}]'::jsonb, 'a', 'القطّ فقاريّ بريّ، فيتنفّس برئتين، مثل كلّ الثدييات التي تعيش في الوسط الهوائي.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('21d1e16b-0878-5f8e-afce-43dec6798b08', '01faf188-3d5e-5053-bfb6-5636fbddfbba', 'الماعز حيوان فقاريّ يعيش على اليابسة. بأيّ عضو يتنفّس؟', '[{"id":"a","text":"بالقصبات الهوائية"},{"id":"b","text":"بالخياشيم"},{"id":"c","text":"برئتين"},{"id":"d","text":"بجلده فقط"}]'::jsonb, 'c', 'الماعز فقاريّ بريّ، فيتنفّس برئتين مثل بقيّة الفقاريات التي تعيش في الوسط الهوائي.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cb286e5a-dfa3-5a90-afb9-a847bd73b0ea', '01faf188-3d5e-5053-bfb6-5636fbddfbba', 'أيّ مقارنة من التالي تصف بدقّة الفرق بين الرئتين والقصبات الهوائية والخياشيم؟', '[{"id":"a","text":"الرئتان تستقبلان الهواء وتُبادلانه مع الدمّ، القصبات الهوائية توزّع الهواء مباشرة داخل جسم الحشرة، والخياشيم تستخلص الأكسجين المذاب في الماء"},{"id":"b","text":"الرئتان والقصبات الهوائية والخياشيم أعضاء متطابقة تمامًا في تركيبها وعملها"},{"id":"c","text":"الخياشيم توجد عند الفقاريات البرّية فقط، والرئتان عند الأسماك فقط"},{"id":"d","text":"القصبات الهوائية هي نفسها القصبة الهوائية الموجودة عند الأرنب"}]'::jsonb, 'a', 'كلّ عضو تنفّسي يعمل بآلية مختلفة تلائم وسطه: الرئتان تبادل مع الدمّ داخل الجسم، القصبات الهوائية توزيع مباشر للهواء عند الحشرات، والخياشيم استخلاص للأكسجين المذاب في الماء.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('891ddddc-5536-5b3e-89e9-4286ace846e4', '01faf188-3d5e-5053-bfb6-5636fbddfbba', 'لو نسي تلميذ تحضير وعاء الشاهد في تجربة الكشف عن ثاني أكسيد الكربون بماء الجير، ماذا يخسر من تجربته؟', '[{"id":"a","text":"لا يخسر شيئًا، فوعاء الشاهد غير ضروري إطلاقًا"},{"id":"b","text":"يخسر إمكانية التأكّد أنّ تكدّر ماء الجير سببه الكائن الحيّ وحده لا عامل آخر"},{"id":"c","text":"يخسر فقط سرعة تكدّر ماء الجير في وعائه الأصلي"},{"id":"d","text":"يصبح ماء الجير في وعائه الأصلي رائقًا بدل أن يتكدّر"}]'::jsonb, 'b', 'وعاء الشاهد (بدون كائن حيّ) هو ما يسمح بالمقارنة: دون هذه المقارنة، لا يمكن الجزم بأنّ تكدّر ماء الجير في الوعاء الآخر سببه فعلًا الكائن الحيّ لا عامل خارجيّ.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f9bf0443-0254-5053-a79c-17872c0d11c6', '1c6d2f00-312b-57e7-9265-9fcdd7b89c53', 'في تجربة، تكدّر تدريجيًّا ماء الجير المتّصل بوعاء يحوي بذورًا نابتة (حيّة) خلال ساعتين، بينما بقي ماء الجير المتّصل بوعاء آخر يحوي بذورًا مغليّة (ميتة) رائقًا طوال المدّة نفسها. ما الاستنتاج الأدقّ؟', '[{"id":"a","text":"البذور المغليّة أكثر نشاطًا في التنفّس من البذور النابتة"},{"id":"b","text":"نوع البذور (نابتة أو مغليّة) لا علاقة له بنتيجة التجربة"},{"id":"c","text":"ماء الجير يتكدّر تلقائيًّا بعد ساعتين مهما كان محتوى الوعاء"},{"id":"d","text":"طرح ثاني أكسيد الكربون مرتبط بكون الكائن حيًّا فعلًا: البذور النابتة الحيّة تتنفّس وتطرحه، أمّا البذور المغليّة الميتة فلا تتنفّس"}]'::jsonb, 'd', 'الغلي يقتل البذور فتتوقّف عن أداء وظائفها الحيوية، ومنها التنفّس، فلا تطرح ثاني أكسيد الكربون؛ أمّا البذور النابتة فحيّة وتتنفّس فعلًا، وهذا ما يفسّر تكدّر ماء الجير عندها دون الأخرى — التنفّس دليل على الحياة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('397c675d-381d-59a5-a33d-65045d365905', '99803c95-c8e1-584b-940d-626890ca579e', 'من أين تحصل أوراق النّبات الأخضر على غاز ثاني أكسيد الكربون؟', '[{"id":"a","text":"من التّربة عبر الجذور"},{"id":"b","text":"من الماء الذي تشربه"},{"id":"c","text":"لا تحتاج إليه إطلاقًا"},{"id":"d","text":"من الهواء المحيط مباشرة"}]'::jsonb, 'd', 'تمتصّ أوراق النّبات غاز ثاني أكسيد الكربون (CO₂) مباشرة من الهواء المحيط بها، بخلاف الماء والأملاح المعدنية اللّذين تمتصّهما الجذور من التّربة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6f136bbf-bc61-54b4-bc1e-95506ca04bec', '945fd01d-4434-5705-90de-be5a343ce3ae', 'من أين تحصل شجرة البرتقال في جهة نابل على غاز ثاني أكسيد الكربون الذي تحتاجه؟', '[{"id":"a","text":"من التّربة عبر جذورها"},{"id":"b","text":"من الهواء عبر أوراقها"},{"id":"c","text":"من الماء الذي تشربه"},{"id":"d","text":"من الأملاح المعدنية الموجودة في التّربة"}]'::jsonb, 'b', 'تمتصّ أوراق شجرة البرتقال ثاني أكسيد الكربون مباشرة من الهواء المحيط بها، بخلاف الماء والأملاح المعدنية اللّذين تمتصّهما الجذور من التّربة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0fc6fca8-b341-5bc3-a242-2d137644f685', '945fd01d-4434-5705-90de-be5a343ce3ae', 'ما اسم الصّبغة الخضراء الموجودة في أوراق النّبات، والّتي تلتقط طاقة الضّوء؟', '[{"id":"a","text":"الكلوروفيل"},{"id":"b","text":"الأكسجين"},{"id":"c","text":"الأملاح المعدنية"},{"id":"d","text":"ثاني أكسيد الكربون"}]'::jsonb, 'a', 'الكلوروفيل صبغة خضراء توجد في أوراق النّبات الأخضر، تلتقط طاقة الضّوء وتستعملها لتركيب المادّة العضويّة، ومنها يأتي اللّون الأخضر للأوراق.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2e2992bc-55da-56b1-b0a2-df18bdd5189b', 'ad84b448-69ee-5c38-90cb-9f66aab0d58f', 'شجرة زيتون تمتصّ الماء والأملاح المعدنية بجذورها من التّربة. ماذا تمتصّ بأوراقها من الهواء؟', '[{"id":"a","text":"بخار الماء فقط"},{"id":"b","text":"الأملاح المعدنية أيضًا"},{"id":"c","text":"الأكسجين فقط"},{"id":"d","text":"ثاني أكسيد الكربون"}]'::jsonb, 'd', 'تمتصّ الأوراق ثاني أكسيد الكربون (CO₂) من الهواء المحيط بها؛ أمّا الماء والأملاح المعدنية فتمتصّهما الجذور من التّربة، لا الأوراق.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('822a8d2a-618a-5771-87ac-e53e1333a223', 'ad84b448-69ee-5c38-90cb-9f66aab0d58f', 'أيّ ممّا يلي يصف بدقّة دور الكلوروفيل عند النّبات الأخضر؟', '[{"id":"a","text":"يمتصّ الماء من التّربة مباشرة بدل الجذور"},{"id":"b","text":"يلتقط طاقة الضّوء ويستعملها لتركيب المادّة العضويّة من الماء والأملاح المعدنية وCO₂"},{"id":"c","text":"يطرح الأملاح المعدنية الزّائدة إلى الهواء"},{"id":"d","text":"يحوّل ثاني أكسيد الكربون إلى ماء داخل الأوراق"}]'::jsonb, 'b', 'الكلوروفيل صبغة تلتقط طاقة الضّوء وتستعملها، مع الماء والأملاح المعدنية وثاني أكسيد الكربون، لتركيب المادّة العضويّة عند النّبات الأخضر — وهذا هو التركيب الضّوئيّ.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('62b133da-50ff-5d77-b558-6a1b4478a25f', 'ad84b448-69ee-5c38-90cb-9f66aab0d58f', 'لاحظ فلّاح أنّ نبتة طماطم زُرعت في تربة خصبة وسُقيت بانتظام، لكنّها وُضعت داخل كوخ مظلم تمامًا طوال نموّها. ماذا يُتوقّع لهذه النّبتة رغم توفّر الماء والأملاح المعدنية لها؟', '[{"id":"a","text":"تنمو بشكل طبيعيّ تمامًا لأنّ الماء والأملاح المعدنية كافيان وحدهما"},{"id":"b","text":"تنمو بشكل أفضل من نبتة مماثلة زُرعت في الضّوء"},{"id":"c","text":"تتحوّل إلى كائن مستهلك بدل منتج"},{"id":"d","text":"يضعف نموّها وتصفرّ أوراقها لأنّها لا تستطيع تركيب مادّتها العضويّة بغياب الضّوء"}]'::jsonb, 'd', 'الخطأ الشّائع هو الاعتقاد أنّ الماء والأملاح المعدنية وحدهما يكفيان: النّبات يحتاج إلى الضّوء أيضًا ليركّب مادّته العضويّة بواسطة الكلوروفيل؛ غياب الضّوء طويلًا يضعف النّموّ ويُصفّر الأوراق، كما في تجربة الفصل.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fa4f8462-43a6-5d6e-b292-eaaf225505dc', 'e6614d03-220a-5837-9e94-ba5cdeb7c233', 'أيّ غاز من التالي يمتصّه النّبات الأخضر من الهواء المحيط به، لا من التّربة؟', '[{"id":"a","text":"الأملاح المعدنية"},{"id":"b","text":"الماء"},{"id":"c","text":"ثاني أكسيد الكربون"},{"id":"d","text":"الحديد"}]'::jsonb, 'c', 'ثاني أكسيد الكربون (CO₂) هو الغاز الذي يمتصّه النّبات الأخضر من الهواء المحيط به بواسطة أوراقه، بخلاف الماء والأملاح المعدنية الآتيين من التّربة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3c479068-4341-549e-9b45-5d8a5effe0b1', '3f1fd5e5-d1fb-5d89-8291-38da0c61ad67', 'أيّ العبارات الأربع التالية عن التّغذية عند النّبات الأخضر **خاطئة**؟', '[{"id":"a","text":"يمتصّ النّبات الأخضر الماء والأملاح المعدنية بجذوره من التّربة"},{"id":"b","text":"يمتصّ النّبات الأخضر ثاني أكسيد الكربون بأوراقه من الهواء"},{"id":"c","text":"يحتاج النّبات الأخضر إلى الضّوء ليركّب مادّته العضويّة بفضل الكلوروفيل"},{"id":"d","text":"يحصل النّبات الأخضر على مادّته العضويّة جاهزة من التّربة دون تركيبها بنفسه"}]'::jsonb, 'd', 'العبارة الخاطئة هي أنّ النّبات يحصل على مادّته العضويّة جاهزة من التّربة: النّبات الأخضر يصنع مادّته العضويّة بنفسه بالتركيب الضّوئيّ، فهو منتج لا مستهلك. العبارات الثّلاث الأخرى صحيحة تمامًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('da181e56-c4a9-5fac-9af7-95969927a244', '81537fef-e72e-5582-b5d7-45146b6c6228', 'أيّ ممّا يلي يفسّر سبب اخضرار أوراق النّبات؟', '[{"id":"a","text":"وجود الكلوروفيل، الصّبغة الّتي تلتقط طاقة الضّوء"},{"id":"b","text":"امتصاص الأملاح المعدنية الزّائدة"},{"id":"c","text":"طرح ثاني أكسيد الكربون بكثافة"},{"id":"d","text":"نقص الماء في التّربة"}]'::jsonb, 'a', 'لون الأوراق الأخضر مصدره الكلوروفيل، الصّبغة الّتي تلتقط طاقة الضّوء وتستعملها لتركيب المادّة العضويّة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('80939fe0-3d5f-573b-a492-5b6cc9d48c4e', '81537fef-e72e-5582-b5d7-45146b6c6228', 'أيّ مقارنة من التالي تصف بدقّة الفرق بين الامتصاص الجذريّ وتركيب المادّة العضويّة (التركيب الضّوئيّ) عند النّبات الأخضر؟', '[{"id":"a","text":"الامتصاص الجذريّ يأخذ الماء والأملاح المعدنية من التّربة، والتركيب الضّوئيّ يستعملها مع CO₂ والضّوء في الأوراق لصنع مادّة عضويّة"},{"id":"b","text":"كلاهما يحدث في الجذور فقط وبنفس الآلية"},{"id":"c","text":"التركيب الضّوئيّ يحدث في الجذور لا في الأوراق"},{"id":"d","text":"الامتصاص الجذريّ هو نفسه التركيب الضّوئيّ باسم مختلف"}]'::jsonb, 'a', 'الامتصاص الجذريّ خطوة تزوّد النّبات بالماء والأملاح المعدنية من التّربة، بينما التركيب الضّوئيّ خطوة لاحقة تحدث في الأوراق وتستعمل هذه الموادّ مع ثاني أكسيد الكربون والضّوء لصنع المادّة العضويّة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ac4c82f9-116c-5a86-b301-4a055c662085', '4dccf20e-13f9-5dab-be0c-6dd4def067c1', 'الدجاج يلتقط حبوبًا مثل عاشب، لكنّه يلتقط أيضًا حشرات صغيرة وديدانًا. إلى أيّ نظام غذائي ينتمي؟', '[{"id":"a","text":"قارت"},{"id":"b","text":"عاشب فقط"},{"id":"c","text":"لاحم فقط"},{"id":"d","text":"لا ينتمي إلى نظام معروف"}]'::jsonb, 'a', 'الدجاج يأكل النبات (الحبوب) والحيوان (الحشرات والديدان) معًا، وهذا يجعله قارتًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7c9f4fdd-09a4-5288-b107-ebdd609a9c3d', 'c7db6f68-62de-5fdc-bac9-bb2dde729f41', 'الأرنب البرّي حيوان عاشب يقتات على الأعشاب والجذور اللينة، ولا يصطاد أيّ فريسة. أيّ نوع سنّ يكون غالبًا ضعيفًا جدًّا أو منعدمًا عنده؟', '[{"id":"a","text":"الأنياب"},{"id":"b","text":"الأضراس"},{"id":"c","text":"القواطع"},{"id":"d","text":"كلّ أنواع الأسنان معًا"}]'::jsonb, 'a', 'العاشب مثل الأرنب البرّي لا يحتاج إلى صيد فريسة أو تمزيق لحم، فأنيابه ضعيفة جدًّا أو منعدمة، بخلاف قواطعه وأضراسه الفعّالتين في قطف النبات وطحنه.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('18143cd1-5bec-5bc0-bc9b-5d436689b2ca', 'c7db6f68-62de-5fdc-bac9-bb2dde729f41', 'لماذا لا يحتاج القطّ البرّي إلى أضراس واسعة مسطّحة مثل الماعز؟', '[{"id":"a","text":"لأنّه لا يملك أضراسًا إطلاقًا"},{"id":"b","text":"لأنّه لا يطحن نباتًا، بل يقطع لحمًا بأضراس حادّة مسنّنة"},{"id":"c","text":"لأنّه يبلع غذاءه دون مضغه إطلاقًا"},{"id":"d","text":"لأنّه قارت وليس لاحمًا"}]'::jsonb, 'b', 'الأضراس الواسعة المسطّحة وظيفتها طحن النبات، وهذا لا يحتاجه القطّ البرّي لأنّه لاحم يقطع اللحم بأضراس حادّة مسنّنة لا يطحنه.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('22284673-f9af-5094-b405-8f874483c3c5', 'f18769c1-fe35-53bb-b6d3-ecf66d9f0078', 'بعد أن يمسك الحيوان بغذائه، ما الترتيب الصحيح لما يحدث؟', '[{"id":"a","text":"تفتيت الغذاء ميكانيكيًّا بالأسنان أو المنقار، ثمّ تحوّله داخل الجسم إلى موادّ بسيطة"},{"id":"b","text":"تحوّل الغذاء داخل الجسم أوّلًا، ثمّ تفتيته بالأسنان لاحقًا"},{"id":"c","text":"طرح الفضلات أوّلًا، ثمّ تفتيت الغذاء"},{"id":"d","text":"لا ترتيب محدّدًا؛ تحدث كلّ المراحل في اللحظة نفسها"}]'::jsonb, 'a', 'يمرّ الغذاء بمرحلتين متتاليتين: أوّلًا التفتيت الميكانيكي بالأسنان أو المنقار قبل البلع، ثمّ تحوّله داخل الجسم إلى موادّ بسيطة يمتصّها الحيوان.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('59e49d4d-f664-5988-bd9f-c5c9cd70ee5e', 'f18769c1-fe35-53bb-b6d3-ecf66d9f0078', 'ماذا يحدث للأجزاء غير المهضومة من الغذاء بعد تحوّله داخل جسم الحيوان؟', '[{"id":"a","text":"تبقى داخل الجسم إلى الأبد"},{"id":"b","text":"تتحوّل إلى أكسجين"},{"id":"c","text":"تمتصّها الأسنان مباشرة"},{"id":"d","text":"تُطرح خارج الجسم كفضلات"}]'::jsonb, 'd', 'بعد تحوّل الغذاء داخل الجسم، تُمتصّ الموادّ البسيطة المفيدة، بينما تُطرح الأجزاء غير المهضومة خارج الجسم على شكل فضلات.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f88857b3-3015-540b-a6b0-1d2cb35cc5ec', '911eb879-9600-50eb-adaa-8f8a6699adf2', 'البقرة عاشب يقتات على العشب طوال النهار، دون أن تصطاد أيّ فريسة. ماذا نتوقّع بخصوص أنيابها؟', '[{"id":"a","text":"أنياب طويلة وحادّة مثل اللاحم"},{"id":"b","text":"أنياب ضعيفة جدًّا أو منعدمة"},{"id":"c","text":"أنياب متوسّطة تجمع بين العاشب واللاحم"},{"id":"d","text":"لا تملك البقرة أيّ أسنان إطلاقًا"}]'::jsonb, 'b', 'البقرة عاشب يقتات على النبات فقط، فأنيابها ضعيفة جدًّا أو منعدمة، مثل بقيّة الحيوانات العاشبة التي لا تحتاج إلى صيد فريسة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1b3a6a37-7f8a-5eee-8b45-56bc8875ee7d', 'f0daec27-e71d-53c1-965a-0a40272be898', 'الغزال يقتات على الأعشاب والأوراق فقط، ولا يصطاد أيّ حيوان. إلى أيّ نظام غذائي ينتمي؟', '[{"id":"a","text":"عاشب"},{"id":"b","text":"لاحم"},{"id":"c","text":"قارت"},{"id":"d","text":"لا ينتمي إلى نظام معروف"}]'::jsonb, 'a', 'الغزال يقتات على النبات فقط (أعشاب وأوراق) دون صيد أيّ حيوان، وهذا هو النظام العاشب.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('51a590a6-a028-59c0-b2ad-15058a720efc', 'f0daec27-e71d-53c1-965a-0a40272be898', 'الدرّاج طائر بريّ يتغذّى على الحبوب والبذور. أيّ شكل منقار يناسبه؟', '[{"id":"a","text":"منقار معقوف حادّ"},{"id":"b","text":"منقار قصير مخروطي قويّ"},{"id":"c","text":"أسنان صغيرة حادّة"},{"id":"d","text":"منقار مسطّح واسع"}]'::jsonb, 'b', 'الدرّاج طائر حبوبيّ، فمنقاره قصير مخروطي قويّ مخصّص لكسر الحبوب والبذور، لا منقار مصمّم لتمزيق اللحم.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a13a15ce-f508-5727-84c6-10a906b8e7f5', 'c2af133d-6d36-5780-ab3e-786ec84f5e7f', 'في سلسلة الواحة نخلة → يرقة حشرة → عصفور دوري، أيّ كائن من الثلاثة يمثّل المنتج؟', '[{"id":"a","text":"النخلة"},{"id":"b","text":"يرقة الحشرة"},{"id":"c","text":"العصفور الدوري"},{"id":"d","text":"لا يوجد منتج في هذه السلسلة"}]'::jsonb, 'a', 'النخلة نبتة خضراء تصنع غذاءها بنفسها، فهي المنتج الذي تبدأ به هذه السلسلة الغذائية.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('496e1016-e5d7-578f-874b-1feb326ebe0e', 'c2af133d-6d36-5780-ab3e-786ec84f5e7f', 'أيّ كائنات حيّة تُسمّى مفكّكات؟', '[{"id":"a","text":"جراثيم وفطريات التربة"},{"id":"b","text":"النباتات الخضراء فقط"},{"id":"c","text":"الحيوانات اللاحمة الكبيرة"},{"id":"d","text":"الأسماك في البحر"}]'::jsonb, 'a', 'المفكّكات كائنات مجهرية تعيش في التراب، أهمّها الجراثيم والفطريات، وهي التي تحوّل المادّة العضوية الميّتة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a5864d00-d1bb-51d0-9b43-eaa47c0717fc', 'b0c15d35-4771-54be-b9d8-7b8fef99bd31', 'إذا اصطاد الإنسان أعدادًا كبيرة من الصقور الحرّة في الواحة، فماذا يُتوقّع أن يحدث لأعداد العصافير الدورية؟', '[{"id":"a","text":"تتناقص أيضًا فورًا"},{"id":"b","text":"تتكاثر بشكل غير منضبط لغياب مفترسها الطبيعي"},{"id":"c","text":"لا تتأثّر إطلاقًا"},{"id":"d","text":"تتحوّل إلى مفكّكات"}]'::jsonb, 'b', 'باختفاء الصقور (مفترسها الطبيعي)، تتكاثر العصافير الدورية دون رادع، ما يختلّ به التوازن الطبيعي للواحة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8dec583a-e65c-57f7-bf42-f1f53d115296', '9e7170b4-4429-536f-bd07-4955e4d39a2e', 'في سلسلة عوالق نباتية → سمكة صغيرة → سمكة كبيرة → نورس، إلى أيّ حلقة تنتمي العوالق النباتية؟', '[{"id":"a","text":"منتج"},{"id":"b","text":"مستهلك أوّل"},{"id":"c","text":"مستهلك ثانٍ"},{"id":"d","text":"مفكّك"}]'::jsonb, 'a', 'العوالق النباتية كائنات خضراء تصنع غذاءها بنفسها، فهي المنتج الذي تبدأ به هذه السلسلة البحرية.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bc5d79a6-270a-5d43-b157-c03acfcf3e15', '9e7170b4-4429-536f-bd07-4955e4d39a2e', 'أيّ كائن في السلسلة السابقة يمثّل المستهلك الثالث؟', '[{"id":"a","text":"سمكة كبيرة"},{"id":"b","text":"النورس"},{"id":"c","text":"سمكة صغيرة"},{"id":"d","text":"عوالق نباتية"}]'::jsonb, 'b', 'النورس يتغذّى على السمكة الكبيرة (وهي مستهلك ثانٍ)، فهو بذلك مستهلك ثالث في هذه السلسلة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b219dd71-2a07-58bd-8a10-69b7210bae41', 'ec8bc23b-d478-5a5b-808d-1713ec1a4e23', 'أيّ تعريف صحيح للمنتج في السلسلة الغذائية؟', '[{"id":"a","text":"كائن يتغذّى على المستهلكات فقط"},{"id":"b","text":"كائن حيّ يصنع غذاءه العضوي بنفسه انطلاقًا من مادّة معدنية"},{"id":"c","text":"كائن يحوّل المادّة العضوية إلى أملاح معدنية"},{"id":"d","text":"كائن يعيش في التراب فقط"}]'::jsonb, 'b', 'المنتج كائن حيّ (نبتة خضراء) يصنع غذاءه العضوي بنفسه انطلاقًا من الماء والأملاح المعدنية بفضل الضوء.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('21b51f5f-34c1-554a-b773-8f8f8570cb93', 'fe0fb41e-470d-52f9-a73e-e48139308397', 'توجد في التراب كائنات مجهرية (جراثيم وفطريات) تعيش على بقايا نباتية وحيوانية ميّتة. هل يصحّ اعتبارها الحلقة الأولى في السلسلة الغذائية بدل المنتج؟', '[{"id":"a","text":"نعم، لأنّها أوّل ما يظهر في التراب"},{"id":"b","text":"لا، لأنّها لا تصنع مادّة عضوية من مادّة معدنية، ولا تُعدّ حلقة أولى في السلسلة، بل تتدخّل بعد موت الكائنات"},{"id":"c","text":"نعم، لأنّها أصغر حجمًا من المنتج"},{"id":"d","text":"لا فرق بين المفكّك والمنتج في بداية السلسلة"}]'::jsonb, 'b', 'المفكّكات لا تصنع مادّة عضوية من مادّة معدنية كالمنتج، ولا تُدرَج ضمن حلقات السلسلة، بل تتدخّل لاحقًا على بقايا الكائنات الميّتة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d0b9810e-c5a6-5684-bbd7-fe3b8102ef02', '88be354f-3405-5e62-95e5-322f21f3543c', 'أيّ مكوّن معدنيّ في التّربة يتميّز بحبيبات دقيقة جدًّا تصبح لزجة عند بلّها بالماء؟', '[{"id":"a","text":"الحصى"},{"id":"b","text":"الرّمل"},{"id":"c","text":"الدّبال (الموادّ العضويّة)"},{"id":"d","text":"الطّين"}]'::jsonb, 'd', 'الطّين حبيباته دقيقة جدًّا، تتماسك وتصبح لزجة عند بلّها بالماء، بخلاف الرّمل الأكثر خشونة والحصى الأكبر حجمًا. الدّبال ليس مكوّنًا معدنيًّا بل عضويًّا.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ddfce6cd-24e1-5ff5-8465-de9fa5bf6106', '1298ff44-f09c-5682-a9de-18e9f125e9b5', 'لماذا يُعتبر وجود الهواء داخل التّربة ضروريًّا لجذور النّباتات وللكائنات الحيّة الّتي تعيش فيها؟', '[{"id":"a","text":"لأنّه يُصلّب حبيبات التّربة"},{"id":"b","text":"لأنّه ضروريّ لتنفّس الجذور والكائنات الحيّة داخل التّربة"},{"id":"c","text":"لأنّه يمنع تسرّب الماء"},{"id":"d","text":"لأنّه يُحلّل الموادّ العضويّة"}]'::jsonb, 'b', 'يملأ الهواء الفراغات الصّغيرة بين حبيبات التّربة، وهو ضروريّ لتنفّس جذور النّباتات والكائنات الحيّة الموجودة داخل التّربة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('116f475b-dc7f-5c34-ba20-efdaf9f9e30d', '7721d4e1-e1c5-5bf2-b327-2f4807807845', 'ما اسم الظّاهرة الّتي تفقد فيها التّربة طبقتها السّطحيّة الخصبة بفعل الرّياح القويّة أو الأمطار الغزيرة؟', '[{"id":"a","text":"النّفاذيّة"},{"id":"b","text":"التّعرية"},{"id":"c","text":"التّحلّل"},{"id":"d","text":"التّركيب الضّوئيّ"}]'::jsonb, 'b', 'التّعرية هي فقدان التّربة لطبقتها السّطحيّة الخصبة بفعل عوامل طبيعيّة كالرّياح القويّة والأمطار الغزيرة.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b7938454-a22d-5c16-b242-430b5a1164e4', '7721d4e1-e1c5-5bf2-b327-2f4807807845', 'لو اختفى الغطاء النّباتيّ تمامًا من منطقة ما، فما الأثر المتوقّع على تربتها على المدى الطّويل؟', '[{"id":"a","text":"تصبح التّربة أكثر خصوبة تلقائيًّا"},{"id":"b","text":"لا يتغيّر شيء لأنّ الجذور لا علاقة لها بثبات التّربة"},{"id":"c","text":"تتحوّل التّربة إلى صخور صلبة"},{"id":"d","text":"تفقد التّربة ما كان يُثبّتها فتصبح أكثر عرضة للانجراف والتّعرية"}]'::jsonb, 'd', 'بدون غطاء نباتيّ، تفقد التّربة الجذور الّتي كانت تُثبّتها، فتصبح حبيباتها أكثر عرضة للانجراف بفعل الرّياح والأمطار، أي أكثر عرضة للتّعرية.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7d4f010c-41e3-551e-8270-b6a6a39280f9', '61a47596-63ef-5041-a451-7cfd57c077f9', 'لماذا تُعدّ نسبة الماء المتسرّبة بين حبيبات التّربة عنصرًا ضروريًّا لحياة النّبات، لا مجرّد وجود عابر؟', '[{"id":"a","text":"لأنّها تُصلّب حبيبات التّربة"},{"id":"b","text":"لأنّها تمنع نموّ الكائنات المجهريّة داخل التّربة"},{"id":"c","text":"لأنّ النّبات يمتصّ الماء والأملاح المعدنيّة الذّائبة فيه عبر جذوره"},{"id":"d","text":"لأنّها تُحوّل حبيبات الرّمل إلى طين"}]'::jsonb, 'c', 'الماء المتسرّب بين حبيبات التّربة يحمل الأملاح المعدنيّة الذّائبة، وهذا المزيج هو ما تمتصّه جذور النّبات لتغذيته؛ لذلك تُعدّ التّربة مصدر غذاء النّبات لا مجرّد حاضنة له.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bffc97ac-160e-5635-af6c-a9420bf3803a', '316f482a-cd80-52fa-86b1-6c4e0cb1ffad', 'ما أحد الأسباب الرّئيسية لتلوّث الماء في الوسط البيئي؟', '[{"id":"a","text":"إلقاء النّفايات المنزلية والموادّ الكيميائية الزراعية في الأودية والبحيرات دون معالجة"},{"id":"b","text":"شرب الحيوانات للماء بانتظام"},{"id":"c","text":"امتصاص جذور النّباتات للماء من التّربة"},{"id":"d","text":"تنفّس الأسماك داخل الماء بواسطة خياشيمها"}]'::jsonb, 'a', 'من أهمّ أسباب تلوّث الماء إلقاء النّفايات المنزلية وتسرّب الموادّ الكيميائية الزراعية والنّفايات المعملية في الأودية والبحيرات دون معالجة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('846dde04-8b18-54d8-a340-28da03ff46d1', 'cd576536-2543-58bc-a3f5-9ddf40bbb0e7', 'لماذا يُعدّ الأكسجين المذاب في الماء أمرًا حيويًّا بالنّسبة إلى الأسماك؟', '[{"id":"a","text":"لأنّها تشربه فقط دون تنفّس"},{"id":"b","text":"لأنّها تتنفّس به عبر خياشيمها"},{"id":"c","text":"لأنّه يصنع غذاءها مباشرة"},{"id":"d","text":"لا علاقة للأكسجين المذاب بحياة الأسماك"}]'::jsonb, 'b', 'تمتصّ الأسماك الأكسجين المذاب في الماء عبر خياشيمها لتتنفّس، ولهذا يضرّ تلوّث الماء بها حين يقلّل هذا الأكسجين المذاب.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3c38c768-02a6-512e-b8af-641fb32de24c', '39a5721d-06e2-5f56-910b-e5e22264e371', 'يعيش أرنب برّيّ في منطقة جافّة، يقتات على أعشاب طازجة صباحًا ويلجأ إلى الظّلّ ظهرًا، ونادرًا ما يشرب ماءً مباشرة. من أين يحصل هذا الأرنب على معظم حاجته للماء؟', '[{"id":"a","text":"من تبخّر الماء عبر جلده فقط"},{"id":"b","text":"لا يحتاج الأرنب البرّيّ إلى ماء إطلاقًا"},{"id":"c","text":"يخزّن الماء في جسمه كالجمل حصريًّا"},{"id":"d","text":"من الأعشاب الطّازجة الغنيّة بالماء الّتي يأكلها"}]'::jsonb, 'd', 'بما أنّ الأرنب نادرًا ما يشرب مباشرة، فهو يحصل على معظم حاجته للماء بصفة غير مباشرة من الأعشاب الطّازجة الّتي يأكلها. أمّا الخيار (ج) فخاطئ: الجمل نفسه لا يخزّن الماء في سنامه بل دهنًا يمنحه الطّاقة، فلا وجود لحيوان «يخزّن الماء» بهذا المعنى.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d9f10875-b71d-5134-bbd1-b3c13c47b67b', '05252fc0-9e36-51a3-973a-24323671b645', 'يُصنَّف الماء ضمن أيّ مكوّن من مكوّنات الوسط البيئي الّذي درسته سابقًا؟', '[{"id":"a","text":"عنصر غير حيّ ضمن الوسط غير الحيّ (biotope)"},{"id":"b","text":"مجموع الكائنات الحيّة (biocénose)"},{"id":"c","text":"لا يُصنَّف الماء ضمن أيّ من المكوّنين"},{"id":"d","text":"الماء نفسه كائن حيّ مستقلّ"}]'::jsonb, 'a', 'الوسط البيئي يتكوّن من الوسط غير الحيّ (biotope: تربة، ماء، هواء، مناخ) ومجموع الكائنات الحيّة (biocénose)؛ الماء عنصر غير حيّ ضمن الوسط غير الحيّ.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c1dc1f6c-df4a-561f-8879-d63a8ab1bd36', '05252fc0-9e36-51a3-973a-24323671b645', 'ما الفرق بين دور الماء ودور ثاني أكسيد الكربون (CO2) في تغذية النّبات الأخضر الّتي درستها سابقًا؟', '[{"id":"a","text":"كلاهما يُمتصّ بالجذور من التّربة فقط"},{"id":"b","text":"الماء يُمتصّ بالجذور من التّربة، وCO2 يُمتصّ بالأوراق من الهواء، وكلاهما ضروريّ للتّركيب الضّوئيّ"},{"id":"c","text":"لا علاقة لـ CO2 بالتّركيب الضّوئيّ، فقط الماء ضروريّ"},{"id":"d","text":"الماء يُمتصّ بالأوراق وCO2 بالجذور"}]'::jsonb, 'b', 'يمتصّ النّبات الماء بجذوره من التّربة، بينما يمتصّ CO2 بأوراقه من الهواء المحيط؛ وكلاهما مادّة أوّلية ضرورية للتّركيب الضّوئيّ إلى جانب الضّوء.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
