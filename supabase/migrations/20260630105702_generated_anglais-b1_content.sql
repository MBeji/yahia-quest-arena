...
-- Subject: anglais-b1 (English — Intermediate (B1))
...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('anglais-b1', 'English — Intermediate (B1)', 'Reach the intermediate threshold: the present perfect, the past continuous, conditionals, modals of obligation and advice, and relative clauses. Intermediate level (CEFR B1), building on A1 and A2.', 'Agilité', 'subject-english', 'Globe', 3, 'en', false, 'anglais', NULL)
...
- **gone vs been** — _has gone_ (still away) vs _has been_ (visited, now back).', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
- ⚠️ **Stative verbs** (_know, want, like, be_) are normally NOT used in the continuous — use the past simple (_I knew_, not _I was knowing_).', 2, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Base verb** — _will_ and _would_ are always followed by the bare base verb (_will go_, _would come_, never _will to go_ / _would goes_).', 3, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Past** — _must_ and _have to_ both become **had to** (_Yesterday I had to work late_).', 4, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Never use **what** as a relative pronoun (_the thing that I need_, not _the thing what I need_), and don''t confuse **whose** (possession) with **who''s** (= _who is_).', 5, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Don''t confuse _used to do_ (past habit) with _be used to doing_ (accustomed now) — they look similar but mean very different things.', 6, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- Three-word phrasal verbs (_run out of_, _come up with_) are always inseparable.', 7, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- Inference answers must be supported by text clues — not by your personal knowledge or opinion.', 8, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('1757de03-9447-575a-b3f6-12239af5e49d', 'd3573188-ea41-5396-b14c-c7c1f7fae1e1', 'anglais-b1', '⭐⭐ Drill: Present Perfect', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('878e2e85-b24e-5c63-a07a-64f6a777b8c8', '1757de03-9447-575a-b3f6-12239af5e49d', 'Complete: "The train ___ just left. You missed it!"', '[{"id":"a","text":"have"},{"id":"b","text":"has"},{"id":"c","text":"had"},{"id":"d","text":"is"}]'::jsonb, 'b', 'The train is singular (he/she/it), so the present perfect uses has: The train has just left. "have" is for I/you/we/they, "had" forms the past perfect, and "is" cannot form the present perfect here.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dc2d97ae-af4f-5de9-af6b-7509a9c247de', '1757de03-9447-575a-b3f6-12239af5e49d', 'Complete: "I have worked here ___ three months."', '[{"id":"a","text":"since"},{"id":"b","text":"ago"},{"id":"c","text":"during"},{"id":"d","text":"for"}]'::jsonb, 'd', '"for" goes with a length of time: for three months. "since" needs a starting point (since March), "ago" counts back from now with the past simple, and "during" is followed by an event noun (during the summer), not a duration.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('db2cbc20-4898-5951-907d-63f097e37be6', '1757de03-9447-575a-b3f6-12239af5e49d', 'Complete: "___ you ever tried sushi?"', '[{"id":"a","text":"Did"},{"id":"b","text":"Were"},{"id":"c","text":"Have"},{"id":"d","text":"Do"}]'::jsonb, 'c', 'Life experience questions use the present perfect: Have you ever tried? "Did" starts a past-simple question and can''t take "ever" in this pattern, "Were" starts a past-continuous or passive question, and "Do" forms the present simple.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('00d33855-0299-5047-9006-955b4c2eaf92', '1757de03-9447-575a-b3f6-12239af5e49d', 'Find the INCORRECT sentence.', '[{"id":"a","text":"She has gone to the market; she came back an hour ago."},{"id":"b","text":"They haven''t finished the project yet."},{"id":"c","text":"He has spoken to the manager this morning."},{"id":"d","text":"I''ve known him for years."}]'::jsonb, 'a', 'The incorrect sentence is "She has gone to the market; she came back an hour ago.": "has gone" means she is still away, which contradicts "came back an hour ago" (the correct verb would be "has been"). The other three use the present perfect correctly with "this morning", "yet", and "for".', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('40383eea-e61e-549e-b960-2100173bb11f', '1757de03-9447-575a-b3f6-12239af5e49d', 'Complete the reply: "Have you done the washing-up?" — "Yes, I ___ done it."', '[{"id":"a","text":"''ve already"},{"id":"b","text":"did already"},{"id":"c","text":"am already"},{"id":"d","text":"''ve yet"}]'::jsonb, 'a', 'To confirm a completed action in an affirmative present-perfect reply, use already between have and the participle: I''ve already done it. "did already" is past simple and doesn''t match the question''s tense, "am already" misses the participle, and "''ve yet" is ungrammatical — yet belongs to questions and negatives.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7d7e0d31-1085-5d86-8f90-9e368dd1f86e', '1757de03-9447-575a-b3f6-12239af5e49d', 'Complete: "We ___ in this flat since we got married, and we love it here."', '[{"id":"a","text":"lived"},{"id":"b","text":"were living"},{"id":"c","text":"have lived"},{"id":"d","text":"had lived"}]'::jsonb, 'c', '"since we got married" links a past starting point to the present, which requires the present perfect: We have lived here since…. "lived" (past simple) cuts the connection to now, "were living" (past continuous) suggests the action is over, and "had lived" (past perfect) would place the event entirely in the past before another past moment.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('43eb0372-c967-5945-99ce-206cb493368f', 'd1dc7e47-b0d8-5f2d-866b-378c7e8e4f53', 'anglais-b1', '⭐⭐ Drill: Past Continuous', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('32878cfb-66cf-59a8-999a-6b3df9dd7a79', '43eb0372-c967-5945-99ce-206cb493368f', 'Complete: "The children ___ in the street when it started to snow."', '[{"id":"a","text":"played"},{"id":"b","text":"were playing"},{"id":"c","text":"was playing"},{"id":"d","text":"are playing"}]'::jsonb, 'b', '"The children" is plural, so the past continuous uses were: they were playing when the snow started. "played" (past simple) loses the in-progress sense, "was playing" is the wrong agreement for a plural subject, and "are playing" is present.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('38ca120f-87f7-56c6-b333-73e33b4a413f', '43eb0372-c967-5945-99ce-206cb493368f', 'Complete the negative: "They ___ dinner; the kitchen was completely empty."', '[{"id":"a","text":"didn''t cooking"},{"id":"b","text":"weren''t cook"},{"id":"c","text":"wasn''t cooking"},{"id":"d","text":"weren''t cooking"}]'::jsonb, 'd', 'The past-continuous negative for they is weren''t + -ing: they weren''t cooking. "wasn''t cooking" is the wrong agreement (was is for I/he/she/it), "weren''t cook" drops the -ing, and "didn''t cooking" mixes two tenses incorrectly.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('927d24d5-00ca-5bd4-8957-188bae8fd857', '43eb0372-c967-5945-99ce-206cb493368f', 'Choose the correct -ing spelling: "She was ___ in her favourite armchair."', '[{"id":"a","text":"siting"},{"id":"b","text":"sitting"},{"id":"c","text":"sittting"},{"id":"d","text":"satting"}]'::jsonb, 'b', 'sit ends in a short vowel + single consonant, so we double the t before -ing: sitting. "siting" keeps only one t, "sittting" adds an extra t, and "satting" starts from the past form sat — none are correct.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('892b26c1-cc9b-5277-b603-166e17f7d562', '43eb0372-c967-5945-99ce-206cb493368f', 'Complete: "He ___ me when I arrived — he was looking at his phone."', '[{"id":"a","text":"wasn''t seeing"},{"id":"b","text":"weren''t seeing"},{"id":"c","text":"didn''t see"},{"id":"d","text":"was not seeing"}]'::jsonb, 'c', 'see is a stative verb and is not used in the continuous. For the short, completed event of not noticing someone arrive, use the past simple: he didn''t see me. "wasn''t seeing" and "was not seeing" wrongly put a state verb into the continuous, and "weren''t seeing" also has wrong agreement.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('79210646-7575-5840-8a63-27701559fb57', '43eb0372-c967-5945-99ce-206cb493368f', 'Complete: "___ they talking quietly so they answered without waking the baby?"', '[{"id":"a","text":"While"},{"id":"b","text":"Were"},{"id":"c","text":"Was"},{"id":"d","text":"Did"}]'::jsonb, 'b', 'A past-continuous question with they inverts subject and auxiliary: Were they talking…? "Was" is the wrong agreement for they, "While" starts a clause not a question, and "Did" forms the past-simple question and doesn''t fit the continuous -ing that follows.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ef2bedc4-82d8-567c-834c-85eb45b44a46', '43eb0372-c967-5945-99ce-206cb493368f', 'Choose the fully correct sentence.', '[{"id":"a","text":"This time yesterday, we were flying over the Alps."},{"id":"b","text":"This time yesterday, we was flying over the Alps."},{"id":"c","text":"This time yesterday, we were fly over the Alps."},{"id":"d","text":"This time yesterday, we were flying over the Alps when we arrived."}]'::jsonb, 'a', '"This time yesterday" describes an action in progress at a past moment, so we use the past continuous: we were flying. "was" is the wrong agreement for we, "were fly" drops the -ing, and the last option adds "when we arrived" which contradicts being mid-flight over the Alps — the clause is inconsistent.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('3dc923c0-66a9-5091-8789-7ade50a37469', '589c4ce0-c4da-5533-947d-7432b122e351', 'anglais-b1', '⭐⭐ Drill: Conditionals', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('31557f07-f746-5857-baa8-4e421be37438', '3dc923c0-66a9-5091-8789-7ade50a37469', 'Complete the zero conditional: "If you ___ a plant with no water, it dies."', '[{"id":"a","text":"will leave"},{"id":"b","text":"leave"},{"id":"c","text":"would leave"},{"id":"d","text":"left"}]'::jsonb, 'b', 'A zero conditional describes a permanent truth: both clauses use the present simple, so the if-clause is "if you leave". "will leave" and "would leave" belong to the first and second conditionals, and "left" (past) would start a second conditional meaning something imaginary.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ff513236-5103-51d4-b52a-d5ee8dc73748', '3dc923c0-66a9-5091-8789-7ade50a37469', 'Complete the first conditional: "If she ___ harder, she will get better marks."', '[{"id":"a","text":"studies"},{"id":"b","text":"will study"},{"id":"c","text":"studied"},{"id":"d","text":"would study"}]'::jsonb, 'a', 'In the first conditional, the if-clause uses the present simple: if she studies. "will study" wrongly puts will in the if-clause, "studied" (past) would make it a second conditional (imaginary), and "would study" also belongs in the result clause only.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fb0c8884-2c9b-505f-83ae-84596048cef4', '3dc923c0-66a9-5091-8789-7ade50a37469', 'Complete the second conditional: "If he ___ more, he would feel healthier."', '[{"id":"a","text":"exercise"},{"id":"b","text":"exercises"},{"id":"c","text":"exercised"},{"id":"d","text":"will exercise"}]'::jsonb, 'c', 'The result "would feel" signals the second (imaginary) conditional, so the if-clause needs the past simple: if he exercised. "exercise" and "exercises" are present forms (zero and first conditional), and "will exercise" wrongly places will in the if-clause.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('52b36183-99ee-5d4e-aab0-4760c5c37398', '3dc923c0-66a9-5091-8789-7ade50a37469', 'Find the INCORRECT sentence.', '[{"id":"a","text":"If you don''t hurry, you will be late."},{"id":"b","text":"If she would study, she would pass."},{"id":"c","text":"If I had a boat, I would sail around the world."},{"id":"d","text":"If you press that button, the machine stops."}]'::jsonb, 'b', 'The error is in the second option: would must never appear in the if-clause of a second conditional. The correct form is: If she studied, she would pass. The first option is a correct first conditional, the third a correct second conditional, and the fourth a correct zero conditional.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8f2d6971-b525-5755-b51f-737111c776e6', '3dc923c0-66a9-5091-8789-7ade50a37469', 'Identify the conditional type: "If you drop something heavy on your foot, it hurts."', '[{"id":"a","text":"First conditional — a real future plan"},{"id":"b","text":"Second conditional — an imaginary situation"},{"id":"c","text":"Zero conditional — a general, always-true fact"},{"id":"d","text":"A mixed conditional"}]'::jsonb, 'c', 'Both clauses are present simple (drop / hurts), and the meaning is an always-true physical fact — that is the zero conditional. The first conditional (a) uses will in the result, the second (b) uses a past if-clause and would in the result, and a mixed conditional (d) combines different time frames.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('43a78b68-3038-5e12-9295-201ba5669a9d', '3dc923c0-66a9-5091-8789-7ade50a37469', 'Complete the dialogue: "I don''t know what to cook tonight." — "___ were you, I''d make pasta."', '[{"id":"a","text":"If I"},{"id":"b","text":"If I am"},{"id":"c","text":"If I will be"},{"id":"d","text":"If I would be"}]'::jsonb, 'a', 'The advice phrase is the fixed second conditional "If I were you, I''d…" — here split across the gap, so the answer is "If I" (completing to If I were you). "If I am" uses the present, "If I will be" puts will in the if-clause, and "If I would be" also wrongly places would there.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('75609a28-7188-5145-8c84-87a3ff295adf', '442e97bd-5019-5a8e-b7eb-861f9cf2b597', 'anglais-b1', '⭐⭐ Drill: Modals of Obligation', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f1db3ec3-2416-5eb7-84e4-2ef00707f021', '75609a28-7188-5145-8c84-87a3ff295adf', 'Complete: "Children ___ cross the road without looking both ways. It''s dangerous."', '[{"id":"a","text":"should"},{"id":"b","text":"must"},{"id":"c","text":"don''t have to"},{"id":"d","text":"mustn''t"}]'::jsonb, 'd', 'Crossing without looking is forbidden and dangerous, so we use mustn''t: children mustn''t cross without looking. "should" gives soft advice (not a prohibition), "must" would make the dangerous action obligatory, and "don''t have to" means it is simply optional.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f29f4e74-ca7d-52f6-abed-0b33e1789388', '75609a28-7188-5145-8c84-87a3ff295adf', 'Complete: "It''s a free event, so you ___ buy a ticket."', '[{"id":"a","text":"must"},{"id":"b","text":"mustn''t"},{"id":"c","text":"have to"},{"id":"d","text":"don''t have to"}]'::jsonb, 'd', 'A free event means buying a ticket is not necessary: you don''t have to buy one. "must" and "have to" would make buying obligatory (the opposite), and "mustn''t" would forbid buying — neither fits a free, optional entry.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ef44e8fb-2f04-5b64-9c73-692df8bc7b13', '75609a28-7188-5145-8c84-87a3ff295adf', 'Complete: "You look pale. I think you ___ go home and rest."', '[{"id":"a","text":"should"},{"id":"b","text":"have"},{"id":"c","text":"must to"},{"id":"d","text":"mustn''t"}]'::jsonb, 'a', 'This is friendly advice based on how someone looks, so we use should + base verb: you should go home. "must to" adds a wrong to, bare "have" cannot express advice here, and "mustn''t" would forbid going home — the opposite of the intended meaning.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('449446d9-ba76-5848-abfc-c5980c7600df', '75609a28-7188-5145-8c84-87a3ff295adf', 'Find the INCORRECT sentence.', '[{"id":"a","text":"We must leave before midnight."},{"id":"b","text":"She doesn''t have to come if she''s busy."},{"id":"c","text":"He should to call his parents more often."},{"id":"d","text":"You mustn''t take photos in this gallery."}]'::jsonb, 'c', 'The error is in the third option: should is a modal and is followed by the bare infinitive with no to — He should call his parents. The first option (must + base) and fourth option (mustn''t + base) are correct, as is the second (doesn''t have to + base).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4a4cd55b-ad4f-5b82-969b-6d8d6971c25d', '75609a28-7188-5145-8c84-87a3ff295adf', 'Read the signs: "NO PARKING 8–10 a.m. · SPEED LIMIT 30 mph · HELMETS RECOMMENDED"
Which modal best completes: "You ___ wear a helmet — it is not legally required but is strongly advised."', '[{"id":"a","text":"must"},{"id":"b","text":"should"},{"id":"c","text":"mustn''t"},{"id":"d","text":"have to"}]'::jsonb, 'b', '"Recommended" means it is a good idea but not a law, so should fits: you should wear a helmet. "must" and "have to" express legal obligation (the sign says it is NOT legally required), and "mustn''t" would forbid wearing a helmet — completely the wrong meaning.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cbc82e12-d5a7-5905-90a1-3cdd8771f84d', '75609a28-7188-5145-8c84-87a3ff295adf', 'Complete: "When I was ten, I ___ do the washing-up every evening — that was my chore."', '[{"id":"a","text":"must"},{"id":"b","text":"have to"},{"id":"c","text":"had to"},{"id":"d","text":"must to"}]'::jsonb, 'c', '"When I was ten" places the obligation in the past. The past form of must / have to is had to: I had to do the washing-up. "must" has no past form of its own, "have to" is the present form, and "must to" wrongly adds to after must.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('0bd12eda-cb9e-585c-b0c5-008a291c1dbe', '97bbe81f-2f56-59be-a5de-bf2292f92b73', 'anglais-b1', '⭐⭐ Drill: Relative Clauses', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f5cd07fc-e305-5d79-909b-74221000e7d5', '0bd12eda-cb9e-585c-b0c5-008a291c1dbe', 'Complete: "The bus ___ stops outside the school runs every fifteen minutes."', '[{"id":"a","text":"who"},{"id":"b","text":"where"},{"id":"c","text":"whose"},{"id":"d","text":"that"}]'::jsonb, 'd', 'A bus is a thing and the subject of "stops", so use that (or which): the bus that stops outside. "who" is only for people, "where" introduces a place inside the clause (not the subject), and "whose" shows possession and needs a noun after it.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3c8448b4-44da-5aec-8e01-4fa1ca756e60', '0bd12eda-cb9e-585c-b0c5-008a291c1dbe', 'Complete: "She married a chef ___ restaurant is famous across the whole city."', '[{"id":"a","text":"who"},{"id":"b","text":"which"},{"id":"c","text":"whose"},{"id":"d","text":"who''s"}]'::jsonb, 'c', 'whose shows possession (his restaurant): a chef whose restaurant is famous. "who" needs a verb directly after it (a chef who cooks), "which" is for things not people, and "who''s" means "who is" — a completely different meaning.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('59853e83-9269-5b92-ac41-5de04c12af16', '0bd12eda-cb9e-585c-b0c5-008a291c1dbe', 'Complete: "This is the city ___ I was born."', '[{"id":"a","text":"that"},{"id":"b","text":"which"},{"id":"c","text":"who"},{"id":"d","text":"where"}]'::jsonb, 'd', 'Use where for a place when the meaning is "in which": the city where I was born. "that" and "which" can refer to the city as an object but not as a location without a preposition (the city in which I was born), and "who" is only for people.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d123e527-2a3d-5a8b-9114-9d9b310d172d', '0bd12eda-cb9e-585c-b0c5-008a291c1dbe', 'In which sentence CAN the relative pronoun be omitted?', '[{"id":"a","text":"The journalist who broke the story works here."},{"id":"b","text":"The report that she wrote won an award."},{"id":"c","text":"I found the cat that was hiding in the garden."},{"id":"d","text":"The man whose wallet I found lives nearby."}]'::jsonb, 'b', 'You can drop the relative pronoun only when it is the object — a subject follows. In the second option "she" follows "that", making it the object: the report she wrote. In the first and third options a verb follows (broke, was hiding), so the pronoun is the subject and must stay. In the fourth option "whose" is possessive and can never be dropped.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('61a194f9-b6b5-52b6-bc7d-5634949a1111', '0bd12eda-cb9e-585c-b0c5-008a291c1dbe', 'Find the INCORRECT sentence.', '[{"id":"a","text":"The colleague that helped me is on holiday."},{"id":"b","text":"The street which I grew up is very quiet."},{"id":"c","text":"The letter which arrived this morning is for you."},{"id":"d","text":"Is this the bag that you were looking for?"}]'::jsonb, 'b', 'The error is in the second option: "the street which I grew up" is wrong — which can''t carry the meaning of location here. It should be the street where I grew up (or in which I grew up). The other three correctly use that for a person and a thing, which as the subject of a thing, and that as the object of a thing.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9d7284a7-95d1-5284-90fe-5b24af0cd207', '0bd12eda-cb9e-585c-b0c5-008a291c1dbe', 'Combine into one sentence: "I spoke to a manager. The manager''s team had won the award."', '[{"id":"a","text":"I spoke to a manager who team had won the award."},{"id":"b","text":"I spoke to a manager which team had won the award."},{"id":"c","text":"I spoke to a manager whose team had won the award."},{"id":"d","text":"I spoke to a manager that team had won the award."}]'::jsonb, 'c', 'whose shows possession (the manager''s team): a manager whose team had won. "who" alone needs a verb after it (not a noun like team), "which" is for things, not people, and "that" cannot be possessive — none of them can replace "the manager''s" except whose.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2189b79f-f14c-5c54-a7fc-cab8bbf2db79', '8144efc4-8228-5d01-b3cc-1e36c3bdef4f', 'Complete: "On weekends, we ___ go fishing at the lake with our father."', '[{"id":"a","text":"use to"},{"id":"b","text":"would"},{"id":"c","text":"are used to"},{"id":"d","text":"got used to"}]'::jsonb, 'b', 'Going fishing is a repeated past action with a time frame ("on weekends"), so "would" fits the narrative pattern: we would go fishing. "use to" is incorrect — the past form is "used to" (with -d). "are/got used to" mean accustomed to, a different meaning.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('ee5fe07f-a227-5bbb-8163-d8e2bd345147', '103f22ad-0c64-534c-b534-dc30a036c9fb', 'anglais-b1', '⭐⭐ Drill: Used to & Would', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('58b1eaa0-b768-5048-98a7-e9abdaa634d9', 'ee5fe07f-a227-5bbb-8163-d8e2bd345147', 'Complete: "As a child, she ___ believe in fairy tales, but she doesn''t any more."', '[{"id":"a","text":"would"},{"id":"b","text":"used to"},{"id":"c","text":"is used to"},{"id":"d","text":"got used to"}]'::jsonb, 'b', '"believe" is a state verb, so only "used to" can describe this finished past state: she used to believe. "would" cannot be used with state verbs like believe. "is/got used to" mean accustomed to and take an -ing form after them.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c811ac01-131f-5a67-a97c-29d649f92e37', 'ee5fe07f-a227-5bbb-8163-d8e2bd345147', 'Complete: "After a year abroad, she finally ___ living far from her family."', '[{"id":"a","text":"used to"},{"id":"b","text":"would"},{"id":"c","text":"got used to"},{"id":"d","text":"use to"}]'::jsonb, 'c', '"After a year" describes a process of becoming accustomed that is now complete — "get used to + -ing" in the past: she got used to living far away. "used to" alone describes a past habit (now stopped), "would" describes repeated actions, and "use to" is only correct after did in questions or negatives.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f11041e1-08cb-50b5-b547-fea35af7d792', 'ee5fe07f-a227-5bbb-8163-d8e2bd345147', 'Complete: "Every summer, my family ___ rent a small house by the sea."', '[{"id":"a","text":"is used to"},{"id":"b","text":"used to"},{"id":"c","text":"are used to"},{"id":"d","text":"get used to"}]'::jsonb, 'b', 'Renting a house every summer is a past repeated habit now finished, so "used to" is correct: my family used to rent. "would" is also possible for a repeated action, but only "used to" appears here. "is/are used to" and "get used to" mean accustomed to — a different idea.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6160e0f7-4e0f-5153-8ae8-3f934855231f', 'ee5fe07f-a227-5bbb-8163-d8e2bd345147', 'Complete: "___ he use to cycle to school before the new bus route opened?"', '[{"id":"a","text":"Would"},{"id":"b","text":"Was"},{"id":"c","text":"Did"},{"id":"d","text":"Has"}]'::jsonb, 'c', 'The question form of "used to" is: Did + subject + use to + verb? — Did he use to cycle? "Would" forms a different question: Would he cycle? (not combining with "use to"). "Was" starts a past-continuous or passive question, and "Has" forms the present perfect.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d3fda64d-4d7e-5982-9247-6885fad8ef5c', 'ee5fe07f-a227-5bbb-8163-d8e2bd345147', 'Find the INCORRECT sentence.', '[{"id":"a","text":"She used to own a cat when she lived in the country."},{"id":"b","text":"He would walk to the market every Friday."},{"id":"c","text":"I am getting used to waking up early."},{"id":"d","text":"They would own a big house in the past."}]'::jsonb, 'd', 'The error is in the fourth option: "own" is a state verb, so "would" cannot describe this past state. The correct form is: They used to own a big house. The first option correctly uses "used to" with the state verb own, the second uses "would" with the action verb walk, and the third correctly uses "getting used to + -ing".', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('71887317-4408-5886-b5e5-eec7c85ea791', 'ee5fe07f-a227-5bbb-8163-d8e2bd345147', 'Complete: "She is slowly ___ the new software at work — it''s very different from the old system."', '[{"id":"a","text":"used to use"},{"id":"b","text":"getting used to using"},{"id":"c","text":"would use"},{"id":"d","text":"used to using"}]'::jsonb, 'b', 'The process of becoming accustomed ("slowly", present context) is expressed by "get used to + -ing": she is getting used to using the software. "used to use" describes a finished past habit (not a present process), "would use" describes a repeated past action, and "used to using" would need "is" in front to make "is used to using" (already accustomed) — which contradicts "slowly".', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('e89647df-0242-5671-9747-6177768dd216', '777eefdf-d77b-55c6-be60-dee5cdaf1fae', 'anglais-b1', '⭐⭐ Drill: Phrasal Verbs', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6d5267b6-ce5c-5273-8004-934bebd009a8', 'e89647df-0242-5671-9747-6177768dd216', 'Complete: "The flight was delayed, so we ___ at midnight instead of nine."', '[{"id":"a","text":"set off"},{"id":"b","text":"put off"},{"id":"c","text":"gave up"},{"id":"d","text":"looked after"}]'::jsonb, 'a', '"Set off" means to begin a journey or depart: we set off at midnight. "Put off" means to postpone (the subject here is the passengers, not the event), "gave up" means to stop trying, and "looked after" means to take care of someone — none fit departing on a journey.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d30c8a46-b977-5c32-a54f-2aaa63c1ea25', 'e89647df-0242-5671-9747-6177768dd216', 'Complete: "Could you ___ the radio? I''m trying to concentrate."', '[{"id":"a","text":"turn on"},{"id":"b","text":"turn off"},{"id":"c","text":"run out of"},{"id":"d","text":"come up with"}]'::jsonb, 'b', 'Turning off removes sound so you can concentrate: could you turn off the radio? "Turn on" would make the noise louder, "run out of" means to have no more of something, and "come up with" means to think of an idea — none fit silencing an interruption.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1519bd30-bf97-5e42-bd0f-099cf252555c', 'e89647df-0242-5671-9747-6177768dd216', 'Choose the CORRECT sentence with a pronoun object.', '[{"id":"a","text":"I looked it up in the dictionary."},{"id":"b","text":"I looked up it in the dictionary."},{"id":"c","text":"I up looked it in the dictionary."},{"id":"d","text":"I looked in it up the dictionary."}]'::jsonb, 'a', '"Look up" is a separable phrasal verb. When the object is a pronoun, it must go between verb and particle: I looked it up. Placing the pronoun after the particle ("looked up it") is incorrect with pronouns. The other options have impossible word orders.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('de286c8b-4a68-5538-a2c3-3d38820f53b1', 'e89647df-0242-5671-9747-6177768dd216', 'Complete: "She ___ her keys for twenty minutes before she found them in her coat pocket."', '[{"id":"a","text":"looked after"},{"id":"b","text":"looked up"},{"id":"c","text":"looked for"},{"id":"d","text":"looked forward to"}]'::jsonb, 'c', '"Look for" means to search for something: she looked for her keys. "Look after" means to care for someone, "look up" means to search for information in a reference source, and "look forward to" means to feel excited about a future event — none describe physically searching for an object.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c67386ea-1089-59e4-a486-5a7e7ed2ff72', 'e89647df-0242-5671-9747-6177768dd216', 'Complete: "Don''t ___ the cat while we''re away — our neighbour will do it."', '[{"id":"a","text":"find out"},{"id":"b","text":"run out of"},{"id":"c","text":"worry about"},{"id":"d","text":"give up"}]'::jsonb, 'c', '"Worry about" means to feel anxious about something: don''t worry about the cat. "Find out" means to discover information, "run out of" means to have no more of something, and "give up" means to stop trying — none fit feeling anxious about an animal''s welfare.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9380512f-9531-52bd-a80e-25d719c8063a', 'e89647df-0242-5671-9747-6177768dd216', 'Find the INCORRECT sentence.', '[{"id":"a","text":"We finally came up with a plan."},{"id":"b","text":"She is looking forward to her holiday."},{"id":"c","text":"He ran into his old teacher at the café."},{"id":"d","text":"They looked after it the project all week."}]'::jsonb, 'd', 'The error is in the last option: "look after" is an inseparable phrasal verb — the object must always follow the complete phrasal verb, never interrupt it. It should be: They looked after the project all week. The first option (come up with + noun), second (look forward to + noun), and third (run into + noun) all place the object correctly after the full phrasal verb.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('54f1bee8-3d98-564c-938c-f8a6d7a24bb8', '3f0bbd99-331c-57c0-bf91-79e182a825a3', 'anglais-b1', '⭐⭐ Drill: Reading Comprehension', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b416151b-bcb3-5c40-96ba-2992c7cfb09d', '54f1bee8-3d98-564c-938c-f8a6d7a24bb8', 'Read the notice:
"GYM NOTICE
The gym will open one hour later than usual on Saturday 22nd due to a staff event. Normal Sunday hours apply. Members with a Saturday-only pass may attend Sunday at no extra charge."

What time does the gym USUALLY open on Saturdays?', '[{"id":"a","text":"The text does not say."},{"id":"b","text":"One hour earlier than on Sunday"},{"id":"c","text":"At the same time as Sunday"},{"id":"d","text":"One hour later than on Sunday"}]'::jsonb, 'a', 'The notice only states the gym will open one hour later than usual — it never gives the usual Saturday opening time. Choosing any specific hour would be guessing. The Sunday hours are mentioned as a comparison, but no actual times appear, so this is Not Given in the text.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5c093251-4c8f-59e0-a7ad-88ad770af98a', '54f1bee8-3d98-564c-938c-f8a6d7a24bb8', 'Read the article extract:
"Sleep experts recommend that adults get between seven and nine hours of sleep per night. However, a recent survey found that more than half of adults in the country regularly sleep fewer than six hours. Experts warn that sleep deprivation can affect memory, mood, and physical health."

What is the article MAINLY about?', '[{"id":"a","text":"The benefits of sleeping nine hours a night"},{"id":"b","text":"How to improve the quality of your sleep"},{"id":"c","text":"The gap between recommended and actual sleep hours, and its consequences"},{"id":"d","text":"Why surveys about sleep are unreliable"}]'::jsonb, 'c', 'The extract presents the recommended amount (seven to nine hours), shows the reality (fewer than six hours), and warns about the consequences. The main idea is the gap between the two, and its health effects. Nine hours as a single benefit (first option) is too narrow, tips for improving sleep are never given, and the text treats the survey as valid rather than questioning it.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c380a6af-f2d7-584b-8250-0583082c3a4a', '54f1bee8-3d98-564c-938c-f8a6d7a24bb8', 'Read the story:
"Nour stared at her phone. The message was from her best friend: ''I''m moving to Canada next month.'' She put the phone down on the table and sat very still."

What can we INFER about Nour?', '[{"id":"a","text":"Nour is happy because her friend is getting a great opportunity."},{"id":"b","text":"Nour is shocked or upset by the unexpected news."},{"id":"c","text":"Nour already knew her friend was moving."},{"id":"d","text":"Nour is planning to move to Canada too."}]'::jsonb, 'b', 'Nour goes very still and puts her phone down — a physical reaction that signals shock or emotional distress at unexpected news. There is no sign of happiness or excitement (no smile, no positive reaction). Nothing suggests she already knew (she received a message), and moving to Canada herself is never mentioned.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('18a22197-3c50-5f25-b11d-9066568d6e70', '54f1bee8-3d98-564c-938c-f8a6d7a24bb8', 'Read the sentence:
"The atmosphere at the awards ceremony was electric, with the audience cheering every announcement."
What does ELECTRIC most likely mean here?', '[{"id":"a","text":"Powered by electricity"},{"id":"b","text":"Very exciting and full of energy"},{"id":"c","text":"Silent and formal"},{"id":"d","text":"Boring and predictable"}]'::jsonb, 'b', 'The context — an awards ceremony with a cheering audience — is clearly positive and energetic. "Electric" here is a metaphor meaning full of excitement and energy. The literal meaning (powered by electricity) does not fit an atmosphere. "Silent and formal" and "boring" are the opposite of what the cheering audience suggests.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('691a5a1f-76cd-5ea7-9645-e47abedfff75', '54f1bee8-3d98-564c-938c-f8a6d7a24bb8', 'Read the article extract:
"The coastal village of Sandcroft has been affected by rising sea levels for over a decade. Several homes have already been abandoned, and experts predict that without action, the entire village could be submerged by 2060. Local residents are divided: some want to build sea defences, while others believe it is time to relocate."

Statement: "All Sandcroft residents agree that sea defences are the best solution."
True, False, or Not Given?', '[{"id":"a","text":"True"},{"id":"b","text":"False"},{"id":"c","text":"Not Given"},{"id":"d","text":"True — the experts agree too"}]'::jsonb, 'b', 'The text explicitly says residents are divided — some want sea defences, others want to relocate. The statement that all residents agree on sea defences is therefore False. Not Given would mean the text is silent, but the text directly contradicts the statement. The experts discuss submersion, not a preferred solution.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4f322f75-5630-5344-b5d2-3b93d391b12e', '54f1bee8-3d98-564c-938c-f8a6d7a24bb8', 'Read the email:
"Dear Mr Hassan,
Thank you for attending yesterday''s interview. We were impressed by your experience and communication skills. However, we have decided to offer the position to another candidate whose qualifications more closely match our current requirements.
We will keep your details on file and will contact you should a suitable vacancy arise.
Best wishes, The Recruitment Team"

What is the WRITER''S purpose?', '[{"id":"a","text":"To invite Mr Hassan to a second interview"},{"id":"b","text":"To offer Mr Hassan a different position immediately"},{"id":"c","text":"To inform Mr Hassan that he did not get the job, while leaving the door open"},{"id":"d","text":"To criticise Mr Hassan''s performance at the interview"}]'::jsonb, 'c', 'The email politely declines to offer Mr Hassan the position but says they will keep his details and contact him about future vacancies — rejecting him while leaving the door open. There is no invitation to a second interview, no immediate alternative offer, and the tone is positive about his skills, not critical.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
