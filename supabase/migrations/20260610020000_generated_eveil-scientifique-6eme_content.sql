...
- ⚠️ لا تخلط بين الكتلة (مادة ثابتة) والثقل (قوّة).', 8)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ العينُ تستقبلُ الضوءَ، لا تُصدرُه.', 9)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('50aead6a-3172-59e2-94b8-83b0eeab5a66', '2b3f3ebc-164e-551a-aac8-57ac330a531c', 'ما هو الثقل؟', '[{"id":"a","text":"قوّةُ جذب الأرض للأجسام"},{"id":"b","text":"لونُ الجسم"},{"id":"c","text":"حجمُ الجسم"},{"id":"d","text":"حرارةُ الجسم"}]'::jsonb, 'a', 'الثقلُ قوّةٌ تجذبُ بها الأرضُ الأجسامَ نحوها (نحو الأسفل).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e7601d7f-c809-5386-ba3e-7f3333bacf33', '2b3f3ebc-164e-551a-aac8-57ac330a531c', 'ما اتّجاهُ الثقل دائمًا؟', '[{"id":"a","text":"نحو الأسفل"},{"id":"b","text":"نحو الأعلى"},{"id":"c","text":"نحو اليمين"},{"id":"d","text":"في كلّ الاتّجاهات"}]'::jsonb, 'a', 'اتّجاهُ الثقل دائمًا نحو الأسفل (نحو مركز الأرض).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('58d591fe-2158-558e-a03f-b606e383cb98', '2b3f3ebc-164e-551a-aac8-57ac330a531c', 'ما الأداةُ التي نقيسُ بها الثقل؟', '[{"id":"a","text":"الدينامومتر (الميزان النابضيّ)"},{"id":"b","text":"المسطرة"},{"id":"c","text":"الترمومتر"},{"id":"d","text":"الساعة"}]'::jsonb, 'a', 'نقيسُ الثقلَ بالدينامومتر، وهو ميزانٌ نابضيٌّ يتمدّدُ نابضُه بقدر الثقل.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c23ef002-b497-5eb5-89ad-1547d242043d', '2b3f3ebc-164e-551a-aac8-57ac330a531c', 'لماذا تسقطُ الأجسامُ إلى الأرض عند تركها؟', '[{"id":"a","text":"بسبب جذب الأرض لها (الثقل)"},{"id":"b","text":"بسبب الرياح دائمًا"},{"id":"c","text":"لأنّها خفيفة"},{"id":"d","text":"بسبب الضوء"}]'::jsonb, 'a', 'تسقطُ الأجسامُ لأنّ الأرضَ تجذبُها نحوها بقوّة الثقل.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a0a8dbf0-54f2-5afd-8de0-89b822cdae73', '1e33a32a-5f87-5cca-83ce-6ea7d3423dcb', 'الثقلُ هو:', '[{"id":"a","text":"قوّةُ جذب الأرض للأجسام"},{"id":"b","text":"صوتُ الجسم"},{"id":"c","text":"لونُ الجسم"},{"id":"d","text":"رائحةُ الجسم"}]'::jsonb, 'a', 'الثقلُ قوّةُ جذبٍ تمارسُها الأرضُ على كلّ الأجسام.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0724bb22-0521-50eb-9114-ccade861f225', '1e33a32a-5f87-5cca-83ce-6ea7d3423dcb', 'اتّجاهُ الثقل هو:', '[{"id":"a","text":"نحو الأسفل"},{"id":"b","text":"نحو الأعلى"},{"id":"c","text":"أفقيٌّ نحو اليمين"},{"id":"d","text":"متغيّرٌ عشوائيًّا"}]'::jsonb, 'a', 'يتّجهُ الثقلُ دائمًا نحو الأسفل (نحو مركز الأرض).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6d344ac5-c956-50b5-a16c-38a4b71a087a', '1e33a32a-5f87-5cca-83ce-6ea7d3423dcb', 'بأيّ أداةٍ نقيسُ الثقل؟', '[{"id":"a","text":"الدينامومتر"},{"id":"b","text":"المسطرة"},{"id":"c","text":"الساعة"},{"id":"d","text":"الترمومتر"}]'::jsonb, 'a', 'الدينامومتر (الميزان النابضيّ) هو أداةُ قياس الثقل.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9224c225-bafd-5280-af8d-d03661027534', '1e33a32a-5f87-5cca-83ce-6ea7d3423dcb', 'بأيّ أداةٍ نقيسُ كتلةَ جسم؟', '[{"id":"a","text":"الميزان"},{"id":"b","text":"الدينامومتر"},{"id":"c","text":"المنقلة"},{"id":"d","text":"البوصلة"}]'::jsonb, 'a', 'نقيسُ الكتلةَ بالميزان، ووحدتُها الكيلوغرام.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e6ebd9af-a2cd-5000-88ad-e0e8bcc285d9', '271b1526-be79-5804-9478-e7fd732b9131', 'الثقلُ قوّةٌ مصدرُها:', '[{"id":"a","text":"جذبُ الأرض"},{"id":"b","text":"ضوءُ الشمس"},{"id":"c","text":"الرياح"},{"id":"d","text":"صوتُ الجسم"}]'::jsonb, 'a', 'الثقلُ ناتجٌ عن جذب الأرض للأجسام نحوها.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bcdc025c-8f7d-57a7-a0cd-5d67eecedc0a', '271b1526-be79-5804-9478-e7fd732b9131', 'ما وحدةُ قياس الثقل؟', '[{"id":"a","text":"النيوتن (N)"},{"id":"b","text":"الكيلوغرام"},{"id":"c","text":"المتر"},{"id":"d","text":"الثانية"}]'::jsonb, 'a', 'الثقلُ قوّةٌ، ووحدتُه النيوتن (N)؛ أمّا الكيلوغرام فوحدةُ الكتلة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0ba93b45-71f5-5fb5-bad9-b29b3d87ed4d', '6e200bc7-e58e-577c-baaf-55a949d2dd53', 'اتّجاهُ الثقل دائمًا:', '[{"id":"a","text":"نحو الأسفل"},{"id":"b","text":"نحو الأعلى"},{"id":"c","text":"نحو الشمال"},{"id":"d","text":"نحو الشمس"}]'::jsonb, 'a', 'الثقلُ يتّجهُ دائمًا نحو الأسفل (نحو مركز الأرض).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b67924e8-f021-5a78-94fb-f07b71c11f3c', '6e200bc7-e58e-577c-baaf-55a949d2dd53', 'الثقلُ هو:', '[{"id":"a","text":"قوّةُ جذب الأرض للجسم"},{"id":"b","text":"كمّيّةُ الضوء"},{"id":"c","text":"درجةُ الحرارة"},{"id":"d","text":"سرعةُ الجسم"}]'::jsonb, 'a', 'الثقلُ قوّةُ جذبٍ تمارسُها الأرضُ على الجسم نحو الأسفل.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('43fabd5a-a0ac-5f7a-9e35-1bb71f10cb8e', '6e200bc7-e58e-577c-baaf-55a949d2dd53', 'بمَ نقيسُ الثقل؟', '[{"id":"a","text":"الدينامومتر"},{"id":"b","text":"الميزان العاديّ"},{"id":"c","text":"المنقلة"},{"id":"d","text":"البوصلة"}]'::jsonb, 'a', 'نقيسُ الثقلَ بالدينامومتر (الميزان النابضيّ).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('959efeaa-7de0-53c8-9a9d-3860b0e20285', '6e200bc7-e58e-577c-baaf-55a949d2dd53', 'بمَ نقيسُ الكتلة؟', '[{"id":"a","text":"الميزان"},{"id":"b","text":"الدينامومتر"},{"id":"c","text":"الترمومتر"},{"id":"d","text":"المسطرة"}]'::jsonb, 'a', 'نقيسُ الكتلةَ بالميزان، ووحدتُها الكيلوغرام.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a749d251-5477-53f5-b091-3bcf82a0b1b8', '6e200bc7-e58e-577c-baaf-55a949d2dd53', 'ماذا يحدثُ لكرةٍ تُركت من اليد في الهواء؟', '[{"id":"a","text":"تسقطُ نحو الأسفل"},{"id":"b","text":"تصعدُ نحو الأعلى"},{"id":"c","text":"تبقى معلّقةً مكانَها"},{"id":"d","text":"تختفي"}]'::jsonb, 'a', 'بفعل الثقل تسقطُ الكرةُ نحو الأسفل إلى الأرض.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2b4e10b4-d65e-56d5-adc5-89b5bff33060', '8f161787-a898-59a5-8134-f42406e0d550', 'على أيّ مبدأٍ يعملُ الدينامومتر؟', '[{"id":"a","text":"تمدّدُ نابضٍ (زنبرك) بقدر ثقل الجسم المعلّق"},{"id":"b","text":"تغيّرُ لون الجسم"},{"id":"c","text":"دورانُ عقارب"},{"id":"d","text":"تبخّرُ الماء"}]'::jsonb, 'a', 'في الدينامومتر يتمدّدُ النابضُ بمقدارٍ يتناسبُ مع ثقل الجسم المعلّق به، فنقرأُ الثقل.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2540166d-cb24-5925-bdbf-ae3fdadfc00f', '8f161787-a898-59a5-8134-f42406e0d550', 'على سطح القمر يكونُ ثقلُ الجسم:', '[{"id":"a","text":"أقلَّ منه على الأرض"},{"id":"b","text":"أكبرَ منه على الأرض"},{"id":"c","text":"منعدمًا تمامًا"},{"id":"d","text":"هو نفسُه تمامًا"}]'::jsonb, 'a', 'جذبُ القمر أضعفُ من جذب الأرض، فيكونُ ثقلُ الجسم على القمر أقلّ.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('16800556-089a-5bdc-b7bc-8a29f80ae9fb', '8f161787-a898-59a5-8134-f42406e0d550', 'لماذا نمثّلُ الثقلَ بسهمٍ متّجهٍ إلى أسفل؟', '[{"id":"a","text":"لأنّ اتّجاهَه نحو الأرض (الأسفل)"},{"id":"b","text":"لأنّه يتّجهُ نحو السماء"},{"id":"c","text":"لأنّه أفقيّ"},{"id":"d","text":"لأنّه بلا اتّجاه"}]'::jsonb, 'a', 'الثقلُ قوّةٌ نحو الأسفل (نحو مركز الأرض)، فنمثّلُه بسهمٍ يشيرُ إلى أسفل.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('21d55777-f632-5727-8a77-9745a5395bc5', '8f161787-a898-59a5-8134-f42406e0d550', 'ما الذي يجعلُ ماءَ الشلّال ينزلُ إلى الأسفل؟', '[{"id":"a","text":"الثقل (جذب الأرض)"},{"id":"b","text":"الرياحُ فقط"},{"id":"c","text":"ضوءُ الشمس"},{"id":"d","text":"صوتُ الماء"}]'::jsonb, 'a', 'ينزلُ ماءُ الشلّال نحو الأسفل بفعل الثقل، أي جذب الأرض له.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2215f8f0-28c0-5c97-ad25-5f314b845415', '8f161787-a898-59a5-8134-f42406e0d550', 'جسمان على الأرض: الأوّلُ كتلتُه أكبرُ من الثاني. أيُّهما أكبرُ ثقلًا؟', '[{"id":"a","text":"الأكبرُ كتلةً"},{"id":"b","text":"الأصغرُ كتلةً"},{"id":"c","text":"لهما الثقلُ نفسُه دائمًا"},{"id":"d","text":"لا علاقةَ بين الكتلة والثقل"}]'::jsonb, 'a', 'كلّما زادت كتلةُ الجسم زاد ثقلُه على الأرض، فالأكبرُ كتلةً أكبرُ ثقلًا.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1154077d-d319-5347-8149-7de3436be35b', '0054979e-48e6-52da-920d-ddb26b045cf1', 'الثقلُ قوّةٌ تجذبُ الأجسامَ نحو:', '[{"id":"a","text":"الأسفل (الأرض)"},{"id":"b","text":"الأعلى (السماء)"},{"id":"c","text":"الجوانب"},{"id":"d","text":"الشمس"}]'::jsonb, 'a', 'الثقلُ يجذبُ الأجسامَ نحو الأسفل، أي نحو الأرض.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('544cd381-48fb-5c01-8580-258f563eb9d6', '0054979e-48e6-52da-920d-ddb26b045cf1', 'أداةُ قياس الثقل هي:', '[{"id":"a","text":"الدينامومتر"},{"id":"b","text":"الميزان العاديّ"},{"id":"c","text":"الترمومتر"},{"id":"d","text":"البوصلة"}]'::jsonb, 'a', 'نقيسُ الثقلَ بالدينامومتر (الميزان النابضيّ).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f73471ba-30c8-54d8-a0a6-3f7b3d3fdba5', '0054979e-48e6-52da-920d-ddb26b045cf1', 'أداةُ قياس الكتلة هي:', '[{"id":"a","text":"الميزان"},{"id":"b","text":"الدينامومتر"},{"id":"c","text":"المنقلة"},{"id":"d","text":"المسطرة"}]'::jsonb, 'a', 'نقيسُ الكتلةَ بالميزان، ووحدتُها الكيلوغرام.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('61fe56df-d6c8-5004-ab16-3d0c7ef09cc0', '0054979e-48e6-52da-920d-ddb26b045cf1', 'ما وحدةُ قياس الكتلة؟', '[{"id":"a","text":"الكيلوغرام"},{"id":"b","text":"النيوتن"},{"id":"c","text":"المتر"},{"id":"d","text":"اللتر"}]'::jsonb, 'a', 'وحدةُ الكتلة هي الكيلوغرام (كغ)؛ أمّا النيوتن فوحدةُ الثقل.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0fc01dc4-5ec8-522b-9a27-385299106c38', '0054979e-48e6-52da-920d-ddb26b045cf1', 'لماذا تنزلُ الأمطارُ نحو الأرض؟', '[{"id":"a","text":"بفعل الثقل (جذب الأرض)"},{"id":"b","text":"بفعل الضوء"},{"id":"c","text":"لأنّ الغيومَ تدفعُها للأعلى"},{"id":"d","text":"بفعل الصوت"}]'::jsonb, 'a', 'تسقطُ قطراتُ المطر نحو الأرض بفعل الثقل، أي جذب الأرض لها.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f778eee0-c790-5d2c-bcfc-96776ad15054', 'b6a7681c-91e3-54b4-803e-7962284147cd', 'العينُ هي عضوُ حاسّة:', '[{"id":"a","text":"البصر"},{"id":"b","text":"السمع"},{"id":"c","text":"الشمّ"},{"id":"d","text":"الذوق"}]'::jsonb, 'a', 'العينُ هي عضوُ حاسّة البصر التي نرى بها الأجسامَ والألوان.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('78d9e7ea-b59a-59f6-9b0e-ae8bf4caaeca', 'b6a7681c-91e3-54b4-803e-7962284147cd', 'من أيّ جزءٍ يدخلُ الضوءُ إلى العين؟', '[{"id":"a","text":"البؤبؤ"},{"id":"b","text":"العصب البصريّ"},{"id":"c","text":"الشبكيّة"},{"id":"d","text":"الجفن"}]'::jsonb, 'a', 'يدخلُ الضوءُ إلى العين عبر البؤبؤ (الفتحة السوداء وسط القزحيّة).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('61148198-06d4-573f-b8e0-a6099b256fe2', 'b6a7681c-91e3-54b4-803e-7962284147cd', 'أين تتكوّنُ صورةُ الأجسام داخل العين؟', '[{"id":"a","text":"على الشبكيّة"},{"id":"b","text":"على القرنيّة"},{"id":"c","text":"على الجفن"},{"id":"d","text":"على القزحيّة"}]'::jsonb, 'a', 'تتكوّنُ صورةُ الأجسام على الشبكيّة في مؤخّرة العين.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f60e2a21-9adf-5ad5-8889-25a2fd7d0502', 'b6a7681c-91e3-54b4-803e-7962284147cd', 'ما الذي ينقلُ الرسالةَ من العين إلى الدماغ؟', '[{"id":"a","text":"العصب البصريّ"},{"id":"b","text":"العدسة"},{"id":"c","text":"القرنيّة"},{"id":"d","text":"البؤبؤ"}]'::jsonb, 'a', 'العصبُ البصريُّ ينقلُ الرسالةَ من الشبكيّة إلى الدماغ فنُبصر.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3858e486-bf12-5765-9396-519120f10d1b', 'a42bdc73-186e-55b0-9d2c-81e5c7d80597', 'العينُ عضوٌ لـ:', '[{"id":"a","text":"الإبصار"},{"id":"b","text":"السمع"},{"id":"c","text":"التنفّس"},{"id":"d","text":"الهضم"}]'::jsonb, 'a', 'العينُ عضوُ الإبصار (حاسّة البصر).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a0f8dad8-cba3-54f1-bef3-022a72e05d38', 'a42bdc73-186e-55b0-9d2c-81e5c7d80597', 'ما الجزءُ الأماميُّ الشفّاف من العين؟', '[{"id":"a","text":"القرنيّة"},{"id":"b","text":"الشبكيّة"},{"id":"c","text":"العصب البصريّ"},{"id":"d","text":"البؤبؤ"}]'::jsonb, 'a', 'القرنيّةُ هي الغشاءُ الأماميُّ الشفّافُ للعين.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('594f1059-51c8-546e-8e4b-2aa02acad6ca', 'a42bdc73-186e-55b0-9d2c-81e5c7d80597', 'ما اسمُ الفتحة السوداء في وسط العين، التي يدخلُ منها الضوء؟', '[{"id":"a","text":"البؤبؤ (الحدقة)"},{"id":"b","text":"القرنيّة"},{"id":"c","text":"الشبكيّة"},{"id":"d","text":"العصب البصريّ"}]'::jsonb, 'a', 'البؤبؤ (الحدقة) هو الفتحةُ في وسط القزحيّة، ومنه يدخلُ الضوء.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ed764c79-7d80-59b7-b437-2cc5030b30a4', 'a42bdc73-186e-55b0-9d2c-81e5c7d80597', 'أين تتكوّنُ الصورةُ في العين؟', '[{"id":"a","text":"على الشبكيّة"},{"id":"b","text":"على القرنيّة"},{"id":"c","text":"على القزحيّة"},{"id":"d","text":"على الجفن"}]'::jsonb, 'a', 'تتكوّنُ الصورةُ على الشبكيّة في مؤخّرة العين.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9de8733e-7941-5942-83c6-49d7d12185c8', 'b62dfdd8-6431-5b94-ba86-dc4827008072', 'العينُ عضوُ حاسّة:', '[{"id":"a","text":"البصر"},{"id":"b","text":"اللمس"},{"id":"c","text":"الذوق"},{"id":"d","text":"الشمّ"}]'::jsonb, 'a', 'العينُ هي عضوُ حاسّة البصر، وبها نرى الأجسامَ والألوانَ والأشكال.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('60dad7b5-6fa7-56f4-a8c5-5c7cb0d920d9', 'b62dfdd8-6431-5b94-ba86-dc4827008072', 'من أين يدخلُ الضوءُ إلى العين؟', '[{"id":"a","text":"من البؤبؤ"},{"id":"b","text":"من العصب البصريّ"},{"id":"c","text":"من الشبكيّة"},{"id":"d","text":"من الجفن"}]'::jsonb, 'a', 'يدخلُ الضوءُ من البؤبؤ (الفتحة وسط القزحيّة).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('edb6be80-efb8-5740-a274-dff4c884074f', 'b62dfdd8-6431-5b94-ba86-dc4827008072', 'ما الذي يجمعُ الضوءَ داخل العين لتكوين صورةٍ واضحة؟', '[{"id":"a","text":"العدسة"},{"id":"b","text":"الجفن"},{"id":"c","text":"العصب البصريّ"},{"id":"d","text":"القزحيّة"}]'::jsonb, 'a', 'العدسةُ تجمعُ الضوءَ الداخلَ لتكوين صورةٍ واضحةٍ على الشبكيّة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('286ed54d-0cbf-54e2-ae9c-a6a7f7f9d591', 'b62dfdd8-6431-5b94-ba86-dc4827008072', 'أكملِ التسلسل: ضوءٌ ← بؤبؤ ← عدسة ← ...؟', '[{"id":"a","text":"الشبكيّة (ثمّ العصب البصريّ)"},{"id":"b","text":"القرنيّة"},{"id":"c","text":"الجفن"},{"id":"d","text":"خارج العين"}]'::jsonb, 'a', 'بعد العدسة تتكوّنُ الصورةُ على الشبكيّة، ثمّ ينقلُها العصبُ البصريّ إلى الدماغ.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4e77bff5-505f-5e30-89be-4d82fcfd6f8e', 'b62dfdd8-6431-5b94-ba86-dc4827008072', 'ما الذي ينقلُ الرسالةَ البصريّةَ إلى الدماغ؟', '[{"id":"a","text":"العصب البصريّ"},{"id":"b","text":"العدسة"},{"id":"c","text":"البؤبؤ"},{"id":"d","text":"القرنيّة"}]'::jsonb, 'a', 'العصبُ البصريُّ ينقلُ الرسالةَ من الشبكيّة إلى الدماغ.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d3f9ff06-c2c7-5dd7-82ef-bd0a733ec2c6', '96302446-dd68-562d-bc70-7940d5935052', 'ما العضوُ المسؤولُ عن الإبصار؟', '[{"id":"a","text":"العين"},{"id":"b","text":"الأذن"},{"id":"c","text":"الأنف"},{"id":"d","text":"اللسان"}]'::jsonb, 'a', 'العينُ هي العضوُ المسؤولُ عن الإبصار (حاسّة البصر).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('445e5317-752b-5994-aefc-e00ac72043c2', '96302446-dd68-562d-bc70-7940d5935052', 'ما دورُ العدسة في العين؟', '[{"id":"a","text":"جمعُ الضوء لتكوين صورة"},{"id":"b","text":"نقلُ الرسالة إلى الدماغ"},{"id":"c","text":"حمايةُ العين من الغبار"},{"id":"d","text":"إصدارُ الضوء"}]'::jsonb, 'a', 'تجمعُ العدسةُ الضوءَ الداخلَ إلى العين لتكوين صورةٍ واضحةٍ على الشبكيّة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('559a0a71-4537-565d-890e-8bbc27fee6a7', '96302446-dd68-562d-bc70-7940d5935052', 'أين تتكوّنُ صورةُ الأجسام؟', '[{"id":"a","text":"على الشبكيّة"},{"id":"b","text":"على القزحيّة"},{"id":"c","text":"على الجفن"},{"id":"d","text":"على القرنيّة"}]'::jsonb, 'a', 'تتكوّنُ الصورةُ على الشبكيّة في مؤخّرة العين.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('aa8b2aae-b7ba-552e-8fc8-578493a4a278', '96302446-dd68-562d-bc70-7940d5935052', 'كيف نحافظُ على سلامة العين؟', '[{"id":"a","text":"إضاءةٌ كافية وعدمُ الاقتراب من الشاشات"},{"id":"b","text":"النظرُ إلى الشمس مباشرةً"},{"id":"c","text":"القراءةُ في الظلام"},{"id":"d","text":"تقريبُ الكتاب جدًّا من العين"}]'::jsonb, 'a', 'نحمي العينَ بإضاءةٍ كافيةٍ وبالابتعاد المناسب عن الشاشات وعدم النظر للشمس مباشرة.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('99023dd2-5b75-528d-bf29-49c8e9adc16f', '96302446-dd68-562d-bc70-7940d5935052', 'نرى الأجسامَ لأنّ العينَ:', '[{"id":"a","text":"تستقبلُ الضوءَ المنعكسَ عنها"},{"id":"b","text":"تُصدرُ ضوءًا نحوها"},{"id":"c","text":"تلمسُها عن بعد"},{"id":"d","text":"تسمعُ صوتَها"}]'::jsonb, 'a', 'العينُ تستقبلُ الضوءَ المنعكسَ عن الأجسام، ولا تُصدرُ ضوءًا.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1cdc49db-9396-5dd5-8d53-5989d560c625', '91498677-36e3-51c3-9196-fac9b6705f1a', 'ما دورُ العصب البصريّ؟', '[{"id":"a","text":"نقلُ الرسالة البصريّة إلى الدماغ"},{"id":"b","text":"جمعُ الضوء"},{"id":"c","text":"تلوينُ العين"},{"id":"d","text":"إفرازُ الدموع"}]'::jsonb, 'a', 'العصبُ البصريُّ ينقلُ الرسالةَ من الشبكيّة إلى الدماغ حيث تُدرَكُ الصورة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('91dc2be8-c0a1-5259-8fba-62f965af4181', 'ea014475-8628-5998-8d3b-010690177228', 'العينُ عضوُ حاسّة:', '[{"id":"a","text":"البصر"},{"id":"b","text":"السمع"},{"id":"c","text":"الشمّ"},{"id":"d","text":"اللمس"}]'::jsonb, 'a', 'العينُ عضوُ حاسّة البصر التي نُدركُ بها صورَ العالم من حولنا.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6083bb95-1e30-5c0f-b33b-ef96563341d2', 'ea014475-8628-5998-8d3b-010690177228', 'من أين يدخلُ الضوءُ إلى العين؟', '[{"id":"a","text":"البؤبؤ"},{"id":"b","text":"الشبكيّة"},{"id":"c","text":"العصب البصريّ"},{"id":"d","text":"الجفن"}]'::jsonb, 'a', 'يدخلُ الضوءُ عبر البؤبؤ (الفتحة وسط القزحيّة).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('324b1dd7-0a3b-5e32-9114-4ba17dd49e73', 'ea014475-8628-5998-8d3b-010690177228', 'ما الجزءُ الملوّنُ في العين؟', '[{"id":"a","text":"القزحيّة"},{"id":"b","text":"الشبكيّة"},{"id":"c","text":"العدسة"},{"id":"d","text":"القرنيّة"}]'::jsonb, 'a', 'القزحيّةُ هي الجزءُ الملوّنُ من العين، ويتوسّطُها البؤبؤ.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('eef3a4ae-0f63-5def-8fc8-51265c64d054', 'ea014475-8628-5998-8d3b-010690177228', 'أين تتكوّنُ الصورةُ في العين؟', '[{"id":"a","text":"على الشبكيّة"},{"id":"b","text":"على القرنيّة"},{"id":"c","text":"على القزحيّة"},{"id":"d","text":"على الجفن"}]'::jsonb, 'a', 'تتكوّنُ صورةُ الأجسام على الشبكيّة في مؤخّرة العين.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1d246c5f-088e-53c0-893a-a72f5fec6956', 'ea014475-8628-5998-8d3b-010690177228', 'ما الذي ينقلُ الإشارةَ من العين إلى الدماغ؟', '[{"id":"a","text":"العصب البصريّ"},{"id":"b","text":"العدسة"},{"id":"c","text":"القرنيّة"},{"id":"d","text":"البؤبؤ"}]'::jsonb, 'a', 'العصبُ البصريُّ ينقلُ الإشارةَ من الشبكيّة إلى الدماغ فنُبصر.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
