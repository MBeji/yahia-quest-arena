...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6143b8f2-695a-5943-a326-804ad37bfa5a', '149ff0b0-1897-54bd-ba40-c6a6b26c8655', 'أذبنا سكّرًا في كأس ماء فاختفى عن العين. ماذا حدث للسكّر؟', '[{"id":"a","text":"زال السكّر نهائيًّا ولم يعد له وجود"},{"id":"b","text":"تحوّل السكّر إلى ماء"},{"id":"c","text":"توزّع السكّر في الماء ويمكن استرجاعه بتبخير الماء"},{"id":"d","text":"تصاعد السكّر في الهواء على شكل بخار"}]'::jsonb, 'c', 'المذاب لا يزول عند الذوبان، بل يتوزّع في الماء على شكل جسيمات دقيقة؛ ويمكن استرجاعه جافًّا بتبخير الماء، والكتلة محفوظة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5c3adcb5-8444-5204-9cc0-709403bee79e', '149ff0b0-1897-54bd-ba40-c6a6b26c8655', 'واصل تلميذ إضافة الملح إلى كأس ماء إلى أن بقي فائض من الملح مستقرًّا في القاع لا يذوب مهما حرّك. ماذا نسمّي هذا المحلول؟', '[{"id":"a","text":"محلول مشبع"},{"id":"b","text":"خليط غير متجانس دائمًا"},{"id":"c","text":"ماء نقيّ"},{"id":"d","text":"محلول منصهر"}]'::jsonb, 'a', 'عند بلوغ الحدّ الأقصى للذوبان، لا يذوب الفائض ويتراكم في القاع، فيصبح المحلول مشبعًا؛ والتحريك يُسرّع الذوبان فقط ولا يزيد الكمّية القصوى.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2a847e44-2edd-5c07-abb0-e027eaa9245a', '3d93c7c8-42e0-565b-9e1a-69df1ed5c2bb', 'في محلول مكوّن من ماء وسكّر مذاب، ما هو المذيب؟', '[{"id":"a","text":"السكّر"},{"id":"b","text":"الملح"},{"id":"c","text":"الماء"},{"id":"d","text":"الهواء"}]'::jsonb, 'c', 'المذيب هو السائل الذي يُذيب المذاب؛ وهنا الماء هو الذي يُذيب السكّر، فالماء هو المذيب.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('11c5289a-2979-59b0-9c63-55ceb3b483fb', '3d93c7c8-42e0-565b-9e1a-69df1ed5c2bb', 'ما اسم الجسم الذي يذوب فيختفي عن العين داخل المذيب؟', '[{"id":"a","text":"المذيب"},{"id":"b","text":"المحلول"},{"id":"c","text":"الراسب"},{"id":"d","text":"المذاب"}]'::jsonb, 'd', 'المذاب هو الجسم الذي يذوب ويختفي عن العين المجرّدة داخل المذيب، مثل السكّر أو الملح في الماء.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8f22107e-5463-51c4-9cb8-012dad188be3', '2e174a23-9d42-58db-82c4-65bc22e0eb5b', 'أذاب تلميذ 15 g من السكّر في 135 g من الماء ذوبانًا تامًّا، ثمّ بدأ يبخّر جزءًا من الماء. ما مجموع كتلة (المحلول المتبقّي + بخار الماء المتصاعد)؟', '[{"id":"a","text":"135 g"},{"id":"b","text":"15 g"},{"id":"c","text":"75 g"},{"id":"d","text":"150 g"}]'::jsonb, 'd', 'الكتلة محفوظة: كتلة المحلول الأصلي = 135 g + 15 g = 150 g؛ وعند التبخير لا تُفقد كتلة بل تنتقل جزئيًّا إلى البخار، فمجموع (المحلول المتبقّي + البخار المتصاعد) يبقى 150 g.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('70e355d3-bf51-5488-a04d-f979e3ade1c3', '43e62201-c1fd-557c-95be-8360c855b0f8', 'ما اسم السائل الصافي الذي يمرّ عبر ورقة الترشيح؟', '[{"id":"a","text":"الراسب"},{"id":"b","text":"المذاب"},{"id":"c","text":"المقطّر"},{"id":"d","text":"الراشح"}]'::jsonb, 'd', 'السائل الصافي النافذ عبر مسامّ ورقة الترشيح يُسمّى الراشح؛ أمّا الراسب فهو الجسم الصلب المستقرّ في القاع بعد الترسيب.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7538d4ed-478d-573f-bb59-df41793a4d91', '0f13b6c8-9891-5c2b-8604-008b188405c2', 'بماذا يختلف التبخير عن التقطير؟', '[{"id":"a","text":"التبخير يسترجع الجسم الصلب المذاب ويهدر الماء، والتقطير يسترجع الماء النقيّ"},{"id":"b","text":"التبخير لغير المتجانس والتقطير للمتجانس"},{"id":"c","text":"التبخير يستعمل مغنطيسًا والتقطير يستعمل ورقة ترشيح"},{"id":"d","text":"لا فرق بينهما فكلاهما يعطي النتيجة نفسها"}]'::jsonb, 'a', 'كلاهما لخليط متجانس ويعتمد التسخين، لكنّ التبخير يترك الماء يتصاعد فنسترجع المذاب فقط، بينما التقطير يبرّد البخار في مبرّد فيتكاثف ونسترجع الماء النقيّ.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9767a970-8040-5d5f-a7dc-cabacc99d548', '0f13b6c8-9891-5c2b-8604-008b188405c2', 'لاسترجاع ملح الطعام من ماء البحر في المِلّاحات، أيّ ظاهرة تُستغلّ؟', '[{"id":"a","text":"الترشيح عبر ورقة"},{"id":"b","text":"تبخّر الماء بفعل الشمس والحرارة ليبقى الملح"},{"id":"c","text":"الفرز المغناطيسي للملح"},{"id":"d","text":"التعقيم بالكلور"}]'::jsonb, 'b', 'في المِلّاحات يتبخّر ماء البحر بفعل الشمس والحرارة فيبقى ملح الطعام؛ هذا تطبيق مباشر للتبخير الذي يسترجع الجسم الصلب المذاب.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b6f3e895-7b43-5493-9105-2f71093dfc85', '13059654-9eb4-5020-932c-4b5b4026fc0d', 'أيّ وحدة من الوحدات التالية تصلح للتعبير عن الكتلة الحجمية؟', '[{"id":"a","text":"g/cm³"},{"id":"b","text":"cm³"},{"id":"c","text":"g"},{"id":"d","text":"°C"}]'::jsonb, 'a', 'الكتلة الحجمية = كتلة/حجم، فوحدتها تجمع بين وحدة كتلة وحدة حجم: g/cm³ (أو kg/m³). أمّا cm³ فوحدة حجم و g وحدة كتلة و °C وحدة درجة حرارة.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('77af8d7e-371d-580e-b8e2-e37e07040598', '13059654-9eb4-5020-932c-4b5b4026fc0d', 'كم يساوي 1 mL بوحدة السنتيمتر المكعّب؟', '[{"id":"a","text":"1 cm³"},{"id":"b","text":"10 cm³"},{"id":"c","text":"1000 cm³"},{"id":"d","text":"0.1 cm³"}]'::jsonb, 'a', 'المِلّيلتر والسنتيمتر المكعّب متساويان تمامًا: 1 mL = 1 cm³. لهذا نقرأ حجم الجسم المغمور بالمِلّيلتر أو بالسنتيمتر المكعّب دون فرق.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2c292172-c3e9-5e2e-b0a0-842d9e4dc728', 'b2fb5e28-2fa3-5d7a-b22e-c6b1d3c981d7', 'كم يساوي 1 kg بوحدة الغرام؟', '[{"id":"a","text":"100 g"},{"id":"b","text":"10 g"},{"id":"c","text":"1000 g"},{"id":"d","text":"1 g"}]'::jsonb, 'c', 'الكيلوغرام يساوي ألف غرام: 1 kg = 1000 g. لذلك للتحويل من الكيلوغرام إلى الغرام نضرب في 1000.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4bd9d48b-dc39-5060-9379-7114100efd8c', '9e5504c1-2f9f-57f3-86a2-893643000aba', 'قطعة زجاج كتلتها الحجمية ρ = 2.5 g/cm³ وحجمها V = 8 cm³. ما كتلتها m؟', '[{"id":"a","text":"3.2 g"},{"id":"b","text":"20 g"},{"id":"c","text":"10.5 g"},{"id":"d","text":"2.5 g"}]'::jsonb, 'b', 'من العلاقة ρ = m/V نستنتج m = ρ × V = 2.5 × 8 = 20 g. الرقم 3.2 ناتج عن قسمة V على ρ، و10.5 عن جمع ρ + V.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5a13c6c8-120c-5f60-8873-75ad70591caf', '9e5504c1-2f9f-57f3-86a2-893643000aba', 'غمر حاتم قطعة حديد كتلتها 79 g في مخبار مدرّج، فارتفع مستوى الماء من 10 cm³ إلى 20 cm³. ما كتلتها الحجمية؟', '[{"id":"a","text":"7.9 g/cm³"},{"id":"b","text":"3.95 g/cm³"},{"id":"c","text":"2.63 g/cm³"},{"id":"d","text":"0.13 g/cm³"}]'::jsonb, 'a', 'أوّلًا حجم القطعة بالإزاحة: V = 20 − 10 = 10 cm³. ثمّ ρ = m/V = 79/10 = 7.9 g/cm³. الخطأ 3.95 يأتي من استعمال V2 = 20 دون طرح، و2.63 من استعمال V1 + V2 = 30.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fd2c873d-3efa-5152-9428-bc43f56776c9', '9e5504c1-2f9f-57f3-86a2-893643000aba', 'كتلة حجمية لمادّة تساوي ρ = 2.7 g/cm³. كم تساوي بوحدة kg/m³؟', '[{"id":"a","text":"27 kg/m³"},{"id":"b","text":"2.7 kg/m³"},{"id":"c","text":"0.0027 kg/m³"},{"id":"d","text":"2700 kg/m³"}]'::jsonb, 'd', 'للتحويل من g/cm³ إلى kg/m³ نضرب في 1000: 2.7 × 1000 = 2700 kg/m³. لذلك 1 g/cm³ = 1000 kg/m³.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fc862229-f738-5939-8684-b1c1b2069b29', 'd25076ee-aee5-5de8-95c9-e16ba669eca2', 'لتعيين حجم مفتاح معدني غير منتظم الشكل، أيّ طريقة نستعمل؟', '[{"id":"a","text":"نزنه بالميزان"},{"id":"b","text":"نقيس طوله بالمسطرة فقط"},{"id":"c","text":"نقيس درجة حرارته بمقياس الحرارة"},{"id":"d","text":"طريقة الإزاحة: نغمره في مخبار مدرّج ونقرأ ارتفاع الماء"}]'::jsonb, 'd', 'الجسم الصلب غير المنتظم يُقاس حجمه بطريقة الإزاحة: حجمه = V2 − V1 (فرق مستوى الماء بعد الغمر وقبله). الميزان يقيس الكتلة لا الحجم.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('650a7239-f331-51fa-9e34-32ffed907b29', 'd25076ee-aee5-5de8-95c9-e16ba669eca2', 'كم يساوي 1 L بوحدة السنتيمتر المكعّب؟', '[{"id":"a","text":"100 cm³"},{"id":"b","text":"1000 cm³"},{"id":"c","text":"10 cm³"},{"id":"d","text":"1000000 cm³"}]'::jsonb, 'b', '1 L = 1000 mL، وبما أنّ 1 mL = 1 cm³ فإنّ 1 L = 1000 cm³. أمّا 1000000 cm³ فهو حجم متر مكعّب واحد (1 m³).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7e0394c6-f8d8-5be8-8acd-aca9088f34b7', 'd25076ee-aee5-5de8-95c9-e16ba669eca2', 'قطعة معدنية كتلتها m = 48 g وحجمها V = 6 cm³. ما كتلتها الحجمية؟', '[{"id":"a","text":"0.125 g/cm³"},{"id":"b","text":"288 g/cm³"},{"id":"c","text":"8 g/cm³"},{"id":"d","text":"42 g/cm³"}]'::jsonb, 'c', 'ρ = m/V = 48/6 = 8 g/cm³. الرقم 0.125 من قلب النسبة V/m، و288 من الضرب m × V، و42 من الطرح m − V.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('31cb9e0a-2b13-517d-b7f0-9272f2132429', 'd25076ee-aee5-5de8-95c9-e16ba669eca2', 'صبّت نجاة عسلًا كتلته الحجمية ρ = 1.3 g/cm³ في كأس ماء (ρ الماء = 1 g/cm³). ماذا يحدث للعسل؟', '[{"id":"a","text":"يرسب لأنّ كتلته الحجمية أكبر من كتلة الماء الحجمية"},{"id":"b","text":"يطفو لأنّ كتلته الحجمية 1.3 g/cm³ أكبر من 1 g/cm³"},{"id":"c","text":"يطفو دائمًا لأنّه سائل مثل الماء"},{"id":"d","text":"يبقى معلّقًا في منتصف الكأس"}]'::jsonb, 'a', 'كتلة العسل الحجمية 1.3 g/cm³ أكبر من كتلة الماء الحجمية 1 g/cm³، فيرسب إلى قاع الكأس. الرسوب يحدث عندما تكون الكتلة الحجمية للجسم أكبر من كتلة الماء الحجمية.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('57fba02d-8ab7-51e3-bf84-3cecbfa128b4', '6f2168ac-8732-5d94-ac82-a03f5a49fe84', 'سبيكة كتلتها m = 64 g وحجمها V = 8 cm³. ما كتلتها الحجمية؟', '[{"id":"a","text":"8 g/cm³"},{"id":"b","text":"0.125 g/cm³"},{"id":"c","text":"512 g/cm³"},{"id":"d","text":"72 g/cm³"}]'::jsonb, 'a', 'ρ = m/V = 64/8 = 8 g/cm³. الرقم 0.125 من قلب النسبة V/m، و512 من الضرب m × V، و72 من الجمع m + V.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('253e4efa-383f-5e13-a984-8adeb1f3a4c5', '6f2168ac-8732-5d94-ac82-a03f5a49fe84', 'صبّ عامل في معمل زيت 200 cm³ من الزيت (ρ = 0.9 g/cm³) في قارورة. ما كتلة هذا الزيت؟', '[{"id":"a","text":"222 g"},{"id":"b","text":"180 g"},{"id":"c","text":"200.9 g"},{"id":"d","text":"0.0045 g"}]'::jsonb, 'b', 'm = ρ × V = 0.9 × 200 = 180 g. الخطأ 222 ناتج عن قسمة V على ρ بدل الضرب.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f927dc22-31e4-5d0c-a788-14ef07429cdc', '6f2168ac-8732-5d94-ac82-a03f5a49fe84', 'جسم كتلته m = 140 g وحجمه V = 100 cm³. هل يطفو فوق الماء أم يرسب؟', '[{"id":"a","text":"يطفو ; كتلته الحجمية 1.4 g/cm³ أصغر من 1 g/cm³"},{"id":"b","text":"يبقى معلّقًا في منتصف الماء"},{"id":"c","text":"يطفو لأنّ حجمه 100 cm³ كبير"},{"id":"d","text":"يرسب ; كتلته الحجمية 1.4 g/cm³ أكبر من كتلة الماء الحجمية"}]'::jsonb, 'd', 'ρ = m/V = 140/100 = 1.4 g/cm³، وهي أكبر من كتلة الماء الحجمية 1 g/cm³، فالجسم يرسب. القرار يعتمد على الكتلة الحجمية لا الحجم وحده.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8f197ba9-afb7-563d-a438-6a2882dd72ca', '6f2168ac-8732-5d94-ac82-a03f5a49fe84', 'كتلة حجمية لمعدن تساوي ρ = 8 g/cm³. كم تساوي بوحدة kg/m³؟', '[{"id":"a","text":"0.008 kg/m³"},{"id":"b","text":"8000 kg/m³"},{"id":"c","text":"80 kg/m³"},{"id":"d","text":"800 kg/m³"}]'::jsonb, 'b', 'للتحويل من g/cm³ إلى kg/m³ نضرب في 1000: 8 × 1000 = 8000 kg/m³، لأنّ 1 g/cm³ = 1000 kg/m³.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('af653de9-33ac-5907-906b-f5dee8afcee3', '40d77d53-30ce-54a0-ac62-242df9edfa69', 'صخرة كتلتها m = 1500 g وحجمها V = 500 cm³. ما كتلتها الحجمية؟', '[{"id":"a","text":"0.33 g/cm³"},{"id":"b","text":"2000 g/cm³"},{"id":"c","text":"750000 g/cm³"},{"id":"d","text":"3 g/cm³"}]'::jsonb, 'd', 'ρ = m/V = 1500/500 = 3 g/cm³. الرقم 0.33 من قلب النسبة V/m، و2000 من الجمع m + V، و750000 من الضرب m × V.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('61c036b0-210f-506c-82dd-1adacf13e97c', '40d77d53-30ce-54a0-ac62-242df9edfa69', 'جسم متجانس كتلته m = 250 g وحجمه V = 250 cm³. احسب كتلته الحجمية وحدّد سلوكه في الماء.', '[{"id":"a","text":"ρ = 1 g/cm³ ; يبقى معلّقًا لأنّها تساوي كتلة الماء الحجمية"},{"id":"b","text":"ρ = 1 g/cm³ ; يرسب حتمًا إلى القاع"},{"id":"c","text":"ρ = 0.5 g/cm³ ; يطفو"},{"id":"d","text":"ρ = 250 g/cm³ ; يرسب"}]'::jsonb, 'a', 'ρ = m/V = 250/250 = 1 g/cm³، وهي تساوي تمامًا كتلة الماء الحجمية، فيبقى الجسم معلّقًا داخل الماء (لا يطفو ولا يرسب). هذه هي الحالة الوسطى بين الطفو والرسوب.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cd1e8e59-dd67-538d-98c3-2638008ff68c', '72d7c61e-fe6b-56cb-8a12-f258d0e040f6', 'أيّ مادّة من التالية عازلة لا تسمح بمرور التيّار الكهربائي؟', '[{"id":"a","text":"النحاس"},{"id":"b","text":"الحديد"},{"id":"c","text":"الخشب الجافّ"},{"id":"d","text":"الماء الذي يحوي أملاحًا مذابة"}]'::jsonb, 'c', 'الخشب الجافّ مادّة عازلة تمنع مرور التيّار. النحاس والحديد معدنان ناقلان، والماء الذي يحوي أملاحًا مذابة ناقل أيضًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fc191a28-350f-5797-91b0-dc17fc2bef70', '644691d8-3ac3-5057-bacf-7ed7e4a5bc23', 'ما اسم العنصر الذي يتحكّم في فتح الدارة الكهربائية أو غلقها عن قصد؟', '[{"id":"a","text":"المولّد"},{"id":"b","text":"القاطع"},{"id":"c","text":"المصباح"},{"id":"d","text":"سلك التوصيل"}]'::jsonb, 'b', 'القاطع (المفتاح) هو العنصر الذي يتحكّم عن قصد في فتح الدارة أو غلقها: يغلقها فيجري التيّار، أو يفتحها فيتوقّف.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('10a19083-6cba-5056-b5f7-3c06ac8405fe', '592d8f4e-40c2-577c-b1d3-4622b6586c88', 'ركّبت هالة مصباحَين على فرعَين منفصلَين بين نقطتَي تفرّع مشتركتَين مع المولّد. ما اسم هذا التركيب؟', '[{"id":"a","text":"التركيب بالتفرّع"},{"id":"b","text":"التركيب بالتسلسل"},{"id":"c","text":"الدارة القصيرة"},{"id":"d","text":"الدارة المفتوحة"}]'::jsonb, 'a', 'توصيل المصابيح على فروع منفصلة بين نقطتَي تفرّع مشتركتَين هو تعريف التركيب بالتفرّع، حيث يجد التيّار عدّة مسارات ولكلّ مصباح فرعه الخاصّ.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fc0e0d5c-95c6-57a4-ad40-95c3cd0cef49', 'bce0b1fc-b545-599b-9e55-e7a4f52697eb', 'في تركيب بالتفرّع بمصباحَين على فرعَين، نزع خالد مصباح الفرع الأوّل. كيف يكون سلوك مصباح الفرع الثاني؟', '[{"id":"a","text":"ينطفئ لأنّ الدارة كلّها أصبحت مفتوحة"},{"id":"b","text":"يتوقّف المولّد عن العمل"},{"id":"c","text":"يضيء لثوانٍ ثمّ ينطفئ نهائيًّا"},{"id":"d","text":"يبقى مضيئًا عادةً لأنّ فرعه دارة مغلقة مستقلّة"}]'::jsonb, 'd', 'نزع مصباح فرع في التفرّع يفتح ذلك الفرع وحده، بينما يبقى الفرع الثاني دارة مغلقة مستقلّة، فيظلّ مصباحه مضيئًا عادةً. هذا هو الفرق الجوهري عن التسلسل.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('08f73ec8-f95b-5f30-a510-1eda3a29c5cc', 'bce0b1fc-b545-599b-9e55-e7a4f52697eb', 'لماذا تُغلَّف أسلاك التوصيل النحاسية بطبقة من البلاستيك؟', '[{"id":"a","text":"لأنّ البلاستيك ناقل أفضل من النحاس"},{"id":"b","text":"لزيادة عدد المصابيح التي تعمل"},{"id":"c","text":"لأنّ البلاستيك عازل يمنع وصول التيّار إلى يد من يمسك السلك"},{"id":"d","text":"لتحويل التركيب من تسلسل إلى تفرّع"}]'::jsonb, 'c', 'اللبّ النحاسي ناقل ينقل التيّار، ويُغلَّف بالبلاستيك العازل لمنع التيّار من الوصول إلى يد من يمسك السلك، فتُضمَن السلامة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ffee084f-1a4c-57e5-889c-d5a95984cdcd', '3aa750a3-e085-512c-af1e-00573ae9b8f2', 'ركّبت مهندسة مصباحَين متماثلَين مرّة بالتسلسل ومرّة بالتفرّع بالمولّد نفسه، وسجّلت: (تركيب 1) عند نزع مصباح ينطفئ الآخر وإضاءة كلّ مصباح ضعيفة؛ (تركيب 2) عند نزع مصباح يبقى الآخر مضيئًا بكامل شدّته. ما التركيبان بالترتيب؟', '[{"id":"a","text":"تركيب 1 بالتفرّع، وتركيب 2 بالتسلسل"},{"id":"b","text":"تركيب 1 بالتسلسل، وتركيب 2 بالتفرّع"},{"id":"c","text":"كلاهما بالتسلسل"},{"id":"d","text":"كلاهما بالتفرّع"}]'::jsonb, 'b', 'الترابط في المصير (نزع مصباح يطفئ الآخر) والإضاءة الأضعف علامتا التسلسل، فتركيب 1 بالتسلسل؛ واستقلال الفروع (بقاء الآخر مضيئًا بكامل شدّته) علامة التفرّع، فتركيب 2 بالتفرّع.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('92a509e3-d02f-57ad-897c-9a16e44189a3', '3aa750a3-e085-512c-af1e-00573ae9b8f2', 'أيّ العبارات الأربع التالية هي **الصحيحة الوحيدة** بخصوص التركيبَين؟', '[{"id":"a","text":"في التسلسل يبقى المصباح السليم مضيئًا عند احتراق مصباح آخر في الحلقة نفسها"},{"id":"b","text":"في التفرّع تضيء المصابيح أضعف من مصباح وحيد مماثل بالمولّد نفسه"},{"id":"c","text":"زيادة عدد المصابيح المتسلسلة تُضعف إضاءة كلّ واحد منها، بينما في التفرّع يعمل كلّ فرع باستقلال بكامل شدّته"},{"id":"d","text":"قاطع واحد على فرع في التفرّع يطفئ كلّ مصابيح الدارة"}]'::jsonb, 'c', 'الصحيحة الوحيدة هي (ج). العبارات الأخرى خاطئة: في التسلسل ينطفئ الجميع بعطب واحد لا يبقى السليم مضيئًا؛ وفي التفرّع تضيء المصابيح بكامل شدّتها (أقوى لا أضعف)؛ وقاطع فرع واحد يطفئ مصباح فرعه وحده لا الكلّ.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7a87cda9-e3b8-57d9-9b3c-4cf477794e51', '70946f62-dfe4-50c4-bc18-420950be7f1a', 'دارتان بالمولّد نفسه: الأولى مصباحان بالتسلسل، والثانية مصباحان بالتفرّع. أيّ مقارنة لإضاءة كلّ مصباح صحيحة؟', '[{"id":"a","text":"مصابيح التسلسل تضيء أقوى من مصابيح التفرّع"},{"id":"b","text":"مصابيح التفرّع تضيء أقوى، لأنّ كلّ مصباح يعمل على فرعه المستقلّ بكامل شدّته"},{"id":"c","text":"الإضاءة متساوية تمامًا في التركيبَين"},{"id":"d","text":"لا تضيء أيّ مصابيح في التركيبَين"}]'::jsonb, 'b', 'في التفرّع يعمل كلّ مصباح بكامل شدّته على فرعه المستقلّ، بينما في التسلسل يتقاسم المصباحان الطاقة نفسها فيضيء كلّ منهما أضعف؛ لذلك مصابيح التفرّع أقوى إضاءة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8ec10b45-5e16-5f52-a45d-74b2afdba4ab', '629df4c5-0d0d-5356-9fbf-5f379bcf3809', 'أيّ العبارات الأربع التالية هي **الوحيدة الصحيحة**؟', '[{"id":"a","text":"وضع مصباح على الجذع المشترك لتركيب بالتفرّع يجعل احتراقه يطفئ كلّ الفروع التي بعده"},{"id":"b","text":"الدارة القصيرة أكثر أمانًا من مرور التيّار عبر مستقبل"},{"id":"c","text":"في التسلسل يعمل كلّ مصباح باستقلال تامّ عن الآخرين"},{"id":"d","text":"الزجاج والخشب الجافّ ناقلان جيّدان في الدارات المتفرّعة فقط"}]'::jsonb, 'a', 'الصحيحة الوحيدة (أ): مصباح على الجذع المشترك يغذّي كلّ الفروع، فاحتراقه يقطع التيّار عنها جميعًا. الباقي خاطئ: الدارة القصيرة خطيرة لا آمنة؛ والاستقلال خاصّية التفرّع لا التسلسل؛ والزجاج والخشب الجافّ عازلان في كلّ الدارات.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9e8def54-2d94-537d-ba9c-9e174c3148ca', '16442953-9c4b-5c71-b160-33c82e680c6a', 'بأيّ حرف نرمز إلى شدّة التيّار الكهربائي؟', '[{"id":"a","text":"V"},{"id":"b","text":"I"},{"id":"c","text":"m"},{"id":"d","text":"T"}]'::jsonb, 'b', 'نرمز إلى شدّة التيّار الكهربائي بالحرف I. الحرف V يخصّ التوتّر، و m يخصّ الكتلة.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f0c4a753-1567-5ade-847d-8331025a2a0e', '16442953-9c4b-5c71-b160-33c82e680c6a', 'ما وحدة قيس شدّة التيّار الكهربائي؟', '[{"id":"a","text":"الغرام (g)"},{"id":"b","text":"الفولط (V)"},{"id":"c","text":"الأمبير (A)"},{"id":"d","text":"المتر (m)"}]'::jsonb, 'c', 'وحدة قيس شدّة التيّار هي الأمبير ورمزها A. الفولط (V) وحدة التوتّر، والغرام (g) وحدة الكتلة، والمتر (m) وحدة الطول.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dd294748-e29f-5453-8649-c6d586e6127d', '16442953-9c4b-5c71-b160-33c82e680c6a', 'كم يساوي 1 A بالمليأمبير؟', '[{"id":"a","text":"1000 mA"},{"id":"b","text":"100 mA"},{"id":"c","text":"10 mA"},{"id":"d","text":"1 mA"}]'::jsonb, 'a', 'المليأمبير مضاعِف جزئي للأمبير: 1 A = 1000 mA. للتحويل من A إلى mA نضرب في 1000.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b4393e85-f78a-5de0-814d-ea47ac08f07c', '16442953-9c4b-5c71-b160-33c82e680c6a', 'في دارة بالتسلسل، قرأ أمبيرمتر الشدّة 0.5 A عند نقطة معيّنة. ماذا نتوقّع أن يقرأ أمبيرمتر آخر عند نقطة أخرى من نفس الحلقة؟', '[{"id":"a","text":"أكبر من 0.5 A"},{"id":"b","text":"أقلّ من 0.5 A"},{"id":"c","text":"0.5 A، لأنّ الشدّة نفسها في كلّ نقاط التسلسل"},{"id":"d","text":"0 A"}]'::jsonb, 'c', 'في دارة بالتسلسل شدّة التيّار هي نفسها في كلّ النقاط، فالأمبيرمتر الثاني يقرأ 0.5 A أيضًا.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('51ae34f7-f5e3-54b9-88f8-0f5f4dcbd400', '80eb7153-04ea-50ca-9e89-7fd6343a4048', 'دارة متفرّعة إلى ثلاثة فروع، شدّاتها: I1 = 0.15 A ; I2 = 0.2 A ; I3 = 0.1 A. ما شدّة التيّار الرئيسي I؟', '[{"id":"a","text":"0.45 A"},{"id":"b","text":"0.2 A"},{"id":"c","text":"0.05 A"},{"id":"d","text":"0.15 A"}]'::jsonb, 'a', 'قانون العقد يُعمَّم على أيّ عدد من الفروع: I = I1 + I2 + I3 = 0.15 + 0.2 + 0.1 = 0.45 A. التيّار الرئيسي مجموع الفروع، فهو أكبر منها جميعًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('67706db9-c346-5641-b87c-b9ff1d33a68c', '714ec5f5-442b-59dd-8551-87f902aca9c3', 'حوّل الشدّة 120 mA إلى الأمبير.', '[{"id":"a","text":"0.12 A"},{"id":"b","text":"1.2 A"},{"id":"c","text":"12 A"},{"id":"d","text":"120000 A"}]'::jsonb, 'a', 'للتحويل من mA إلى A نقسم على 1000: 120 ÷ 1000 = 0.12 A. القيمة 1.2 A ناتجة عن القسمة على 100 بالخطأ.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1ee3cafa-014e-5894-8e47-c47c3a41e5ef', 'b8aea220-9c60-5d13-b11c-1165b8f1be90', 'تلميذ يعتقد أنّ الأمبيرمتر يُركّب بالتفرّع كي «يرى» التيّار دون أن يعترضه، وأنّ شدّة التيّار تنقص بعد كلّ مصباح في التسلسل. أيّ تصحيح صحيح لمعتقدَيه معًا؟', '[{"id":"a","text":"الأمبيرمتر يُركّب بالتسلسل ليمرّ التيّار من خلاله، وشدّة التيّار نفسها في كلّ نقاط التسلسل لا تنقص بعد المصباح"},{"id":"b","text":"الأمبيرمتر يُركّب بالتفرّع فعلًا، لكنّ الشدّة ثابتة في التسلسل"},{"id":"c","text":"الأمبيرمتر يُركّب بالتسلسل، لكنّ الشدّة تنقص فعلًا بعد كلّ مصباح"},{"id":"d","text":"المعتقدان صحيحان معًا ولا يحتاجان تصحيحًا"}]'::jsonb, 'a', 'المعتقدان خاطئان: الأمبيرمتر يُركّب بالتسلسل ليمرّ التيّار من خلاله (لا بالتفرّع)، وشدّة التيّار في التسلسل واحدة في كلّ النقاط ولا تنقص بعد المصباح (المصباح يحوّل الطاقة لا الشدّة).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e6cd7c28-c6cc-5dd6-ac90-1ffad838d8a1', 'b8aea220-9c60-5d13-b11c-1165b8f1be90', 'في دارة متفرّعة، قيست شدّة التيّار في فرعَيها: I1 = 0.4 A ; I2 = 0.4 A. ثمّ رُكّب أمبيرمتر في الجذع الرئيسي قبل نقطة التفرّع. ما القيمة المنتظرة، ولماذا؟', '[{"id":"a","text":"0.4 A، لأنّ الشدّة نفسها في الجذع كما في كلّ فرع"},{"id":"b","text":"0.8 A، لأنّ التيّار الرئيسي مجموع تيّارات الفروع (0.4 + 0.4)"},{"id":"c","text":"0 A، لأنّ الفرعين المتساويين يلغي أحدهما الآخر"},{"id":"d","text":"0.16 A، لأنّ الشدّة الرئيسية جذاء الفرعين"}]'::jsonb, 'b', 'الجذع الرئيسي يحمل مجموع تيّارات الفروع وفق قانون العقد: I = I1 + I2 = 0.4 + 0.4 = 0.8 A. الفرعان لا يلغي أحدهما الآخر، والشدّة الرئيسية ليست جذاءهما.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('28835fa8-35e9-5144-92ca-0ef9b61cff56', 'f2c69168-2631-575a-8c53-a077ade8ac39', 'دارة متفرّعة إلى ثلاثة فروع متطابقة تمامًا. قيس التيّار الرئيسي فوُجد 0.66 A. ما شدّة التيّار في كلّ فرع؟', '[{"id":"a","text":"0.33 A"},{"id":"b","text":"0.22 A"},{"id":"c","text":"0.66 A"},{"id":"d","text":"1.98 A"}]'::jsonb, 'b', 'الفروع الثلاثة متطابقة فينقسم التيّار الرئيسي بينها بالتساوي: كلّ فرع = 0.66 ÷ 3 = 0.22 A. نتحقّق: 0.22 × 3 = 0.66 A ✓. القيمة 1.98 A ناتجة عن الضرب في 3 بدل القسمة.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('62319a38-64b6-540b-a566-19c9e94473c0', 'f2c69168-2631-575a-8c53-a077ade8ac39', 'أيّ العبارات الأربع التالية عن قيس التيّار وتوزيعه هي **الخاطئة الوحيدة**؟', '[{"id":"a","text":"إشارة سالبة على أمبيرمتر رقمي تعني أنّ قطبَيه مركّبان بالمقلوب، والشدّة الفعلية هي القيمة المطلقة"},{"id":"b","text":"في التسلسل، إضافة مصباح تُنقص الشدّة في كامل الدارة مع بقائها موحّدة في كلّ نقطة"},{"id":"c","text":"قانون العقد يُعمَّم إلى أيّ عدد من الفروع: I = I1 + I2 + I3 + ..."},{"id":"d","text":"في التفرّع، شدّة كلّ فرع تساوي شدّة التيّار الرئيسي كاملةً"}]'::jsonb, 'd', 'الخاطئة هي (ج): في التفرّع ينقسم التيّار الرئيسي بين الفروع، فشدّة كلّ فرع أصغر من الرئيسي لا مساوية له. الباقي صحيح: الإشارة السالبة تعني قلب القطبين، وإضافة مصباح بالتسلسل تُنقص الشدّة الموحّدة، وقانون العقد يُعمَّم إلى أيّ عدد من الفروع.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('93011218-bb20-56b3-aedd-5488272b8df5', '069f92c3-acce-5a32-9906-4bba512e1479', 'ما وحدة قيس التوتّر الكهربائي ورمزها؟', '[{"id":"a","text":"الأمبير، رمزه A"},{"id":"b","text":"الفولط، رمزه V"},{"id":"c","text":"الفولط، رمزه A"},{"id":"d","text":"الأمبير، رمزه V"}]'::jsonb, 'b', 'وحدة التوتّر الكهربائي هي الفولط ورمزها V؛ أمّا الأمبير (A) فهو وحدة شدّة التيّار الكهربائي، لا التوتّر.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0b1858bb-480a-570a-b31b-48dd9ead6525', '069f92c3-acce-5a32-9906-4bba512e1479', 'كيف يُركَّب الفولطمتر في الدارة لقيس التوتّر بين طرفَي ثنائي قطب؟', '[{"id":"a","text":"بالتفرّع بين طرفَي الثنائي"},{"id":"b","text":"بالتسلسل داخل الحلقة"},{"id":"c","text":"بين قطبَي المولّد فقط دائمًا"},{"id":"d","text":"خارج الدارة دون توصيل"}]'::jsonb, 'a', 'يُركَّب الفولطمتر بالتفرّع (بالتوازي) بين طرفَي الثنائي المراد قيس توتّره، ولا يُركَّب بالتسلسل؛ التركيب بالتسلسل خاصّ بالأمبيرمتر.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('eaf884b8-2fd0-57cc-9225-758559f79e7a', 'b10099c5-70b1-51c4-bced-13e914936a28', 'بأيّ حرف يُرمز إلى التوتّر الكهربائي؟', '[{"id":"a","text":"الحرف I"},{"id":"b","text":"الحرف U"},{"id":"c","text":"الحرف V"},{"id":"d","text":"الحرف A"}]'::jsonb, 'b', 'يُرمز إلى التوتّر الكهربائي بالحرف U؛ أمّا V فهو رمز وحدته (الفولط)، والحرف I يرمز إلى شدّة التيّار.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('de45771e-48be-5845-b61c-381011e94faf', 'e2cd76c2-d2b6-5d50-9804-779d0255e3be', 'لقيس التوتّر بين طرفَي محرّك يعمل، أيّ تركيب للفولطمتر هو الصحيح؟', '[{"id":"a","text":"نقطع الدارة عند المحرّك ونضع الفولطمتر مكانه بالتسلسل"},{"id":"b","text":"نصل مربطَي الفولطمتر بطرفَي المحرّك بالتفرّع دون قطع الدارة"},{"id":"c","text":"نصل مربطًا واحدًا فقط بأحد طرفَي المحرّك"},{"id":"d","text":"نصل الفولطمتر بقطبَي المولّد لأنّ التوتّر واحد في كلّ مكان"}]'::jsonb, 'b', 'الفولطمتر يُركَّب بالتفرّع بين طرفَي المحرّك مباشرةً دون قطع الحلقة. قطع الدارة ووضعه بالتسلسل خطأ (ذاك تركيب الأمبيرمتر)، وقيس توتّر المولّد لا يساوي توتّر المحرّك في التسلسل.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d5d44f27-b37d-5476-8bd6-409f3e7623f0', 'e2cd76c2-d2b6-5d50-9804-779d0255e3be', 'دارة متفرّعة توتّر مولّدها 4,5 V، وبها مصباحان في فرعَين بين نفس النقطتَين. قال تلميذ: «بما أنّهما مصباحان، فالتوتّر ينقسم فيصبح 2,25 V لكلّ واحد». ما الصحيح؟', '[{"id":"a","text":"كلامه صحيح: 2,25 V لكلّ مصباح"},{"id":"b","text":"التوتّر بين طرفَي كلّ مصباح 4,5 V لأنّه متساوٍ في التفرّع"},{"id":"c","text":"التوتّر بين طرفَي كلّ مصباح 9 V"},{"id":"d","text":"لا يمكن معرفة التوتّر دون قيس شدّة التيّار"}]'::jsonb, 'b', 'في التفرّع التوتّر بين طرفَي كلّ فرع متساوٍ: U1 = U2 = 4,5 V. الانقسام (2,25 V) خطأ ينقل سلوك شدّة التيّار (التي تتوزّع في التفرّع) إلى التوتّر.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7b2b30b6-8d54-548c-a175-fb898d361371', 'e2cd76c2-d2b6-5d50-9804-779d0255e3be', 'أيّ العبارات التالية **خاطئة**؟', '[{"id":"a","text":"في التسلسل تُجمع التوترات: U = U1 + U2"},{"id":"b","text":"في التفرّع يتساوى التوتّر بين طرفَي الفروع"},{"id":"c","text":"في التسلسل يتساوى التوتّر بين طرفَي كلّ مستقبل دائمًا كما تتساوى شدّة التيّار"},{"id":"d","text":"الفولطمتر يُركَّب بالتفرّع والأمبيرمتر بالتسلسل"}]'::jsonb, 'c', 'العبارة الخاطئة هي: «في التسلسل يتساوى التوتّر بين طرفَي كلّ مستقبل دائمًا». في التسلسل شدّة التيّار هي المتساوية، أمّا التوتّر فيُجمع ولا يتساوى إلّا صدفةً عند تماثل المستقبلات. بقيّة العبارات صحيحة.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('226e84e8-26ce-5ea4-816b-4e6d2e114e8a', 'dfd55ec5-8aa0-555c-9925-da9a4eda8e67', 'أيّ عبارة تصف التوتّر الكهربائي وصفًا صحيحًا؟', '[{"id":"a","text":"مقدار يعبُر الثنائي ويُقاس بالأمبيرمتر"},{"id":"b","text":"مقدار بين طرفَي الثنائي ويُقاس بالفولطمتر"},{"id":"c","text":"كتلة الثنائي ويُقاس بالميزان"},{"id":"d","text":"درجة حرارة الثنائي ويُقاس بالترمومتر"}]'::jsonb, 'b', 'التوتّر مقدار يوجد بين طرفَي الثنائي (بين نقطتَين) ويُقاس بالفولطمتر. الوصف الأوّل يخصّ شدّة التيّار (تعبُر الثنائي، أمبيرمتر).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5d6b96d6-87bd-58a7-936c-922965e929cd', 'dec94a5b-949d-527e-8a07-6272b058c4f9', 'في دارة بالتسلسل، مولّد توتّره 12 V يغذّي أربعة مصابيح متماثلة. ما التوتّر بين طرفَي مصباحَين متتاليَين معًا (بين طرفَي المجموعة)؟', '[{"id":"a","text":"3 V"},{"id":"b","text":"24 V"},{"id":"c","text":"12 V"},{"id":"d","text":"6 V"}]'::jsonb, 'd', 'كلّ مصباح: 12 ÷ 4 = 3 V. التوتّر بين طرفَي مصباحَين متتاليَين هو مجموع توتّرَيهما: 3 + 3 = 6 V. القيمة 3 V توتّر مصباح واحد فقط، و12 V توتّر الأربعة معًا.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('598fe436-ee3e-59e6-978b-987291208c3d', 'dec94a5b-949d-527e-8a07-6272b058c4f9', 'دارة بالتسلسل توتّر مولّدها 6 V، بها مصباحان: قِيس توتّر المصباح الأوّل 2 V. ثمّ فُصل المصباح الثاني وأُبدل بسلك توصيل بسيط (توتّره ≈ 0 V) مع بقاء المصباح الأوّل. ما التوتّر الجديد بين طرفَي المصباح الأوّل تقريبًا؟', '[{"id":"a","text":"2 V كما كان"},{"id":"b","text":"0 V"},{"id":"c","text":"6 V تقريبًا (يظهر كامل توتّر المولّد عليه)"},{"id":"d","text":"4 V"}]'::jsonb, 'c', 'بعد استبدال المستقبل الثاني بسلك توتّره ≈ 0 V، يبقى المصباح الأوّل وحده مستقبلًا فعليًّا في التسلسل: U = U(مصباح) + U(سلك) = U + 0، فيظهر عليه كامل توتّر المولّد ≈ 6 V. توزيع 2 V/4 V كان بسبب وجود مستقبلَين.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7ab11d45-39d9-548f-ac77-f009eb8409eb', '657a8e53-4608-5b50-904b-c3ae6abdf998', 'تلميذة في نابل تريد قيس التوتّر بين طرفَي مصباح. أيّ خطوة صحيحة؟', '[{"id":"a","text":"تقطع الدارة وتُدخل الفولطمتر بالتسلسل"},{"id":"b","text":"تصل مربط COM جهة القطب السالب ومربط V جهة الموجب، بالتفرّع"},{"id":"c","text":"تستعمل أمبيرمترًا بالتفرّع"},{"id":"d","text":"تصل الفولطمتر بمربط واحد فقط"}]'::jsonb, 'b', 'يُركَّب الفولطمتر بالتفرّع بين طرفَي المصباح، مع وصل COM جهة السالب وV جهة الموجب حتّى تظهر قيمة موجبة. الأمبيرمتر لا يقيس التوتّر، والتركيب بالتسلسل خطأ.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('234f57d4-4784-53a3-af91-5c75bf7857ea', '657a8e53-4608-5b50-904b-c3ae6abdf998', 'في دارة بالتسلسل، مولّد توتّره 9 V يغذّي مصباحًا (توتّره 3,5 V) ومحرّكًا. ثمّ في تجربة أخرى رُكِّب نفس المصباح والمحرّك بالتفرّع على نفس المولّد. ما التوتّر بين طرفَي المصباح في كلّ حالة؟', '[{"id":"a","text":"3,5 V في التسلسل، و9 V في التفرّع"},{"id":"b","text":"9 V في الحالتَين"},{"id":"c","text":"3,5 V في الحالتَين"},{"id":"d","text":"5,5 V في التسلسل، و3,5 V في التفرّع"}]'::jsonb, 'a', 'في التسلسل يتوزّع التوتّر: المصباح 3,5 V (والمحرّك 9 − 3,5 = 5,5 V). في التفرّع يتساوى التوتّر بين طرفَي الفرعَين مع المصدر: 9 V للمصباح. فالنتيجة 3,5 V ثمّ 9 V.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
