...
-- Subject: iq-training-ar (مرّن دماغك — تدريب الذكاء)
...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('iq-training-ar', 'مرّن دماغك — تدريب الذكاء', 'تحديات بصرية في المنطق الخالص: تأمّل الشكل، استنتج القاعدة الخفية، واختر الإجابة الصحيحة — لا حاجة للحفظ، فقط الاستدلال.', 'Logique', 'subject-math', 'Brain', 62, 'ar', false, 'muscle-cerveau', NULL)
...
هنا لا نراجع شيئًا: كل مهمة لغز يُحلّ بالاستنتاج الخالص. ثق بعينك وبمنطقك. 💪', '📜 حُلّ بالاستنتاج، لا بالحفظ أبدًا.', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('f1fe9612-e645-526d-bc44-3fa7363d066d', 'iq-training-ar', 'المنطق', 'متتاليات وتناظرات وأقيسة منطقية واستنتاجات شرطية: اكتشف القاعدة الخفية وطبّقها دون أن تحفظ شيئًا.', '# 🧠 المنطق — لا درس. لاحِظ، استنتج القاعدة، ثم طبّقها.', '📜 قاعدة واحدة تحكم كل لغز: اعثر عليها، ثم طبّقها.', 2, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('4a093f2d-7950-50df-a390-9a288dcc4b77', 'iq-training-ar', 'الرياضيات والاستدلال', 'متتاليات عددية، تماثلات رقمية، شبكات حسابية ونسب: اكتشف القاعدة الخفية بالاستنتاج، لا بصيغة محفوظة.', '# 🧠 الرياضيات والاستدلال — لا درس هنا. تأمّل الأعداد، استنتج القاعدة، ثم طبّقها.', '📜 القاعدة كامنة في الأعداد: استنتجها، لا تردّدها عن ظهر قلب.', 3, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('3c755566-06b5-5a65-b56d-b233748d0617', 'iq-training-ar', 'الذكاء السيّال', 'مسائل جديدة بلا طريقة محفوظة: استنتج النمط، واكتشف قاعدة التحويل وطبّقها — قدرة خالصة على الاستدلال.', '# 🧠 الذكاء السيّال — لا درس. لاحِظ، واستنتج القاعدة، وطبّقها.', '📜 أمام الجديد: استنتج النمط، وجِد القاعدة، وطبّقها — لا اعتماد على الذاكرة أبدًا.', 4, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('006becf5-229a-58e9-8a5c-c81818b22ae9', 'iq-training-ar', 'الهندسة والإدراك المكاني', 'دورانات وتماثلات وعدّ المكعبات المخفية ومخططات قابلة للطي: تخيّل الشكل في الفضاء واستنتج التحويل.', '# 🧠 الهندسة والإدراك المكاني — لا درس هنا. لاحظ الشكل، واستنتج القاعدة، ثم طبّقها.', '📐 أدِر الشكل في ذهنك: استنتج التحويل، ولا تحفظه.', 5, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('bb58bce7-2a97-5635-8e93-bd46b7fd3426', '4212a2ce-dc73-58c6-b7f9-711137cc2f4e', 'استنتاج: «كل الزوغات تضع قبعة.» نلاحظ مخلوقًا لا يضع قبعة. ماذا يمكن أن نستنتج بيقين؟', '[{"id":"a","text":"هذا المخلوق زوغ."},{"id":"b","text":"هذا المخلوق ليس زوغًا."},{"id":"c","text":"كل من يضع قبعة هو زوغ."},{"id":"d","text":"لا أحد من المخلوقات يضع قبعة."}]'::jsonb, 'b', 'تقول القاعدة إن كل زوغ يضع قبعة. إذن مخلوق بلا قبعة لا يمكن أن يكون زوغًا (وإلا لكان يضعها) ← الخيار b ✓. الفخّ: a يناقض المشاهدة مباشرة؛ c يعكس القاعدة («كل زوغ له قبعة» لا يعني «كل قبعة لزوغ»)؛ d يخترع تأكيدًا لا علاقة له بشيء. نطبّق القاعدة بنقيضها: لا قبعة ⇐ ليس زوغًا.', 5, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('bd79d725-261a-5bc4-9d65-266cc3924b6b', 'ef8eb95c-c1c9-5333-8cfc-29dd649c6d95', 'استنتاج منطقي. نعلم أن: (1) كل الغليبات بروماتٌ. (2) لا بروم زارن. (3) ميلو غليب. ما الاستنتاج الصحيح بالضرورة؟', '[{"id":"a","text":"ميلو زارن."},{"id":"b","text":"ميلو ليس زارنًا."},{"id":"c","text":"بعض البرومات زارنات."},{"id":"d","text":"ميلو ليس برومًا."}]'::jsonb, 'b', 'القاعدة: نسلسل الاستلزامات. ميلو غليب (3)، وكل الغليبات بروماتٌ (1)، إذن ميلو بروم. ولا بروم زارن (2)، إذن ميلو ليس زارنًا. ✓ الخيار b. فخّ a: استنتاج معاكس، يناقض (2). فخّ d: خاطئ، فقد استنتجنا للتو أن ميلو بروم عبر (1). فخّ c: يناقض مباشرة (2) التي تقول إن لا بروم زارن.', 5, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('9cdb451a-8318-5f9e-a8a8-a7223ebdb53a', '28bccb54-dffd-5bac-af66-10f6cea1559c', 'وصفة تستعمل 2 بيضة لـ 6 فطائر. بالحفاظ على النسبة نفسها، كم بيضة يلزم لـ 12 فطيرة؟', '[{"id":"a","text":"8"},{"id":"b","text":"6"},{"id":"c","text":"4"},{"id":"d","text":"3"}]'::jsonb, 'c', 'القاعدة: عدد الفطائر يتضاعف (6 → 12)، إذن كل شيء يتضاعف بنسبة متساوية. ✓ يلزم 2 × 2 = 4 بيضات، أي الخيار c. الخيار a (8) يضيف 6 للبيض كما أضفنا 6 للفطائر: نجمع بدل احترام النسبة. الخيار b (6) ينسخ عدد الفطائر الأولي. الخيار d (3) يضيف 1 فقط دون مراعاة التضاعف.', 4, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('bb37a426-5636-522b-bd9d-7d4a09111922', 'e8e1afe6-52a0-5699-8ac5-9b008e2c7bf3', 'تأمّل المتتالية واكتشف القاعدة الخفية: 4, 7, 10, 13, ؟ ما العدد الذي يأتي بعد ذلك؟', '[{"id":"a","text":"16"},{"id":"b","text":"15"},{"id":"c","text":"17"},{"id":"d","text":"26"}]'::jsonb, 'a', 'القاعدة هي: +3 في كل خطوة (7−4 = 3 ; 10−7 = 3 ; 13−10 = 3). إذن العدد الموالي هو 13 + 3 = 16 ← الخيار a ✓. الفخّ: b (15) يضيف 2 فقط، c (17) يضيف 4، وd (26) يضاعف العدد الأخير. الفارق بين حدّين يبقى ثابتًا ويساوي 3.', 1, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('add79ee1-14a9-50a8-a926-9bc684d2ae03', 'e8e1afe6-52a0-5699-8ac5-9b008e2c7bf3', 'تأمّل المتتالية واكتشف القاعدة الخفية: 2, 4, 6, 8, ؟ ما العدد الذي يأتي بعد ذلك؟', '[{"id":"a","text":"9"},{"id":"b","text":"16"},{"id":"c","text":"12"},{"id":"d","text":"10"}]'::jsonb, 'd', 'القاعدة هي: +2 في كل خطوة، وهي الأعداد الزوجية (2, 4, 6, 8…). الموالي هو 8 + 2 = 10 ← الخيار d ✓. الفخّ: a (9) يضيف 1 ويعطي عددًا فرديًا، b (16) يضاعف الحدّ الأخير، وc (12) يقفز خطوة (+4). نتقدّم بانتظام 2 خانتين خانتين، إذن بعد 8 يأتي 10.', 4, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('4994015a-5da5-58ed-bdac-402e0d3c6f55', '4a093f2d-7950-50df-a390-9a288dcc4b77', 'iq-training-ar', '⭐⭐ إدخال حرّ: احسب واكتب إجابتك', 2, 75, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('9fafae81-0bf1-5f5d-8899-f67c0836e33e', '4994015a-5da5-58ed-bdac-402e0d3c6f55', 'لا خيارات هذه المرّة: اكتشف القاعدة ثمّ اكتب العدد الموالي. 5, 8, 11, 14, ?', '[]'::jsonb, NULL, 'القاعدة هي إضافة 3 في كلّ خطوة (8−5 = 3 ; 11−8 = 3 ; 14−11 = 3). إذن العدد الموالي هو 14 + 3 = 17. لا خيارات تُقصى — حسابك هو الذي يتكلّم!', 1, 'numeric', '{"value":17}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('c66425c6-fef5-5628-8f20-83ffecf7c966', '4994015a-5da5-58ed-bdac-402e0d3c6f55', 'اكتشف القاعدة المشتركة بين المثالين ثمّ طبّقها واكتب النتيجة: 3 → 9، 5 → 15، إذن 8 → ؟', '[]'::jsonb, NULL, 'قاعدة واحدة فقط تنطبق على المثالين معًا: الضرب في 3 (لأنّ 3 × 3 = 9 و 5 × 3 = 15 ✓). نطبّقها على 8: فيكون 8 × 3 = 24.', 2, 'numeric', '{"value":24}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('4ff64df6-89ae-532a-a738-9ab0c9a0fa7a', '4994015a-5da5-58ed-bdac-402e0d3c6f55', 'أفكّر في عدد. ضِعفه ناقص 4 يساوي 10. اكتب هذا العدد.', '[]'::jsonb, NULL, 'نرجع بالحساب إلى الوراء: إذا كان الضعف ناقص 4 يساوي 10 فإنّ الضعف يساوي 10 + 4 = 14، ومنه العدد هو 14 ÷ 2 = 7. تحقّق: 2 × 7 − 4 = 10 ✓.', 3, 'numeric', '{"value":7}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('e944c90c-28b9-5d92-8ed7-69c4f9286734', '4994015a-5da5-58ed-bdac-402e0d3c6f55', 'احسب معدّل الأعداد 12 و15 و18 ثمّ اكتب النتيجة.', '[]'::jsonb, NULL, 'المعدّل = المجموع ÷ عدد القيم = (12 + 15 + 18) ÷ 3 = 45 ÷ 3 = 15. ملاحظة: عندما تكون القيم متباعدة بانتظام يكون المعدّل هو القيمة الوسطى.', 4, 'numeric', '{"value":15}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('128a3e1e-0528-5986-a6da-9b91732a4d99', '4994015a-5da5-58ed-bdac-402e0d3c6f55', 'احسب ثلث نصف العدد 42 ثمّ اكتب النتيجة.', '[]'::jsonb, NULL, 'خطوة بخطوة: نصف 42 هو 42 ÷ 2 = 21، ثمّ ثلث 21 هو 21 ÷ 3 = 7. الترتيب لا يهمّ هنا: 42 ÷ 6 = 7 أيضًا.', 5, 'numeric', '{"value":7}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('a5e473eb-8dc0-5d97-b7a4-b4736d851f33', '4994015a-5da5-58ed-bdac-402e0d3c6f55', 'كلّ حدّ مضروب في العدد نفسه: 0.5, 1.5, 4.5, ? اكتب الحدّ الموالي (يمكنك استعمال النقطة أو الفاصلة).', '[]'::jsonb, NULL, 'النسبة ثابتة: 1.5 ÷ 0.5 = 3 و 4.5 ÷ 1.5 = 3 — كلّ حدّ مضروب في 3. إذن الحدّ الموالي هو 4.5 × 3 = 13.5.', 6, 'numeric', '{"value":13.5}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('d4281e4c-3304-5f27-997f-dbdb13b7befe', '4a093f2d-7950-50df-a390-9a288dcc4b77', 'iq-training-ar', '⭐⭐ سحب وإفلات: رتّب وطابق', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('aac054a5-8088-54a6-bd68-d4bf8bc484b3', 'd4281e4c-3304-5f27-997f-dbdb13b7befe', 'رتّب هذه الأعداد من الأصغر إلى الأكبر (اسحبها إلى مواضعها).', '[{"id":"a","text":"0.5"},{"id":"b","text":"0.09"},{"id":"c","text":"0.45"}]'::jsonb, NULL, 'نقارن رقمًا رقمًا بعد الفاصلة: 0.09 < 0.45 < 0.5 (لأنّ 0.5 = 0.50). الفخّ الشهير: يبدو 0.09 « كبيرًا » بسبب الرقم 9، لكنّ رقم أعشاره هو 0.', 1, 'ordering', '{"order":["b","c","a"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('5893ca84-7675-5083-a3b6-c9db8a622a6f', 'd4281e4c-3304-5f27-997f-dbdb13b7befe', 'أعد ترتيب خطوات حلّ المعادلة 2x + 4 = 10.', '[{"id":"a","text":"نقسم الطرفين على 2: x = 3"},{"id":"b","text":"نطرح 4 من الطرفين: 2x = 6"},{"id":"c","text":"نتحقّق: 2 × 3 + 4 = 10 ✓"}]'::jsonb, NULL, 'نعزل أوّلًا الحدّ الذي فيه x بطرح 4 (فيصير 2x = 6)، ثمّ نقسم على 2 (فيكون x = 3)، ونختم دائمًا بالتحقّق: 2 × 3 + 4 = 10 ✓.', 2, 'ordering', '{"order":["b","a","c"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('123005db-2b51-56b1-953f-ce33abc6030b', 'd4281e4c-3304-5f27-997f-dbdb13b7befe', 'طابق كلّ عملية حساب ذهني مع نتيجتها.', '[{"id":"l1","text":"25% من 80"},{"id":"l2","text":"نصف 46"},{"id":"l3","text":"ضِعف 35"},{"id":"r1","text":"23"},{"id":"r2","text":"70"},{"id":"r3","text":"20"}]'::jsonb, NULL, '25% تعني الربع، إذن 80 ÷ 4 = 20 ؛ ونصف 46 هو 46 ÷ 2 = 23 ؛ وضِعف 35 هو 35 × 2 = 70.', 3, 'matching', '{"pairs":[["l1","r3"],["l2","r1"],["l3","r2"]]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('884371eb-e731-5fb4-a0a5-0f0acaac01ac', 'd4281e4c-3304-5f27-997f-dbdb13b7befe', 'طابق كلّ متتالية مع القاعدة التي تسيّرها.', '[{"id":"l1","text":"2, 4, 8, 16"},{"id":"l2","text":"5, 8, 11, 14"},{"id":"l3","text":"64, 32, 16, 8"},{"id":"r1","text":"نضيف 3"},{"id":"r2","text":"نقسم على 2"},{"id":"r3","text":"نضرب في 2"}]'::jsonb, NULL, 'المتتالية 2, 4, 8, 16 تتضاعف في كلّ خطوة (×2) ؛ و5, 8, 11, 14 تتقدّم بإضافة 3 (لأنّ 8−5 = 3) ؛ و64, 32, 16, 8 تُقسم على 2 في كلّ خطوة. تحقّق من القاعدة دائمًا على خطوتين متتاليتين.', 4, 'matching', '{"pairs":[["l1","r3"],["l2","r1"],["l3","r2"]]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('8f828d46-3533-5ebd-84ce-b32f8101dab0', '4a093f2d-7950-50df-a390-9a288dcc4b77', 'iq-training-ar', '⭐⭐ اختيار متعدّد: اختر كلّ الإجابات الصحيحة', 2, 75, 15, 'practice', 'admin', 6)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('d0eaeef9-932c-5005-8b35-8b6ecbebc0ed', '8f828d46-3533-5ebd-84ce-b32f8101dab0', 'من بين هذه الأعداد، اختر كلّ الأعداد التي هي من مضاعفات 3.', '[{"id":"a","text":"9"},{"id":"b","text":"10"},{"id":"c","text":"21"},{"id":"d","text":"16"}]'::jsonb, NULL, '9 = 3 × 3 و21 = 3 × 7 من مضاعفات 3. أمّا 10 و16 فليسا كذلك (10 ÷ 3 و16 ÷ 3 ليسا عددين صحيحين).', 1, 'multi', '{"correct":["a","c"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('0b05875c-5391-5190-8dc9-58e7bbaa6f52', '8f828d46-3533-5ebd-84ce-b32f8101dab0', 'بخصوص عدد زوجي، اختر كلّ العبارات الصحيحة.', '[{"id":"a","text":"يقبل القسمة على 2"},{"id":"b","text":"رقمه الأخير هو 0 أو 2 أو 4 أو 6 أو 8"},{"id":"c","text":"هو بالضرورة من مضاعفات 4"},{"id":"d","text":"مجموعه مع عدد زوجي آخر يكون دائمًا زوجيًّا"}]'::jsonb, NULL, 'العدد الزوجي يقبل فعلًا القسمة على 2 (a) وينتهي بـ 0/2/4/6/8 (b)؛ ومجموع عددين زوجيّين دائمًا زوجي (d). لكنّ 6 زوجي وليس من مضاعفات 4، فالعبارة (c) خاطئة.', 2, 'multi', '{"correct":["a","b","d"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('951d6d45-6aad-5c81-a057-c1e59b10af3a', '8f828d46-3533-5ebd-84ce-b32f8101dab0', 'أيّ من هذه المتتاليات تتقدّم بخطوة ثابتة (متتالية حسابية)؟ اختر كلّ الإجابات الصحيحة.', '[{"id":"a","text":"3, 6, 9, 12"},{"id":"b","text":"2, 4, 8, 16"},{"id":"c","text":"5, 8, 11, 14"},{"id":"d","text":"1, 4, 9, 16"}]'::jsonb, NULL, 'المتتالية 3, 6, 9, 12 تتقدّم بـ 3+ في كلّ خطوة، وكذلك 5, 8, 11, 14 : كلتاهما متتالية حسابية. أمّا 2, 4, 8, 16 فتتضاعف في كلّ مرّة (×2؛ ليست خطوة ثابتة)، و1, 4, 9, 16 هي المربّعات المتتالية (1² ; 2² ; 3² ; 4²) — لا واحدة منهما لها خطوة ثابتة.', 3, 'multi', '{"correct":["a","c"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('35240517-3da3-5ef3-bc43-cc817e8a9522', '0e4f0aee-576b-5d25-8991-c3ad5267012f', 'إليك شكلًا: عَلَم مثبَّت في أعلى سارية، يشير نحو اليمين. أيُّ الخيارات هو صورته في مرآة عمودية (يُعكَس اليسار واليمين)؟ <svg viewBox="0 0 100 100"><line x1="35" y1="15" x2="35" y2="85" stroke="#222" stroke-width="3"/><polygon points="35,18 70,30 35,42" fill="#222" stroke="#222" stroke-width="2"/></svg>', '[{"id":"a","text":"<svg viewBox=\"0 0 100 100\"><line x1=\"35\" y1=\"15\" x2=\"35\" y2=\"85\" stroke=\"#222\" stroke-width=\"3\"/><polygon points=\"35,58 70,70 35,82\" fill=\"#222\" stroke=\"#222\" stroke-width=\"2\"/></svg>"},{"id":"b","text":"<svg viewBox=\"0 0 100 100\"><line x1=\"35\" y1=\"15\" x2=\"35\" y2=\"85\" stroke=\"#222\" stroke-width=\"3\"/><polygon points=\"35,18 70,30 35,42\" fill=\"#222\" stroke=\"#222\" stroke-width=\"2\"/></svg>"},{"id":"c","text":"<svg viewBox=\"0 0 100 100\"><line x1=\"65\" y1=\"15\" x2=\"65\" y2=\"85\" stroke=\"#222\" stroke-width=\"3\"/><polygon points=\"65,18 30,30 65,42\" fill=\"#222\" stroke=\"#222\" stroke-width=\"2\"/></svg>"},{"id":"d","text":"<svg viewBox=\"0 0 100 100\"><line x1=\"65\" y1=\"15\" x2=\"65\" y2=\"85\" stroke=\"#222\" stroke-width=\"3\"/><polygon points=\"65,58 30,70 65,82\" fill=\"#222\" stroke=\"#222\" stroke-width=\"2\"/></svg>"}]'::jsonb, 'c', 'المرآة العمودية تبادل اليسار واليمين لكنها تُبقي الأعلى في الأعلى. فتنتقل السارية إلى اليمين، والعَلَم الذي كان يشير إلى اليمين يجب أن يشير إلى اليسار ← الخيار c ✓. الفخّ: b هو الشكل الأصلي دون تغيير (لا انعكاس)، و a يُبقي السارية في اليسار وينزل العَلَم فقط (خَلْطٌ بين المرآة العمودية والمرآة الأفقية)، و d يقلب الشكل من الأعلى إلى الأسفل إضافةً إلى الجهة (تحويل مزدوج، وليس مجرّد مرآة يسار-يمين).', 1, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
