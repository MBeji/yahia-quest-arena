...
-- Subject: anglais-a2 (English — Elementary (A2))
...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('anglais-a2', 'English — Elementary (A2)', 'Step up from beginner: the past simple, present continuous, the future (going to & will), comparatives & superlatives, and quantifiers. Elementary level (CEFR A2), building on the A1 foundations.', 'Agilité', 'subject-english', 'Globe', 2, 'en', false, 'anglais', NULL)
...
- ⚠️ The past is carried by **did / didn''t** — never mark it twice (_Did you go?_, not _Did you went?_).', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
- ⚠️ Don''t put a **habit** in the continuous (_Every morning I drink coffee_, not _am drinking_) or a **now-action** in the simple (_Look! He is playing_, not _plays_).', 2, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ After _will_ use the **base verb, no "to"** (_I''ll go_, not _I''ll to go_); never double the future (_~~will going to~~_) and never drop the **be** (_~~I going to~~_).', 3, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ _than_ (comparison) ≠ _then_ (time); don''t drop **the** before a superlative (_She is the tallest_, not _She is tallest_).', 4, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Match the quantifier to the noun — never _many money_, _much books_, _a few money_, or _a little books_.', 5, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ **in bed**, **in a car/taxi**; but **on a bus/train/plane**.', 6, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ No contraction-only short answer: _Yes, she is._ (not _~~Yes, she''s.~~_)', 7, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- ⚠️ Re-read the question after choosing your answer to confirm you answered what was asked.', 8, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
Which sentence is FALSE according to the notice?', '[{"id":"a","text":"The change starts on 1st September."},{"id":"b","text":"Students without a card should contact the office."},{"id":"c","text":"Card payment will be required in the canteen."},{"id":"d","text":"Students can still pay with cash after 1st September."}]'::jsonb, 'd', 'The notice says cash will not be accepted from 1st September, so "Students can still pay with cash after 1st September" is FALSE — that is the answer. The other three statements are all true: the change starts on 1st September, card payment will be required, and students without a card should contact the office.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
