...
**To be** is the most used verb in English. It links a subject to what it _is_, _where_ it is, or _how_ it feels. Master its three present forms — **am**, **is**, **are** — and you can build hundreds of true sentences from day one.
...
> 🗡️ Quick rule: **I → am**, **he / she / it → is**, everything plural (and _you_) → **are**.

## 🛡️ Contractions — how natural English sounds

In speech and informal writing we shorten _subject + verb_. The meaning is identical.
...
> ⚠️ Classic trap: **it''s** (= _it is_) is not the same as **its** (possessive). _**It''s** cold today_ vs _The dog wags **its** tail._
...
> 🗡️ Note: there is **no** "amn''t" — for _I_ always use **I''m not**.

## 🧭 Questions — flip the order

For a yes/no question, put the verb **before** the subject (this swap is called _inversion_).
...
With a question word (_what, where, who, how old_), that word comes first:
_**Where is** she? **How are** you? **What is** your name?_

> ⚠️ Trap: do **not** add _do/does_ with _to be_. Say _Are you ready?_, never _~~Do you are ready?~~_

## 🌍 "There is" / "There are"

Use **there is** for one thing and **there are** for several, to say that something _exists_ somewhere.
...
- **Three present forms** — _I am_, _he / she / it is_, _you / we / they are_. The base of every simple sentence.
- **Contractions** — _I''m, you''re, he''s, she''s, it''s, we''re, they''re_; same meaning, more natural.
- **Negative** — add _not_ after the verb: _isn''t, aren''t_, and _I''m not_ (there is no "amn''t").
- **Yes/no questions** — invert subject and verb: _Are you…? Is she…?_ — never add _do/does_.
- **Short answers** — reuse the verb: _Yes, I am. / No, it isn''t._
- **Question words** — _Where is…? How are…? What is your name?_
- **There is / there are** — say that something exists (one thing / several things).
- ⚠️ _It''s_ (= _it is_) ≠ _its_ (possessive); _they''re_ ≠ _their_ ≠ _there_.', 1)
ON CONFLICT (id) DO UPDATE SET
...
> ⚠️ The number-one mistake: double marking. Say _She **doesn''t work**_, never _~~She doesn''t works~~_. The **-s** lives on _does_, not on the main verb.
...
With a question word (_what, where, when, how often_), that word comes first:
...
To say _how often_ something happens, use **always, usually, often, sometimes, never**. They go **before the main verb** — but **after** the verb _be_.

_She **always** gets up early. They **often** play outside. I **never** eat fast food._
_He **is usually** late._ (after _be_) vs _He **usually** finishes at six._ (before a normal verb)
...
> 🏆 Gate cleared! You can now describe routines, state facts, deny them with don''t/doesn''t, ask about them with do/does, and time them with frequency adverbs. Next stop: **articles and plurals** — _a_, _an_, _the_, and how to make nouns plural.', '# 📜 Résumé: The Present Simple

- **Uses** — habits and routines, general truths, and fixed timetables: _I live in Tunis. Water boils at 100°._
- **Basic form** — use the base verb for _I / you / we / they_: _They play football._
- **Third-person -s** — add **-s** for _he / she / it_: _He plays. She works. It rains._
- **Spelling** — _-ch/-sh/-ss/-x/-o → -es_ (_watch → watches_, _go → goes_); _consonant + y → -ies_ (_study → studies_, _fly → flies_); _play → plays_.
- **Negative** — _don''t_ / _doesn''t_ + **base verb**: _She doesn''t work_ — never _doesn''t works_.
- **Questions** — _do_ / _does_ + subject + **base verb**: _Does she go…?_ — never _Do she…?_ or _Does she goes…?_
- **Short answers** — reuse the auxiliary: _Yes, I do. / No, he doesn''t._
- **Wh- questions** — question word first: _Where do you live? What does she do?_
- **Frequency adverbs** — _always, usually, often, sometimes, never_ go **before the main verb**, but **after** _be_: _He always goes / He is usually late_.
- ⚠️ Golden rule: _does/doesn''t_ already carries the _-s_, so the main verb stays in its **base form**.', 2)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
> 💡 «Once you can name _a_ thing, _the_ thing, and _many_ things, the whole world becomes describable.»

## 🏰 The three tiny words that open every door

English puts a small word in front of most nouns. **a** and **an** are the _indefinite_ articles — one thing, mentioned for the first time. **the** is the _definite_ article — a specific thing we both already know. Sometimes we use **no article at all** (the _zero_ article). Master this trio and your sentences instantly sound natural.
...
**the** = we both know _which one_. **a/an** = one of many, first mention. **No article** = something general or uncountable.
...
> 🗡️ The **-y** rule depends on the letter _before_ y: a **consonant + y** flips to **-ies** (_baby → babies_), but a **vowel + y** simply adds **-s** (_boy → boys_, never _~~boies~~_).
...
- **Three articles** — _a/an_ (one thing, first mention), _the_ (a specific, known thing), and _no article_ (general or uncountable).
- **a vs an = sound, not letter** — _an_ before a vowel **sound**, _a_ before a consonant **sound**.
- **Tricky a** — _a university_ (/j/ "yoo"), _a one-euro coin_ (/w/): vowel letters, but consonant sounds.
- **Tricky an** — _an hour, an honest man, an MP_: silent h or a vowel-sound start, so _an_.
- **the** — use it when both speakers know which one, or for unique things (_the sun, the moon_).
- **Zero article** — general plurals and uncountables take **no** article: _Cats are nice. Water is essential._
- **Regular plurals** — add _-s_; _-es_ after s/x/z/ch/sh (_boxes, watches, buses_).
- **The -y rule** — consonant + y → _-ies_ (_city → cities_); vowel + y → _-s_ (_boy → boys_).
- **-f / -fe → -ves** — _knife → knives, leaf → leaves, wife → wives_.
- **Irregular plurals** — _man → men, woman → women, child → children, foot → feet, tooth → teeth, mouse → mice, person → people_; _fish_ and _sheep_ stay the same.', 3)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
- **Family** — _mother / father → parents_, _sister / brother_, _son / daughter_, _aunt / uncle_, _niece / nephew_, _grandmother / grandfather_; a _cousin_ is the child of an aunt or uncle.
- **Numbers** — cardinals count (_one, two, three…_); ordinals order (_first, second, third_).
- **Days & months** — seven days (_Monday … Sunday_), twelve months (_January … December_), always **capitalized**.
- **Colours** — _red, blue, green, yellow, black, white, orange, purple, brown, grey, pink_.
- **Home & school objects** — _table, chair, door, window, key, phone_; _book, pen, pencil, bag, desk_.
- **Jobs** — _teacher, doctor, nurse, driver, cook/chef, farmer, engineer_.
- **Food & drink** — _bread, rice, apple, egg_; _water, milk, coffee, tea_; _a glass of water_, _a cup of tea_.
- **Basic adjectives & opposites** — _big ↔ small, hot ↔ cold, happy ↔ sad, old ↔ new, cheap ↔ expensive, fast ↔ slow, easy ↔ difficult_.
- ⚠️ Don''t mix the pairs: _aunt_ (female) ≠ _uncle_ (male); _niece_ (girl) ≠ _nephew_ (boy); a _pen_ (ink) ≠ a _pencil_ (lead).', 4)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
Each question word asks for a different kind of answer. Learn what each one _expects_, and you will never confuse a place with a time again.
...
> ⚠️ Classic trap: never **double-mark** the verb. Say _Where **does** she **live**?_, never _~~Where does she lives?~~_ The **-s** lives on _does_, not on the main verb. And never drop the helper: _~~Where she lives?~~_ is wrong.

## 🧭 Short answers — match the question to its answer

The question word tells you the _shape_ of the answer. A **Where** question wants a place; a **When** question wants a time; **Whose** wants an owner.
...
Real English means _reading_ short texts and pulling out facts. Read slowly, then answer in two ways:

- **Find a detail** — the answer is written in the text. _"Sara is a doctor. She works in a hospital."_ → **What is Sara''s job?** → _a doctor._
- **Make an inference** — the text does not say it directly, but you can work it out. _"Sara works in a hospital. She helps sick people."_ → **Does Sara have a job?** → _Yes_ (a hospital + helping people = work).
...
- **Question words** — _what_ (thing), _where_ (place), _when_ (time), _who_ (person), _why_ (reason), _how_ (manner), _whose_ (possession).
- **How many vs how much** — _how many_ + countable (_how many books_), _how much_ + uncountable (_how much water_).
- **Golden word order** — (question word) + auxiliary/be + subject + …: _Where is she? Who are they? What do you want?_
- **Questions with be** — just invert subject and verb, no helper: _Is she a nurse? Where is she?_
- **Questions with ordinary verbs** — add _do_ (I/you/we/they) or _does_ (he/she/it) + the **base** verb: _Where does he live?_
- ⚠️ Never **double-mark**: _Where does she live?_ (not _does she lives_); never drop the helper: not _Where she lives?_
- **Match question to answer** — a _Where_ question wants a place, a _When_ question a time, _Whose_ an owner.
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'a9babe02-35db-5739-b219-57a666359ba6', 'anglais-a1', '⭐⭐ Drill: The Verb To Be', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('91714987-62ec-56f9-ada5-76ee579677e8', 'e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'Complete: "My two sisters ___ nurses at the local hospital."', '[{"id":"a","text":"is"},{"id":"b","text":"are"},{"id":"c","text":"am"},{"id":"d","text":"be"}]'::jsonb, 'b', 'My two sisters refers to more than one person, so it takes are: My two sisters are nurses. Is is for a single he/she/it subject, am is only for I, and be is the base form — not a present-tense form on its own.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5c38694c-26ac-58ab-bc57-ee768f4e0b0b', 'e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'Complete: "Leila is tired. ___ is in bed."', '[{"id":"a","text":"He"},{"id":"b","text":"They"},{"id":"c","text":"We"},{"id":"d","text":"She"}]'::jsonb, 'd', 'Leila is a girl''s name, so the correct pronoun to replace it is she: She is in bed. He replaces a man''s name, they replaces a group of people or things, and we includes the speaker — none of those fits Leila alone.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cfcdd863-dd7f-5505-8da1-7ab87d09e2fd', 'e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'Choose the correct negative contraction: "The classroom ___ very clean today."', '[{"id":"a","text":"isn''t"},{"id":"b","text":"aren''t"},{"id":"c","text":"don''t"},{"id":"d","text":"not is"}]'::jsonb, 'a', 'The classroom is singular (it), so the negative is isn''t: The classroom isn''t very clean today. Aren''t is for you/we/they, don''t belongs to ordinary verbs (not to be), and "not is" puts not before the verb — the wrong order.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('974cda11-f487-503c-8718-cac369bd84a1', 'e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'Find the INCORRECT sentence.', '[{"id":"a","text":"The weather is cold today."},{"id":"b","text":"Omar and Sana are cousins."},{"id":"c","text":"I are very happy."},{"id":"d","text":"There are five students in the room."}]'::jsonb, 'c', 'The error is (c): I takes am, not are — the correct form is I am very happy. Sentences (a), (b) and (d) all use the right form of to be: is with a singular subject, are with two people joined by and, and are with the plural five students.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('03392ad8-64c0-5a3e-8d9e-1828281c7f84', 'e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'Your answer is YES. Choose the correct short answer to "Are your parents at home?"', '[{"id":"a","text":"Yes, they''re."},{"id":"b","text":"Yes, they are."},{"id":"c","text":"Yes, them are."},{"id":"d","text":"Yes, are they."}]'::jsonb, 'b', 'A positive short answer with are is not contracted, so say Yes, they are (not Yes, they''re). "Them" is an object pronoun, never the subject of a short answer; and "are they" is question order, not an answer.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e74ffcfc-ac44-5e15-bd2d-d28f4334db0b', 'e7d22f69-c79b-5de2-8985-7c4ad4b5fc66', 'Complete: "The quality of these shoes ___ really good."', '[{"id":"a","text":"are"},{"id":"b","text":"am"},{"id":"c","text":"is"},{"id":"d","text":"were"}]'::jsonb, 'c', 'The real subject is the quality (singular), not shoes — the phrase "of these shoes" is just a modifier. So the verb is is: The quality of these shoes is really good. This is the same trap as "The price of books is…" — find the head noun before picking the verb form.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'e702c00c-86b8-5423-b0e2-5cb024ce78a3', 'anglais-a1', '⭐⭐ Drill: Present Simple', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('24eeb290-88c6-52d0-abaa-15ca58f3f5e0', 'ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'Complete: "My father ___ the car every Saturday."', '[{"id":"a","text":"washes"},{"id":"b","text":"washing"},{"id":"c","text":"washs"},{"id":"d","text":"wash"}]'::jsonb, 'a', 'My father = he, and wash ends in -sh, so add -es: My father washes the car. "washing" is the -ing form (not the simple present), "washs" spells it wrong (you need -es after -sh, not just -s), and "wash" forgets the third-person ending.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cf3dd501-c27a-564c-8051-3fffbc41d932', 'ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'Choose the correct word order: "___ before bed."', '[{"id":"a","text":"She reads always a book"},{"id":"b","text":"She always reads a book"},{"id":"c","text":"Always she a book reads"},{"id":"d","text":"She a book always reads"}]'::jsonb, 'b', 'Adverbs of frequency (always, never, usually, often) go before the main verb in a present-simple statement: She always reads a book. Placing always after the verb ("reads always") is incorrect, and fronting it without inverting the sentence ("Always she…") sounds unnatural at A1.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a7a06dd2-326b-5a97-a440-3a1c89a688aa', 'ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'Complete the negative: "Our teacher ___ French in class."', '[{"id":"a","text":"don''t speak"},{"id":"b","text":"not speak"},{"id":"c","text":"doesn''t speaks"},{"id":"d","text":"doesn''t speak"}]'::jsonb, 'd', 'Our teacher = she/he, so the negative auxiliary is doesn''t + base verb: doesn''t speak. "don''t" is for I/you/we/they, "doesn''t speaks" double-marks the third-person -s (it already sits on does), and "not speak" has no auxiliary at all.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fc601614-187e-5dae-908a-b0f5289cddc6', 'ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'Choose the correct question: "What time ___ they finish school?"', '[{"id":"a","text":"do"},{"id":"b","text":"is"},{"id":"c","text":"does"},{"id":"d","text":"are"}]'::jsonb, 'a', 'They is a plural subject, so the auxiliary is do: What time do they finish school? Does is only for he/she/it, and is/are belong to the verb be — they cannot form a present-simple question with the verb finish.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('31ca987a-44f3-5648-87e6-151071359e86', 'ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'Choose the fully correct sentence.', '[{"id":"a","text":"He fly to Paris twice a year."},{"id":"b","text":"He flys to Paris twice a year."},{"id":"c","text":"He flies to Paris twice a year."},{"id":"d","text":"He is fly to Paris twice a year."}]'::jsonb, 'c', 'He is third person, and fly ends in consonant + y, so y → i + es: He flies to Paris. "fly" forgets the -s ending, "flys" uses the wrong spelling (y must change before -es), and "is fly" wrongly mixes two verbs.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8c713d74-0fa2-5daa-8c94-0d518e805fb8', 'ca43ad41-dd8b-5941-bcfc-664ecda51d7e', 'Find the INCORRECT sentence.', '[{"id":"a","text":"She doesn''t like spicy food."},{"id":"b","text":"They don''t play video games."},{"id":"c","text":"He often forgets his keys."},{"id":"d","text":"My sister don''t eat meat."}]'::jsonb, 'd', 'The error is (d): my sister = she, so the auxiliary must be doesn''t, not don''t — the correct sentence is My sister doesn''t eat meat. Sentences (a), (b) and (c) all match the auxiliary to the subject correctly.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('7db09ff5-a6f4-5518-a43a-ef0a0df8b143', '23ae9a2a-83b4-5566-9f6a-6a72af1cc3a5', 'anglais-a1', '⭐⭐ Drill: Articles & Plurals', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1d2b4cf5-ca63-5abd-84fb-4771e3c148ae', '7db09ff5-a6f4-5518-a43a-ef0a0df8b143', 'Choose the correct article: "Please bring ___ umbrella — it is raining."', '[{"id":"a","text":"an"},{"id":"b","text":"the"},{"id":"c","text":"(no article)"},{"id":"d","text":"a"}]'::jsonb, 'a', 'Umbrella starts with the vowel sound /ʌ/, so it takes an: an umbrella. The article a is used before consonant sounds, and the would only work if a specific, already-known umbrella were meant. First mention of an unspecified object gets a or an depending on the sound.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1eacfad8-37aa-58a9-a2bf-31c59371d95a', '7db09ff5-a6f4-5518-a43a-ef0a0df8b143', 'What is the correct plural of "bus"?', '[{"id":"a","text":"buss"},{"id":"b","text":"buses"},{"id":"c","text":"busies"},{"id":"d","text":"bus"}]'::jsonb, 'b', 'Bus ends in -s, so it takes -es in the plural: bus → buses. Just adding another -s ("buss") would make the ending hard to pronounce, the -ies rule applies only to nouns ending in consonant + y, and bus without any ending stays singular.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('83b97bbd-d0bb-5749-8ccd-9656b9cd2b96', '7db09ff5-a6f4-5518-a43a-ef0a0df8b143', 'Fill the gaps: "I found ___ wallet in the street. I gave ___ wallet to the police."', '[{"id":"a","text":"a … the"},{"id":"b","text":"the … a"},{"id":"c","text":"a … a"},{"id":"d","text":"the … the"}]'::jsonb, 'a', 'The first mention of something unknown uses a: I found a wallet. The second mention switches to the because now both speaker and listener know which wallet: I gave the wallet to the police. This a → the shift is the core article pattern.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5177e665-67d0-5f68-aa0b-8be53e337eed', '7db09ff5-a6f4-5518-a43a-ef0a0df8b143', 'What is the correct plural of "foot"?', '[{"id":"a","text":"foots"},{"id":"b","text":"feet"},{"id":"c","text":"feets"},{"id":"d","text":"footes"}]'::jsonb, 'b', 'Foot is an irregular noun that changes its vowel in the plural: foot → feet (like tooth → teeth, goose → geese). "foots" wrongly applies the regular -s rule, "feets" adds -s to a form that is already plural, and "footes" is an invented ending.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('96b06a73-ff1f-5f93-88aa-db7ea6cfcf63', '7db09ff5-a6f4-5518-a43a-ef0a0df8b143', 'Choose the correct sentence about rice in general.', '[{"id":"a","text":"A rice is popular in many countries."},{"id":"b","text":"An rice is popular in many countries."},{"id":"c","text":"Rice is popular in many countries."},{"id":"d","text":"The rices are popular in many countries."}]'::jsonb, 'c', 'Rice is an uncountable noun used here as a general statement, so it takes no article and has no plural form: Rice is popular in many countries. You cannot say a rice or an rice (uncountable nouns never take a/an), and "the rices" would wrongly suggest a countable plural.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('26843890-1ba6-58c3-b500-ed02f3003f9a', '7db09ff5-a6f4-5518-a43a-ef0a0df8b143', 'Find the INCORRECT sentence.', '[{"id":"a","text":"There are six women in the room."},{"id":"b","text":"He is an engineer."},{"id":"c","text":"The children are playing outside."},{"id":"d","text":"I need a information about the bus."}]'::jsonb, 'd', 'The error is (d): information is an uncountable noun and cannot take the article a — say I need some information or I need information. Sentences (a), (b) and (c) are all correct: the irregular plural women, an engineer (vowel sound /e/), and the irregular plural children.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('3c7fc987-3613-5c82-85ce-113d864d9da7', '4637b3e6-610c-5b41-b0f9-dba49d698d90', 'anglais-a1', '⭐⭐ Drill: Everyday Vocabulary', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('68221073-7bec-5842-a2bb-545060593496', '3c7fc987-3613-5c82-85ce-113d864d9da7', 'Which word means the son of your brother or sister?', '[{"id":"a","text":"nephew"},{"id":"b","text":"niece"},{"id":"c","text":"cousin"},{"id":"d","text":"grandfather"}]'::jsonb, 'a', 'Your nephew is the son of your brother or sister; the daughter would be your niece. A cousin is the child of your aunt or uncle, and a grandfather is your parent''s father. Nephew (boy) and niece (girl) are a gender pair — keep them apart.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7b4ad1b5-8737-5284-a193-6f356e9ad7f2', '3c7fc987-3613-5c82-85ce-113d864d9da7', 'Find the odd one out.', '[{"id":"a","text":"pilot"},{"id":"b","text":"baker"},{"id":"c","text":"black"},{"id":"d","text":"engineer"}]'::jsonb, 'c', 'Pilot, baker and engineer are all jobs — work that people do. Black is a colour, so it is the odd one out. Grouping words by field (jobs, colours, foods) is a useful memory trick.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('043292c4-fd5c-570b-bf5c-17992b9dbce4', '3c7fc987-3613-5c82-85ce-113d864d9da7', 'Complete the common phrase: "a ___ of juice".', '[{"id":"a","text":"loaf"},{"id":"b","text":"slice"},{"id":"c","text":"piece"},{"id":"d","text":"bottle"}]'::jsonb, 'd', 'Juice is a drink you pour, so we say a bottle of juice (or a glass of juice). A loaf, a slice and a piece all go with solid foods like bread or cake — they cannot hold a liquid like juice.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ea5a9313-0002-5858-8f9e-94aa2a134e13', '3c7fc987-3613-5c82-85ce-113d864d9da7', 'The opposite of "early" is …', '[{"id":"a","text":"fast"},{"id":"b","text":"late"},{"id":"c","text":"new"},{"id":"d","text":"cheap"}]'::jsonb, 'b', 'The opposite of early (before the expected time) is late (after the expected time): I am early / I am late. Fast is the opposite of slow, new is the opposite of old, and cheap is the opposite of expensive — none of those means the same as late.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('21f351d1-c168-5779-b1bb-c5d66572ba48', '3c7fc987-3613-5c82-85ce-113d864d9da7', 'Which word belongs to the field "colours"?', '[{"id":"a","text":"pink"},{"id":"b","text":"cousin"},{"id":"c","text":"pilot"},{"id":"d","text":"Friday"}]'::jsonb, 'a', 'Pink is a colour. Cousin is a family word, pilot is a job, and Friday is a day of the week, so none of those is a colour. Colours at A1 include red, blue, green, yellow, orange, black, white, brown, grey and pink.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c3a2f3d3-8e26-558d-81ae-3a612374ce45', '3c7fc987-3613-5c82-85ce-113d864d9da7', 'Read: "My father has one brother. That brother has a daughter named Yasmine."
What is Yasmine to me?', '[{"id":"a","text":"my sister"},{"id":"b","text":"my niece"},{"id":"c","text":"my aunt"},{"id":"d","text":"my cousin"}]'::jsonb, 'd', 'My father''s brother is my uncle, and the child of my uncle is my cousin. Yasmine is a girl, but cousin is the same word for boys and girls. A niece would be my own sibling''s daughter, a sister shares my parents, and an aunt is a parent''s sister — so only cousin fits the daughter of an uncle.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('ea3b3f60-a711-56bc-8415-44aa1b31f791', '492783bf-3de9-5c90-81ff-7ead506d6381', 'anglais-a1', '⭐⭐ Drill: Asking Questions & Reading', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ddf19fc8-781e-54f7-9048-c70095c2fe40', 'ea3b3f60-a711-56bc-8415-44aa1b31f791', 'Which question word asks about a REASON?', '[{"id":"a","text":"What"},{"id":"b","text":"Whose"},{"id":"c","text":"Why"},{"id":"d","text":"How many"}]'::jsonb, 'c', 'Why asks for a reason and expects an answer starting with Because: Why are you tired? — Because I didn''t sleep. What asks for a thing, whose asks for an owner, and how many asks for a number — none of these asks for a reason.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dd273d44-5acf-5c17-a0e1-1bede2bbd08f', 'ea3b3f60-a711-56bc-8415-44aa1b31f791', 'Complete: "___ old are you?" — "I am fourteen."', '[{"id":"a","text":"What"},{"id":"b","text":"How"},{"id":"c","text":"When"},{"id":"d","text":"Where"}]'::jsonb, 'b', 'To ask about age in English, use How old: How old are you? — I am fourteen. "What old" is not English (we cannot say "what old"), when asks for a time, and where asks for a place — neither fits an age answer.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a9dd8f35-af34-5821-bb91-362f482eed38', 'ea3b3f60-a711-56bc-8415-44aa1b31f791', 'Complete: "___ does your brother go to school?" — "On foot."', '[{"id":"a","text":"How"},{"id":"b","text":"What"},{"id":"c","text":"When"},{"id":"d","text":"Where"}]'::jsonb, 'a', '"On foot" describes the way of travelling, so the question word is how: How does your brother go to school? What asks for a thing, when asks for a time, and where asks for a place — none of those is answered by "on foot".', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4e4510df-5519-5758-8a67-b893f598176d', 'ea3b3f60-a711-56bc-8415-44aa1b31f791', 'Choose the correct question: "___ colour is your bag?"', '[{"id":"a","text":"How"},{"id":"b","text":"Where"},{"id":"c","text":"When"},{"id":"d","text":"What"}]'::jsonb, 'd', 'Colour is a thing, so we use What: What colour is your bag? The phrase "what colour" is a fixed pattern in English. How asks about manner or condition, where about place, and when about time — none fits a question about colour.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5ef6b45a-2a18-50f5-9ef7-3c16b7fcf70f', 'ea3b3f60-a711-56bc-8415-44aa1b31f791', 'Find the INCORRECT question.', '[{"id":"a","text":"What does he do every morning?"},{"id":"b","text":"How many sisters does she have?"},{"id":"c","text":"Why does he late?"},{"id":"d","text":"Where do they live?"}]'::jsonb, 'c', 'The error is (c): late is an adjective, not a verb, so the question needs the verb to be — Why is he late? You cannot use does with an adjective ("does he late" has no main verb). Sentences (a), (b) and (d) all form their questions correctly with do/does.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('88243ea0-bf61-54a6-ba03-a83c22e4b007', 'ea3b3f60-a711-56bc-8415-44aa1b31f791', 'Read: "Ahmed sells fruit at the market. He opens his stall at seven in the morning. He sells oranges, apples and bananas."
What does Ahmed sell?', '[{"id":"a","text":"He sells vegetables."},{"id":"b","text":"He sells clothes."},{"id":"c","text":"He opens at nine."},{"id":"d","text":"He sells fruit."}]'::jsonb, 'd', 'The text says "Ahmed sells fruit", so the answer is He sells fruit (d). He sells oranges, apples and bananas (all fruit, not vegetables). "He sells clothes" and "He opens at nine" are not in the text — he opens at seven, not nine, and clothes are not mentioned.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
