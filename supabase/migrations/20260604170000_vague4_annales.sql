...
«المهندسُ البارعُ يرسم خرائطَ دقيقةً قبل أن يشيّد بنيانًا متينًا.»

ما نوع كلمة «البارعُ» من حيث الاشتقاق؟', '[{"id":"a","text":"صفة مشبّهة باسم الفاعل تدلّ على ثبوت الصفة"},{"id":"b","text":"اسم مفعول يدلّ على من وقع عليه الفعل"},{"id":"c","text":"اسم تفضيل يدلّ على المفاضلة"},{"id":"d","text":"اسم مكان يدلّ على موضع الحدث"}]'::jsonb, 'a', '«البارع» على وزن «فاعِل» لكنّه يدلّ على صفةٍ ثابتةٍ لازمة في صاحبها (البراعة المستقرّة)، فهو صفة مشبّهة. وليس اسم مفعول (b) فهو لم يقع عليه الحدث بل اتّصف بالبراعة، ولا اسم تفضيل (c) إذ لا مفاضلة بين شيئين، ولا اسم مكان (d).', 5),
