...
-- Subject: iq-training-en (Train Your Brain — IQ Workout)
...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('iq-training-en', 'Train Your Brain — IQ Workout', 'Pure logic visual challenges: study the figure, deduce the hidden rule, pick the right answer — no memory required, just reasoning.', 'Logique', 'subject-math', 'Brain', 61, 'en', false, 'muscle-cerveau', NULL)
...
Here we revise nothing: every mission is a puzzle to solve through pure deduction. Trust your eye and your logic. 💪', '📜 Solve by deduction, never by memory.', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('8f816f7e-6684-527f-a6ae-9c1b3f03a4a5', 'iq-training-en', 'Logic', 'Sequences, analogies, syllogisms and conditional deductions: spot the hidden rule and apply it without memorizing anything.', '# 🧠 Logic — no lesson. Observe, deduce the rule, apply it.', '📜 A single rule governs each puzzle: find it, then apply it.', 2, NULL)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('c7acf680-2963-5ff7-a9c0-857a4e2fac72', '914c2043-32fe-5bfa-8a7d-ee2a1192f5e6', 'Observe the number sequence and find the hidden rule: 3, 6, 9, 12, ? — which number comes next?', '[{"id":"a","text":"15"},{"id":"b","text":"13"},{"id":"c","text":"16"},{"id":"d","text":"24"}]'::jsonb, 'a', 'The hidden rule: you add 3 at each step (3, 6, 9, 12…). ✓ So the next term is 12 + 3 = 15, which is option a. Option b (13) adds only 1, as if you were just counting on. Option c (16) adds 4: that''s the right type of operation but the wrong step. Option d (24) doubles the last term instead of continuing the steady addition.', 1, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('ec59bb07-440b-5917-945d-789568f909d1', '70ba8162-4ecf-57ef-8f32-f6e5f0896d11', 'Observe the sequence and find the hidden rule: 4, 7, 10, 13, ? Which number comes next?', '[{"id":"a","text":"16"},{"id":"b","text":"15"},{"id":"c","text":"17"},{"id":"d","text":"26"}]'::jsonb, 'a', 'The rule is: +3 at each step (7−4 = 3, 10−7 = 3, 13−10 = 3). So the next number is 13 + 3 = 16 → option a ✓. The trap: b (15) adds only 2, c (17) adds 4, and d (26) doubles the last number. The gap between two terms stays constant and equals 3.', 1, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('fc4b4205-7bbe-5259-8678-cd146df4875d', '5b56de20-a91e-5db0-876f-b6ec0ed4d85d', 'iq-training-en', '⭐⭐ Free entry: work it out and type the answer', 2, 75, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('9e42237d-d95a-58fc-8c79-134cc95f15e1', 'fc4b4205-7bbe-5259-8678-cd146df4875d', 'No options this time: find the rule and TYPE the next number. 5, 8, 11, 14, ?', '[]'::jsonb, NULL, 'The rule is +3 at each step (8−5 = 3, 11−8 = 3, 14−11 = 3). The next number is therefore 14 + 3 = 17. With no options to eliminate, your own calculation does the talking!', 1, 'numeric', '{"value":17}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('12d6d1d7-18ed-536f-af51-d99c026a5863', 'fc4b4205-7bbe-5259-8678-cd146df4875d', 'Find the rule shared by both examples, then apply it and type the result: 3 → 9, 5 → 15, so 8 → ?', '[]'::jsonb, NULL, 'Only one rule works for BOTH examples: multiply by 3 (3 × 3 = 9 and 5 × 3 = 15 ✓). Applied to 8: 8 × 3 = 24.', 2, 'numeric', '{"value":24}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('9204d29d-423c-5dd5-a1b4-cc16941fd291', 'fc4b4205-7bbe-5259-8678-cd146df4875d', 'I am thinking of a number. Its double minus 4 equals 10. Type that number.', '[]'::jsonb, NULL, 'Work backwards: if the double minus 4 equals 10, the double equals 10 + 4 = 14, so the number is 14 ÷ 2 = 7. Check: 2 × 7 − 4 = 10 ✓.', 3, 'numeric', '{"value":7}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('40165d5a-15e2-5e66-891e-718cfb882207', 'fc4b4205-7bbe-5259-8678-cd146df4875d', 'Compute the average of 12, 15 and 18, then type the result.', '[]'::jsonb, NULL, 'Average = sum ÷ count = (12 + 15 + 18) ÷ 3 = 45 ÷ 3 = 15. Tip: when the values are evenly spaced, the average is the middle one.', 4, 'numeric', '{"value":15}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('3bf33e50-0d98-54e9-84c0-6b38e3c3c10a', 'fc4b4205-7bbe-5259-8678-cd146df4875d', 'Compute one third of one half of 42, then type the result.', '[]'::jsonb, NULL, 'Step by step: half of 42 is 42 ÷ 2 = 21, then a third of 21 is 21 ÷ 3 = 7. The order does not matter here: 42 ÷ 6 = 7 as well.', 5, 'numeric', '{"value":7}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('9325e99e-6ee7-59e4-8e4c-20553948083d', 'fc4b4205-7bbe-5259-8678-cd146df4875d', 'Each term is multiplied by the same number: 0.5, 1.5, 4.5, ? Type the next term (a dot or a comma both work).', '[]'::jsonb, NULL, 'The ratio is constant: 1.5 ÷ 0.5 = 3 and 4.5 ÷ 1.5 = 3 — each term is multiplied by 3. The next one is therefore 4.5 × 3 = 13.5.', 6, 'numeric', '{"value":13.5}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('ee3ab6dc-163b-5a64-9ee0-ff2626ecf2b6', '5b56de20-a91e-5db0-876f-b6ec0ed4d85d', 'iq-training-en', '⭐⭐ Drag & drop: order and match', 2, 75, 15, 'practice', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('5c388431-3f13-51d4-88f6-a08d84523323', 'ee3ab6dc-163b-5a64-9ee0-ff2626ecf2b6', 'Arrange these numbers from smallest to largest (drag them into order).', '[{"id":"a","text":"0.5"},{"id":"b","text":"0.09"},{"id":"c","text":"0.45"}]'::jsonb, NULL, 'Compare digit by digit after the decimal point: 0.09 < 0.45 < 0.5 (since 0.5 = 0.50). The classic trap: 0.09 looks "big" because of the 9, but its tenths digit is 0.', 1, 'ordering', '{"order":["b","c","a"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('5171b564-2239-5a57-96cf-3cea9cad3b39', 'ee3ab6dc-163b-5a64-9ee0-ff2626ecf2b6', 'Put the steps for solving the equation 2x + 4 = 10 back in order.', '[{"id":"a","text":"Divide both sides by 2: x = 3"},{"id":"b","text":"Subtract 4 from both sides: 2x = 6"},{"id":"c","text":"Check: 2 × 3 + 4 = 10 ✓"}]'::jsonb, NULL, 'First isolate the x term by subtracting 4 (2x = 6), then divide by 2 (x = 3), and always finish with the check: 2 × 3 + 4 = 10 ✓.', 2, 'ordering', '{"order":["b","a","c"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('f4a52681-48b7-59eb-aa56-4565d8ff1277', 'ee3ab6dc-163b-5a64-9ee0-ff2626ecf2b6', 'Match each mental calculation with its result.', '[{"id":"l1","text":"25% of 80"},{"id":"l2","text":"half of 46"},{"id":"l3","text":"double of 35"},{"id":"r1","text":"23"},{"id":"r2","text":"70"},{"id":"r3","text":"20"}]'::jsonb, NULL, '25% is one quarter, so 80 ÷ 4 = 20; half of 46 is 46 ÷ 2 = 23; double of 35 is 35 × 2 = 70.', 3, 'matching', '{"pairs":[["l1","r3"],["l2","r1"],["l3","r2"]]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('af2898e9-803a-53f5-be4b-7bdf70977189', 'ee3ab6dc-163b-5a64-9ee0-ff2626ecf2b6', 'Match each sequence with the rule that drives it.', '[{"id":"l1","text":"2, 4, 8, 16"},{"id":"l2","text":"5, 8, 11, 14"},{"id":"l3","text":"64, 32, 16, 8"},{"id":"r1","text":"add 3"},{"id":"r2","text":"divide by 2"},{"id":"r3","text":"multiply by 2"}]'::jsonb, NULL, '2, 4, 8, 16 doubles at each step (×2); 5, 8, 11, 14 advances by +3 (8−5 = 3); 64, 32, 16, 8 is divided by 2 each step. Always check the rule on TWO consecutive steps.', 4, 'matching', '{"pairs":[["l1","r3"],["l2","r1"],["l3","r2"]]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('b909a81d-ffe4-59df-a4f5-a4f6d5425fbe', '5b56de20-a91e-5db0-876f-b6ec0ed4d85d', 'iq-training-en', '⭐⭐ Multi-select: check ALL the correct answers', 2, 75, 15, 'practice', 'admin', 6)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('d88524a5-ce16-59e7-b844-653821d637ea', 'b909a81d-ffe4-59df-a4f5-a4f6d5425fbe', 'Among these numbers, check ALL that are multiples of 3.', '[{"id":"a","text":"9"},{"id":"b","text":"10"},{"id":"c","text":"21"},{"id":"d","text":"16"}]'::jsonb, NULL, '9 = 3 × 3 and 21 = 3 × 7 are multiples of 3. 10 and 16 are not (10 ÷ 3 and 16 ÷ 3 are not whole numbers).', 1, 'multi', '{"correct":["a","c"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('e2995138-7963-56a6-b23c-01cccf5a6afa', 'b909a81d-ffe4-59df-a4f5-a4f6d5425fbe', 'About an even number, check ALL the statements that are true.', '[{"id":"a","text":"it is divisible by 2"},{"id":"b","text":"its last digit is 0, 2, 4, 6 or 8"},{"id":"c","text":"it must be a multiple of 4"},{"id":"d","text":"its sum with another even number is always even"}]'::jsonb, NULL, 'An even number is indeed divisible by 2 (a) and ends in 0/2/4/6/8 (b); the sum of two even numbers is always even (d). But 6 is even without being a multiple of 4, so c is false.', 2, 'multi', '{"correct":["a","b","d"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('c6807dfd-31e7-58d3-94b8-04a2d1253ada', 'b909a81d-ffe4-59df-a4f5-a4f6d5425fbe', 'Which of these sequences advance by a CONSTANT step (an arithmetic progression)? Check ALL that apply.', '[{"id":"a","text":"3, 6, 9, 12"},{"id":"b","text":"2, 4, 8, 16"},{"id":"c","text":"5, 8, 11, 14"},{"id":"d","text":"1, 4, 9, 16"}]'::jsonb, NULL, '3, 6, 9, 12 advances by +3 each step, and 5, 8, 11, 14 also advances by +3: both are arithmetic progressions. 2, 4, 8, 16 doubles each time (×2, not a constant gap), and 1, 4, 9, 16 are consecutive squares (1², 2², 3², 4²) — neither has a constant step.', 3, 'multi', '{"correct":["a","c"]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key) VALUES
  ('ec5c7302-4606-54ef-85e2-e52d6f3aab56', '9e8580b3-7937-5964-a676-ea57ff9882f2', 'In each box, the dot always moves one corner to the right (clockwise). Where will it be in the missing box? <svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg"><rect x="6" y="38" width="22" height="22" fill="none" stroke="#0f766e" stroke-width="2"/><circle cx="11" cy="43" r="3.5" fill="#0f766e"/><rect x="32" y="38" width="22" height="22" fill="none" stroke="#0f766e" stroke-width="2"/><circle cx="49" cy="43" r="3.5" fill="#0f766e"/><rect x="58" y="38" width="22" height="22" fill="none" stroke="#0f766e" stroke-width="2"/><circle cx="75" cy="55" r="3.5" fill="#0f766e"/><rect x="84" y="38" width="22" height="22" fill="none" stroke="#0f766e" stroke-width="2"/><text x="95" y="55" font-size="15" fill="#64748b" text-anchor="middle">?</text></svg>', '[{"id":"a","text":"<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"38\" y=\"38\" width=\"24\" height=\"24\" fill=\"none\" stroke=\"#0f766e\" stroke-width=\"2\"/><circle cx=\"56\" cy=\"44\" r=\"3.5\" fill=\"#0f766e\"/></svg>"},{"id":"b","text":"<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"38\" y=\"38\" width=\"24\" height=\"24\" fill=\"none\" stroke=\"#0f766e\" stroke-width=\"2\"/><circle cx=\"44\" cy=\"56\" r=\"3.5\" fill=\"#0f766e\"/></svg>"},{"id":"c","text":"<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"38\" y=\"38\" width=\"24\" height=\"24\" fill=\"none\" stroke=\"#0f766e\" stroke-width=\"2\"/><circle cx=\"56\" cy=\"56\" r=\"3.5\" fill=\"#0f766e\"/></svg>"},{"id":"d","text":"<svg viewBox=\"0 0 100 100\" xmlns=\"http://www.w3.org/2000/svg\"><rect x=\"38\" y=\"38\" width=\"24\" height=\"24\" fill=\"none\" stroke=\"#0f766e\" stroke-width=\"2\"/><circle cx=\"44\" cy=\"44\" r=\"3.5\" fill=\"#0f766e\"/></svg>"}]'::jsonb, 'b', 'The hidden rule: the dot advances one corner clockwise in each box — top-left, top-right, bottom-right… ✓ The next corner clockwise is bottom-left, which is option b. Option c (bottom-right) repeats the previous box. Option a (top-right) steps back one. Option d (top-left) returns to the starting point, as if the loop were already complete.', 3, 'mcq', NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
