-- Ouvrir le parcours Baccalauréat — section Sciences expérimentales :
...
--
--   * français — `french-bac-sciences-exp`, **7 chapitres sur 7 (100 %)**, compilés
...
--   * anglais — `english-bac-sciences-exp`, 6 chapitres, même mécanique depuis
...
-- dominantes propres (SVT et sciences physiques) et la philosophie — dont le chapitrage est
...
WHERE id = 'concours-bac-sciences-exp';
