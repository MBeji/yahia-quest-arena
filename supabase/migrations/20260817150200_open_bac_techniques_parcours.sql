-- Ouvrir le parcours Baccalauréat — section Sciences techniques :
...
--
--   * français — `french-bac-techniques`, **7 chapitres sur 7 (100 %)**, compilés
...
--   * anglais — `english-bac-techniques`, 6 chapitres, même mécanique depuis
...
-- dominantes propres (technologie et sciences techniques) et la philosophie — dont le chapitrage est
...
WHERE id = 'concours-bac-techniques';
