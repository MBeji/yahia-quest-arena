...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('c5e78bf2-6447-53a1-95f4-fb8393484462', '68fcfcd2-e474-535f-afcb-4be86b27d228', 'العقدة المعلّمة بنقطةٍ سوداء تقع في السطر 2 والعمود 4. كيف نكتب موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(4 ; 2)"},{"id":"b","text":"(2 ; 2)"},{"id":"c","text":"(4 ; 4)"},{"id":"d","text":"(2 ; 4)"}]'::jsonb, 'd', 'نكتب السطر أوّلًا ثمّ العمود: السطر 2 والعمود 4، أي (2 ; 4). الترتيب (4 ; 2) خطأ لأنّه يعكس السطر والعمود.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('e8908e1c-7cad-541d-a2ff-fff7a9cc7670', '6f8bca92-5bde-5296-a8e9-e6c5f5cd9f99', 'العقدة المعلّمة تقع في السطر 1 والعمود 3. ما موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(3 ; 1)"},{"id":"b","text":"(1 ; 3)"},{"id":"c","text":"(1 ; 1)"},{"id":"d","text":"(3 ; 3)"}]'::jsonb, 'b', 'نكتب السطر أوّلًا ثمّ العمود: السطر 1 والعمود 3 يُكتب (1 ; 3).', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('0d1c0441-9d90-5bc0-a8b7-6023a7f562a7', 'ec820faa-04fd-53ac-9841-5477b8ba7984', 'العقدة في السطر 3 والعمود 2. ما موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(2 ; 3)"},{"id":"b","text":"(3 ; 2)"},{"id":"c","text":"(3 ; 3)"},{"id":"d","text":"(2 ; 2)"}]'::jsonb, 'b', 'السطر أوّلًا ثمّ العمود: السطر 3 والعمود 2 يُكتب (3 ; 2). الزوج (2 ; 3) يعكس الترتيب فهو خطأ.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('597bdb0b-ee05-5669-ac88-d71acc96be73', '836f097b-ff8d-5790-a559-f91a64bc4129', 'العقدة في السطر 2 والعمود 1. ما موضعها بالزوج (سطر، عمود)؟', '[{"id":"a","text":"(1 ; 2)"},{"id":"b","text":"(2 ; 2)"},{"id":"c","text":"(2 ; 1)"},{"id":"d","text":"(1 ; 1)"}]'::jsonb, 'c', 'السطر أوّلًا ثمّ العمود: السطر 2 والعمود 1 يُكتب (2 ; 1). الزوج (1 ; 2) يعكس الترتيب.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('ed5208fa-35cd-503b-8ac0-b157453d6d36', 'fd6c52fc-9d01-5de4-b32c-8897708e53e3', 'مربّعٌ ضلعه 6 cm. ما محيطه؟', '[{"id":"a","text":"12 cm"},{"id":"b","text":"18 cm"},{"id":"c","text":"24 cm"},{"id":"d","text":"36 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 6 × 4 = 24 cm. (أو 6 + 6 + 6 + 6 = 24 cm.)', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('b4a5d4d0-f362-5966-85d8-106a2b902430', '0a2a8702-3e93-58fb-b458-2566b9c0fe4a', 'مربّعٌ ضلعه 3 cm. ما محيطه؟', '[{"id":"a","text":"9 cm"},{"id":"b","text":"6 cm"},{"id":"c","text":"12 cm"},{"id":"d","text":"7 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 3 × 4 = 12 cm. (أو 3 + 3 + 3 + 3 = 12 cm.)', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('f516cb77-19e2-56e9-8fb6-8475f6b2d822', '0a2a8702-3e93-58fb-b458-2566b9c0fe4a', 'مستطيلٌ طوله 5 cm وعرضه 3 cm. ما محيطه؟', '[{"id":"a","text":"8 cm"},{"id":"b","text":"13 cm"},{"id":"c","text":"15 cm"},{"id":"d","text":"16 cm"}]'::jsonb, 'd', 'المحيط = (الطول + العرض) × 2 = (5 + 3) × 2 = 8 × 2 = 16 cm.', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('4c93393c-7a0e-5ac4-8918-7a20ca32623b', '06b6c8c0-3f73-58b2-a9da-b180bc217e9d', 'مستطيلٌ طوله 7 cm وعرضه 3 cm. ما محيطه؟', '[{"id":"a","text":"10 cm"},{"id":"b","text":"21 cm"},{"id":"c","text":"20 cm"},{"id":"d","text":"14 cm"}]'::jsonb, 'c', 'المحيط = (7 + 3) × 2 = 10 × 2 = 20 cm. الخطأ الشائع: التوقّف عند 7 + 3 = 10 ونسيان الضرب في 2، لأنّ للمستطيل ضلعين بكلّ قياس.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('16e399ea-63cd-5e12-b2c4-ee38aecde75f', '06b6c8c0-3f73-58b2-a9da-b180bc217e9d', 'حديقةٌ مستطيلةٌ طولها 9 m وعرضها 6 m، نريد سياجًا حولها. كم مترًا من السياج نحتاج؟', '[{"id":"a","text":"15 m"},{"id":"b","text":"30 m"},{"id":"c","text":"24 m"},{"id":"d","text":"54 m"}]'::jsonb, 'b', 'طول السياج = محيط المستطيل = (9 + 6) × 2 = 15 × 2 = 30 m. الخطأ الشائع: ضرب 9 × 6 = 54 (ذلك ليس المحيط).', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('fe65563d-dad8-51c7-9e57-9dafde6f137d', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'مربّعٌ ضلعه 8 cm. ما محيطه؟', '[{"id":"a","text":"16 cm"},{"id":"b","text":"24 cm"},{"id":"c","text":"32 cm"},{"id":"d","text":"64 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 8 × 4 = 32 cm.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('af4fd70b-8a4b-57be-be0a-4191d0d6c101', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'مستطيلٌ طوله 10 cm وعرضه 4 cm. ما محيطه؟', '[{"id":"a","text":"14 cm"},{"id":"b","text":"28 cm"},{"id":"c","text":"40 cm"},{"id":"d","text":"24 cm"}]'::jsonb, 'b', 'المحيط = (الطول + العرض) × 2 = (10 + 4) × 2 = 14 × 2 = 28 cm.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('b86a261f-6175-5855-be3b-7df4894c91b4', '87aff9ac-39e1-5396-88b0-a0ec6392ecdb', 'مثلّثٌ أطوال أضلاعه 5 cm و6 cm و7 cm. ما محيطه؟', '[{"id":"a","text":"18 cm"},{"id":"b","text":"17 cm"},{"id":"c","text":"210 cm"},{"id":"d","text":"11 cm"}]'::jsonb, 'a', 'محيط المضلّع = مجموع أطوال أضلاعه = 5 + 6 + 7 = 18 cm.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('1c954ae7-239c-51b7-96e0-b787e7d1002b', 'cfb47759-fb46-529a-8bff-460fbc2e2c7f', 'مربّعٌ ضلعه 4 cm. ما محيطه؟', '[{"id":"a","text":"8 cm"},{"id":"b","text":"12 cm"},{"id":"c","text":"16 cm"},{"id":"d","text":"20 cm"}]'::jsonb, 'c', 'محيط المربّع = الضلع × 4 = 4 × 4 = 16 cm.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('75160c06-c81f-5a9b-9086-ea9be45bede9', 'cfb47759-fb46-529a-8bff-460fbc2e2c7f', 'نريد إطارًا حول صورةٍ مستطيلةٍ طولها 12 cm وعرضها 8 cm. كم سنتيمترًا من الإطار نحتاج؟', '[{"id":"a","text":"20 cm"},{"id":"b","text":"32 cm"},{"id":"c","text":"40 cm"},{"id":"d","text":"96 cm"}]'::jsonb, 'c', 'طول الإطار = محيط المستطيل = (12 + 8) × 2 = 20 × 2 = 40 cm. الخطأ الشائع: ضرب 12 × 8 = 96 (ذلك ليس المحيط).', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
