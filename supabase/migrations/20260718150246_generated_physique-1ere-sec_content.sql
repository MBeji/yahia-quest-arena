...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id, manuel_refs) VALUES
  ('physique-1ere-sec', 'Sciences Physiques', 'L''électricité, la matière, la mécanique, l''énergie, l''astronomie et l''optique selon le programme officiel de la 1ère année de l''enseignement secondaire (tronc commun) : le phénomène d''électrisation, le circuit électrique, l''intensité et la tension électriques, le dipôle résistor et la loi d''Ohm ; les états physiques de la matière, ses propriétés (dilatation, température, conductivité thermique), la masse (masse volumique, densité) et les changements d''état d''un corps pur ; la mécanique : le mouvement, les actions mécaniques et le poids, forces et équilibre, forces et pression ; l''énergie et son contrôle (sources renouvelables ou non, formes, conservation et conversions, modes de transfert, chaleur, isolation thermique) ; l''astronomie : la Terre et l''univers (corps célestes, constellations, année-lumière, système solaire, jours, nuits et saisons) ; l''optique : la lumière et sa propagation (sources primaires et secondaires, propagation rectiligne, ombres, phases de la Lune et éclipses), puis le spectre de la lumière blanche et la vision des couleurs (lumières monochromatique et polychromatique, absorption et diffusion des couleurs, daltonisme, ultraviolet et infrarouge)', 'Observation', 'subject-svt', 'Atom', 2, 'fr', false, 'ecole-tn', (SELECT id FROM public.grades WHERE theme_id = 'ecole-tn' AND slug = '1ere-sec'), NULL)
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('48a8ac5b-4a30-54e1-8e9d-b2a1465d264c', 'physique-1ere-sec', 'La Terre et l''univers', 'Les corps célestes : étoiles (qui scintillent et produisent leur lumière, comme le Soleil), planètes (comme la Terre), satellites (la Lune), astéroïdes, météores ou étoiles filantes et météorites. Les constellations et le repérage du nord par l''étoile Polaire à partir de la Grande Ourse. L''année-lumière (a.l), unité de distance : 1 a.l ≈ 9,46×10¹² km, avec c = 3×10⁸ m·s⁻¹. La Voie Lactée, notre Galaxie, et les amas de galaxies. Le système solaire (Soleil, planètes, satellites, ceinture d''astéroïdes, comètes) et les deux familles de planètes, telluriques et gazeuses. La rotation de la Terre sur son axe (succession des jours et des nuits) et sa révolution autour du Soleil, dont l''inclinaison de l''axe engendre les saisons', '# 🌌 La Terre et l''univers — voyage parmi les astres
...
> 🏆 Première quête de l''ASTRONOMIE franchie ! Étoiles et planètes, constellations, année-lumière, système solaire, jours, nuits et saisons : l''univers t''a livré ses repères. Héros, tu voyages maintenant parmi les astres !', '# 📜 Résumé : La Terre et l''univers
...
- **Jours, nuits et saisons.** La **rotation** de la Terre sur son axe (≈ 23 h 56 min) donne la **succession des jours et des nuits** ; sa **révolution** autour du Soleil (≈ 365,25 jours) avec l''**inclinaison** de l''axe donne les **saisons**.', 15, '{"code":"223103P00","pages":"227-242","pageNumbers":[227,228,229,230,231,232,233,234,235,236,237,238,239,240,241,242]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('f6966a12-cbe5-5382-ab2f-9ff6b6376703', 'physique-1ere-sec', 'La lumière et sa propagation', 'L''œil, détecteur de lumière : un objet n''est visible que s''il envoie de la lumière dans nos yeux. Les sources primaires de lumière (qui produisent leur lumière) et secondaires (qui diffusent la lumière reçue). Les corps transparents, translucides et opaques. La propagation rectiligne de la lumière dans un milieu homogène et transparent ; le rayon lumineux, les faisceaux (parallèle, convergent, divergent) ; la célérité de la lumière dans le vide c = 3×10⁸ m·s⁻¹. L''ombre propre et l''ombre portée avec une source ponctuelle ; l''ombre et la pénombre avec une source étendue. Les phases de la Lune (lunaison) et les éclipses de Soleil et de Lune, expliquées par la propagation rectiligne et l''alignement des astres', '# 🔦 La lumière et sa propagation — sur le chemin des rayons
...
> 🏆 Première quête de L''OPTIQUE franchie ! Sources, transparence, propagation rectiligne, ombres, phases et éclipses : tu sais suivre la lumière du départ jusqu''à ton œil. Héros, plus rien ne t''aveugle !', '# 📜 Résumé : La lumière et sa propagation
...
- **Phases et éclipses.** La Lune, éclairée par le Soleil, montre ses **phases** au cours de la **lunaison** (≈ 29,5 jours). **Éclipse de Soleil** : Lune entre Soleil et Terre (Soleil – Lune – Terre). **Éclipse de Lune** : Lune dans le cône d''ombre de la Terre (Soleil – Terre – Lune).', 16, '{"code":"223103P00","pages":"243-258","pageNumbers":[243,244,245,246,247,248,249,250,251,252,253,254,255,256,257,258]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order, manuel_ref) VALUES
  ('a736a592-8789-5052-967c-ac0256c430e0', 'physique-1ere-sec', 'Spectre de lumière et vision', 'La décomposition de la lumière blanche par un prisme ou un réseau : le spectre continu, les lumières monochromatiques (radiations) du rouge au violet, la lumière blanche polychromatique ; l''arc-en-ciel. La couleur des objets par absorption et diffusion sélective des radiations ; un corps qui absorbe toutes les radiations paraît noir ; la couleur dépend de l''objet et de la lumière qui l''éclaire. La vision des couleurs par les cônes de la rétine (sensibles au rouge, au vert et au bleu) et le daltonisme. Les illusions d''optique (interprétation du cerveau). Le transfert d''énergie par rayonnement lumineux. Les rayonnements invisibles : l''ultraviolet (au-delà du violet) et l''infrarouge (en deçà du rouge), leur mise en évidence et leurs applications. Les couleurs primaires, secondaires et complémentaires (synthèse additive)', '# 🌈 Spectre de lumière et vision — les couleurs cachées de la lumière
...
> 🏆 Quête de L''OPTIQUE achevée — et avec elle, tout le programme ! Spectre, couleurs, vision, rayonnements invisibles : la lumière n''a plus de secret pour toi. Héros, tu vois désormais au-delà du visible !', '# 📜 Résumé : Spectre de lumière et vision
...
- **Mélange des lumières.** Couleurs **primaires** : rouge, vert, bleu ; leurs sommes donnent les **secondaires** (jaune, magenta, cyan) ; les trois réunies donnent du **blanc** (synthèse additive).', 17, '{"code":"223103P00","pages":"259-274","pageNumbers":[259,260,261,262,263,264,265,266,267,268,269,270,271,272,273,274]}'::jsonb)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('34f74307-494d-5820-8ef9-1dda219e5620', '48a8ac5b-4a30-54e1-8e9d-b2a1465d264c', 'physique-1ere-sec', 'Test de compréhension ⭐ : La Terre et l''univers', 1, 20, 5, 'quiz', 'admin', 0)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('ec63dca2-a61b-52b0-a3f3-75a4f4c7d77f', '34f74307-494d-5820-8ef9-1dda219e5620', 'Le Soleil produit sa propre lumière et scintille dans le ciel. C''est donc...', '[{"id":"a","text":"une planète"},{"id":"b","text":"une étoile"},{"id":"c","text":"un satellite"},{"id":"d","text":"une comète"}]'::jsonb, 'b', 'Le Soleil est une étoile ✓ : il produit sa propre lumière et scintille. Les planètes, elles, ne font que renvoyer la lumière qu''elles reçoivent.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('9a7d68d6-43a8-50d3-9425-278bb238d62d', '34f74307-494d-5820-8ef9-1dda219e5620', 'Par rapport à la Terre, la Lune est...', '[{"id":"a","text":"un satellite naturel"},{"id":"b","text":"une étoile"},{"id":"c","text":"une planète"},{"id":"d","text":"une constellation"}]'::jsonb, 'a', 'La Lune tourne autour de la Terre : c''est son satellite naturel ✓. Elle ne produit pas sa propre lumière (ce n''est pas une étoile).', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('3ae2033a-110e-5866-9ace-c8204de45c04', '34f74307-494d-5820-8ef9-1dda219e5620', 'Comment appelle-t-on un groupement d''étoiles vu dans une même région du ciel ?', '[{"id":"a","text":"une galaxie"},{"id":"b","text":"un amas"},{"id":"c","text":"une comète"},{"id":"d","text":"une constellation"}]'::jsonb, 'd', 'Un groupement d''étoiles vu dans une même région du ciel est une constellation ✓ (comme la Grande Ourse), utilisée depuis toujours pour se repérer.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('a4f59707-0b07-535e-b11c-c192fef06a7d', '34f74307-494d-5820-8ef9-1dda219e5620', 'L''année-lumière est une unité de...', '[{"id":"a","text":"durée (temps)"},{"id":"b","text":"distance"},{"id":"c","text":"masse"},{"id":"d","text":"vitesse"}]'::jsonb, 'b', 'L''année-lumière est la distance parcourue par la lumière en une année : c''est donc une distance ✓ (1 a.l ≈ 9,46×10¹² km), pas une durée, malgré le mot « année ».', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('38cc53ed-0724-5a7e-85b7-01ee89518441', '34f74307-494d-5820-8ef9-1dda219e5620', 'Parmi ces planètes, laquelle est une planète tellurique ?', '[{"id":"a","text":"Jupiter"},{"id":"b","text":"Saturne"},{"id":"c","text":"Mars"},{"id":"d","text":"Neptune"}]'::jsonb, 'c', 'Mars est une planète tellurique ✓ : dense et à surface solide, comme Mercure, Vénus et la Terre. Jupiter, Saturne et Neptune sont des planètes gazeuses.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('ef1c4717-9b80-5f96-99b4-c706b2ffba98', '48a8ac5b-4a30-54e1-8e9d-b2a1465d264c', 'physique-1ere-sec', '⭐ Exercice : Astres, système solaire et rotation', 1, 50, 10, 'practice', 'admin', 1)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('7e67450c-0184-5096-9949-daa76b7366f8', 'ef1c4717-9b80-5f96-99b4-c706b2ffba98', 'Un astre qui ne scintille pas et qui renvoie la lumière du Soleil est...', '[{"id":"a","text":"une étoile"},{"id":"b","text":"une planète"},{"id":"c","text":"une comète"},{"id":"d","text":"le Soleil lui-même"}]'::jsonb, 'b', 'Une planète ne produit pas sa propre lumière : elle renvoie celle du Soleil et ne scintille pas ✓. Ce sont les étoiles qui scintillent et produisent leur lumière.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('5f1bee98-cadf-54e7-9b53-c2668cfdd8d2', 'ef1c4717-9b80-5f96-99b4-c706b2ffba98', 'Comment appelle-t-on un petit corps céleste qui brûle en entrant dans l''atmosphère terrestre ?', '[{"id":"a","text":"une météorite"},{"id":"b","text":"une planète"},{"id":"c","text":"une galaxie"},{"id":"d","text":"un météore (étoile filante)"}]'::jsonb, 'd', 'En brûlant au contact de l''atmosphère, il forme un météore, ou étoile filante ✓. S''il atteint le sol, on parle alors de météorite.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('6221fc66-86c4-5eb0-a8a5-aa93a3873b7d', 'ef1c4717-9b80-5f96-99b4-c706b2ffba98', 'Grâce à quelle constellation retrouve-t-on facilement l''étoile Polaire, qui indique le nord ?', '[{"id":"a","text":"la Grande Ourse"},{"id":"b","text":"Orion"},{"id":"c","text":"le Lion"},{"id":"d","text":"le Cygne"}]'::jsonb, 'a', 'La Grande Ourse, en forme de casserole, permet de repérer l''étoile Polaire, qui indique le nord ✓.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('f10328ea-d894-5adc-ac26-4bbe175fe5b6', 'ef1c4717-9b80-5f96-99b4-c706b2ffba98', 'Comment appelle-t-on notre galaxie ?', '[{"id":"a","text":"Andromède"},{"id":"b","text":"l''Amas Local"},{"id":"c","text":"la Voie Lactée"},{"id":"d","text":"Magellan"}]'::jsonb, 'c', 'Notre galaxie est la Voie Lactée ✓, un immense disque en spirale d''environ 200 milliards d''étoiles. L''Amas Local est le groupe de galaxies auquel elle appartient.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('d01b8d94-c4ca-5e28-9481-bc4370d18565', 'ef1c4717-9b80-5f96-99b4-c706b2ffba98', 'Qu''est-ce qui engendre la succession des jours et des nuits ?', '[{"id":"a","text":"la révolution de la Terre autour du Soleil"},{"id":"b","text":"l''inclinaison de l''axe de la Terre"},{"id":"c","text":"la rotation de la Terre sur son axe"},{"id":"d","text":"les phases de la Lune"}]'::jsonb, 'c', 'En tournant sur son axe (en environ 23 h 56 min), la Terre présente tour à tour au Soleil chacune de ses faces : c''est la succession des jours et des nuits ✓.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('3d909c48-db5d-5b0f-8576-25f667ae2fef', 'ef1c4717-9b80-5f96-99b4-c706b2ffba98', 'Parmi ces planètes, laquelle est une planète gazeuse ?', '[{"id":"a","text":"Jupiter"},{"id":"b","text":"Mercure"},{"id":"c","text":"Vénus"},{"id":"d","text":"la Terre"}]'::jsonb, 'a', 'Jupiter est une planète gazeuse ✓ : peu dense, avec des anneaux et de nombreux satellites. Mercure, Vénus et la Terre sont des planètes telluriques.', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('92e01f66-db86-5904-a304-0ecfc8000493', '48a8ac5b-4a30-54e1-8e9d-b2a1465d264c', 'physique-1ere-sec', '⭐⭐ Révision (type examen) : L''univers, le système solaire et la Terre', 2, 75, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('f47ff8d8-4fe1-5eff-ba75-a865db8c9e4d', '92e01f66-db86-5904-a304-0ecfc8000493', 'Un corps céleste ne brûle pas entièrement dans l''atmosphère et atteint le sol, y creusant un cratère. On l''appelle...', '[{"id":"a","text":"un astéroïde"},{"id":"b","text":"un météore"},{"id":"c","text":"une comète"},{"id":"d","text":"une météorite"}]'::jsonb, 'd', 'Le corps qui atteint le sol et y creuse un cratère est une météorite ✓. Tant qu''il ne fait que brûler dans l''atmosphère sans toucher le sol, c''est un météore (étoile filante).', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('c0ac8478-c271-5ff6-b306-f67a9fc2bf49', '92e01f66-db86-5904-a304-0ecfc8000493', 'L''étoile Proxima du Centaure est à 4,22 années-lumière de la Terre. Combien de temps la lumière a-t-elle mis pour nous parvenir de cette étoile ?', '[{"id":"a","text":"4,22 secondes"},{"id":"b","text":"4,22 jours"},{"id":"c","text":"4,22 ans"},{"id":"d","text":"4,22 siècles"}]'::jsonb, 'c', 'La lumière parcourt 1 année-lumière en 1 an. Pour 4,22 années-lumière, elle met donc 4,22 ans ✓ : on voit l''étoile telle qu''elle était il y a 4,22 ans.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('3b0db541-49c9-5c3b-8a6a-c62b73fc2a59', '92e01f66-db86-5904-a304-0ecfc8000493', 'Qu''est-ce qui caractérise les planètes gazeuses, par rapport aux planètes telluriques ?', '[{"id":"a","text":"elles possèdent des anneaux et de nombreux satellites"},{"id":"b","text":"elles ont une surface solide et peu de satellites"},{"id":"c","text":"elles sont plus denses que l''eau"},{"id":"d","text":"elles sont toutes plus proches du Soleil"}]'::jsonb, 'a', 'Les planètes gazeuses (Jupiter, Saturne, Uranus, Neptune) sont peu denses et possèdent des anneaux et de nombreux satellites ✓. Ce sont les telluriques qui ont une surface solide et peu de satellites.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('cfcf2bcc-03df-5e6e-8c06-6ac4b5285609', '92e01f66-db86-5904-a304-0ecfc8000493', 'Le tableau des planètes donne les densités moyennes : Terre 5,52 ; Mars 3,95 ; Jupiter 1,33 ; Saturne 0,69. Quelle est la planète la moins dense de cette liste ?', '[{"id":"a","text":"la Terre"},{"id":"b","text":"Mars"},{"id":"c","text":"Jupiter"},{"id":"d","text":"Saturne"}]'::jsonb, 'd', 'La densité la plus faible de la liste est 0,69, celle de Saturne ✓ : plus la valeur est petite, moins la planète est dense (Saturne est même moins dense que l''eau, dont la densité vaut 1).', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('e2671735-1931-5b82-8884-683101d69931', '92e01f66-db86-5904-a304-0ecfc8000493', 'La Terre tourne sur son axe en 23 h 56 min et fait le tour du Soleil en 365,25 jours. Quel mouvement, combiné à l''inclinaison de son axe, explique l''alternance des saisons ?', '[{"id":"a","text":"la rotation de la Terre sur son axe"},{"id":"b","text":"la révolution de la Terre autour du Soleil"},{"id":"c","text":"les phases de la Lune"},{"id":"d","text":"la scintillation des étoiles"}]'::jsonb, 'b', 'Les saisons viennent de la révolution de la Terre autour du Soleil (365,25 jours), combinée à l''inclinaison de son axe ✓. La rotation sur l''axe (23 h 56 min), elle, explique la succession des jours et des nuits.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('acacbaf5-0675-517d-8504-7b0ef0df5070', '92e01f66-db86-5904-a304-0ecfc8000493', 'La pesanteur à la surface vaut 9,80 N/kg sur la Terre, 24,9 N/kg sur Jupiter et 3,72 N/kg sur Mars. Sur quelle planète un même objet aurait-il le poids le plus grand ?', '[{"id":"a","text":"sur la Terre"},{"id":"b","text":"sur Jupiter"},{"id":"c","text":"sur Mars"},{"id":"d","text":"le poids serait le même partout"}]'::jsonb, 'b', 'Le poids est d''autant plus grand que la pesanteur (en N/kg) est élevée. La plus grande valeur est 24,9 N/kg, sur Jupiter ✓ : un même objet y pèse le plus lourd.', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('0184ba76-8420-5076-89b4-940b066baa62', 'f6966a12-cbe5-5382-ab2f-9ff6b6376703', 'physique-1ere-sec', 'Test de compréhension ⭐ : La lumière et sa propagation', 1, 20, 5, 'quiz', 'admin', 0)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('bb3a770a-f526-5699-a391-a5cb9ae71441', '0184ba76-8420-5076-89b4-940b066baa62', 'Parmi ces objets, lequel est une source primaire de lumière ?', '[{"id":"a","text":"la Lune"},{"id":"b","text":"une feuille de papier éclairée"},{"id":"c","text":"un mur blanc éclairé"},{"id":"d","text":"une lampe allumée"}]'::jsonb, 'd', 'Une lampe allumée produit sa propre lumière : c''est une source primaire ✓. La Lune, une feuille de papier et un mur ne font que diffuser la lumière qu''ils reçoivent (sources secondaires).', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('a1e7e4d3-3a84-52ed-b75f-eb24e8ede7f4', '0184ba76-8420-5076-89b4-940b066baa62', 'Pour qu''un objet nous soit visible, il faut avant tout que...', '[{"id":"a","text":"il envoie de la lumière dans nos yeux"},{"id":"b","text":"nos yeux touchent l''objet"},{"id":"c","text":"il produise de la chaleur"},{"id":"d","text":"il soit toujours coloré"}]'::jsonb, 'a', 'On ne voit un objet que s''il envoie de la lumière (qu''il produit ou qu''il diffuse) dans nos yeux ✓. L''œil est un détecteur de lumière.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('210b8908-a639-50f4-9c46-dac0b945dedc', '0184ba76-8420-5076-89b4-940b066baa62', 'Un corps qui laisse passer la lumière sans la diffuser, et à travers lequel on voit nettement, est...', '[{"id":"a","text":"opaque"},{"id":"b","text":"translucide"},{"id":"c","text":"transparent"},{"id":"d","text":"lumineux"}]'::jsonb, 'c', 'Un corps transparent laisse passer la lumière sans la diffuser : on voit nettement à travers (le verre ordinaire) ✓. Un corps translucide, lui, brouille l''image.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('d0168460-d3a5-5818-b534-6fa7ebb4789a', '0184ba76-8420-5076-89b4-940b066baa62', 'Dans un milieu homogène et transparent, la lumière se propage...', '[{"id":"a","text":"en ligne courbe"},{"id":"b","text":"en ligne droite"},{"id":"c","text":"en zigzag"},{"id":"d","text":"en cercle"}]'::jsonb, 'b', 'Dans un milieu homogène et transparent, la lumière se propage en ligne droite ✓ : c''est la propagation rectiligne, modélisée par le rayon lumineux.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('2b875aaa-072c-5acd-9cb4-b0e10c005360', '0184ba76-8420-5076-89b4-940b066baa62', 'Une éclipse de Soleil se produit lorsque...', '[{"id":"a","text":"la Lune passe entre le Soleil et la Terre"},{"id":"b","text":"la Terre passe entre le Soleil et la Lune"},{"id":"c","text":"le Soleil s''éteint pendant la nuit"},{"id":"d","text":"la Lune entre dans l''ombre de la Terre"}]'::jsonb, 'a', 'Lors d''une éclipse de Soleil, la Lune passe entre le Soleil et la Terre et projette son ombre sur la Terre ✓. Quand la Lune entre dans l''ombre de la Terre, c''est une éclipse de Lune.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('d4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'f6966a12-cbe5-5382-ab2f-9ff6b6376703', 'physique-1ere-sec', '⭐ Exercice : Sources, transparence et rayons de lumière', 1, 50, 10, 'practice', 'admin', 1)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('95962944-106c-5d51-931b-80c189f06ed8', 'd4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'Quel organe joue le rôle de détecteur de lumière dans notre vision ?', '[{"id":"a","text":"l''œil"},{"id":"b","text":"l''oreille"},{"id":"c","text":"la peau"},{"id":"d","text":"le nez"}]'::jsonb, 'a', 'L''œil est le détecteur de lumière ✓ : la lumière qui y pénètre forme une image sur la rétine.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('0050e987-e2bc-5752-b860-6d5a5f952a76', 'd4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'La Lune brille dans le ciel nocturne parce qu''elle diffuse la lumière du Soleil. C''est donc une source de lumière...', '[{"id":"a","text":"primaire"},{"id":"b","text":"secondaire"},{"id":"c","text":"de chaleur"},{"id":"d","text":"électrique"}]'::jsonb, 'b', 'La Lune ne produit pas sa propre lumière : elle diffuse celle qu''elle reçoit du Soleil. C''est une source secondaire ✓.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('b4d8104b-0da8-5bdf-8414-2e181e156059', 'd4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'Un corps qui ne laisse pas du tout passer la lumière est dit...', '[{"id":"a","text":"transparent"},{"id":"b","text":"translucide"},{"id":"c","text":"opaque"},{"id":"d","text":"brillant"}]'::jsonb, 'c', 'Un corps opaque arrête complètement la lumière (le bois, un métal, le carton) ✓. Le corps transparent, lui, la laisse passer.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('cd25eebf-753d-520a-8c99-28c81a4549ab', 'd4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'Comment appelle-t-on la droite fléchée qui modélise le trajet suivi par la lumière ?', '[{"id":"a","text":"une ombre"},{"id":"b","text":"un faisceau"},{"id":"c","text":"un spectre"},{"id":"d","text":"un rayon lumineux"}]'::jsonb, 'd', 'Le trajet de la lumière est modélisé par un rayon lumineux, une droite fléchée ✓. Un ensemble de rayons issus d''une même source forme un faisceau.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('c8c83850-bfb9-5943-accc-6e8db9e1da17', 'd4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'Quelle est la valeur de la célérité de la lumière dans le vide ?', '[{"id":"a","text":"340 m·s⁻¹"},{"id":"b","text":"3×10⁸ m·s⁻¹"},{"id":"c","text":"3×10⁸ km·h⁻¹"},{"id":"d","text":"9,46×10¹² km"}]'::jsonb, 'b', 'La lumière se propage dans le vide à la célérité c = 3×10⁸ m·s⁻¹ ✓. La valeur 340 m·s⁻¹ est l''ordre de grandeur de la vitesse du son ; 9,46×10¹² km est une distance (une année-lumière).', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('9df35157-9bab-528a-9052-52b16471bac8', 'd4ae0d89-cb59-592b-a0d3-8dd0e52dd0cb', 'Les différentes formes sous lesquelles on voit la Lune au fil du mois s''appellent...', '[{"id":"a","text":"les éclipses"},{"id":"b","text":"les constellations"},{"id":"c","text":"les saisons"},{"id":"d","text":"les phases de la Lune"}]'::jsonb, 'd', 'Ce sont les phases de la Lune ✓ (nouvelle Lune, premier quartier, pleine Lune, dernier quartier), qui se succèdent au cours d''une lunaison (≈ 29,5 jours).', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('bc60ebb2-0b2e-5756-93c6-243de244e157', 'f6966a12-cbe5-5382-ab2f-9ff6b6376703', 'physique-1ere-sec', '⭐⭐ Révision (type examen) : Faisceaux, ombres et éclipses', 2, 75, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('db04906d-c891-5ced-994a-5453d92917e9', 'bc60ebb2-0b2e-5756-93c6-243de244e157', 'Un faisceau dont tous les rayons se dirigent vers un même point est un faisceau...', '[{"id":"a","text":"convergent"},{"id":"b","text":"parallèle"},{"id":"c","text":"divergent"},{"id":"d","text":"rectiligne"}]'::jsonb, 'a', 'Un faisceau convergent a tous ses rayons dirigés vers un même point ✓. S''ils semblent partir d''un même point en s''écartant, il est divergent ; s''ils gardent la même direction, il est parallèle.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('0579671f-d419-57cd-8283-ecd5bb62cb17', 'bc60ebb2-0b2e-5756-93c6-243de244e157', 'La zone sombre qu''un objet opaque projette sur un écran placé derrière lui s''appelle...', '[{"id":"a","text":"l''ombre propre"},{"id":"b","text":"l''ombre portée"},{"id":"c","text":"la pénombre"},{"id":"d","text":"le faisceau"}]'::jsonb, 'b', 'L''ombre portée est la zone sombre projetée sur l''écran, derrière l''objet ✓. L''ombre propre, elle, est la face non éclairée de l''objet lui-même.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('846602d2-0da0-52dd-90fa-71d3ce67e18f', 'bc60ebb2-0b2e-5756-93c6-243de244e157', 'Éclairée par une source étendue, la région d''où l''on ne voit qu''une partie de la source est appelée...', '[{"id":"a","text":"la pleine lumière"},{"id":"b","text":"la zone d''ombre"},{"id":"c","text":"la pénombre"},{"id":"d","text":"la réflexion"}]'::jsonb, 'c', 'Avec une source étendue, autour de l''ombre (où aucun rayon n''arrive) apparaît une zone de pénombre, éclairée par une partie seulement de la source ✓.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('78ae75d4-205e-52a0-9e43-5d9a68dd261d', 'bc60ebb2-0b2e-5756-93c6-243de244e157', 'Une éclipse de Lune se produit lorsque la Lune...', '[{"id":"a","text":"cesse de tourner autour de la Terre"},{"id":"b","text":"s''éloigne du Soleil"},{"id":"c","text":"passe entre le Soleil et la Terre"},{"id":"d","text":"entre dans le cône d''ombre de la Terre"}]'::jsonb, 'd', 'Lors d''une éclipse de Lune (pleine Lune), la Lune entre dans le cône d''ombre de la Terre et n''est plus éclairée ✓. Quand c''est la Lune qui passe entre le Soleil et la Terre, il s''agit d''une éclipse de Soleil.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('bb440d5a-4399-52f5-b1db-f87384fa1040', 'bc60ebb2-0b2e-5756-93c6-243de244e157', 'Lors d''une éclipse de Soleil, dans quel ordre les trois astres sont-ils alignés ?', '[{"id":"a","text":"Soleil – Lune – Terre"},{"id":"b","text":"Soleil – Terre – Lune"},{"id":"c","text":"Terre – Soleil – Lune"},{"id":"d","text":"Lune – Soleil – Terre"}]'::jsonb, 'a', 'Lors d''une éclipse de Soleil, la Lune se place entre le Soleil et la Terre : l''ordre est Soleil – Lune – Terre ✓. L''ordre Soleil – Terre – Lune correspond, lui, à une éclipse de Lune.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('ae5be56c-624f-5647-8243-997b5dfc1c7a', 'bc60ebb2-0b2e-5756-93c6-243de244e157', 'Un rayon laser reste rectiligne dans de l''eau pure, mais se courbe en traversant de l''eau salée mal mélangée. Pourquoi ?', '[{"id":"a","text":"parce que l''eau salée est un milieu opaque à la lumière"},{"id":"b","text":"parce que le laser change de couleur au contact du sel"},{"id":"c","text":"parce que l''eau salée mal mélangée n''est pas un milieu homogène"},{"id":"d","text":"parce que la lumière accélère fortement dans l''eau salée"}]'::jsonb, 'c', 'La propagation n''est rectiligne que dans un milieu homogène. L''eau salée mal mélangée n''est pas homogène : la lumière n''y suit plus une ligne droite ✓.', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('3472a0bc-f245-574c-863d-8a5424de73b9', 'a736a592-8789-5052-967c-ac0256c430e0', 'physique-1ere-sec', 'Test de compréhension ⭐ : Spectre de lumière et vision', 1, 20, 5, 'quiz', 'admin', 0)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('f300164e-72cf-5f11-b8f0-46bd36fb26d1', '3472a0bc-f245-574c-863d-8a5424de73b9', 'Quel objet décompose la lumière blanche en plusieurs lumières colorées ?', '[{"id":"a","text":"un miroir"},{"id":"b","text":"une lampe"},{"id":"c","text":"un filtre opaque"},{"id":"d","text":"un prisme"}]'::jsonb, 'd', 'Un prisme (ou un réseau) décompose la lumière blanche en un spectre de lumières colorées ✓, du rouge au violet.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('90921ae7-e839-58af-9528-3acb4ecea634', '3472a0bc-f245-574c-863d-8a5424de73b9', 'La lumière blanche, formée de la superposition de plusieurs lumières colorées, est dite...', '[{"id":"a","text":"monochromatique"},{"id":"b","text":"polychromatique"},{"id":"c","text":"opaque"},{"id":"d","text":"invisible"}]'::jsonb, 'b', 'La lumière blanche est polychromatique ✓ : elle superpose plusieurs lumières monochromatiques que l''œil ne distingue pas séparément.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('bfa0acc4-9c9e-524b-8931-dc5f2cf47ee3', '3472a0bc-f245-574c-863d-8a5424de73b9', 'Éclairée en lumière blanche, une tomate paraît rouge parce qu''elle...', '[{"id":"a","text":"produit elle-même sa propre lumière rouge"},{"id":"b","text":"absorbe le rouge et diffuse les autres couleurs"},{"id":"c","text":"diffuse le rouge et absorbe les autres couleurs"},{"id":"d","text":"laisse passer la lumière sans la diffuser"}]'::jsonb, 'c', 'La tomate diffuse la lumière rouge (sa couleur) et absorbe les autres radiations ✓. Si elle absorbait le rouge, elle ne paraîtrait pas rouge ; et elle ne produit pas sa propre lumière.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('bb263752-0dc9-52fa-9aba-f9c485e54e7e', '3472a0bc-f245-574c-863d-8a5424de73b9', 'Un corps qui absorbe toutes les radiations qu''il reçoit, sans en diffuser aucune, paraît...', '[{"id":"a","text":"noir"},{"id":"b","text":"blanc"},{"id":"c","text":"rouge"},{"id":"d","text":"transparent"}]'::jsonb, 'a', 'S''il absorbe toutes les radiations et n''en diffuse aucune, le corps paraît noir ✓. À l''inverse, un corps qui diffuse toutes les radiations paraît blanc.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('8ff624b4-a6eb-5529-a9f6-065b96b1c343', '3472a0bc-f245-574c-863d-8a5424de73b9', 'Parmi les rayonnements émis par le Soleil, lesquels sont invisibles pour l''œil ?', '[{"id":"a","text":"le rouge et le violet"},{"id":"b","text":"l''infrarouge et l''ultraviolet"},{"id":"c","text":"le jaune et le vert"},{"id":"d","text":"le bleu et l''indigo"}]'::jsonb, 'b', 'L''infrarouge (en deçà du rouge) et l''ultraviolet (au-delà du violet) sont invisibles ✓. Le rouge, le violet, le jaune, le vert, le bleu et l''indigo appartiennent, eux, à la lumière visible.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'a736a592-8789-5052-967c-ac0256c430e0', 'physique-1ere-sec', '⭐ Exercice : Spectre, couleurs et rayonnements', 1, 50, 10, 'practice', 'admin', 1)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('936dbe7c-0f5b-527b-bb4d-bf10dab4fa77', '62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'Une lumière colorée simple, qu''un prisme ne peut plus décomposer, est une lumière...', '[{"id":"a","text":"blanche"},{"id":"b","text":"monochromatique"},{"id":"c","text":"polychromatique"},{"id":"d","text":"noire"}]'::jsonb, 'b', 'Une lumière colorée simple, non décomposable, est monochromatique (une radiation) ✓. La lumière blanche, elle, est polychromatique.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('ecf46d7a-b55e-58bf-b75c-ed59b4ea1690', '62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'Dans le spectre de la lumière blanche, les couleurs s''étalent du rouge au...', '[{"id":"a","text":"noir"},{"id":"b","text":"blanc"},{"id":"c","text":"violet"},{"id":"d","text":"gris"}]'::jsonb, 'c', 'Le spectre continu va du rouge au violet ✓, en passant par l''orange, le jaune, le vert, le bleu et l''indigo.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('4d4a613a-f7b6-528e-9e8a-022c75471f98', '62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'L''arc-en-ciel apparaît quand la lumière blanche du Soleil est décomposée par...', '[{"id":"a","text":"un miroir posé au sol"},{"id":"b","text":"des nuages opaques"},{"id":"c","text":"la Lune"},{"id":"d","text":"les gouttelettes d''eau en suspension dans l''air"}]'::jsonb, 'd', 'Les gouttelettes d''eau en suspension dans l''air décomposent la lumière blanche du Soleil : c''est l''arc-en-ciel ✓.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('2c11ff9a-5b61-51b7-a6a6-ea2f25e46f07', '62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'Comment appelle-t-on les cellules de la rétine responsables de la vision des couleurs ?', '[{"id":"a","text":"les cônes"},{"id":"b","text":"les os"},{"id":"c","text":"les muscles"},{"id":"d","text":"les tympans"}]'::jsonb, 'a', 'Les cônes de la rétine, de trois types (sensibles au rouge, au vert et au bleu), assurent la vision des couleurs ✓.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('dcb2b09d-6822-5022-bc92-6a4e744ceb57', '62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'Une loupe concentre la lumière du Soleil sur du papier noir, qui se met à brûler. Par quel mode l''énergie a-t-elle été transférée au papier ?', '[{"id":"a","text":"la conduction"},{"id":"b","text":"la convection"},{"id":"c","text":"le rayonnement"},{"id":"d","text":"le vent"}]'::jsonb, 'c', 'La lumière transporte de l''énergie : elle est transférée au papier par rayonnement ✓, ce qui le fait brûler.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('498160e7-69bb-5269-be63-ef83c6987af5', '62bd5b38-ea0c-5e14-b106-27ffaefbb816', 'Le rayonnement invisible situé en deçà du rouge, responsable d''une sensation de chaleur, est...', '[{"id":"a","text":"l''ultraviolet"},{"id":"b","text":"l''infrarouge"},{"id":"c","text":"le violet"},{"id":"d","text":"le bleu"}]'::jsonb, 'b', 'L''infrarouge, situé en deçà du rouge, est invisible et provoque une sensation de chaleur ✓. L''ultraviolet, lui, se situe au-delà du violet.', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('537e039d-5765-5288-b7bc-a199a07e9e9f', 'a736a592-8789-5052-967c-ac0256c430e0', 'physique-1ere-sec', '⭐⭐ Révision (type examen) : Couleurs, vision et rayonnements', 2, 75, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('be37568f-37a3-5e96-ae87-eac7995dc955', '537e039d-5765-5288-b7bc-a199a07e9e9f', 'Un piment, qui paraît vert en lumière blanche, est éclairé uniquement en lumière rouge. Il paraît alors...', '[{"id":"a","text":"vert"},{"id":"b","text":"rouge"},{"id":"c","text":"noir"},{"id":"d","text":"blanc"}]'::jsonb, 'c', 'En lumière blanche, le piment diffuse le vert (sa couleur) et absorbe le reste. Éclairé seulement en rouge, il absorbe ce rouge et ne diffuse aucune lumière : il paraît noir ✓. La couleur perçue dépend donc de la lumière qui éclaire.', 1, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('1396b460-4b63-5da0-a93f-48d0904ba19b', '537e039d-5765-5288-b7bc-a199a07e9e9f', 'Que fait un objet qui nous paraît blanc lorsqu''il est éclairé en lumière blanche ?', '[{"id":"a","text":"il absorbe toutes les couleurs"},{"id":"b","text":"il diffuse toutes les couleurs"},{"id":"c","text":"il ne diffuse aucune couleur"},{"id":"d","text":"il produit sa propre lumière"}]'::jsonb, 'b', 'Un objet blanc diffuse toutes les radiations de la lumière blanche ✓. À l''inverse, un objet qui absorbe tout et ne diffuse rien paraît noir.', 2, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('f0e82b2f-5e11-5f3e-9fe0-95e5c2a83151', '537e039d-5765-5288-b7bc-a199a07e9e9f', 'Le daltonisme est dû à...', '[{"id":"a","text":"une inflammation des nerfs de l''oreille interne"},{"id":"b","text":"une opacité passagère du cristallin de l''œil"},{"id":"c","text":"une déficience d''un des types de cônes de la rétine"},{"id":"d","text":"une exposition trop forte à la lumière bleue"}]'::jsonb, 'c', 'Le daltonisme vient d''une absence ou d''une faiblesse d''un des trois types de cônes (sensibles au rouge, au vert ou au bleu) : la couleur correspondante n''est plus vue ✓.', 3, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('181f5552-7f23-57f9-a7fa-c1f868802201', '537e039d-5765-5288-b7bc-a199a07e9e9f', 'Une illusion d''optique est due à...', '[{"id":"a","text":"une mauvaise interprétation des signaux par le cerveau"},{"id":"b","text":"un trajet incorrect de la lumière dans l''air"},{"id":"c","text":"une panne des cônes de la rétine, dans l''œil"},{"id":"d","text":"une décomposition de la lumière par l''atmosphère"}]'::jsonb, 'a', 'L''illusion d''optique n''est pas due au trajet de la lumière : elle vient d''une mauvaise interprétation, par le cerveau, des informations reçues de l''œil ✓.', 4, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('6e4a0046-ecff-51f8-927f-513fd694fda5', '537e039d-5765-5288-b7bc-a199a07e9e9f', 'Parmi ces effets, lequel est dû au rayonnement ultraviolet ?', '[{"id":"a","text":"faire fonctionner une télécommande de télévision"},{"id":"b","text":"permettre à la peau de synthétiser la vitamine D"},{"id":"c","text":"transmettre la chaleur d''un radiateur"},{"id":"d","text":"éclairer une pièce plongée dans le noir"}]'::jsonb, 'b', 'Les ultraviolets permettent à la peau de synthétiser la vitamine D (une carence provoque le rachitisme) ✓. Les télécommandes, la chaleur d''un radiateur et la vision nocturne relèvent, eux, de l''infrarouge.', 5, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order, question_type, answer_key, distractor_tags) VALUES
  ('53893803-a1ae-5154-875a-dd12431c3dd8', '537e039d-5765-5288-b7bc-a199a07e9e9f', 'Deux bouteilles d''eau identiques, l''une peinte en noir, l''autre en blanc, sont exposées au Soleil. Dans laquelle l''eau devient-elle la plus chaude ?', '[{"id":"a","text":"la blanche, car elle absorbe plus de lumière"},{"id":"b","text":"les deux chauffent exactement autant"},{"id":"c","text":"la blanche, car elle diffuse plus de lumière"},{"id":"d","text":"la noire, car elle absorbe plus de lumière"}]'::jsonb, 'd', 'La bouteille noire absorbe presque toute la lumière (donc l''énergie) qu''elle reçoit, tandis que la blanche en diffuse beaucoup : l''eau de la bouteille noire devient la plus chaude ✓.', 6, 'mcq', NULL, NULL)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
