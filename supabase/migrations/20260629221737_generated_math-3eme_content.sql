...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d1e85591-44bf-5cec-99f4-c2e095e1c38d', 'b628e645-8f1d-5dae-ba4c-eb065cc7eb1e', 'أيّ تفكيكٍ يوافق العدد 3 408؟', '[{"id":"a","text":"3 × 100 + 4 × 10 + 8"},{"id":"b","text":"3 × 1000 + 4 × 100 + 8"},{"id":"c","text":"3 × 1000 + 4 × 10 + 8"},{"id":"d","text":"3 × 1000 + 4 × 100 + 8 × 10"}]'::jsonb, 'b', 'العدد 3 408 = 3 آلاف + 4 مئات + 0 عشرات + 8 آحاد، أي 3 × 1000 + 4 × 100 + 8.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4fa88fa6-ecf0-5506-a624-93a6d845c3ef', 'dbf6265e-9b03-5ded-8cc4-572dd85b5614', 'أيّ تفكيكٍ يوافق العدد 9 207؟', '[{"id":"a","text":"9 × 1000 + 2 × 10 + 7"},{"id":"b","text":"9 × 100 + 2 × 10 + 7"},{"id":"c","text":"9 × 1000 + 2 × 100 + 7"},{"id":"d","text":"9 × 1000 + 2 × 100 + 7 × 10"}]'::jsonb, 'c', 'العدد 9 207 = 9 آلاف + 2 مئات + 0 عشرات + 7 آحاد، أي 9 × 1000 + 2 × 100 + 7. ✓ الفخّ: وضع 2 في العشرات (9 × 1000 + 2 × 10 + 7) يعطي 9 027 لا 9 207.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c5d93406-1c09-5ce8-98b9-81d6b697c3cd', '27d2f233-fc4a-5350-b0ae-9eed34f4273a', 'أيّ جمعٍ متكرّر يساوي 4 × 3؟', '[{"id":"a","text":"3 + 3 + 3 + 3"},{"id":"b","text":"4 + 3"},{"id":"c","text":"4 + 4 + 4 + 4"},{"id":"d","text":"3 + 3 + 3"}]'::jsonb, 'a', '4 × 3 تعني العدد 3 مأخوذًا 4 مرّات: 3 + 3 + 3 + 3 = 12. الفخّ: جمع العاملين 4 + 3 بدل تكرار الحدّ، أو تكرار 3 ثلاث مرّات فقط (3 + 3 + 3 = 9).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
