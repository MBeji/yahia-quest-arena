...
$$
U = R \times I \quad|\quad I = \frac{U}{R} \quad|\quad R = \frac{U}{I}
$$
...
$$
m_{\text{المتفاعلات}} = m_{\text{النواتج}}
$$
...
- **التحقّق دائمًا**: الوحدة موجودة + النتيجة معقولة + المعادلة موزونة + الوحدات محوّلة.', 9),
