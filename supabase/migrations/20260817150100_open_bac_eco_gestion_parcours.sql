-- Ouvrir le parcours Baccalauréat — section Économie et gestion :
...
--
--   * français — `french-bac-eco-gestion`, **7 chapitres sur 7 (100 %)**, compilés
...
--   * anglais — `english-bac-eco-gestion`, 6 chapitres, même mécanique depuis
...
-- dominantes propres (économie et gestion) et la philosophie — dont le chapitrage est
...
WHERE id = 'concours-bac-eco-gestion';
