...
-- Subject: culture-generale-geographie-fr (Culture générale — Géographie)
...
INSERT INTO public.subjects (id, name_fr, description, attribute, color_token, icon, display_order, content_language, is_premium, theme_id, grade_id) VALUES
  ('culture-generale-geographie-fr', 'Culture générale — Géographie', 'Pays, capitales, continents, océans et records de la planète : la géographie du monde en version culture générale.', 'Exploration', 'subject-english', 'Globe', 13, 'fr', false, 'culture-generale', NULL)
...
- **Records naturels** : plus haut sommet le **mont Everest** (8 849 m) ; plus long fleuve le **Nil** (~6 650 km).', 1, NULL)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dc61c432-4be1-5f74-b869-50ebad811b6a', '4caf2929-2f4e-5f61-8789-ea6e7f9ffeb7', 'Combien de continents compte la Terre dans le modèle international (anglo-saxon) ?', '[{"id":"a","text":"Cinq"},{"id":"b","text":"Six"},{"id":"c","text":"Sept"},{"id":"d","text":"Huit"}]'::jsonb, 'c', 'Le modèle international (anglo-saxon) distingue 7 continents : Asie, Afrique, Amérique du Nord, Amérique du Sud, Antarctique, Europe et Océanie. En France, on enseigne souvent 6 continents en réunissant les deux Amériques. L''Asie est le plus vaste et le plus peuplé.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
