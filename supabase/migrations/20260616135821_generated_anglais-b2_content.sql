...
- **Trap 3 — Don''t double up:** The later action takes the past simple, not the past perfect (_After she had eaten, she **went** home_ — not _had gone_).', 1)
ON CONFLICT (id) DO UPDATE SET
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('70b6d97e-6e56-5608-b0b8-220f8a148fed', 'c67ac08d-3246-51ff-b0e3-e390eb153e06', 'Complete the sentence: ''When I arrived, the film ___ already started.''', '[{"id":"a","text":"was"},{"id":"b","text":"has"},{"id":"c","text":"had"},{"id":"d","text":"were"}]'::jsonb, 'c', '''Had already started'' is the past perfect. The film''s starting happened BEFORE I arrived — that earlier past event requires ''had + past participle''. ''Was'' is past simple of ''be''; ''has'' is present perfect; ''were'' does not fit the singular ''film''.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dd2d5030-824e-56cc-bdbe-c86c78fc9f7b', '279aad4c-0118-54e1-bb0d-b9e7781b9551', 'Choose the ACTIVE version of: ''The committee has approved the new budget.''', '[{"id":"a","text":"The new budget was approved by the committee."},{"id":"b","text":"The new budget will be approved by the committee."},{"id":"c","text":"The new budget has been approved by the committee."},{"id":"d","text":"The new budget is approved by the committee."}]'::jsonb, 'c', 'The active ''The committee has approved'' (present perfect) becomes the passive ''The new budget has been approved by the committee'' (has/have been + past participle). Option A (was approved) is past simple passive. Option B (will be approved) is future passive. Option D (is approved) is present simple passive.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fcb16eea-9c34-54a8-bff2-8a07f4543019', '279aad4c-0118-54e1-bb0d-b9e7781b9551', 'Which sentence is INCORRECT?', '[{"id":"a","text":"The winner was announced at midnight."},{"id":"b","text":"The documents will be signed tomorrow."},{"id":"c","text":"The meeting was happened in the conference room."},{"id":"d","text":"A new policy has been introduced by the government."}]'::jsonb, 'c', '''Was happened'' is grammatically impossible — ''happen'' is an intransitive verb with no object, so it cannot be passivised. The correct sentence is ''The meeting happened in the conference room'' (active). Options A, C, and D all correctly passivise transitive verbs: announce (A), sign (C), introduce (D).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f0422ea5-a6c5-5740-83f6-76b1d508da32', '279aad4c-0118-54e1-bb0d-b9e7781b9551', 'Which sentence correctly uses passive voice to maintain topic continuity?', '[{"id":"a","text":"The drug was developed in the 1980s. Doctors tested it in clinical trials. Patients benefited from it."},{"id":"b","text":"The drug was developed in the 1980s. It was tested in clinical trials. It is now used worldwide."},{"id":"c","text":"Researchers developed the drug. Doctors tested it. Patients benefited."},{"id":"d","text":"The drug was developed. Researchers then tested it. Patients took it."}]'::jsonb, 'b', 'Option B maintains ''the drug / it'' as the consistent subject throughout all three sentences, using passives (''was developed'', ''was tested'', ''is used''). This is the key paragraph-level reason to use passive: keeping the same topic as subject for coherence. Options A and D switch subjects mid-paragraph (doctors, patients). Option C uses active throughout but shifts agents each sentence, which is less coherent.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('70efc4dc-32e6-5a6d-9824-322e5102ad91', '47a9669b-59e3-560a-9c0d-b665ced19277', 'Which sentence correctly uses ''say'' and ''tell''?', '[{"id":"a","text":"She told that she was ready."},{"id":"b","text":"She said me that she was ready."},{"id":"c","text":"She told me that she was ready."},{"id":"d","text":"She said to told me she was ready."}]'::jsonb, 'c', '''Tell'' requires a personal object: ''told me'' is correct. Option (a) is wrong because ''told'' needs an object before ''that''. Option (b) is wrong because ''said'' cannot take a direct personal object — ''said me'' is not English. Option (d) is grammatically incoherent.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4674ab60-aee2-52f4-84d7-bb919b00e829', '31aa4e2f-c9f5-5b7e-bf53-26d65d580eca', 'Complete the reported statement: She said, "I work in a hospital." → She said she ___ in a hospital.', '[{"id":"a","text":"works"},{"id":"b","text":"work"},{"id":"c","text":"worked"},{"id":"d","text":"has worked"}]'::jsonb, 'c', 'Backshift rule: present simple (''work'') shifts to past simple (''worked'') in reported speech. ''Works'' keeps the present tense, which is not backshifted. ''Work'' is missing the past form. ''Has worked'' is present perfect, not the correct backshift of present simple.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3e355305-1953-5862-a4c1-81ed5a20b2c8', '31aa4e2f-c9f5-5b7e-bf53-26d65d580eca', 'Complete the reported statement: They said, "We will leave tomorrow." → They said they ___ leave the next day.', '[{"id":"a","text":"will"},{"id":"b","text":"shall"},{"id":"c","text":"would"},{"id":"d","text":"could"}]'::jsonb, 'c', '''Will'' shifts to ''would'' in reported speech. ''Will'' is the unbackshifted original. ''Shall'' is a different modal that doesn''t result from backshifting ''will''. ''Could'' is the backshift of ''can'', not ''will''.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('91d38468-c670-5586-b080-f076a69f17f9', 'ae143677-2635-5aff-b34d-7d9b0e8948a4', 'Report the question: "Do you like coffee?" → She asked me ___ coffee.', '[{"id":"a","text":"do I like"},{"id":"b","text":"if I liked"},{"id":"c","text":"if I like"},{"id":"d","text":"whether did I like"}]'::jsonb, 'b', 'Yes/no reported questions use ''if'' or ''whether'' and restore subject-verb order with tense backshift: ''if I liked''. Option (a) keeps the question inversion and present tense. Option (c) keeps the present tense ''like'' and so misses the required backshift to ''liked''. Option (d) wrongly keeps the auxiliary ''did'' after ''whether''.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('41deca32-3341-5a4c-926f-62439ecae4b4', 'ae143677-2635-5aff-b34d-7d9b0e8948a4', 'Report the question: "Are you coming to the party?" → He asked her ___.', '[{"id":"a","text":"was she coming to the party"},{"id":"b","text":"if she was coming to the party"},{"id":"c","text":"if was she coming to the party"},{"id":"d","text":"whether she comes to the party"}]'::jsonb, 'b', 'Yes/no reported questions use ''if/whether'' + subject-verb order + backshift: ''if she was coming to the party''. Option (a) is missing ''if/whether'' and keeps the inverted order. Option (c) keeps the inverted word order after ''if''. Option (d) has the correct structure but forgets to backshift (''comes'' should be ''was coming'').', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f3c7e371-d784-53f0-a75f-3d2599b31aa9', 'bd900608-00a7-5ec0-b193-9054092e3db2', 'Which sentence contains BOTH a correct time-word change AND correct backshift?', '[{"id":"a","text":"She said she would call me tomorrow."},{"id":"b","text":"He said he had seen the film the previous night."},{"id":"c","text":"They said they will come here the next day."},{"id":"d","text":"She said she goes there today."}]'::jsonb, 'b', '''Had seen'' correctly backshifts past simple, and ''the previous night'' correctly shifts ''last night''. Option (a) keeps ''tomorrow'' instead of shifting it to ''the next day''. Option (c) keeps ''will'' (not backshifted) and ''here'' (should be ''there''). Option (d) keeps ''goes'' (present) and ''today'' (should be ''that day'').', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
Which option correctly fills both gaps?', '[{"id":"a","text":"stays / organises"},{"id":"b","text":"was staying / was organising"},{"id":"c","text":"had stayed / organised"},{"id":"d","text":"is staying / organises"}]'::jsonb, 'b', 'Leila''s original words were likely ''I am staying in Tunis all week because my company is organising a big conference.'' Both present continuous verbs backshift to past continuous in reported speech: ''was staying / was organising''. Option (a) keeps present tenses. Option (c) uses past perfect, suggesting the stay was completed before Leila spoke, which contradicts ''all week''. Option (d) keeps present tenses without backshifting.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('816edd55-4bef-56e3-a706-b6677ed43b77', '6423a2b1-a4ec-59c1-bc14-8f2c31b07039', 'Read: "Omar called Sana last night. He said: ''I spoke to the director here today and he told me I can start the new job this week.''" What is the correctly reported version of Omar''s words?', '[{"id":"a","text":"Omar said he had spoken to the director there that day and that the director had told him he could start the new job that week."},{"id":"b","text":"Omar said he spoke to the director here today and he told him he can start the new job this week."},{"id":"c","text":"Omar said he had spoken to the director there today and that the director told him he could start the new job this week."},{"id":"d","text":"Omar told he had spoken to the director and he can start the job that week."}]'::jsonb, 'a', 'Option (a) applies all backshifts correctly: ''spoke'' → ''had spoken'', ''told'' → ''had told'', ''can'' → ''could''; and all time/place shifts: ''here'' → ''there'', ''today'' → ''that day'', ''this week'' → ''that week''. Option (b) applies no changes at all. Option (c) shifts ''here/today/this week'' but inconsistently backshifts (''told'' stays in past simple and ''could'' is correct but ''today'' is not shifted). Option (d) uses ''told'' without an object and skips ''spoke''.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
Which option fills all three gaps correctly?', '[{"id":"a","text":"said / will create / will boost"},{"id":"b","text":"told / would create / would boost"},{"id":"c","text":"said / would create / would boost"},{"id":"d","text":"told that / would create / would boost"}]'::jsonb, 'c', '''Said'' takes no personal object and is correct here (no ''us/them'' follows). ''Will'' backshifts to ''would'' for both verbs. Option (a) keeps ''will'' — no backshift. Option (b) uses ''told'' without a personal object, which is wrong. Option (d) uses ''told that'' — ''told'' needs an object (''told us that''), not a direct ''that'' clause.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('70dea884-eb1d-5e12-95e5-431bee412d1b', '760121e7-3470-5fc5-a64a-2c39e7c38729', 'Complete the third conditional: "If she ___ harder, she would have passed."', '[{"id":"a","text":"studied"},{"id":"b","text":"had studied"},{"id":"c","text":"has studied"},{"id":"d","text":"would have studied"}]'::jsonb, 'b', 'The third conditional uses ''if + past perfect'' in the if-clause: ''had studied''. Option (a) uses past simple, which is correct for the second conditional (unreal present), not the third. Option (c) uses present perfect, which has no place in a conditional if-clause. Option (d) uses ''would have'', which belongs in the result clause, never in the if-clause.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('86b33a6e-9afb-5223-8302-c89479029fb9', '760121e7-3470-5fc5-a64a-2c39e7c38729', '"Unless you hurry, you''ll be late." This means the same as:', '[{"id":"a","text":"If you hurry, you''ll be late."},{"id":"b","text":"If you don''t hurry, you''ll be late."},{"id":"c","text":"Unless you don''t hurry, you''ll be late."},{"id":"d","text":"If you hurry, you won''t be late."}]'::jsonb, 'b', '''Unless'' means ''if … not'', so ''Unless you hurry'' = ''If you don''t hurry, you''ll be late''. Option (a) reverses the condition — ''if you hurry'' would mean being on time. Option (c) doubles the negative (''unless … don''t''), which is incorrect. Option (d) changes both the condition and the result.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8268d822-ecb3-544e-8edc-c771f6bd3d7e', '053b4c2b-c691-5fc7-83b5-933a2395c16d', 'Complete with the correct result: "If they hadn''t missed the meeting, the deal ___."', '[{"id":"a","text":"might close"},{"id":"b","text":"was closed"},{"id":"c","text":"might have been closed"},{"id":"d","text":"would close"}]'::jsonb, 'c', 'The third conditional result can use ''could/might/would + have + past participle'': ''might have been closed'' correctly uses a passive past participle. Option (a) drops ''have'' — ''might close'' is present/future. Option (b) is a simple past passive with no modal. Option (d) uses ''would + base'', which is the second conditional.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('aa810e30-cdc5-59c7-bc63-1c5325c89df1', '053b4c2b-c691-5fc7-83b5-933a2395c16d', 'Choose the sentence that expresses a PAST regret using the third conditional.', '[{"id":"a","text":"If I had more money, I would buy a car."},{"id":"b","text":"If I have more money, I will buy a car."},{"id":"c","text":"If I had had more money, I would have bought a car."},{"id":"d","text":"If I would have money, I would buy a car."}]'::jsonb, 'c', 'A past regret uses the third conditional: ''If I had had more money, I would have bought a car.'' Option (a) is the second conditional (present/future hypothetical). Option (b) is the first conditional (real future). Option (d) is wrong because ''would'' cannot go in the if-clause.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7a19830a-c885-50ed-bdf3-3205a945b3b8', '5527b612-be00-554f-9940-597f2c988fef', 'Which sentence correctly uses ''wish'' to express annoyance at someone else''s behaviour?', '[{"id":"a","text":"I wish he stopped talking."},{"id":"b","text":"I wish he would stop talking."},{"id":"c","text":"I wish he stops talking."},{"id":"d","text":"I wish he had stopped talking."}]'::jsonb, 'b', 'To express annoyance at someone''s repeated behaviour, use ''wish + would + base verb'': ''I wish he would stop talking''. Option (a) uses past simple — this expresses a present wish (I want him to be a non-talker), but for annoyance about an ongoing habit, ''would'' is the natural choice. Option (c) keeps the present tense — grammatically wrong. Option (d) uses past perfect — this expresses regret that he didn''t stop in the past.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5c61d2ca-f74d-5a41-a7e0-686ad9208771', '5527b612-be00-554f-9940-597f2c988fef', 'Which sentence correctly uses ''provided that''?', '[{"id":"a","text":"I will lend you the money provided that you will pay me back."},{"id":"b","text":"I will lend you the money provided that you pay me back."},{"id":"c","text":"I would lend you the money provided that you paid me back."},{"id":"d","text":"I lend you the money provided that you paid me back."}]'::jsonb, 'b', '''Provided that'' introduces a condition with the present simple in the condition clause: ''provided that you pay me back''. Option (a) wrongly puts ''will'' inside the condition clause — just like ''if'', ''provided that'' takes present simple for future conditions. Option (c) is a second conditional — grammatically possible, but the question asks about the standard ''provided that'' construction. Option (d) drops ''will'' from the result clause, making it a statement rather than a conditional promise.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e559d125-04bb-5873-9f15-1a8ac896908d', 'da08d717-b872-539d-810e-512716687ca0', 'Which sentence demonstrates the most natural use of a mixed conditional (past condition → present consequence)?', '[{"id":"a","text":"If I had learnt to code at school, I would have got a better job."},{"id":"b","text":"If I had learnt to code at school, I would be earning more money now."},{"id":"c","text":"If I learn to code, I will get a better job."},{"id":"d","text":"If I learned to code, I would get a better job."}]'::jsonb, 'b', 'Mixed Conditional A links a past unrealised condition (if + past perfect: ''had learnt… at school'') to a present result (would + base: ''would be… now''). ''Now'' is the key signal. Option (a) is a pure third conditional — past condition, past result (''would have got''). Option (c) is a first conditional (real future). Option (d) is a second conditional (present hypothetical).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ea5499af-df25-58a3-b5f3-fa04f7bc4cf4', 'da08d717-b872-539d-810e-512716687ca0', 'Read: "Nour is a night owl — she never goes to bed before midnight. Yesterday she overslept and missed her 8am lecture." Which sentence BEST captures her Mixed B situation?', '[{"id":"a","text":"If she hadn''t overslept, she would have attended the lecture."},{"id":"b","text":"If she went to bed earlier, she would have made it to the lecture yesterday."},{"id":"c","text":"If she goes to bed earlier, she will make it to her lectures."},{"id":"d","text":"If she had gone to bed earlier, she would have attended the lecture."}]'::jsonb, 'b', 'Mixed B captures a present habit/state (she doesn''t go to bed early — present condition: ''if + past simple'') that caused a past result (she missed the lecture: ''would + have + pp''). Option (a) is a pure third conditional focusing on the oversleeping event, not her general night-owl nature. Option (c) is a first conditional — a real future suggestion, not a mixed conditional about what happened. Option (d) is a pure third conditional: both condition (''had gone'') and result (''would have attended'') are past — this doesn''t highlight her ongoing habit as the cause.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c8445449-8f48-5808-b0e8-186cdd1246c1', 'd3edc675-da3e-51d5-af79-48c9a346f63d', 'Complete: "He left the meeting ___ a single word."', '[{"id":"a","text":"without saying"},{"id":"b","text":"without to say"},{"id":"c","text":"without say"},{"id":"d","text":"not to say"}]'::jsonb, 'a', 'After the preposition "without", only the gerund is possible: without saying. "without to say" incorrectly uses an infinitive after a preposition, "without say" uses the bare base form, and "not to say" changes the meaning entirely (it would suggest a deliberate choice not to speak).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('edf7b1af-b64a-5eb2-bb81-cfb89f60ba4f', 'ab523941-55ea-5448-9e3c-343a105141d1', 'Complete: "She tried ___ earlier, but the traffic was just as bad."', '[{"id":"a","text":"to leave"},{"id":"b","text":"leaving"},{"id":"c","text":"leave"},{"id":"d","text":"to leaving"}]'::jsonb, 'b', '"try doing" (gerund) means experiment with something as a possible solution: she tried leaving earlier (as an experiment to avoid traffic). "try to do" (infinitive) means make an effort — but if she succeeded in leaving earlier and it still didn''t help, the gerund fits. The context implies she experimented. "leave" and "to leaving" are both grammatically incorrect here.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
