...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order) VALUES
  ('cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', 'الضرب والقسمة في مجموعة الأعداد العشرية', 'ضربُ الأعداد العشرية (وضعُ الفاصلة)، الضربُ والقسمةُ على 10 و100 و1000، قسمةُ عددٍ عشريّ على عددٍ طبيعيّ، والتقدير', '# ✖️➗ الضرب والقسمة في مجموعة الأعداد العشرية
...
> 🏆 صرتَ تضرب وتقسم الأعدادَ العشرية وتُزحزح الفاصلةَ بثقة. الوجهةُ التالية: المضاعفاتُ المشتركة.', '# 📜 ملخّص: الضرب والقسمة في الأعداد العشرية
...
- **تحقّق بالتقدير** إلى أقرب وحدة قبل اعتماد النتيجة.', 5)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order) VALUES
  ('998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', 'المضاعفات المشتركة', 'مضاعفاتُ عدد، العلاقةُ مضاعف/قاسم/قابلية القسمة، المضاعفاتُ المشتركة لعددين، وأصغرُ مضاعفٍ مشترك غيرِ معدوم', '# 🔗 المضاعفات والمضاعفات المشتركة
...
> 🏆 صرتَ تجد مضاعفاتِ عددٍ ومضاعفاتِهما المشتركة وأصغرَها. الخطوةُ التالية: قابليّةُ القسمة.', '# 📜 ملخّص: المضاعفات المشتركة
...
- **تذكّر:** 0 مضاعفٌ لكلّ عدد، لذا نطلب أصغرَ مضاعفٍ مشترك *غيرِ معدوم*.', 6)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.chapters (id, subject_id, title, description, lesson_content, summary, display_order) VALUES
  ('9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', 'قابلية القسمة على 2 و3 و5 و9 و10', 'معاييرُ قابلية القسمة: على 2 و5 و10 (رقم الآحاد)، وعلى 3 و9 (مجموع الأرقام)، والعلاقةُ بين القسمة على 9 و3', '# 🔍 قابليّةُ القسمة (على 2 و3 و5 و9 و10)
...
> 🏆 صرتَ تحكم على قابليّة القسمة بنظرةٍ ذكيّة. أنت الآن جاهزٌ لعالَم الكسور.', '# 📜 ملخّص: قابليّة القسمة
...
- كلُّ ما يقبل القسمة على 9 يقبلها على 3 (والعكسُ ليس دائمًا صحيحًا).', 7)
ON CONFLICT (id) DO UPDATE SET
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
  description = EXCLUDED.description,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('85406265-d062-5c0d-bbb8-44c0e5a40e80', 'cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', 'اختبار فهم الدرس ⭐', 1, 20, 5, 'quiz', 'admin', 0)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('90061b35-a242-5af4-802c-17794aea07c2', '85406265-d062-5c0d-bbb8-44c0e5a40e80', 'كم رقمًا عشريًّا في جداء 2,3 × 1,4؟', '[{"id":"a","text":"1"},{"id":"b","text":"2"},{"id":"c","text":"0"},{"id":"d","text":"3"}]'::jsonb, 'b', 'نجمع عددَ الأرقام العشرية للعاملين: 1 + 1 = 2، فجداءُ 2,3 × 1,4 = 3,22 فيه رقمان عشريّان.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('2940ae3a-69ce-555b-b1ae-78014f1a09d7', '85406265-d062-5c0d-bbb8-44c0e5a40e80', 'ما ناتجُ 4,5 × 10؟', '[{"id":"a","text":"0,45"},{"id":"b","text":"450"},{"id":"c","text":"45"},{"id":"d","text":"4,50"}]'::jsonb, 'c', 'الضربُ في 10 يُزحزح الفاصلةَ رقمًا واحدًا نحو اليمين: 4,5 × 10 = 45.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9c8e8257-d8be-5d0c-b93e-9192646c03a6', '85406265-d062-5c0d-bbb8-44c0e5a40e80', 'ما ناتجُ 1,2 × 3؟', '[{"id":"a","text":"3,6"},{"id":"b","text":"36"},{"id":"c","text":"3,2"},{"id":"d","text":"4,2"}]'::jsonb, 'a', 'نحسب 12 × 3 = 36، وفي العامل 1,2 رقمٌ عشريٌّ واحد، فالجداء 3,6.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('05b00885-4e35-5637-85db-a26e0d95ad61', '85406265-d062-5c0d-bbb8-44c0e5a40e80', 'ما ناتجُ 8,4 ÷ 2؟', '[{"id":"a","text":"4,02"},{"id":"b","text":"42"},{"id":"c","text":"6,4"},{"id":"d","text":"4,2"}]'::jsonb, 'd', 'نقسم على عددٍ طبيعيّ: 8,4 ÷ 2 = 4,2 (نتحقّق: 2 × 4,2 = 8,4).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c8bd6a3a-98f4-57e5-b7fa-8a7a5e2ac3cd', '85406265-d062-5c0d-bbb8-44c0e5a40e80', 'ما ناتجُ 6 ÷ 100؟', '[{"id":"a","text":"0,6"},{"id":"b","text":"0,06"},{"id":"c","text":"0,006"},{"id":"d","text":"60"}]'::jsonb, 'b', 'القسمةُ على 100 تُزحزح الفاصلةَ رقمين نحو اليسار: 6 = 6,00 ومنها 0,06.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('39ddb55d-b548-5931-a77c-0fcf973c03a2', 'cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', '⭐ تمرين: أوّلُ ضربٍ وقسمةٍ عشريّ', 1, 50, 10, 'practice', 'admin', 1)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('196483d8-1b2e-5b5d-8426-649428e57871', '39ddb55d-b548-5931-a77c-0fcf973c03a2', 'ما ناتجُ 2,1 × 2؟', '[{"id":"a","text":"4,2"},{"id":"b","text":"42"},{"id":"c","text":"2,2"},{"id":"d","text":"4,02"}]'::jsonb, 'a', 'نحسب 21 × 2 = 42، وفي العامل 2,1 رقمٌ عشريٌّ واحد، فالجداء 4,2.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('347eae8c-da92-5ec9-9033-0a724781f807', '39ddb55d-b548-5931-a77c-0fcf973c03a2', 'ما ناتجُ 1,3 × 10؟', '[{"id":"a","text":"1,3"},{"id":"b","text":"130"},{"id":"c","text":"13"},{"id":"d","text":"0,13"}]'::jsonb, 'c', 'الضربُ في 10 يُزحزح الفاصلةَ رقمًا واحدًا نحو اليمين: 1,3 × 10 = 13.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('60661f44-aa0c-5425-8fdb-84a7a320fa1e', '39ddb55d-b548-5931-a77c-0fcf973c03a2', 'ما ناتجُ 6,4 ÷ 2؟', '[{"id":"a","text":"32"},{"id":"b","text":"3,2"},{"id":"c","text":"2,2"},{"id":"d","text":"3,02"}]'::jsonb, 'b', 'نقسم على عددٍ طبيعيّ: 6,4 ÷ 2 = 3,2 (نتحقّق: 2 × 3,2 = 6,4).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('aac6c36a-4660-586a-aa8f-9671d1fd60f5', '39ddb55d-b548-5931-a77c-0fcf973c03a2', 'كم رقمًا عشريًّا في جداء 0,5 × 0,5؟', '[{"id":"a","text":"1"},{"id":"b","text":"2"},{"id":"c","text":"0"},{"id":"d","text":"3"}]'::jsonb, 'b', 'نجمع الأرقامَ العشرية للعاملين: 1 + 1 = 2، فجداءُ 0,5 × 0,5 = 0,25 فيه رقمان عشريّان.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0e4dbe45-515a-52de-8390-94a1ef557d3d', '39ddb55d-b548-5931-a77c-0fcf973c03a2', 'ما ناتجُ 3,2 × 4؟', '[{"id":"a","text":"128"},{"id":"b","text":"12,2"},{"id":"c","text":"6,4"},{"id":"d","text":"12,8"}]'::jsonb, 'd', 'نحسب 32 × 4 = 128، وفي العامل 3,2 رقمٌ عشريٌّ واحد، فالجداء 12,8.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('098e4a65-b918-5248-8d72-d2d5a2e88a60', '39ddb55d-b548-5931-a77c-0fcf973c03a2', 'ما ناتجُ 45,6 ÷ 10؟', '[{"id":"a","text":"456"},{"id":"b","text":"0,456"},{"id":"c","text":"4,56"},{"id":"d","text":"45,6"}]'::jsonb, 'c', 'القسمةُ على 10 تُزحزح الفاصلةَ رقمًا واحدًا نحو اليسار: 45,6 ÷ 10 = 4,56.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('6d50bd59-40b8-5436-a985-ad1e47d1b319', 'cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', '⚔️ زعيم الفصل ⭐⭐⭐: معركةُ الضرب والقسمة', 3, 120, 30, 'boss', 'admin', 2)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d8082989-ac79-59e7-9a91-a6e557b314a7', '6d50bd59-40b8-5436-a985-ad1e47d1b319', 'ما ناتجُ 5,2 × 2؟', '[{"id":"a","text":"10,4"},{"id":"b","text":"104"},{"id":"c","text":"7,2"},{"id":"d","text":"10,04"}]'::jsonb, 'a', 'نحسب 52 × 2 = 104، وفي العامل 5,2 رقمٌ عشريٌّ واحد، فالجداء 10,4.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e35a53a2-b16c-5c99-b53c-cf1fa0b58013', '6d50bd59-40b8-5436-a985-ad1e47d1b319', 'ما ناتجُ 2,5 × 4؟', '[{"id":"a","text":"1"},{"id":"b","text":"10"},{"id":"c","text":"100"},{"id":"d","text":"8,5"}]'::jsonb, 'b', 'نحسب 25 × 4 = 100، وفي العامل 2,5 رقمٌ عشريٌّ واحد، فالجداء 10,0 = 10.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b98b10cb-3e5a-57f2-ad11-30947abe8e0e', '6d50bd59-40b8-5436-a985-ad1e47d1b319', 'ما ناتجُ 0,3 × 0,6؟', '[{"id":"a","text":"1,8"},{"id":"b","text":"18"},{"id":"c","text":"0,18"},{"id":"d","text":"0,9"}]'::jsonb, 'c', 'نحسب 3 × 6 = 18، ومجموعُ الأرقام العشرية للعاملين رقمان، فجداءُ 0,3 × 0,6 = 0,18.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('38cb4b43-a05b-5671-a3a5-c640054b600c', '6d50bd59-40b8-5436-a985-ad1e47d1b319', 'ما ناتجُ 7 ÷ 4؟', '[{"id":"a","text":"1,7"},{"id":"b","text":"0,57"},{"id":"c","text":"1,57"},{"id":"d","text":"1,75"}]'::jsonb, 'd', 'نواصل القسمة بإضافة الأصفار: 7,00 ÷ 4 = 1,75 (نتحقّق: 4 × 1,75 = 7).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dc2c0013-34a2-57a6-bbcb-f1d881a46fe1', '6d50bd59-40b8-5436-a985-ad1e47d1b319', 'ما ناتجُ 12,5 × 100؟', '[{"id":"a","text":"1 250"},{"id":"b","text":"125"},{"id":"c","text":"12 500"},{"id":"d","text":"1,25"}]'::jsonb, 'a', 'الضربُ في 100 يُزحزح الفاصلةَ رقمين نحو اليمين: 12,5 × 100 = 1 250.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('22debbd2-38c9-52b3-b24c-bd11bbc980da', '6d50bd59-40b8-5436-a985-ad1e47d1b319', 'ما ناتجُ 9 ÷ 100؟', '[{"id":"a","text":"0,9"},{"id":"b","text":"0,009"},{"id":"c","text":"0,09"},{"id":"d","text":"900"}]'::jsonb, 'c', 'القسمةُ على 100 تُزحزح الفاصلةَ رقمين نحو اليسار: 9 = 9,00 ومنها 0,09.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', '⭐⭐ تمرين مراجعة (نمط امتحان): الضرب والقسمة العشريّ', 2, 70, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('36e3f61e-72d6-5df6-9437-5b51720a50f2', '0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'ما ناتجُ 1,1 × 5؟', '[{"id":"a","text":"5,5"},{"id":"b","text":"55"},{"id":"c","text":"6,1"},{"id":"d","text":"5,05"}]'::jsonb, 'a', 'نحسب 11 × 5 = 55، وفي العامل 1,1 رقمٌ عشريٌّ واحد، فالجداء 5,5.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f86ce9b1-d358-5c28-9aa6-c192f07d7b81', '0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'ما ناتجُ 3,45 × 100؟', '[{"id":"a","text":"34,5"},{"id":"b","text":"345"},{"id":"c","text":"3 450"},{"id":"d","text":"3,45"}]'::jsonb, 'b', 'الضربُ في 100 يُزحزح الفاصلةَ رقمين نحو اليمين: 3,45 × 100 = 345.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fec37754-d596-5264-ab54-c25f10cdbd2b', '0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'ما ناتجُ 9,9 ÷ 3؟', '[{"id":"a","text":"33"},{"id":"b","text":"3,03"},{"id":"c","text":"3,3"},{"id":"d","text":"6,6"}]'::jsonb, 'c', 'نقسم على عددٍ طبيعيّ: 9,9 ÷ 3 = 3,3 (نتحقّق: 3 × 3,3 = 9,9).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e0d6ae6f-3fb0-5e6e-a329-85f9949d1dd7', '0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'ما ناتجُ 2,5 × 2؟', '[{"id":"a","text":"50"},{"id":"b","text":"4,5"},{"id":"c","text":"0,5"},{"id":"d","text":"5"}]'::jsonb, 'd', 'نحسب 25 × 2 = 50، وفي العامل 2,5 رقمٌ عشريٌّ واحد، فالجداء 5,0 = 5.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('480f2c8f-cc68-5940-9e83-c544154855b4', '0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'ما ناتجُ 0,8 × 0,5؟', '[{"id":"a","text":"0,4"},{"id":"b","text":"4"},{"id":"c","text":"0,04"},{"id":"d","text":"1,3"}]'::jsonb, 'a', 'نحسب 8 × 5 = 40، ومجموعُ الأرقام العشرية رقمان، فجداءُ 0,8 × 0,5 = 0,40 = 0,4.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('23974945-7082-54f0-b12e-b72f6b6a9349', '0c1ec197-8e8e-5c49-bf14-4e3f85d20d7c', 'ما ناتجُ 15 ÷ 4؟', '[{"id":"a","text":"3,7"},{"id":"b","text":"3,75"},{"id":"c","text":"3,5"},{"id":"d","text":"4,25"}]'::jsonb, 'b', 'نواصل القسمة بإضافة الأصفار: 15 ÷ 4 = 3,75 (نتحقّق: 4 × 3,75 = 15).', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', '👑 تحدّي النخبة ⭐⭐⭐⭐: سادةُ الضرب والقسمة', 4, 300, 60, 'challenge', 'admin', 4)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8ec83d72-c469-5ae9-bab4-9c632eb4e60f', '916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'ما ناتجُ 1,25 × 8؟', '[{"id":"a","text":"10"},{"id":"b","text":"100"},{"id":"c","text":"1"},{"id":"d","text":"9,25"}]'::jsonb, 'a', 'نحسب 125 × 8 = 1 000، ومجموعُ الأرقام العشرية رقمان، فجداءُ 1,25 × 8 = 10,00 = 10.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0eac0e0f-51a9-5725-821d-c8e68028d6ae', '916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'ما ناتجُ 0,25 × 0,4؟', '[{"id":"a","text":"1"},{"id":"b","text":"0,01"},{"id":"c","text":"0,1"},{"id":"d","text":"0,001"}]'::jsonb, 'c', 'نحسب 25 × 4 = 100، ومجموعُ الأرقام العشرية ثلاثةٌ، فجداءُ 0,25 × 0,4 = 0,100 = 0,1.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a6b01d40-f1a0-5dc3-a792-bece4626c942', '916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'ثمنُ مترٍ من القماش 3,5 دينارًا. ما ثمنُ 6 أمتار؟', '[{"id":"a","text":"21,5 دينارًا"},{"id":"b","text":"21 دينارًا"},{"id":"c","text":"18 دينارًا"},{"id":"d","text":"9,5 دينارًا"}]'::jsonb, 'b', 'ثمنُ 6 أمتار = 6 × 3,5 = 21 دينارًا.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d7df566f-b851-5c02-905b-c1a2ab166200', '916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'وُزّع 7,2 لترًا من العصير بالتساوي على 8 قوارير. كم في كلّ قارورة؟', '[{"id":"a","text":"9 لترات"},{"id":"b","text":"0,8 لترٍ"},{"id":"c","text":"1,2 لترٍ"},{"id":"d","text":"0,9 لترٍ"}]'::jsonb, 'd', 'نقسم بالتساوي: 7,2 ÷ 8 = 0,9 لترٍ في كلّ قارورة (نتحقّق: 8 × 0,9 = 7,2).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7a4aec75-b456-5203-9198-a3854ffc8f15', '916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'ما ناتجُ 4,5 × 1,2؟', '[{"id":"a","text":"5,4"},{"id":"b","text":"54"},{"id":"c","text":"5,7"},{"id":"d","text":"0,54"}]'::jsonb, 'a', 'نحسب 45 × 12 = 540، ومجموعُ الأرقام العشرية رقمان، فجداءُ 4,5 × 1,2 = 5,40 = 5,4.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e7d8192d-b4a5-55b2-9ebe-2b0f5f970cb9', '916496ab-81cb-5a5d-b50e-9c80ad48a10a', 'عددٌ ضربناه في 100 فصار 250. ما هذا العدد؟', '[{"id":"a","text":"25"},{"id":"b","text":"2,5"},{"id":"c","text":"0,25"},{"id":"d","text":"2 500"}]'::jsonb, 'b', 'نعكس العمليّة بالقسمة على 100: العددُ = 250 ÷ 100 = 2,5 (نتحقّق: 2,5 × 100 = 250).', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('972cbe6d-4356-5671-bb1e-215191105895', 'cb4e8db9-e42c-520e-a2e2-02a3203cca61', 'math-6eme', '📝 تدريب ⭐⭐⭐: مراجعة شاملة للضرب والقسمة العشريّ', 3, 120, 30, 'boss', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('88165417-0c6a-5d2a-9d99-6e4ffaeb2c30', '972cbe6d-4356-5671-bb1e-215191105895', 'ما ناتجُ 2,2 × 3؟', '[{"id":"a","text":"6,6"},{"id":"b","text":"66"},{"id":"c","text":"5,2"},{"id":"d","text":"6,06"}]'::jsonb, 'a', 'نحسب 22 × 3 = 66، وفي العامل 2,2 رقمٌ عشريٌّ واحد، فالجداء 6,6.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f7364d47-afc4-5e55-93ea-7e07cc2ea2b5', '972cbe6d-4356-5671-bb1e-215191105895', 'ما ناتجُ 0,7 × 1000؟', '[{"id":"a","text":"70"},{"id":"b","text":"7 000"},{"id":"c","text":"700"},{"id":"d","text":"0,007"}]'::jsonb, 'c', 'الضربُ في 1000 يُزحزح الفاصلةَ ثلاثةَ أرقامٍ نحو اليمين: 0,7 × 1000 = 700.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cf19e3dd-6f62-5bc9-b187-aca6a15edfc5', '972cbe6d-4356-5671-bb1e-215191105895', 'ما ناتجُ 14,4 ÷ 6؟', '[{"id":"a","text":"24"},{"id":"b","text":"2,4"},{"id":"c","text":"2,04"},{"id":"d","text":"8,4"}]'::jsonb, 'b', 'نقسم على عددٍ طبيعيّ: 14,4 ÷ 6 = 2,4 (نتحقّق: 6 × 2,4 = 14,4).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8aa38b6b-5207-5641-90c5-d1acc0e8eaad', '972cbe6d-4356-5671-bb1e-215191105895', 'ما ناتجُ 0,9 × 0,9؟', '[{"id":"a","text":"8,1"},{"id":"b","text":"81"},{"id":"c","text":"1,8"},{"id":"d","text":"0,81"}]'::jsonb, 'd', 'نحسب 9 × 9 = 81، ومجموعُ الأرقام العشرية رقمان، فجداءُ 0,9 × 0,9 = 0,81.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d90cdd25-11a0-5643-9def-5af359093de3', '972cbe6d-4356-5671-bb1e-215191105895', 'ما ناتجُ 3 ÷ 8؟', '[{"id":"a","text":"0,375"},{"id":"b","text":"0,38"},{"id":"c","text":"2,67"},{"id":"d","text":"0,35"}]'::jsonb, 'a', 'نواصل القسمة بإضافة الأصفار: 3 ÷ 8 = 0,375 (نتحقّق: 8 × 0,375 = 3).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8807dda0-51fc-5704-9634-4d43633845b3', '972cbe6d-4356-5671-bb1e-215191105895', 'اشترى 2,5 kg من اللحم بسعر 28 دينارًا للكيلوغرام. كم دفع؟', '[{"id":"a","text":"75 دينارًا"},{"id":"b","text":"65 دينارًا"},{"id":"c","text":"70 دينارًا"},{"id":"d","text":"56 دينارًا"}]'::jsonb, 'c', 'نحسب الثمنَ بالضرب: 2,5 × 28 = 70 دينارًا.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('ed2f3ad1-bc9a-5446-8a8a-ed79025c1ed5', '998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', 'اختبار فهم الدرس ⭐', 1, 20, 5, 'quiz', 'admin', 0)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('52b49e92-9d95-526f-945e-923a4ac614d1', 'ed2f3ad1-bc9a-5446-8a8a-ed79025c1ed5', 'ما المضاعفُ الموالي للعدد 12 في مضاعفات 4؟', '[{"id":"a","text":"14"},{"id":"b","text":"13"},{"id":"c","text":"8"},{"id":"d","text":"16"}]'::jsonb, 'd', 'مضاعفاتُ 4 تزيد بـ4 في كلّ مرّة: …، 8، 12، 16، 20…؛ فالمضاعفُ الموالي للعدد 12 هو 16.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('47d73725-bb3a-5a79-837c-c3b89da3e2bc', 'ed2f3ad1-bc9a-5446-8a8a-ed79025c1ed5', 'هل العددُ 18 مضاعفٌ للعدد 3؟', '[{"id":"a","text":"لا"},{"id":"b","text":"نعم لأنّ 18 = 3 + 6"},{"id":"c","text":"نعم لأنّ 18 = 3 × 6"},{"id":"d","text":"لا لأنّه عددٌ فرديّ"}]'::jsonb, 'c', 'بما أنّ 18 = 3 × 6 فإنّ 18 مضاعفٌ للعدد 3 (و3 قاسمٌ له).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9f23bfba-4ac8-5c00-adf4-b8fa2714c642', 'ed2f3ad1-bc9a-5446-8a8a-ed79025c1ed5', 'ما أصغرُ مضاعفٍ مشترك غيرِ معدوم للعددين 2 و3؟', '[{"id":"a","text":"6"},{"id":"b","text":"1"},{"id":"c","text":"5"},{"id":"d","text":"12"}]'::jsonb, 'a', 'مضاعفاتُ 2: 0، 2، 4، 6…؛ ومضاعفاتُ 3: 0، 3، 6…؛ أوّلُ مضاعفٍ مشترك غيرِ معدوم هو 6.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('861dee7c-1dd1-50e6-95fc-2b1fa77cb4e5', 'ed2f3ad1-bc9a-5446-8a8a-ed79025c1ed5', 'أيُّ الأعداد التالية مضاعفٌ للعدد 5؟', '[{"id":"a","text":"32"},{"id":"b","text":"28"},{"id":"c","text":"35"},{"id":"d","text":"41"}]'::jsonb, 'c', '35 = 5 × 7 فهو مضاعفٌ للعدد 5؛ أمّا 32 و28 و41 فلا تقبل القسمة على 5.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5b9566ed-7cb0-5190-8b97-89eff005b6ee', 'ed2f3ad1-bc9a-5446-8a8a-ed79025c1ed5', 'العددُ 0 مضاعفٌ لـ:', '[{"id":"a","text":"العدد 0 فقط"},{"id":"b","text":"كلّ الأعداد"},{"id":"c","text":"الأعداد الزوجية فقط"},{"id":"d","text":"لا شيء"}]'::jsonb, 'b', 'بما أنّ b × 0 = 0 مهما كان العدد b، فإنّ 0 مضاعفٌ لكلّ الأعداد.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('879b9258-0cd1-5186-802e-5705b21a4693', '998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', '⭐ تمرين: أوّلُ خطوات مع المضاعفات', 1, 50, 10, 'practice', 'admin', 1)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3b305a5b-0295-5bb4-ba12-6a7a59a850f4', '879b9258-0cd1-5186-802e-5705b21a4693', 'ما أوّلُ خمسةِ مضاعفاتٍ للعدد 3 (بدءًا من 0)؟', '[{"id":"a","text":"3، 6، 9، 12، 15"},{"id":"b","text":"0، 1، 2، 3، 4"},{"id":"c","text":"0، 3، 5، 9، 12"},{"id":"d","text":"0، 3، 6، 9، 12"}]'::jsonb, 'd', 'مضاعفاتُ 3 هي حواصلُ ضربه في 0، 1، 2، 3، 4، أي: 0، 3، 6، 9، 12.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('afbe48d2-edee-5ddb-8451-32273c29967c', '879b9258-0cd1-5186-802e-5705b21a4693', 'العددُ 20 مضاعفٌ للعدد:', '[{"id":"a","text":"3"},{"id":"b","text":"5"},{"id":"c","text":"7"},{"id":"d","text":"9"}]'::jsonb, 'b', '20 = 5 × 4 فالعددُ 20 مضاعفٌ للعدد 5 (و5 قاسمٌ له).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('10045678-6697-5401-aa0c-3a7d5056aca1', '879b9258-0cd1-5186-802e-5705b21a4693', 'أيُّ عددٍ من مضاعفات 10؟', '[{"id":"a","text":"25"},{"id":"b","text":"14"},{"id":"c","text":"40"},{"id":"d","text":"9"}]'::jsonb, 'c', '40 ينتهي بصفرٍ فهو من مضاعفات 10: 40 = 10 × 4.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('85f7173e-638f-57f6-a947-c91360b8274b', '879b9258-0cd1-5186-802e-5705b21a4693', 'ما المضاعفُ الموالي للعدد 18 في مضاعفات 6؟', '[{"id":"a","text":"20"},{"id":"b","text":"19"},{"id":"c","text":"24"},{"id":"d","text":"12"}]'::jsonb, 'c', 'مضاعفاتُ 6 تزيد بـ6 في كلّ مرّة: …، 12، 18، 24…؛ فالموالي للعدد 18 هو 24.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('edd62d83-af6c-5e66-8c1d-42d258c88a34', '879b9258-0cd1-5186-802e-5705b21a4693', 'كم مضاعفًا مشتركًا للعددين 2 و3 يوجد محصورًا بين 1 و13؟', '[{"id":"a","text":"1"},{"id":"b","text":"2"},{"id":"c","text":"3"},{"id":"d","text":"0"}]'::jsonb, 'b', 'المضاعفاتُ المشتركة للعددين 2 و3 هي مضاعفاتُ 6؛ بين 1 و13 نجد 6 و12، أي عددان (2).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('57660c65-59cd-5174-a83e-48642dec99a4', '879b9258-0cd1-5186-802e-5705b21a4693', 'ما أصغرُ مضاعفٍ مشترك غيرِ معدوم للعددين 3 و4؟', '[{"id":"a","text":"12"},{"id":"b","text":"7"},{"id":"c","text":"24"},{"id":"d","text":"1"}]'::jsonb, 'a', 'مضاعفاتُ 3: 0، 3، 6، 9، 12…؛ ومضاعفاتُ 4: 0، 4، 8، 12…؛ أصغرُ مضاعفٍ مشترك غيرِ معدوم هو 12.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('f54acf3f-49a7-5ad7-95d4-b5a61aae8860', '998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', '⚔️ زعيم الفصل ⭐⭐⭐: ملتقى المضاعفات', 3, 120, 30, 'boss', 'admin', 2)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('929f5f2e-4c9a-52c8-9801-f484f9dddc40', 'f54acf3f-49a7-5ad7-95d4-b5a61aae8860', 'العددُ 0 مضاعفٌ لـ:', '[{"id":"a","text":"العدد 0 فقط"},{"id":"b","text":"كلّ الأعداد"},{"id":"c","text":"الأعداد الزوجية"},{"id":"d","text":"لا شيء"}]'::jsonb, 'b', 'بما أنّ b × 0 = 0 مهما كان العدد b، فإنّ 0 مضاعفٌ لكلّ الأعداد، لا للأعداد الزوجية فقط.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8c611f93-90e9-52b1-a5bb-fc13e00f8534', 'f54acf3f-49a7-5ad7-95d4-b5a61aae8860', 'أيُّ الأعداد التالية مضاعفٌ للعددين 2 و5 معًا؟', '[{"id":"a","text":"25"},{"id":"b","text":"14"},{"id":"c","text":"30"},{"id":"d","text":"12"}]'::jsonb, 'c', 'العددُ مضاعفٌ للعددين 2 و5 معًا إذا كان مضاعفًا للعدد 10؛ 30 = 10 × 3.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('06d3cd38-1239-5c9f-aaca-65e3ce067662', 'f54acf3f-49a7-5ad7-95d4-b5a61aae8860', 'ما أصغرُ مضاعفٍ مشترك غيرِ معدوم للعددين 4 و6؟', '[{"id":"a","text":"24"},{"id":"b","text":"12"},{"id":"c","text":"2"},{"id":"d","text":"10"}]'::jsonb, 'b', 'مضاعفاتُ 4: 0، 4، 8، 12…؛ ومضاعفاتُ 6: 0، 6، 12…؛ أصغرُ مضاعفٍ مشترك غيرِ معدوم هو 12.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('82313856-757e-5fb8-8d94-e59eb74d848c', 'f54acf3f-49a7-5ad7-95d4-b5a61aae8860', 'حافلةٌ تمرّ كلّ 6 دقائق وأخرى كلّ 8 دقائق، انطلقتا معًا. بعد كم دقيقةً تلتقيان أوّلَ مرّة؟', '[{"id":"a","text":"24"},{"id":"b","text":"48"},{"id":"c","text":"14"},{"id":"d","text":"12"}]'::jsonb, 'a', 'تلتقيان عند أصغرِ مضاعفٍ مشترك للعددين 6 و8، وهو 24 دقيقة (مضاعفاتُ 6: …، 24؛ ومضاعفاتُ 8: 8، 16، 24).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f634387b-7f80-5ec6-8910-bffe68567040', 'f54acf3f-49a7-5ad7-95d4-b5a61aae8860', 'أيُّ عبارةٍ صحيحة؟', '[{"id":"a","text":"15 مضاعفٌ للعدد 2"},{"id":"b","text":"15 قاسمٌ للعدد 3"},{"id":"c","text":"15 مضاعفٌ للعدد 3 والعدد 5"},{"id":"d","text":"15 مضاعفٌ للعدد 4"}]'::jsonb, 'c', 'بما أنّ 15 = 3 × 5، فإنّ 15 مضاعفٌ للعدد 3 وللعدد 5 معًا.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('71112a1a-0aaf-5aa2-a713-16f5f6eee12b', 'f54acf3f-49a7-5ad7-95d4-b5a61aae8860', 'ما ثالثُ مضاعفٍ مشترك غيرِ معدوم للعددين 2 و3؟', '[{"id":"a","text":"12"},{"id":"b","text":"6"},{"id":"c","text":"24"},{"id":"d","text":"18"}]'::jsonb, 'd', 'المضاعفاتُ المشتركة للعددين 2 و3 هي مضاعفاتُ 6: 6 (الأوّل)، 12 (الثاني)، 18 (الثالث)؛ فالثالثُ هو 18.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('dae1333b-f949-58a8-bdaf-2a5b07032fc3', '998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', '⭐⭐ تمرين مراجعة (نمط امتحان): المضاعفات', 2, 70, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c05c28e1-34a4-5ca9-bdeb-1a092cb2042c', 'dae1333b-f949-58a8-bdaf-2a5b07032fc3', 'ما المضاعفُ الموالي للعدد 25 في مضاعفات 5؟', '[{"id":"a","text":"30"},{"id":"b","text":"26"},{"id":"c","text":"20"},{"id":"d","text":"35"}]'::jsonb, 'a', 'مضاعفاتُ 5 تزيد بـ5 في كلّ مرّة: …، 20، 25، 30…؛ فالموالي للعدد 25 هو 30.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('07266a3f-1376-58ad-9481-5e9a217c394f', 'dae1333b-f949-58a8-bdaf-2a5b07032fc3', 'العددُ 36 مضاعفٌ للعدد:', '[{"id":"a","text":"5"},{"id":"b","text":"6"},{"id":"c","text":"7"},{"id":"d","text":"8"}]'::jsonb, 'b', '36 = 6 × 6 فهو مضاعفٌ للعدد 6 (و6 قاسمٌ له).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('20ae953a-1212-53ef-9269-f0562333953d', 'dae1333b-f949-58a8-bdaf-2a5b07032fc3', 'ما أصغرُ مضاعفٍ مشترك غيرِ معدوم للعددين 5 و10؟', '[{"id":"a","text":"50"},{"id":"b","text":"5"},{"id":"c","text":"10"},{"id":"d","text":"15"}]'::jsonb, 'c', '10 مضاعفٌ للعدد 5 وللعدد 10 معًا، فهو أصغرُ مضاعفٍ مشترك غيرِ معدوم لهما.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('1c41e1fd-f818-5e74-805f-7c23a5a9acbd', 'dae1333b-f949-58a8-bdaf-2a5b07032fc3', 'أيُّ الأعداد التالية ليس من مضاعفات 4؟', '[{"id":"a","text":"16"},{"id":"b","text":"20"},{"id":"c","text":"24"},{"id":"d","text":"18"}]'::jsonb, 'd', '18 ليس من مضاعفات 4 (لأنّ 18 = 4 × 4 + 2)؛ أمّا 16 و20 و24 فكلُّها مضاعفاتٌ للعدد 4.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fe354324-a0c4-55b6-846d-0e7a5bcbbec1', 'dae1333b-f949-58a8-bdaf-2a5b07032fc3', 'إذا كان 7 قاسمًا للعدد 28، فإنّ 28 ...؟', '[{"id":"a","text":"قاسمٌ للعدد 7"},{"id":"b","text":"مضاعفٌ للعدد 7"},{"id":"c","text":"أصغرُ من 7"},{"id":"d","text":"لا علاقة له بالعدد 7"}]'::jsonb, 'b', 'إذا كان 7 قاسمًا للعدد 28، فإنّ 28 مضاعفٌ للعدد 7 (28 = 7 × 4).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('709f67ca-6911-52bd-86d7-a51ff13de116', 'dae1333b-f949-58a8-bdaf-2a5b07032fc3', 'مصباحان: الأوّل يومض كلّ 4 ثوانٍ والثاني كلّ 10 ثوانٍ، بدآ معًا. بعد كم ثانيةً يومضان معًا مجدّدًا؟', '[{"id":"a","text":"40"},{"id":"b","text":"14"},{"id":"c","text":"20"},{"id":"d","text":"10"}]'::jsonb, 'c', 'يومضان معًا عند أصغرِ مضاعفٍ مشترك للعددين 4 و10، وهو 20 ثانية.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('e9fd5a51-3d16-5baa-af2b-d9e5847a1860', '998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', '👑 تحدّي النخبة ⭐⭐⭐⭐: أسيادُ المضاعفات', 4, 300, 60, 'challenge', 'admin', 4)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7a5beefa-2c32-543d-9bdb-a9daa3ac8a40', 'e9fd5a51-3d16-5baa-af2b-d9e5847a1860', 'ما المضاعفاتُ المشتركة للعددين 3 و5 المحصورة بين 1 و31؟', '[{"id":"a","text":"15 فقط"},{"id":"b","text":"8 و15"},{"id":"c","text":"15 و30"},{"id":"d","text":"30 فقط"}]'::jsonb, 'c', 'المضاعفاتُ المشتركة للعددين 3 و5 هي مضاعفاتُ 15؛ بين 1 و31 نجد 15 و30.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cab38aef-a0db-5cc3-999f-f8996d3dcbeb', 'e9fd5a51-3d16-5baa-af2b-d9e5847a1860', 'ما أصغرُ مضاعفٍ مشترك غيرِ معدوم للعددين 6 و9؟', '[{"id":"a","text":"54"},{"id":"b","text":"3"},{"id":"c","text":"18"},{"id":"d","text":"15"}]'::jsonb, 'c', 'مضاعفاتُ 6: 6، 12، 18…؛ ومضاعفاتُ 9: 9، 18…؛ أصغرُ مضاعفٍ مشترك غيرِ معدوم هو 18.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a2b6172a-6453-5622-8613-fd62c900cb1b', 'e9fd5a51-3d16-5baa-af2b-d9e5847a1860', 'عددٌ من مضاعفات 4 ومن مضاعفات 6 ومحصورٌ بين 20 و30. ما هو؟', '[{"id":"a","text":"12"},{"id":"b","text":"24"},{"id":"c","text":"28"},{"id":"d","text":"36"}]'::jsonb, 'b', 'المضاعفاتُ المشتركة للعددين 4 و6 هي مضاعفاتُ 12؛ والمحصورُ منها بين 20 و30 هو 24.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('b9819f3a-1e17-51a4-b8dc-c2656629e446', 'e9fd5a51-3d16-5baa-af2b-d9e5847a1860', 'إذا كان العددُ مضاعفًا للعدد 9، فهو حتمًا مضاعفٌ للعدد:', '[{"id":"a","text":"4"},{"id":"b","text":"5"},{"id":"c","text":"2"},{"id":"d","text":"3"}]'::jsonb, 'd', 'بما أنّ 9 = 3 × 3، فكلُّ مضاعفٍ للعدد 9 هو مضاعفٌ للعدد 3 حتمًا.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ed6a879d-b246-55a9-8826-6658b3c8ef09', 'e9fd5a51-3d16-5baa-af2b-d9e5847a1860', 'ثلاثةُ عدّائين: يكمل الأوّل دورةً كلّ 2 دقيقة، والثاني كلّ 3، والثالث كلّ 4، وانطلقوا معًا. بعد كم دقيقةً يلتقون جميعًا عند الانطلاق؟', '[{"id":"a","text":"24"},{"id":"b","text":"9"},{"id":"c","text":"6"},{"id":"d","text":"12"}]'::jsonb, 'd', 'يلتقون عند أصغرِ مضاعفٍ مشترك للأعداد 2 و3 و4، وهو 12 دقيقة (12 يقبل القسمة على 2 و3 و4).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ac1a017d-04dc-5ef9-9853-eb7fc3452718', 'e9fd5a51-3d16-5baa-af2b-d9e5847a1860', 'كم عددًا من مضاعفات 7 محصورٌ بين 1 و30؟', '[{"id":"a","text":"4"},{"id":"b","text":"3"},{"id":"c","text":"5"},{"id":"d","text":"7"}]'::jsonb, 'a', 'مضاعفاتُ 7 المحصورة بين 1 و30 هي 7 و14 و21 و28، أي 4 أعداد.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('cd3c94ee-5ce9-5f69-b105-6a6e7b715350', '998c1356-5b26-51d9-9ac1-d8f613605e46', 'math-6eme', '📝 تدريب ⭐⭐⭐: مراجعة شاملة للمضاعفات', 3, 120, 30, 'boss', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a1f43195-2914-5660-a370-402f7fcb4c81', 'cd3c94ee-5ce9-5f69-b105-6a6e7b715350', 'لماذا يكون 24 مضاعفًا للعدد 8؟', '[{"id":"a","text":"24 = 8 + 3"},{"id":"b","text":"24 = 8 × 3"},{"id":"c","text":"8 = 24 × 3"},{"id":"d","text":"24 = 8 − 3"}]'::jsonb, 'b', 'العددُ 24 مضاعفٌ للعدد 8 لأنّ 24 = 8 × 3 (و8 قاسمٌ للعدد 24).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('bfd90244-c997-5b6b-aeeb-eb6853b39f57', 'cd3c94ee-5ce9-5f69-b105-6a6e7b715350', 'ما أصغرُ مضاعفٍ مشترك غيرِ معدوم للعددين 8 و12؟', '[{"id":"a","text":"96"},{"id":"b","text":"4"},{"id":"c","text":"24"},{"id":"d","text":"20"}]'::jsonb, 'c', 'مضاعفاتُ 8: 8، 16، 24…؛ ومضاعفاتُ 12: 12، 24…؛ أصغرُ مضاعفٍ مشترك غيرِ معدوم هو 24.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('67f319fb-e6cd-55cd-aa2d-46436c0bcefe', 'cd3c94ee-5ce9-5f69-b105-6a6e7b715350', 'أيُّ الأعداد التالية مضاعفٌ للعددين 3 و4 معًا؟', '[{"id":"a","text":"9"},{"id":"b","text":"8"},{"id":"c","text":"24"},{"id":"d","text":"15"}]'::jsonb, 'c', 'العددُ مضاعفٌ للعددين 3 و4 معًا إذا كان مضاعفًا للعدد 12؛ 24 = 12 × 2.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('27cf379c-705d-5264-8543-d9255c0be0d8', 'cd3c94ee-5ce9-5f69-b105-6a6e7b715350', 'ما المضاعفُ الرابعُ غيرُ المعدوم للعدد 7؟', '[{"id":"a","text":"21"},{"id":"b","text":"28"},{"id":"c","text":"35"},{"id":"d","text":"14"}]'::jsonb, 'b', 'المضاعفُ الرابعُ غيرُ المعدوم للعدد 7 هو 7 × 4 = 28 (المضاعفاتُ: 7، 14، 21، 28).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0565cab9-2d0f-58e2-88f5-dc732b415d4f', 'cd3c94ee-5ce9-5f69-b105-6a6e7b715350', 'عددٌ من مضاعفات 5 ومن مضاعفات 4، محصورٌ بين 15 و25. كم يساوي؟', '[{"id":"a","text":"40"},{"id":"b","text":"24"},{"id":"c","text":"16"},{"id":"d","text":"20"}]'::jsonb, 'd', 'العددُ المشتركُ من مضاعفات 5 و4 (أي مضاعفُ 20) المحصورُ بين 15 و25 هو 20.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7a044546-18d3-55ab-89f3-9c705905522e', 'cd3c94ee-5ce9-5f69-b105-6a6e7b715350', 'إذا كان 6 قاسمًا لعددٍ، فإنّ هذا العددَ مضاعفٌ للعدد 6 وأيضًا للعددين:', '[{"id":"a","text":"2 و3"},{"id":"b","text":"4 و5"},{"id":"c","text":"5 و7"},{"id":"d","text":"7 و8"}]'::jsonb, 'a', 'بما أنّ 6 = 2 × 3، فكلُّ مضاعفٍ للعدد 6 هو مضاعفٌ للعددين 2 و3 أيضًا.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('10acf840-fabe-594d-a711-b1490b1d5255', '9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', 'اختبار فهم الدرس ⭐', 1, 20, 5, 'quiz', 'admin', 0)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('35be53be-e9f5-5d65-ba3a-4c52213848a2', '10acf840-fabe-594d-a711-b1490b1d5255', 'أيُّ عددٍ يقبل القسمة على 2؟', '[{"id":"a","text":"47"},{"id":"b","text":"58"},{"id":"c","text":"33"},{"id":"d","text":"91"}]'::jsonb, 'b', 'العددُ يقبل القسمة على 2 إذا كان رقمُ آحاده زوجيًّا؛ آحادُ 58 هو 8 (زوجيّ)، فهو يقبل القسمة على 2.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('68c44fab-0898-5859-b81b-ff4979c65fe4', '10acf840-fabe-594d-a711-b1490b1d5255', 'أيُّ عددٍ يقبل القسمة على 5؟', '[{"id":"a","text":"52"},{"id":"b","text":"41"},{"id":"c","text":"75"},{"id":"d","text":"28"}]'::jsonb, 'c', 'العددُ يقبل القسمة على 5 إذا كان آحاده 0 أو 5؛ آحادُ 75 هو 5، فهو يقبل القسمة على 5.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7e3da340-0ea3-522b-88b7-614fe86528c3', '10acf840-fabe-594d-a711-b1490b1d5255', 'هل يقبل العددُ 423 القسمةَ على 3؟', '[{"id":"a","text":"نعم لأنّ مجموع أرقامه 9"},{"id":"b","text":"لا"},{"id":"c","text":"نعم لأنّ آحاده 3"},{"id":"d","text":"لا لأنّه عددٌ فرديّ"}]'::jsonb, 'a', 'مجموعُ أرقام 423 هو 4 + 2 + 3 = 9، و9 يقبل القسمة على 3، فالعددُ 423 يقبلها.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fed172b2-54ad-50b2-8ac2-90a8f9634f45', '10acf840-fabe-594d-a711-b1490b1d5255', 'أيُّ عددٍ يقبل القسمة على 10؟', '[{"id":"a","text":"105"},{"id":"b","text":"200"},{"id":"c","text":"25"},{"id":"d","text":"52"}]'::jsonb, 'b', 'العددُ يقبل القسمة على 10 إذا كان آحاده 0؛ آحادُ 200 هو 0، فهو يقبل القسمة على 10.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('fa3f4a39-8db0-5697-8eec-b8de7a9b82a6', '10acf840-fabe-594d-a711-b1490b1d5255', 'العددُ الذي يقبل القسمة على 9 يقبل أيضًا القسمة على:', '[{"id":"a","text":"3"},{"id":"b","text":"4"},{"id":"c","text":"5"},{"id":"d","text":"7"}]'::jsonb, 'a', 'بما أنّ 9 = 3 × 3، فكلُّ عددٍ يقبل القسمة على 9 يقبلها على 3 أيضًا.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('3d4f1a96-9912-5ed0-a9dd-38b01977dd84', '9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', '⭐ تمرين: أوّلُ معايير القسمة', 1, 50, 10, 'practice', 'admin', 1)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('72f3e6e3-8ef5-5c4b-b10c-ba082a2d9dfd', '3d4f1a96-9912-5ed0-a9dd-38b01977dd84', 'ما الذي يجعل العددَ يقبل القسمة على 2؟', '[{"id":"a","text":"أن يكون رقمُ آحاده فرديًّا"},{"id":"b","text":"أن يكون رقمُ آحاده زوجيًّا"},{"id":"c","text":"أن ينتهي بالرقم 5"},{"id":"d","text":"أن ينتهي بالرقم 1"}]'::jsonb, 'b', 'يقبل العددُ القسمةَ على 2 إذا كان رقمُ آحاده زوجيًّا (0، 2، 4، 6، 8).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('34042975-c6d3-5fc4-a8a5-6fd56dba11f1', '3d4f1a96-9912-5ed0-a9dd-38b01977dd84', 'أيُّ عددٍ زوجيّ؟', '[{"id":"a","text":"47"},{"id":"b","text":"36"},{"id":"c","text":"19"},{"id":"d","text":"73"}]'::jsonb, 'b', 'آحادُ 36 هو 6 (زوجيّ)، فالعددُ 36 زوجيّ ويقبل القسمة على 2.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('cb9d731d-1e97-5c39-8b4d-d1e487e8dff2', '3d4f1a96-9912-5ed0-a9dd-38b01977dd84', 'أيُّ عددٍ يقبل القسمة على 5؟', '[{"id":"a","text":"52"},{"id":"b","text":"38"},{"id":"c","text":"60"},{"id":"d","text":"41"}]'::jsonb, 'c', 'آحادُ 60 هو 0، فالعددُ 60 يقبل القسمة على 5 (وعلى 10 و2 كذلك).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('42c7b4e1-e12d-577e-b278-e8fa69aff3ec', '3d4f1a96-9912-5ed0-a9dd-38b01977dd84', 'أيُّ عددٍ يقبل القسمة على 10؟', '[{"id":"a","text":"95"},{"id":"b","text":"19"},{"id":"c","text":"90"},{"id":"d","text":"45"}]'::jsonb, 'c', 'العددُ يقبل القسمة على 10 إذا كان آحاده 0؛ آحادُ 90 هو 0، فهو يقبلها.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5b488842-2cf3-58c6-81bd-057da95145a5', '3d4f1a96-9912-5ed0-a9dd-38b01977dd84', 'ما مجموعُ أرقام العدد 234؟', '[{"id":"a","text":"8"},{"id":"b","text":"7"},{"id":"c","text":"6"},{"id":"d","text":"9"}]'::jsonb, 'd', 'مجموعُ أرقام 234 هو 2 + 3 + 4 = 9 (نستعمله لاختبار القسمة على 3 و9).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('42bbd134-5873-5be9-97a3-febae8a0e87d', '3d4f1a96-9912-5ed0-a9dd-38b01977dd84', 'هل يقبل العددُ 234 القسمةَ على 3؟', '[{"id":"a","text":"نعم"},{"id":"b","text":"لا"},{"id":"c","text":"لا لأنّه عددٌ زوجيّ"},{"id":"d","text":"لا يمكن المعرفة"}]'::jsonb, 'a', 'مجموعُ أرقام 234 يساوي 9 وهو يقبل القسمة على 3، فالعددُ 234 يقبل القسمة على 3.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('22006dca-9d98-571b-b451-0fb643c5841e', '9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', '⚔️ زعيم الفصل ⭐⭐⭐: حُكمُ القسمة', 3, 120, 30, 'boss', 'admin', 2)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a12e1882-5c2f-5524-a15b-de6c60bd5a55', '22006dca-9d98-571b-b451-0fb643c5841e', 'أيُّ عددٍ يقبل القسمة على 2 وعلى 5 معًا؟', '[{"id":"a","text":"75"},{"id":"b","text":"70"},{"id":"c","text":"52"},{"id":"d","text":"35"}]'::jsonb, 'b', 'العددُ يقبل القسمة على 2 و5 معًا إذا كان آحاده 0؛ آحادُ 70 هو 0، فهو يقبلهما (وعلى 10 كذلك).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('76e3ef90-2b5c-5e8a-a835-87c773b06fa3', '22006dca-9d98-571b-b451-0fb643c5841e', 'ما مجموعُ أرقام العدد 567، وهل يقبل القسمة على 9؟', '[{"id":"a","text":"المجموع 18 ولا يقبلها"},{"id":"b","text":"المجموع 17 ويقبلها"},{"id":"c","text":"المجموع 18 ويقبل القسمة على 9"},{"id":"d","text":"لا يقبلها"}]'::jsonb, 'c', 'مجموعُ أرقام 567 هو 5 + 6 + 7 = 18، و18 يقبل القسمة على 9، فالعددُ 567 يقبلها.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('97892311-4704-5c55-87b0-3018960fec6d', '22006dca-9d98-571b-b451-0fb643c5841e', 'أيُّ عددٍ يقبل القسمة على 3 لكن ليس على 9؟', '[{"id":"a","text":"27"},{"id":"b","text":"24"},{"id":"c","text":"81"},{"id":"d","text":"18"}]'::jsonb, 'b', 'مجموعُ أرقام 24 هو 6 (يقبل القسمة على 3 لا على 9)؛ أمّا 27 و81 و18 فمجموعُ أرقامها 9 (تقبل القسمة على 9).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('4a902697-f41e-5f31-a884-0d1acc0a5381', '22006dca-9d98-571b-b451-0fb643c5841e', 'العددُ 105 يقبل القسمة على:', '[{"id":"a","text":"2 و10"},{"id":"b","text":"9 فقط"},{"id":"c","text":"5 و3"},{"id":"d","text":"2 فقط"}]'::jsonb, 'c', 'العددُ 105: آحاده 5 فيقبل القسمة على 5؛ ومجموعُ أرقامه 1 + 0 + 5 = 6 فيقبل القسمة على 3؛ وهو فرديّ فلا يقبلها على 2.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a9875b46-196d-5df6-aaa9-c2c3c06783b6', '22006dca-9d98-571b-b451-0fb643c5841e', 'أيُّ عددٍ يقبل القسمة على 2 و3 معًا؟', '[{"id":"a","text":"25"},{"id":"b","text":"33"},{"id":"c","text":"44"},{"id":"d","text":"42"}]'::jsonb, 'd', 'العددُ 42 زوجيّ (يقبل القسمة على 2) ومجموعُ أرقامه 6 (يقبل القسمة على 3)، فهو يقبل القسمة على 2 و3 معًا.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('abb7fda7-4e1b-57cc-a2b3-c0a8f6a1301d', '22006dca-9d98-571b-b451-0fb643c5841e', 'ما أصغرُ رقمٍ نضعه مكان ▢ في العدد 4▢ ليقبل القسمةَ على 3؟', '[{"id":"a","text":"2"},{"id":"b","text":"1"},{"id":"c","text":"0"},{"id":"d","text":"5"}]'::jsonb, 'a', 'نريد 4 + ▢ مضاعفًا للعدد 3؛ أصغرُ قيمةٍ هي 2 لأنّ 4 + 2 = 6 يقبل القسمة على 3 (العددُ 42).', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('2b386749-eec2-5798-ba80-023291d03ae5', '9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', '⭐⭐ تمرين مراجعة (نمط امتحان): قابلية القسمة', 2, 70, 15, 'practice', 'admin', 3)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('53091fe6-da65-56ab-b3d0-021b8cc168ee', '2b386749-eec2-5798-ba80-023291d03ae5', 'أيُّ عددٍ فرديّ (لا يقبل القسمة على 2)؟', '[{"id":"a","text":"73"},{"id":"b","text":"48"},{"id":"c","text":"60"},{"id":"d","text":"26"}]'::jsonb, 'a', 'العددُ 73 فرديّ لأنّ آحاده 3 (ليس زوجيًّا)، فلا يقبل القسمة على 2.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('0b1722fb-697c-5b72-a77e-a4e1b793d6a4', '2b386749-eec2-5798-ba80-023291d03ae5', 'هل يقبل العددُ 90 القسمةَ على 9؟', '[{"id":"a","text":"لا"},{"id":"b","text":"نعم"},{"id":"c","text":"لا لأنّه ينتهي بالرقم 0"},{"id":"d","text":"لا يمكن المعرفة"}]'::jsonb, 'b', 'مجموعُ أرقام 90 هو 9 + 0 = 9، وهو يقبل القسمة على 9، فالعددُ 90 يقبلها.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('a38ba041-ec2d-5c77-8f88-aab0bf5f5274', '2b386749-eec2-5798-ba80-023291d03ae5', 'أيُّ عددٍ يقبل القسمة على 5 وليس على 2؟', '[{"id":"a","text":"70"},{"id":"b","text":"80"},{"id":"c","text":"65"},{"id":"d","text":"52"}]'::jsonb, 'c', 'آحادُ 65 هو 5 فيقبل القسمة على 5، وهو فرديّ فلا يقبلها على 2.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8141af13-d1c3-55dd-b803-f08a8d6e9255', '2b386749-eec2-5798-ba80-023291d03ae5', 'ما مجموعُ أرقام العدد 1 035؟', '[{"id":"a","text":"8"},{"id":"b","text":"10"},{"id":"c","text":"18"},{"id":"d","text":"9"}]'::jsonb, 'd', 'مجموعُ أرقام 1 035 هو 1 + 0 + 3 + 5 = 9.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5e8bf2d1-32fc-58db-b1e0-aba79e6c4c76', '2b386749-eec2-5798-ba80-023291d03ae5', 'هل يقبل العددُ 1 035 القسمةَ على 9؟', '[{"id":"a","text":"لا"},{"id":"b","text":"نعم"},{"id":"c","text":"نعم على 2 فقط"},{"id":"d","text":"لا يمكن المعرفة"}]'::jsonb, 'b', 'مجموعُ أرقام 1 035 يساوي 9 وهو يقبل القسمة على 9، فالعددُ 1 035 يقبل القسمة على 9.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7315fe8a-d916-5f87-9108-e5e5b328f9f8', '2b386749-eec2-5798-ba80-023291d03ae5', 'أيُّ عددٍ يقبل القسمة على 2 و5 و10 معًا؟', '[{"id":"a","text":"255"},{"id":"b","text":"502"},{"id":"c","text":"250"},{"id":"d","text":"25"}]'::jsonb, 'c', 'العددُ يقبل القسمة على 2 و5 و10 معًا إذا كان آحاده 0؛ آحادُ 250 هو 0، فهو يقبلها جميعًا.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('62aedd47-9c8a-52f0-9a6b-0d76e599e882', '9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', '👑 تحدّي النخبة ⭐⭐⭐⭐: قاضي القسمة', 4, 300, 60, 'challenge', 'admin', 4)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e7beddde-6508-5e1a-8a76-16b81ee616f8', '62aedd47-9c8a-52f0-9a6b-0d76e599e882', 'كم عددًا زوجيًّا محصورًا تمامًا بين 11 و21؟', '[{"id":"a","text":"4"},{"id":"b","text":"6"},{"id":"c","text":"5"},{"id":"d","text":"10"}]'::jsonb, 'c', 'الأعدادُ الزوجية المحصورة بين 11 و21 هي 12 و14 و16 و18 و20، أي 5 أعداد.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('42de4028-92da-54f8-b907-75b6486306ac', '62aedd47-9c8a-52f0-9a6b-0d76e599e882', 'ما أصغرُ رقمٍ نضعه مكان ▢ في العدد 7▢2 ليقبل القسمةَ على 3؟', '[{"id":"a","text":"3"},{"id":"b","text":"1"},{"id":"c","text":"6"},{"id":"d","text":"0"}]'::jsonb, 'd', 'نريد 7 + ▢ + 2 = 9 + ▢ مضاعفًا للعدد 3؛ أصغرُ قيمةٍ هي 0 (المجموع 9 يقبل القسمة على 3).', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('208a9477-1168-5ddb-ac8e-ac79dfef43e9', '62aedd47-9c8a-52f0-9a6b-0d76e599e882', 'عددٌ يقبل القسمة على 9. ما الذي نتأكّد منه عن مجموع أرقامه؟', '[{"id":"a","text":"أنّه عددٌ فرديّ"},{"id":"b","text":"أنّه مضاعفٌ للعدد 9"},{"id":"c","text":"أنّه يساوي 9 دائمًا"},{"id":"d","text":"أنّه عددٌ زوجيّ"}]'::jsonb, 'b', 'إذا كان العددُ يقبل القسمة على 9، فإنّ مجموعَ أرقامه مضاعفٌ للعدد 9 (مثل 9 أو 18 أو 27).', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('860252ce-9a4a-55c2-858d-a2b5f2f37c15', '62aedd47-9c8a-52f0-9a6b-0d76e599e882', 'أيُّ عددٍ يقبل القسمة على 2 و3 و5 معًا؟', '[{"id":"a","text":"100"},{"id":"b","text":"115"},{"id":"c","text":"120"},{"id":"d","text":"144"}]'::jsonb, 'c', 'العددُ 120 زوجيّ (÷2)، ومجموعُ أرقامه 3 (÷3)، وآحاده 0 (÷5)، فهو يقبل القسمة على 2 و3 و5 معًا.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('18964940-33e1-5bef-b8b2-33fda41b86fe', '62aedd47-9c8a-52f0-9a6b-0d76e599e882', 'عددٌ من ثلاث خاناتٍ يبدأ بـ 34 ويقبل القسمةَ على 5 و2 معًا. ما رقمُ آحاده؟', '[{"id":"a","text":"0"},{"id":"b","text":"5"},{"id":"c","text":"4"},{"id":"d","text":"2"}]'::jsonb, 'a', 'ليقبل العددُ القسمةَ على 2 و5 معًا يجب أن يكون آحاده 0، فالعددُ 340.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('f42ab535-ec84-5a94-b78a-45c8b79c8bb6', '62aedd47-9c8a-52f0-9a6b-0d76e599e882', 'كم عددًا محصورًا بين 1 و30 يقبل القسمةَ على 9؟', '[{"id":"a","text":"2"},{"id":"b","text":"3"},{"id":"c","text":"4"},{"id":"d","text":"9"}]'::jsonb, 'b', 'الأعدادُ التي تقبل القسمة على 9 بين 1 و30 هي 9 و18 و27، أي 3 أعداد.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.exercises (id, chapter_id, subject_id, title, difficulty, xp_reward, reward_coins, mode, source, display_order) VALUES
  ('8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', '9abe8925-3e4d-5a6b-8df3-5292cae5598a', 'math-6eme', '📝 تدريب ⭐⭐⭐: مراجعة شاملة لقابلية القسمة', 3, 120, 30, 'boss', 'admin', 5)
ON CONFLICT (id) DO UPDATE SET
  chapter_id = EXCLUDED.chapter_id,
  subject_id = EXCLUDED.subject_id,
  title = EXCLUDED.title,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d8b08e02-b3ef-5bd5-aebf-6e9b6ff60a54', '8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', 'لماذا يقبل العددُ 480 القسمةَ على 10؟', '[{"id":"a","text":"لأنّ آحاده 8"},{"id":"b","text":"لأنّ آحاده 0"},{"id":"c","text":"لأنّ مجموع أرقامه 12"},{"id":"d","text":"لأنّه عددٌ زوجيّ"}]'::jsonb, 'b', 'العددُ 480 يقبل القسمة على 10 لأنّ آحاده 0 (وكلُّ عددٍ آحاده 0 يقبل القسمة على 10).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('3e71ba87-1e4c-5f2e-984d-805147243372', '8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', 'أيُّ عددٍ يقبل القسمة على 3؟', '[{"id":"a","text":"70"},{"id":"b","text":"52"},{"id":"c","text":"81"},{"id":"d","text":"25"}]'::jsonb, 'c', 'مجموعُ أرقام 81 هو 8 + 1 = 9، وهو يقبل القسمة على 3، فالعددُ 81 يقبلها.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5d039205-cbba-510c-bfca-02061832dd20', '8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', 'أيُّ عددٍ يقبل القسمة على 9؟', '[{"id":"a","text":"123"},{"id":"b","text":"144"},{"id":"c","text":"50"},{"id":"d","text":"28"}]'::jsonb, 'b', 'مجموعُ أرقام 144 هو 1 + 4 + 4 = 9، وهو يقبل القسمة على 9، فالعددُ 144 يقبلها.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('07b9832a-7015-5f42-9cbb-d5ba776e00d9', '8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', 'العددُ 256: هل يقبل القسمةَ على 2؟ وعلى 3؟', '[{"id":"a","text":"يقبل على 3 لا على 2"},{"id":"b","text":"يقبلهما معًا"},{"id":"c","text":"يقبل على 2 لا على 3"},{"id":"d","text":"لا يقبل أيًّا منهما"}]'::jsonb, 'c', 'العددُ 256 آحاده 6 (زوجيّ) فيقبل القسمة على 2؛ ومجموعُ أرقامه 2 + 5 + 6 = 13 لا يقبل القسمة على 3.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('5fb7fd35-5814-5665-b9bc-ec3028951b07', '8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', 'ما أكبرُ رقمٍ نضعه مكان ▢ في العدد 2▢ (من خانتين) ليقبل القسمةَ على 5؟', '[{"id":"a","text":"0"},{"id":"b","text":"9"},{"id":"c","text":"2"},{"id":"d","text":"5"}]'::jsonb, 'd', 'ليقبل العددُ 2▢ القسمةَ على 5 يكون آحاده 0 أو 5؛ وأكبرُهما هو 5 (العددُ 25).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ac9a6491-5314-5b70-8325-6388aa8bef4d', '8a5a6ac4-d0ca-5eea-bfa4-a5dc5c6ba06f', 'عددٌ من ثلاث خاناتٍ مجموعُ أرقامه 15. هل يقبل القسمةَ على 3 وعلى 9؟', '[{"id":"a","text":"على 3 نعم وعلى 9 لا"},{"id":"b","text":"عليهما معًا"},{"id":"c","text":"لا على 3 ولا على 9"},{"id":"d","text":"على 9 فقط"}]'::jsonb, 'a', 'مجموعُ الأرقام 15 يقبل القسمة على 3 (15 = 3 × 5) ولا يقبلها على 9، فالعددُ يقبل القسمة على 3 لا على 9.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
