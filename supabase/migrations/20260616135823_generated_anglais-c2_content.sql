...
What do the three highlighted structures have in common?', '[{"id":"a","text":"They all use the mandative subjunctive."},{"id":"b","text":"They all express a hypothetical or unreal situation through a past or subjunctive form."},{"id":"c","text":"They all require the same verb form — the past simple."},{"id":"d","text":"They all invert subject and auxiliary."}]'::jsonb, 'b', '"It''s high time somebody spoke" (unreal past), "Were an employee to raise" (past subjunctive inversion), and "I''d rather the union took" (unreal past) all use a non-present verb form to signal that the situation is hypothetical or not yet real. (a) is wrong — none uses the mandative subjunctive (those appear after demand/insist/etc.). (c) is partly right but imprecise — "were" is past subjunctive, not past simple. (d) is wrong — only the second structure inverts.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('51ed5ed9-dbf6-5e43-9851-bbd3109a67ee', '7f794398-5176-5f36-bad3-70f1438aeaa2', 'What does "the tip of the iceberg" mean in context?', '[{"id":"a","text":"The most important and visible part of a problem."},{"id":"b","text":"A small, visible sign of a much larger hidden problem."},{"id":"c","text":"A cold, unwelcoming atmosphere."},{"id":"d","text":"A dangerous situation with no solution."}]'::jsonb, 'b', '"The tip of the iceberg" refers to the small visible portion of an iceberg above water — used figuratively to mean the visible sign of a much larger hidden problem. (a) is almost the opposite; (c) and (d) invent meanings not supported by the course.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('94a296fe-932c-5c3d-86f5-85e3bea5fdbb', '85b15adb-d3e0-571c-b7b7-08fb8257d0b6', 'What does "break the ice" mean?', '[{"id":"a","text":"Destroy something valuable."},{"id":"b","text":"End a friendship."},{"id":"c","text":"Make people feel relaxed and comfortable at the start of a social situation."},{"id":"d","text":"Begin an argument aggressively."}]'::jsonb, 'c', '"Break the ice" means to do or say something that reduces awkwardness and helps people feel at ease when meeting for the first time or starting an event. The other options are invented negative meanings that do not match this idiom.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9feeb36d-255c-5f61-b4a5-1aec82befe87', '85b15adb-d3e0-571c-b7b7-08fb8257d0b6', 'Identify which sentence uses an idiom CORRECTLY.', '[{"id":"a","text":"She let the cats out of the bags by mentioning the surprise."},{"id":"b","text":"He let the cat out of the bag when he mentioned the surprise."},{"id":"c","text":"They let the cat out of the bags before the party."},{"id":"d","text":"I let out the cat from the bag accidentally."}]'::jsonb, 'b', 'The fixed form of this idiom is "let the cat out of the bag" — always singular (the cat, the bag). (a) uses wrong plurals (cats, bags); (c) has the wrong plural (bags); (d) rearranges the fixed structure incorrectly. Only (b) uses the exact form.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('d27e62b8-1532-5823-a5c9-2fc1408c324f', 'd6645ab0-cae0-55d1-8710-5ace50e95c4e', 'Which sentence uses a SIMILE (not a metaphor)?', '[{"id":"a","text":"The news was a bombshell."},{"id":"b","text":"She has a heart of stone."},{"id":"c","text":"The city never sleeps."},{"id":"d","text":"The exam was like climbing a mountain."}]'::jsonb, 'd', 'A simile makes an explicit comparison using like or as: "like climbing a mountain". (a) a bombshell, (b) a heart of stone, and (c) never sleeps are all metaphors — they describe one thing as another without using like or as.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6e62b2c1-f98a-5314-9476-3d683b0a2c2e', '460d73ed-5900-5cb9-bbb3-cb6db0572f28', 'Identify the METAPHOR in the following group of sentences.', '[{"id":"a","text":"The stock market crashed like a falling house of cards."},{"id":"b","text":"The negotiations were a battlefield from start to finish."},{"id":"c","text":"She was as bold as brass when she walked into the interview."},{"id":"d","text":"The office was as quiet as a library during the exam."}]'::jsonb, 'b', '"The negotiations were a battlefield" is a metaphor — it says one thing (negotiations) IS another (battlefield) without using like or as. (a) and (d) use as…as or like, making them similes. (c) as bold as brass is also a simile. Only (b) makes the implicit identification that defines a metaphor.', 2)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('e0b8875d-deda-506e-abd6-c136f5938792', '50e4da08-9786-5f37-b92c-4756f87f6167', 'Which word correctly replaces "a lot of" in formal writing?', '[{"id":"a","text":"loads of"},{"id":"b","text":"tons of"},{"id":"c","text":"heaps of"},{"id":"d","text":"a considerable number of"}]'::jsonb, 'd', '"A considerable number of" (or "a significant number of") is the formal replacement. "Loads of", "tons of", and "heaps of" are all highly colloquial and inappropriate in academic or formal writing.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9298ed8c-dc6c-5b5a-9b31-d3b742433747', '50e4da08-9786-5f37-b92c-4756f87f6167', 'Which sentence is MOST appropriate for a formal business email?', '[{"id":"a","text":"I''m writing to find out about your prices."},{"id":"b","text":"I am writing to enquire about your pricing structure."},{"id":"c","text":"Just checking what you charge for this stuff."},{"id":"d","text":"Could you tell me what things cost?"}]'::jsonb, 'b', 'Option (b) avoids contractions ("I am"), uses a formal verb ("enquire"), and includes a precise noun phrase ("pricing structure"). (a) uses a contraction (I''m) and a phrasal verb (find out); (c) is very colloquial (stuff, just checking); (d) uses vague language (things, cost).', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('9bd2eb0b-d929-5553-9e3a-00e0a2bf8b54', 'f080ad19-5a66-5c15-a4e5-84d80afc70e8', 'Which feature makes this sentence LESS formal: "We think it''s important to carry out more research."', '[{"id":"a","text":"The use of the verb \"think\"."},{"id":"b","text":"The use of first person (\"We\") and the contraction (\"it''s\") and phrasal verb (\"carry out\")."},{"id":"c","text":"The use of a complete sentence."},{"id":"d","text":"The word \"research\"."}]'::jsonb, 'b', 'Three informal features combine: first-person We, the contraction it''s (formal = it is), and the phrasal verb carry out (formal = conduct). "Research" is perfectly formal; having a complete sentence is not informal. The bundled answer (b) correctly identifies all three informal markers.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
Which is the BEST fully formal rewrite?', '[{"id":"a","text":"The government requires to look into the economic deterioration, devise a plan to deal with inflation, and ascertain the cause."},{"id":"b","text":"An investigation into the causes of economic deterioration is required. The government must devise a strategy to address inflation and ascertain its root causes."},{"id":"c","text":"The government should investigate the economy getting worse and come up with solutions for rising prices."},{"id":"d","text":"It is necessary for the government to look into economic problems and find out about prices."}]'::jsonb, 'b', 'Option (b) achieves the most complete transformation: nominalisation (investigation, deterioration, causes), formal impersonal passive (is required), Latinate verbs (devise, address, ascertain), and formal noun phrase (root causes). (a) incorrectly writes "requires to" (should be "is required") and mixes levels; (c) still uses "come up with" and "getting worse"; (d) still uses phrasal verb "look into" and "find out about".', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('ee7547b0-c1d6-5dd7-acf2-b6b4a1e245e1', '56ac58aa-2ca3-5e52-ad90-59ee85bb06de', 'Which transformation of "We decided to give up the project" is the MOST complete and formally accurate?', '[{"id":"a","text":"We made a decision to give up the project."},{"id":"b","text":"A decision was made to abandon the project."},{"id":"c","text":"The decision for project abandonment was made by us."},{"id":"d","text":"It was decided by the team to give up the project."}]'::jsonb, 'b', 'Option (b) achieves the optimal transformation: nominalisation (decision), impersonal passive (was made), and Latinate single-word verb (abandon, replacing the phrasal "give up"). The actor (we) is removed entirely — perfect for formal writing. (a) nominalises but keeps "give up"; (c) is awkward ("for project abandonment") and unnecessarily names the actor; (d) keeps the phrasal "give up" and names the actor.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8382d959-a78a-5448-bed6-0af18c99b06e', '56ac58aa-2ca3-5e52-ad90-59ee85bb06de', 'Which sentence INCORRECTLY attempts to replace a phrasal verb with a formal equivalent?', '[{"id":"a","text":"The audit revealed that costs had been significantly understated."},{"id":"b","text":"The committee resolved to defer the matter to the next session."},{"id":"c","text":"The proposal was relinquished by the majority of board members."},{"id":"d","text":"The report was examined and all findings were corroborated by independent reviewers."}]'::jsonb, 'c', '"Relinquished" means to voluntarily give up control or possession of something — it replaces "give up" in the sense of releasing something held. But "the proposal was relinquished" is semantically odd: proposals are rejected, withdrawn, or abandoned — not relinquished. The formal word is used incorrectly in context. (a), (b), and (d) all use formal vocabulary accurately and appropriately.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('550495a8-a78c-5c11-9e67-44b2102c9cd1', 'b381c97a-dce4-5e24-905b-9032c809f7ed', 'Complete: "You should ___ more research before reaching a conclusion."', '[{"id":"a","text":"make"},{"id":"b","text":"have"},{"id":"c","text":"take"},{"id":"d","text":"do"}]'::jsonb, 'd', 'The correct collocation is "do research" — not make, have, or take. "Make research" is a very common non-native error. "Do" is the fixed collocate for research, homework, and similar intellectual activities.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('c3e0d485-c44d-5c19-a101-206357fc0455', '2899f53e-4af9-5533-a830-b5b23e9c5ce8', 'Read: "The historical victory of 1966 is still celebrated today. It was a historic moment for the nation."
Are these two uses of "historic" and "historical" correct?', '[{"id":"a","text":"Yes, both are correct — they mean the same thing."},{"id":"b","text":"No — both should be \"historic\"."},{"id":"c","text":"No — \"historical\" in the first sentence is wrong; \"the historic victory\" is correct. \"Historic\" in the second sentence is also correct."},{"id":"d","text":"No — \"historic\" in the second sentence is wrong; it should be \"historical\"."}]'::jsonb, 'c', '"Historical" means relating to or belonging to history in general (a historical novel, historical records). "Historic" means significant or landmark — something that makes history. A victory in 1966 that is still celebrated is a landmark event: the correct adjective is "historic". The second use (a historic moment for the nation) is correct. So the first sentence uses "historical" incorrectly — it should be "historic".', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('02864476-9f47-51c7-8f4b-5126f25db9e1', '2899f53e-4af9-5533-a830-b5b23e9c5ce8', 'Read: "The committee ___ seven members: three from the legal sector, two economists, and two scientists."
Choose the MOST formally precise option.', '[{"id":"a","text":"is comprised of"},{"id":"b","text":"is made up of"},{"id":"c","text":"is composed by"},{"id":"d","text":"comprises"}]'::jsonb, 'd', '"Comprises" is the formally preferred active form: the whole (committee) comprises its parts (the members). "Is comprised of" reverses the passive incorrectly in prescriptive formal usage — many style guides reject it. "Is made up of" is informal. "Is composed by" uses the wrong preposition; the correct passive is "is composed of".', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('7c1e5ec9-d703-5d8a-8a54-852e05e90707', '867db683-8f35-5715-af86-1e84aee80f50', 'What is ellipsis in grammar?', '[{"id":"a","text":"Adding extra words to make a sentence more emphatic."},{"id":"b","text":"Omitting words that are predictable from context to make language more concise."},{"id":"c","text":"Replacing a noun with a pronoun."},{"id":"d","text":"Using connectors such as however and furthermore."}]'::jsonb, 'b', 'Ellipsis is the deliberate omission of words that are understood from context — making language more natural and concise without loss of meaning. Replacing a noun with a pronoun (c) is substitution or reference; adding words (a) is the opposite of ellipsis; connectors (d) describe cohesive devices.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('6413abb8-5794-5328-9bd3-939e2a0095fd', '867db683-8f35-5715-af86-1e84aee80f50', 'Complete: "I''m not sure if the meeting has been rescheduled — I believe ___."', '[{"id":"a","text":"not"},{"id":"b","text":"so"},{"id":"c","text":"one"},{"id":"d","text":"neither"}]'::jsonb, 'b', 'When you believe or think something is true (affirmative), use "so": I believe so = I believe it has been rescheduled. "Not" would mean I believe it has NOT been rescheduled, which contradicts the uncertainty (I''m not sure). "One" replaces nouns; "neither" expresses negative agreement — neither fits here.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('dc47af52-9b85-5d80-ac64-357d3b57e6b8', '867db683-8f35-5715-af86-1e84aee80f50', 'Complete: "She hasn''t seen the film yet. ___ have I."', '[{"id":"a","text":"Neither"},{"id":"b","text":"So"},{"id":"c","text":"Nor"},{"id":"d","text":"Both Neither and Nor are correct."}]'::jsonb, 'd', 'Both "Neither have I" and "Nor have I" are correct ways to express negative agreement — both are standard and interchangeable. "So have I" would express positive agreement (incorrect here since she hasn''t seen it). The question tests whether learners know that neither and nor are both valid.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8e279df7-7e62-5fd0-9644-ff4dd89f80b0', '4e098852-5532-548c-9d46-983637ca99b8', 'Complete: ''Would you like a coffee?'' — ''Yes, I''d love ___.''', '[{"id":"a","text":"so"},{"id":"b","text":"one"},{"id":"c","text":"it"},{"id":"d","text":"such"}]'::jsonb, 'b', '"One" is the nominal substitute for a countable noun (a coffee → one). "So" substitutes a whole clause (I think so). "It" would refer to a specific previously mentioned coffee, not an offer of one. "Such" is a formal demonstrative that replaces a noun phrase in a different way.', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('93afe125-7674-5860-9e54-931ac1aec9ad', '4e098852-5532-548c-9d46-983637ca99b8', 'Complete: "She didn''t enjoy the lecture, and ___ did most of her classmates."', '[{"id":"a","text":"neither"},{"id":"b","text":"so"},{"id":"c","text":"nor"},{"id":"d","text":"Both neither and nor are correct."}]'::jsonb, 'd', 'Both "neither did most of her classmates" and "nor did most of her classmates" are correct ways to express negative agreement — they are interchangeable. "So did" would express positive agreement, which contradicts "didn''t enjoy".', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('eb315260-c92f-5b45-b177-63773e04c22c', 'a44453e4-09ca-5936-b7e6-dbb4e2680c92', 'Choose the CORRECT cohesive device to join these two sentences: "The results were disappointing. ___, the team remained optimistic."', '[{"id":"a","text":"Furthermore"},{"id":"b","text":"Therefore"},{"id":"c","text":"Nevertheless"},{"id":"d","text":"In addition"}]'::jsonb, 'c', 'A contrast is needed: disappointing results vs remaining optimistic. "Nevertheless" (= despite this) signals the contrast perfectly. "Furthermore" and "In addition" add information (wrong relationship). "Therefore" signals a result (wrong direction — the optimism is not caused by the disappointment).', 1)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
Which word BEST fills the gap to maintain cohesion?', '[{"id":"a","text":"A"},{"id":"b","text":"This"},{"id":"c","text":"The"},{"id":"d","text":"Both The and This are correct."}]'::jsonb, 'd', 'Both "The" (definite article, signalling the specific regulation already mentioned) and "This" (demonstrative, pointing back to the just-mentioned regulation) correctly create a reference chain. "A" would reintroduce it as if unrelated, breaking the chain — making it seem like a different regulation.', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
Which is the BEST choice for the gap?', '[{"id":"a","text":"These"},{"id":"b","text":"Such"},{"id":"c","text":"Some"},{"id":"d","text":"Both These and Such are correct."}]'::jsonb, 'd', 'Both "These anomalies" (demonstrative pronoun pointing back to the specific anomalies just mentioned) and "Such anomalies" (formal substitution meaning anomalies of that kind) are correct and create good cohesion. "Some" would imply only a portion of the anomalies, not the specific ones just referenced.', 3)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
INSERT INTO public.questions (id, exercise_id, prompt, options, correct_option, explanation, display_order) VALUES
  ('8895a35e-6e01-51ac-82a8-37a87fcce468', '3c63e2bc-23ae-578e-8ef1-90ceb8146c98', 'Which sentence uses an appropriate cohesive device to introduce an EXAMPLE?', '[{"id":"a","text":"Many animals migrate seasonally. Consequently, the Arctic tern travels from pole to pole."},{"id":"b","text":"Many animals migrate seasonally. For instance, the Arctic tern travels from pole to pole."},{"id":"c","text":"Many animals migrate seasonally. Nevertheless, the Arctic tern travels from pole to pole."},{"id":"d","text":"Many animals migrate seasonally. However, the Arctic tern travels from pole to pole."}]'::jsonb, 'b', '"For instance" introduces a specific example — perfect for illustrating the general claim about seasonal migration. "Consequently" signals a result (wrong); "Nevertheless" signals contrast (wrong — the tern''s migration is not a contrasting exception); "However" also signals contrast (also wrong).', 4)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
Which rewrite BEST uses cohesive devices and reference to avoid repetition?', '[{"id":"a","text":"The CEO announced a restructuring plan. The plan involved redundancies, and these were unexpected, shocking employees."},{"id":"b","text":"The CEO announced a restructuring plan. This involved redundancies, which, being unexpected, shocked employees."},{"id":"c","text":"The CEO announced a restructuring plan involving redundancies. These proved unexpected and shocked employees."},{"id":"d","text":"All three options (a), (b), and (c) are valid rewrites."}]'::jsonb, 'd', 'All three rewrites correctly use cohesive devices: (a) uses "these" (demonstrative reference); (b) uses "This" (demonstrative) and "which" (relative clause); (c) uses "These" (demonstrative) and a participial clause. All three eliminate unnecessary repetition while maintaining clear meaning. At C2, multiple valid cohesion strategies exist — recognising them all is the mastery point.', 5)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
...
What is the FULL form of the ellipsis in "but others didn''t"?', '[{"id":"a","text":"but others didn''t predict a recession"},{"id":"b","text":"but others didn''t believe in economics"},{"id":"c","text":"but others didn''t say so"},{"id":"d","text":"but others didn''t have a prediction"}]'::jsonb, 'a', 'The ellipsis omits the verb phrase "predict a recession" — recoverable from the first clause. The full form is: "many economists predicted a recession, but others didn''t [predict a recession]". This is verbal ellipsis after an auxiliary (didn''t), the most common pattern. The other options introduce content not present in the original sentence.', 6)
ON CONFLICT (id) DO UPDATE SET
  exercise_id = EXCLUDED.exercise_id,
  prompt = EXCLUDED.prompt,
  options = EXCLUDED.options,
