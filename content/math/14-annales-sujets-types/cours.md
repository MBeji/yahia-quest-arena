...
3. نفّذ بالترتيب مستثمرًا النتيجة: $BC = \sqrt{6^2 + 8^2} = \sqrt{100} = 10$، ثمّ بطاليس $MN = \tfrac{1}{2} \times 10 = 5$.
...
$$\sin 30° = \tfrac{1}{2}, \quad \cos 60° = \tfrac{1}{2}, \quad \tan 45° = 1, \quad \cos 30° = \sin 60° = \tfrac{\sqrt{3}}{2}, \quad \tan 60° = \sqrt{3}, \quad \tan 30° = \tfrac{\sqrt{3}}{3}$$
...
5. **الدوال**: صورة عدد = تعويض x في f(x)؛ البحث عن x المجهول = حلّ المعادلة f(x) = c — راجع الفصل 6. مثال: $f(x) = 3x - 2 \Rightarrow f(4) = 3 \times 4 - 2 = 10$.
