...
// Les contrôles du patron de notion (étude 35) vivent à part — `max-lines` l'a exigé au
// lot 5, et le découpage suit la matière : ici le gate général, là le patron.
export {
  auditCoursePitfalls,
  auditLesson,
  contentLineCount,
