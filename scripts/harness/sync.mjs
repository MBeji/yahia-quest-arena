 ...
 * on commit and the drift check fails on the next run.
 *
...
const DO_NOT_EDIT =
  "GENERATED by `npm run harness:sync` from harness/policy.json (permissions) + the hooks " +
  "wired in scripts/harness/sync.mjs. DO NOT EDIT BY HAND — edit the source and re-run the " +
  "sync (étude 25 D-4).";
...
export function buildClaudeSettings({ policy }) {
  return {
          ...
          hooks: [
            {
              type: "command",
              if: "Bash(git commit*)",
              command: "node .claude/hooks/precommit-checks.mjs",
            },
          ],
        },
      ],
