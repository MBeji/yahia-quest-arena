  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">{error.message || "Une erreur est survenue."}</p>
        <div className="mt-6 flex flex-wrap justify-center gap-2">
          ...
          <a href="/" className="rounded-md border border-input bg-background px-4 py-2 text-sm">Accueil</a>
        </div>
      </div>
    </div>
  );
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "YahiaAcademy — Concours 9ème en mode RPG" },
      { name: "description", content: "Prépare le concours de 9ème année tunisien comme un héros de manga. XP, flamme, quêtes, et boss à battre." },
      { name: "author", content: "YahiaAcademy" },
      { property: "og:title", content: "YahiaAcademy — Concours 9ème en mode RPG" },
      { property: "og:description", content: "L'académie shonen pour dominer le concours de 9ème." },
