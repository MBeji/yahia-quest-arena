...
export const fr: TranslationKeys = {
  ...
  public: {
    ...
    landing: {
      ...
      personaParentDesc:
        "Suis le programme officiel de ton enfant, gratuitement, sans inscription.",
      personaTeacherTitle: "Je suis enseignant",
      personaTeacherDesc: "Des ressources conformes au programme officiel, prêtes à imprimer.",
      personaCta: "Découvrir",
