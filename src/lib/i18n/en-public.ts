...
export const enPublic: TranslationKeys["public"] = {
  ...
  landing: {
    ...
    personaTeacherDesc: "Curriculum-aligned lessons, printable in one click for the class.",
    personaStudentCta: "Explore the programme",
    personaParentCta: "Open the tracking",
    personaTeacherCta: "Browse the lessons",
    proofBandKicker: "Already online, for free",
    proofStatSubjects: "subjects",
    proofStatLessons: "lessons & summaries",
    proofStatExercises: "corrected missions",
    proofSampleCta: "See an example lesson",
  ...
  catalogue: {
    ...
    cardSubjects: "{count} subjects",
    themeDescAnglais: "From A1 to C2: tenses, vocabulary, comprehension — CEFR-aligned.",
  ...
  reader: {
    ...
    manuelPrev: "Previous",
    manuelNext: "Next",
    manuelBookTitle: "Official textbook",
    manuelBookHint: "This subject's official student textbook, to read online.",
    manuelBookOpen: "Open the textbook",
    manuelBookTome: "Volume {n}",
