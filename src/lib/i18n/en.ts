...
export const en: TranslationKeys = {
  ...
  errors: {
    ...
    sessionExpired: "Your session has expired. Sign in again to save your progress.",
  },
  auth: {
  ...
  dashboard: {
    ...
    dailyGoalChoose: "Your daily goal",
    dailyGoalChooseHint:
      "The dashboard ring tracks the XP you actually earn. Changeable once a day.",
    dailyGoalAlreadySet: "Goal already changed today — you can set it again tomorrow.",
    dailyGoalSaved: "Daily goal updated.",
    dailyMissionsDone: "Daily goal reached — see you tomorrow!",
    dailyMissionsDoneDesc: "Today's missions are done. Anything more is a bonus.",
    weekTab: "This week",
    allTimeTab: "All time",
    weeklyRecapTitle: "Your week",
    weeklyRecapEmpty: "Your week is just starting — the first mission opens the recap.",
    weeklyRecapStars: "⭐ {stars} stars · {seals} seals this week",
    weeklyRecapXp: "XP earned",
    weeklyRecapMissions: "missions",
    weeklyRecapAccuracy: "accuracy",
    weeklyRecapDays: "active days",
    weeklyRecapVsLast: "vs last week",
    weeklyRecapBadges: "badges earned",
    weeklyRecapLeague: "League: {tier}, rank {rank}",
    podiumTitle: "Your league week",
    podiumRank: "Rank {rank} · {tier}",
    podiumCoins: "+{coins} coins",
    podiumClose: "Continue",
    ...
    objectiveTypes: {
      exercises_n: "Finish 3 exercises",
      score_90: "Score 90% or more on an exercise",
      review_due: "Clear a due review",
      subject_focus: "2 exercises from your track",
      recall_one: "Do one active recall",
      dungeon_floors: "Clear 5 dungeon floors",
      duel_play: "Play a duel",
      chapter_step: "Move forward in a new chapter",
      daily_complete: "Daily goal reached",
    ...
    heroClasses: {
      novice: "Novice",
      candidat: "Civil Candidate",
      aspirant: "Academy Aspirant",
      guerrier: "Equation Warrior",
      maitre: "Master of Languages",
      elite: "Contest Elite",
      s_rank: "S-Rank Legend",
    },
    heroTitles: {
      studious: "The Steady",
      sharp: "The Blade",
  ...
  settings: {
    ...
    helpPrivacy: "Privacy",
    exportTitle: "My data",
    exportDesc: "Everything we know about you, in one file.",
    exportRowLabel: "A copy of my data",
    exportAction: "Download",
    exportBusy: "Preparing…",
    exportDone: "File downloaded — {rows} rows of data about you.",
    exportEmpty: "File downloaded — we hold no data about you yet.",
    exportError: "The download failed. Try again in a moment.",
  ...
  ai: {
    ...
    launcherLabel: "The Prof",
    launcherTitle: "The Prof, your AI help",
    launcherDesc: "Ask about a chapter, or have a custom quiz forged for you.",
    launcherLockedDesc: "AI mode is not open on this account yet. Here is what it unlocks.",
    launcherChat: "Chat with the Prof",
    launcherChatDesc: "A question about a lesson? He answers, on that chapter.",
    launcherForge: "The Forge",
    launcherForgeDesc: "A custom quiz, on the chapter you pick.",
    launcherEntryLocked: "Available once AI mode is open.",
    launcherGo: "Go",
    launcherInvite:
      "AI mode runs on your family's own API key — the app takes nothing and charges nothing. An adult adds it in a minute.",
    launcherInviteCta: "Open Settings",
