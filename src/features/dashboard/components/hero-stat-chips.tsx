    ...
    <>
      ...
      <div className="mt-3 flex flex-wrap items-center gap-3">
        <ExplainHint text={t.explain.level} label={t.dashboard.levelLabel}>
          <span className="rounded-full bg-[color:var(--gold)]/20 px-3 py-1 text-sm font-bold text-[color:var(--gold)]">
            Lvl {level}
          </span>
        </ExplainHint>
        <ExplainHint text={t.explain.streak} label={t.dashboard.longestStreak}>
          <span className="flex items-center gap-1 rounded-full bg-[color:var(--flame)]/20 px-3 py-1 text-sm font-bold text-[color:var(--flame)]">
        ...
        <ExplainHint text={t.explain.xp} label="XP">
          <span className="flex items-center gap-1 rounded-full bg-[color:var(--neon-gold)]/20 px-3 py-1 text-sm font-bold text-[color:var(--neon-gold)]">
            <Zap className="h-4 w-4" /> {xp} XP
          </span>
        </ExplainHint>
        <ExplainHint text={t.explain.coins} label={t.quest.coinsLabel}>
          <span className="flex items-center gap-1 rounded-full border border-[color:var(--gold)]/30 bg-[color:var(--gold)]/10 px-3 py-1 text-sm font-bold text-[color:var(--gold)]">
