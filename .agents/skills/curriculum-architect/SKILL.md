...
ls .Codex/skills/ | grep '^prof-'            # professor overlay coverage
ls .Codex/skills/content-ecole-tn/references/programmes-officiels/programme/  # CNP transcriptions
```
...
- **Ladder plan per chapter**: quiz (gate) + `01-pratique` d1 + `03-revision` d2 free core;
  ...
  phase, see AGENTS.md "Access gate"); which interactive formats fit which chapter
