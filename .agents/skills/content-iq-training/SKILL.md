...
First read the content-engine skill and its references (`.Codex/skills/content-engine/`), **especially
...
- **Difficulty ladder + ⭐** as usual: quiz ⭐ (warm-up reasoning, d1–2) · `01-pratique` ⭐ (d1) ·
  ...
  the current free phase, so nothing is actually gated today; see AGENTS.md "Access gate"). 6 items
