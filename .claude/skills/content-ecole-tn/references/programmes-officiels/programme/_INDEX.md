...
| ☐   | matière           | code guide | fichier cible                             | titre                                                   |
| --- | ----------------- | ---------- | ----------------------------------------- | ------------------------------------------------------- |
| [ ] | allemand          | `661305`   | `programme/3eme-sec/allemand.md`          | الدليل المرجعي في اللغة الألمانية                       |
| [ ] | anglais           | `641303`   | `programme/3eme-sec/anglais.md`           | الدليل المرجعي في اللغة الانقليزية                      |
| [ ] | arts-tech-musique | `608301`   | `programme/3eme-sec/arts-tech-musique.md` | الدليل المرجعي في التربية التشكيلية في المرحلة الثانوية |
| [ ] | espagnol          | `691303`   | `programme/3eme-sec/espagnol.md`          | الدليل المرجعي في اللغة الإسبانية                       |
| [ ] | italien           | `681303`   | `programme/3eme-sec/italien.md`           | الدليل المرجعي في اللغة االإيطالية                      |
...
**Total : 64 lignes au work-list (57 guides du corpus + 7 couples du secondaire adossés au manuel élève, hors corpus de guides) · 24 `[x]` transcrites, auditées et mergées (1ère→5ème base, 1ère-sec chimie) · 22 `[~]` transcrites, en validation (6ème→9ème base, 2ème-sec, 1ère-sec, bac-math) · 18 `[ ]` à faire — soit 46 fichiers `programme/<niveau>/<matière>.md` existants.** _(recompté le 2026-07-16 : les totaux avaient dérivé — ils annonçaient 60/23/18/19/41 alors que le fichier portait déjà 63 lignes et 45 fiches avant l'ajout de `1ere-sec/svt`.)_
...
| [~] | sciences-physiques | `223103P00` (manuel élève) — _pas de guide au corpus_ | `programme/1ere-sec/sciences-physiques.md` | 🚧 **pilote 2026-07-07, complétée + R-7 le 2026-07-17 (MBeji)** — manuel élève seul (276 p.) ; **17 chapitres / 6 thèmes à la profondeur de génération** — le ch.1 et les liminaires, qui étaient les **seuls** trous, ont été transcrits le 2026-07-17 (vision 24/24 p.) ; **R-7 sur les ch.2–17** (5 agents indépendants, une tranche chacun, contre le PDF source : 16 encadrés « L'essentiel du cours » collationnés verbatim, toutes les valeurs chiffrées revérifiées ; **18 findings appliqués**, dont 2 inventions retirées et 2 attestations fausses d'une session antérieure corrigées) ; **langue constatée `fr`** ✅ ; **subject id cible `physique-1ere-sec`** (convention lycée) ; ⚠️ **non promue `[x]`** — dette assumée en §6.1 bis, le **ch.1 n'a aucune relecture indépendante**, ~45 figures non levées (⚠️ l'ancien libellé de cette ligne était **faux deux fois** : les ch.2–17 étaient en profondeur dès le pilote — pas « au niveau bloc » — et **ce manuel ne contient aucune chimie**, celle-ci étant couverte à part par `chimie.md` `[x]` depuis `224101P00`)                                                                                                                                                                                                                                                                                |
| [~] | francais           | `221104P00` (manuel élève)                            | `programme/1ere-sec/francais.md`           | 🚧 **transcription ScribeKit 2026-07-10, complétée en profondeur 2026-07-12 — R-7 vérifiée 2026-07-13 par agent indépendant (fidèle, 2 corrections mineures)** — manuel élève « Communiquer en français » (224 p., lu intégralement) ; **7 modules transcrits en profondeur** (activités/exercices détaillés, encadrés Repère verbatim)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [~] | anglais            | `241104P00` (manuel élève)                            | `programme/1ere-sec/anglais.md`            | 🚧 **transcription ScribeKit 2026-07-10, profondeur de génération complète 2026-07-12, R-7 vérifiée 2026-07-13 (agent indépendant, échantillon — verdict : fidèle, 1 correction mineure)** — manuel élève « Perform through English » (150 p., relu intégralement) ; book map + **35/35 leçons transcrites en profondeur** (chaque ACTIVITY détaillée) + appendice complet ; chanson de la leçon 32 non citée verbatim (droit d'auteur)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [~] | svt                | `225104P00` (manuel élève) — _pas de guide au corpus_ | `programme/1ere-sec/svt.md`                | 🚧 **transcription 2026-07-16 (MBeji) — profondeur de génération complète** — manuel élève « Sciences de la Vie et de la Terre — 1ère année de l'enseignement secondaire » seul (**199 p., lues intégralement 1–199** ; couche-texte propre ⇒ extraction déterministe, 0 OCR) ; **3 parties / 8 chapitres transcrits en profondeur** (chaque activité, document, manipulation et exercice décrit individuellement avec ses données chiffrées ; encadrés « Retenons » et Bilans verbatim ; 11 fiches méthodes + lexique + situations d'intégration) ; **langue constatée `fr`** ✅ conforme à `docs/lycee-architecture.md` §4 (le titre arabe du CATALOGUE est un libellé, pas la langue) ; ⛔ `225105P00` « Sciences biologiques » **écarté** = manuel de la **section SPORT** (hors périmètre, autre matière, aucun nœud `grades` cible) ; **R-7 vérifiée 2026-07-16** (agent indépendant, contre le PDF source — verdict : **fidèle**, 0 invention sur 143 citations testées, 199/199 pages citées exactes, 33/33 titres à la page annoncée, 4 coutures inter-tranches saines ; 2 corrections mineures de signalement appliquées) ; ⚠️ **borne d'usage** : `pdftotext` ne rend **aucune figure** (293 images sur 127/199 p.) — les documents dont le contenu n'existe que dans l'image sont relevés nommément (§6.4) et exigent une passe vision ciblée à la génération |
