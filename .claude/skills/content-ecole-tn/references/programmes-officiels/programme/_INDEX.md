...
| [~] | chimie             | `224101P00` (manuel élève)                    | `programme/1ere-sec/chimie.md`             | 🚧 **profondeur de génération complète 2026-07-12** — manuel élève seul (160 p., relu intégralement) ; **4 parties / 9 chapitres transcrits en profondeur** (chaque activité/exercice/document/T.P. décrit individuellement, encadrés « Retenir »/« Essentiel du cours » verbatim) ; vérifié aucun chevauchement avec `sciences-physiques.md` (ne couvre que la physique, ch.2-17) ; **R-7 (vérification indépendante par un second agent) restant à faire** avant promotion finale |
