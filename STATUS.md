...
| **maths bac (section maths)** | ✅ 2026-07-15 — `01-continuite-limites` (le seul chapitre du pilote bac-math) : **5 figures** (continuité vs saut, asymptotes de (2x+1)/(x−3), théorème des gendarmes, TVI, + résumé). Courbes **calculées** (paths exacts), registre sobre (bac, fr, notation latine)                                              |
