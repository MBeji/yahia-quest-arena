...
- **Brouillons** (non validées) : 02 (examen blanc*) · 06 (PWA) · 07 (knowledge graph*) · 08 (analytics familles*) · 09 (économie du jeu) · 10 (anti-fraude) · 12 (studio d'ingestion) · **19 (questions & exercices illustrés — pendant de l'étude 18 côté questions ; le rendu existe déjà (`SvgFigure`), l'enjeu est la détection par-question à l'échelle : 780/18 708 questions illustrées (4,2 %) ; lot 1 = doctrine + gate signalant les questions spatiales sans figure, exécutable dès sa Q-1 tranchée ; Q-1…Q-4 ouvertes)** · **20 (rappel actif tolérant — jeu de réponses acceptées ; corrige les faux négatifs du mode Rappel constatés en prod le 2026-07-15 : une réponse juste formulée autrement était refusée ; scoring ensembliste + champ contenu `recallAnswers` généré hors-ligne & server-only ; arbitrage humain : **zéro question exclue** ; Q-1…Q-4 ouvertes)**.
