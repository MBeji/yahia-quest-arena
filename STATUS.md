...
- **Validées (prêtes à exécuter)** : 17 (rappel actif — QCM rejoués en saisie libre, arbitrée 2026-07-13) · 18 (cours vivants — blocs pédagogiques & doctrine d'illustration, arbitrée 2026-07-14 ; lots 1-3 = code pur qui restructure 512 cours / 541 résumés **sans toucher un fichier de contenu**, lots 4-5 = axe « Illustration » dans la barre qualité + géométrie 9ᵉ illustrée ; à passer **avant** les prochaines vagues de génération).
