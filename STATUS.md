...
- **Validées (prêtes à exécuter)** : — (17 rappel actif livrée le 2026-07-14).
- **Brouillons** (non validées) : 02 (examen blanc*) · 06 (PWA) · 07 (knowledge graph*) · 08 (analytics familles*) · 09 (économie du jeu) · 10 (anti-fraude) · 12 (studio d'ingestion) · **19 (questions & exercices illustrés — pendant de l'étude 18 côté questions ; le rendu existe déjà (`SvgFigure`), l'enjeu est la détection par-question à l'échelle : 780/18 708 questions illustrées (4,2 %) ; lot 1 = doctrine + gate signalant les questions spatiales sans figure, exécutable dès sa Q-1 tranchée ; Q-1…Q-4 ouvertes)** · **20 (réponses acceptées — rappel tolérant & questions libres natives ; corrige les faux négatifs du mode Rappel constatés en prod le 2026-07-15 (une réponse juste formulée autrement était refusée) via un scoring ensembliste + champ contenu `acceptedAnswers` généré hors-ligne & server-only ; amendée le 2026-07-16 : volet B — type natif `short_answer`, la question **sans réponses proposées** devient authorable, corrigée par le même jeu de réponses acceptées (seam `score_answer`, étude 03) ; arbitrage humain : **zéro question exclue** ; Q-1/Q-3 arbitrées, Q-2/Q-4/Q-5 ouvertes)**.
