...
| Rappel actif (rejouer les QCM maîtrisés en saisie libre, XP ×1,5)                    | ⬜   | étude 17 (brouillon, 2026-07-13) ; audit mesuré : 67 % des questions QCM / 76 % des exercices éligibles                                                                                                                                                                             |
...
- **Brouillons** (non validées) : 02 (examen blanc*) · 06 (PWA) · 07 (knowledge graph*) · 08 (analytics familles*) · 09 (économie du jeu) · 10 (anti-fraude) · 12 (studio d'ingestion) · 17 (rappel actif — QCM rejoués en saisie libre).
