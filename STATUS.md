...
| Rappel actif (rejouer les QCM maîtrisés en saisie libre, XP ×1,5)                    | ⬜   | étude 17 (**validée** 2026-07-13, prête pour le lot 1) ; audit mesuré : 67 % des questions QCM / 76 % des exercices éligibles                                                                                                                                                       |
...
- **En exécution** : 04 (adaptatif — A0 fait, A1+ à venir) · 15 (contenu & composition — lots 0-6 livrés / 14) · 16 (ouverture lycée — lots 0-3 livrés, PRs #367/#369/#371/#375 ; campagne §4bis vague A **en cours : `math-1ere-sec` complète 16/16 et parcours `ecole-1ere-sec` OUVERT le 2026-07-13** — PRs #397/#398/#402/#404 + migration `20260713180000_open_ecole_1ere_sec_parcours` ; reste 4 autres matières 1ère sec ; génération native fr sans traduction, décision 2026-07-13) · 18 (cours vivants — **lots 1-4 livrés 2026-07-14** : le moteur promeut les 2 637 callouts déjà écrits → **517 cours / 541** structurés ; figures = planches légendées, numérotées, agrandissables ; résumé = **3 827 cartes dans 526 résumés** ; et **le gate contenu inspecte enfin les 541 leçons** — son premier passage a révélé **46 violations de notation dans 22 fichiers** (virgule arabe comme séparateur, bidi-cassante), toutes corrigées, et l'**axe 5 « Illustration »** de la barre qualité remonte désormais **28 chapitres spatiaux sans le moindre dessin** = le backlog de la campagne, généré par la machine. Reste **lot 5** : illustrer la géométrie 9ᵉ (le pilote maquetté)).
