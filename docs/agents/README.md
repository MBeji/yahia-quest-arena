...
| [`pgtap-en-local.md`](./pgtap-en-local.md)                     | Avant de toucher à `supabase/migrations/**` ou `supabase/tests/**` — la suite complète en une commande (`npm run db:test:local`, 48 s en session cloud) au lieu de 5-8 min de CI                                 |
...
| [`etude-cloud-first.md`](./etude-cloud-first.md)               | **Étude ouverte** (2026-09-04) : travailler depuis le téléphone et le web sans poste — ce que le cloud fait déjà (mesuré), le seul réglage qui débloque le reste, où vont les documents, et les murs qui restent |
